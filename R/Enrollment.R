	...
	getEnrollmentConfigDistrictYear <- function(EnrollmentConfigDistrictYearID, ConfigDistrictYearID = F, DistrictID = F, SchoolYearID = F, PreviouslyEnrolledSameEntityNoShowActionType = F, EnrolledDifferentEntityNoShowActionType = F, NoDistrictEnrollmentNoShowActionType = F, EnableNoShow = F, PriorNoShowRecord = F, ConfigDistrictYearIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, PreviouslyEnrolledSameEntityNoShowEntryDate = F, PreviouslyEnrolledSameEntityNoShowWithdrawalDate = F, EnrolledDifferentEntityNoShowEntryDate = F, EnrolledDifferentEntityNoShowWithdrawalDate = F, NoDistrictEnrollmentNoShowEntryDate = F, NoDistrictEnrollmentNoShowWithdrawalDate = F, AutoAddSchoolPathOverride = F, PermitIDAutoAdd = F, DefaultRetainInterventionPlanRecords = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "ConfigDistrictYear", objectId = EnrollmentConfigDistrictYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEnrollmentConfigDistrictYear <- function(EnrollmentConfigDistrictYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "ConfigDistrictYear", objectId = EnrollmentConfigDistrictYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createEnrollmentConfigDistrictYear <- function(DistrictID = NULL, SchoolYearID = NULL, PreviouslyEnrolledSameEntityNoShowActionType = NULL, EnrolledDifferentEntityNoShowActionType = NULL, NoDistrictEnrollmentNoShowActionType = NULL, EnableNoShow = NULL, PriorNoShowRecord = NULL, ConfigDistrictYearIDClonedFrom = NULL, PreviouslyEnrolledSameEntityNoShowEntryDate = NULL, PreviouslyEnrolledSameEntityNoShowWithdrawalDate = NULL, EnrolledDifferentEntityNoShowEntryDate = NULL, EnrolledDifferentEntityNoShowWithdrawalDate = NULL, NoDistrictEnrollmentNoShowEntryDate = NULL, NoDistrictEnrollmentNoShowWithdrawalDate = NULL, AutoAddSchoolPathOverride = NULL, PermitIDAutoAdd = NULL, DefaultRetainInterventionPlanRecords = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "ConfigDistrictYear", body = list(DataObject = body), searchFields = append("ConfigDistrictYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyEnrollmentConfigDistrictYear <- function(ConfigDistrictYearID, DistrictID = NULL, SchoolYearID = NULL, PreviouslyEnrolledSameEntityNoShowActionType = NULL, EnrolledDifferentEntityNoShowActionType = NULL, NoDistrictEnrollmentNoShowActionType = NULL, EnableNoShow = NULL, PriorNoShowRecord = NULL, ConfigDistrictYearIDClonedFrom = NULL, PreviouslyEnrolledSameEntityNoShowEntryDate = NULL, PreviouslyEnrolledSameEntityNoShowWithdrawalDate = NULL, EnrolledDifferentEntityNoShowEntryDate = NULL, EnrolledDifferentEntityNoShowWithdrawalDate = NULL, NoDistrictEnrollmentNoShowEntryDate = NULL, NoDistrictEnrollmentNoShowWithdrawalDate = NULL, AutoAddSchoolPathOverride = NULL, PermitIDAutoAdd = NULL, DefaultRetainInterventionPlanRecords = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "ConfigDistrictYear", objectId = ConfigDistrictYearID, body = list(DataObject = body), searchFields = append("ConfigDistrictYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEnrollmentConfigDistrictYearWithdrawalCode <- function(EnrollmentConfigDistrictYearWithdrawalCodeID, ConfigDistrictYearWithdrawalCodeID = F, ConfigDistrictYearID = F, WithdrawalCodeID = F, Type = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ConfigDistrictYearWithdrawalCodeIDClonedFrom = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "ConfigDistrictYearWithdrawalCode", objectId = EnrollmentConfigDistrictYearWithdrawalCodeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEnrollmentConfigDistrictYearWithdrawalCode <- function(EnrollmentConfigDistrictYearWithdrawalCodeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "ConfigDistrictYearWithdrawalCode", objectId = EnrollmentConfigDistrictYearWithdrawalCodeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEnrollmentConfigDistrictYearWithdrawalCode <- function(ConfigDistrictYearID = NULL, WithdrawalCodeID = NULL, Type = NULL, ConfigDistrictYearWithdrawalCodeIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "ConfigDistrictYearWithdrawalCode", body = list(DataObject = body), searchFields = append("ConfigDistrictYearWithdrawalCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEnrollmentConfigDistrictYearWithdrawalCode <- function(ConfigDistrictYearWithdrawalCodeID, ConfigDistrictYearID = NULL, WithdrawalCodeID = NULL, Type = NULL, ConfigDistrictYearWithdrawalCodeIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "ConfigDistrictYearWithdrawalCode", objectId = ConfigDistrictYearWithdrawalCodeID, body = list(DataObject = body), searchFields = append("ConfigDistrictYearWithdrawalCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentEntityYear <- function(TempStudentEntityYearID, StudentEntityYearID = F, StudentFullName = F, StudentNumber = F, GenderCode = F, GradeLevelCodeDescription = F, IsActive = F, HomeroomID = F, HomeroomDetails = F, CurrentHomeroomDetails = F, StaffIDAdvisor = F, AdvisorDetails = F, CurrentAdvisorDetails = F, Message = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempStudentEntityYear", objectId = TempStudentEntityYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentEntityYear <- function(TempStudentEntityYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempStudentEntityYear", objectId = TempStudentEntityYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempStudentEntityYear <- function(StudentEntityYearID = NULL, StudentFullName = NULL, StudentNumber = NULL, GenderCode = NULL, GradeLevelCodeDescription = NULL, IsActive = NULL, HomeroomID = NULL, HomeroomDetails = NULL, CurrentHomeroomDetails = NULL, StaffIDAdvisor = NULL, AdvisorDetails = NULL, CurrentAdvisorDetails = NULL, Message = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "TempStudentEntityYear", body = list(DataObject = body), searchFields = append("TempStudentEntityYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempStudentEntityYear <- function(TempStudentEntityYearID, StudentEntityYearID = NULL, StudentFullName = NULL, StudentNumber = NULL, GenderCode = NULL, GradeLevelCodeDescription = NULL, IsActive = NULL, HomeroomID = NULL, HomeroomDetails = NULL, CurrentHomeroomDetails = NULL, StaffIDAdvisor = NULL, AdvisorDetails = NULL, CurrentAdvisorDetails = NULL, Message = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "TempStudentEntityYear", objectId = TempStudentEntityYearID, body = list(DataObject = body), searchFields = append("TempStudentEntityYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEntryWithdrawal <- function(EntryWithdrawalID, EntryWithdrawalMNID = F, StateDistrictMNID = F, StateAidCategoryCodeMNID = F, StateLastAttendanceLocationCodeMNID = F, IsPostSecondaryOption = F, IsIndependentStudy = F, AttendanceDays = F, MembershipDays = F, SpecialEdServiceHours = F, TotalMembershipDays = F, StudentID = F, EntityID = F, SchoolYearID = F, StartDate = F, EntryCodeID = F, EntryComment = F, SchoolID = F, StudentTypeID = F, GradeReferenceID = F, EntryWithdrawalIDStatusChangePrevious = F, PromotionStatus = F, RenderUndoStatusChangeOption = F, RenderDeleteOption = F, RenderPrintWithdrawalFormOption = F, RenderNoShowOption = F, PercentEnrolled = F, WithdrawalCodeID = F, WithdrawalComment = F, EndDate = F, IsDefaultEntity = F, CalendarID = F, IsNoShow = F, IsCurrentOrFutureEnrollment = F, StatusChangeEntry = F, StatusChangeWithdrawal = F, EnrolledAtLeastOneDay = F, IsStartDateOnOrAfterFirstDayOfSchool = F, IsCrossEntityCourseEnrollment = F, IsHistoricalEnrollment = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, PSEOHours = F, IsPSEOConcurrentEnrollment = F, HasMessageCenterAllowedWithdrawalCodeOverride = F, WithdrawalDate = F, IsCombinedEnrollmentFullTime = F, RenderStatusChangeOption = F, RenderWithdrawalOption = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "EntryWithdrawal", objectId = EntryWithdrawalID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEntryWithdrawal <- function(EntryWithdrawalID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "EntryWithdrawal", objectId = EntryWithdrawalID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createEntryWithdrawal <- function(StateDistrictMNID = NULL, StateAidCategoryCodeMNID = NULL, StateLastAttendanceLocationCodeMNID = NULL, IsPostSecondaryOption = NULL, IsIndependentStudy = NULL, AttendanceDays = NULL, MembershipDays = NULL, SpecialEdServiceHours = NULL, StudentID = NULL, EntityID = NULL, SchoolYearID = NULL, StartDate = NULL, EntryCodeID = NULL, EntryComment = NULL, SchoolID = NULL, StudentTypeID = NULL, GradeReferenceID = NULL, EntryWithdrawalIDStatusChangePrevious = NULL, PromotionStatus = NULL, PercentEnrolled = NULL, WithdrawalCodeID = NULL, WithdrawalComment = NULL, EndDate = NULL, IsDefaultEntity = NULL, CalendarID = NULL, IsNoShow = NULL, PSEOHours = NULL, IsPSEOConcurrentEnrollment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "EntryWithdrawal", body = list(DataObject = body), searchFields = append("EntryWithdrawalID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyEntryWithdrawal <- function(EntryWithdrawalID, StateDistrictMNID = NULL, StateAidCategoryCodeMNID = NULL, StateLastAttendanceLocationCodeMNID = NULL, IsPostSecondaryOption = NULL, IsIndependentStudy = NULL, AttendanceDays = NULL, MembershipDays = NULL, SpecialEdServiceHours = NULL, StudentID = NULL, EntityID = NULL, SchoolYearID = NULL, StartDate = NULL, EntryCodeID = NULL, EntryComment = NULL, SchoolID = NULL, StudentTypeID = NULL, GradeReferenceID = NULL, EntryWithdrawalIDStatusChangePrevious = NULL, PromotionStatus = NULL, PercentEnrolled = NULL, WithdrawalCodeID = NULL, WithdrawalComment = NULL, EndDate = NULL, IsDefaultEntity = NULL, CalendarID = NULL, IsNoShow = NULL, PSEOHours = NULL, IsPSEOConcurrentEnrollment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "EntryWithdrawal", objectId = EntryWithdrawalID, body = list(DataObject = body), searchFields = append("EntryWithdrawalID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSchool <- function(SchoolID, SchoolMNID = F, SchoolNumber = F, StateKindergartenScheduleIndicatorCodeMNID = F, StateTitleISchoolIndicatorCodeMNID = F, IsTitleIII = F, DistrictID = F, Code = F, Name = F, GradeLevelIDLow = F, GradeLevelIDHigh = F, PhoneNumber = F, PhoneNumberIsInternational = F, FaxNumber = F, FaxNumberIsInternational = F, StaffIDPrincipal = F, BuildingID = F, Type = F, FormattedPhoneNumber = F, FormattedFaxNumber = F, SchoolYearID = F, SchoolIDClonedFrom = F, CampusAccountabilityRatingID = F, EdFiSchoolCategoryID = F, FederalAlternativeSchoolDetailID = F, FederalJusticeFacilityTypeID = F, ExcludeFromCRDC = F, IsNonLEA = F, HasUngraded = F, HasPreschoolNonIDEAAge3 = F, HasPreschoolNonIDEAAge4 = F, HasPreschoolNonIDEAAge5 = F, HasUngradedMainlyElementary = F, HasUngradedMainlyMiddleSchool = F, HasUngradedMainlyHighSchool = F, IsSpecialEducation = F, IsMagnet = F, IsCharter = F, IsAlternative = F, IsEntireSchoolMagnet = F, HasGifted = F, HasIBDiplomaProgramme = F, HasAPCourses = F, HasAPSelfSelection = F, HasDualEnrollment = F, HasSingleSexClasses = F, HasCreditRecovery = F, HasSingleSexAthletics = F, HasCorporalPunishment = F, DaysInRegularSchoolYear = F, EducationalProgramHoursPerWeek = F, DaysPriorForAlgebraICounts = F, IsCRDCCollectedForSchoolYear = F, CodeName = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsALCSchool = F, SchoolIDClonedTo = F, HasSafetyPlan = F, HasZeroTolerance = F, HasAntiViolence = F, HasAntiBullying = F, HasAlcoholDrugEducation = F, HasCrisisPlan = F, NameIDSafetySpecialist = F, HasShootingOccurred = F, HasHomicideOccurred = F, FederalNCESSchoolID = F, EdFiSchoolID = F, HasFiberOptic = F, HasWiFi = F, AllowsSchoolDevices = F, AllowsStudentDevices = F, NumberWiFiDevices = F, IsCEP = F, StateSchoolMNID = F, CEEBCode = F, IsTitleISchoolwide = F, StateAssignedID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "School", objectId = SchoolID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchool <- function(SchoolID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "School", objectId = SchoolID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createSchool <- function(SchoolNumber = NULL, StateKindergartenScheduleIndicatorCodeMNID = NULL, StateTitleISchoolIndicatorCodeMNID = NULL, IsTitleIII = NULL, DistrictID = NULL, Code = NULL, Name = NULL, GradeLevelIDLow = NULL, GradeLevelIDHigh = NULL, PhoneNumber = NULL, PhoneNumberIsInternational = NULL, FaxNumber = NULL, FaxNumberIsInternational = NULL, StaffIDPrincipal = NULL, Type = NULL, SchoolYearID = NULL, SchoolIDClonedFrom = NULL, CampusAccountabilityRatingID = NULL, EdFiSchoolCategoryID = NULL, FederalAlternativeSchoolDetailID = NULL, FederalJusticeFacilityTypeID = NULL, ExcludeFromCRDC = NULL, IsNonLEA = NULL, HasUngraded = NULL, HasPreschoolNonIDEAAge3 = NULL, HasPreschoolNonIDEAAge4 = NULL, HasPreschoolNonIDEAAge5 = NULL, HasUngradedMainlyElementary = NULL, HasUngradedMainlyMiddleSchool = NULL, HasUngradedMainlyHighSchool = NULL, IsSpecialEducation = NULL, IsMagnet = NULL, IsCharter = NULL, IsAlternative = NULL, IsEntireSchoolMagnet = NULL, HasGifted = NULL, HasIBDiplomaProgramme = NULL, HasAPCourses = NULL, HasAPSelfSelection = NULL, HasDualEnrollment = NULL, HasSingleSexClasses = NULL, HasCreditRecovery = NULL, HasSingleSexAthletics = NULL, HasCorporalPunishment = NULL, DaysInRegularSchoolYear = NULL, EducationalProgramHoursPerWeek = NULL, DaysPriorForAlgebraICounts = NULL, IsALCSchool = NULL, HasSafetyPlan = NULL, HasZeroTolerance = NULL, HasAntiViolence = NULL, HasAntiBullying = NULL, HasAlcoholDrugEducation = NULL, HasCrisisPlan = NULL, NameIDSafetySpecialist = NULL, HasShootingOccurred = NULL, HasHomicideOccurred = NULL, FederalNCESSchoolID = NULL, EdFiSchoolID = NULL, HasFiberOptic = NULL, HasWiFi = NULL, AllowsSchoolDevices = NULL, AllowsStudentDevices = NULL, NumberWiFiDevices = NULL, IsCEP = NULL, StateSchoolMNID = NULL, CEEBCode = NULL, IsTitleISchoolwide = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "School", body = list(DataObject = body), searchFields = append("SchoolID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifySchool <- function(SchoolID, SchoolNumber = NULL, StateKindergartenScheduleIndicatorCodeMNID = NULL, StateTitleISchoolIndicatorCodeMNID = NULL, IsTitleIII = NULL, DistrictID = NULL, Code = NULL, Name = NULL, GradeLevelIDLow = NULL, GradeLevelIDHigh = NULL, PhoneNumber = NULL, PhoneNumberIsInternational = NULL, FaxNumber = NULL, FaxNumberIsInternational = NULL, StaffIDPrincipal = NULL, Type = NULL, SchoolYearID = NULL, SchoolIDClonedFrom = NULL, CampusAccountabilityRatingID = NULL, EdFiSchoolCategoryID = NULL, FederalAlternativeSchoolDetailID = NULL, FederalJusticeFacilityTypeID = NULL, ExcludeFromCRDC = NULL, IsNonLEA = NULL, HasUngraded = NULL, HasPreschoolNonIDEAAge3 = NULL, HasPreschoolNonIDEAAge4 = NULL, HasPreschoolNonIDEAAge5 = NULL, HasUngradedMainlyElementary = NULL, HasUngradedMainlyMiddleSchool = NULL, HasUngradedMainlyHighSchool = NULL, IsSpecialEducation = NULL, IsMagnet = NULL, IsCharter = NULL, IsAlternative = NULL, IsEntireSchoolMagnet = NULL, HasGifted = NULL, HasIBDiplomaProgramme = NULL, HasAPCourses = NULL, HasAPSelfSelection = NULL, HasDualEnrollment = NULL, HasSingleSexClasses = NULL, HasCreditRecovery = NULL, HasSingleSexAthletics = NULL, HasCorporalPunishment = NULL, DaysInRegularSchoolYear = NULL, EducationalProgramHoursPerWeek = NULL, DaysPriorForAlgebraICounts = NULL, IsALCSchool = NULL, HasSafetyPlan = NULL, HasZeroTolerance = NULL, HasAntiViolence = NULL, HasAntiBullying = NULL, HasAlcoholDrugEducation = NULL, HasCrisisPlan = NULL, NameIDSafetySpecialist = NULL, HasShootingOccurred = NULL, HasHomicideOccurred = NULL, FederalNCESSchoolID = NULL, EdFiSchoolID = NULL, HasFiberOptic = NULL, HasWiFi = NULL, AllowsSchoolDevices = NULL, AllowsStudentDevices = NULL, NumberWiFiDevices = NULL, IsCEP = NULL, StateSchoolMNID = NULL, CEEBCode = NULL, IsTitleISchoolwide = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "School", objectId = SchoolID, body = list(DataObject = body), searchFields = append("SchoolID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getWithdrawalCode <- function(WithdrawalCodeID, WithdrawalCodeMNID = F, StateStatusEndCodeMNID = F, DistrictID = F, Code = F, Description = F, SchoolYearID = F, Type = F, DistrictGroupKey = F, WithdrawalCodeIDClonedFrom = F, CodeDescription = F, IsCrossEntityCourseEnrollment = F, EdFiExitWithdrawID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EdFiExitWithdrawTypeDescriptorID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "WithdrawalCode", objectId = WithdrawalCodeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWithdrawalCode <- function(WithdrawalCodeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "WithdrawalCode", objectId = WithdrawalCodeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createWithdrawalCode <- function(StateStatusEndCodeMNID = NULL, DistrictID = NULL, Code = NULL, Description = NULL, SchoolYearID = NULL, Type = NULL, DistrictGroupKey = NULL, WithdrawalCodeIDClonedFrom = NULL, IsCrossEntityCourseEnrollment = NULL, EdFiExitWithdrawID = NULL, EdFiExitWithdrawTypeDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "WithdrawalCode", body = list(DataObject = body), searchFields = append("WithdrawalCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyWithdrawalCode <- function(WithdrawalCodeID, StateStatusEndCodeMNID = NULL, DistrictID = NULL, Code = NULL, Description = NULL, SchoolYearID = NULL, Type = NULL, DistrictGroupKey = NULL, WithdrawalCodeIDClonedFrom = NULL, IsCrossEntityCourseEnrollment = NULL, EdFiExitWithdrawID = NULL, EdFiExitWithdrawTypeDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "WithdrawalCode", objectId = WithdrawalCodeID, body = list(DataObject = body), searchFields = append("WithdrawalCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentEnrollmentRecord <- function(TempStudentEnrollmentRecordID, StudentID = F, StudentFullName = F, StudentNumber = F, GradeReferenceID = F, GradYear = F, GradeLevelCode = F, IsCurrentActive = F, EntityID = F, EntityCode = F, SchoolYearID = F, NumericYear = F, StartDate = F, EndDate = F, EntryCodeID = F, EntryCode = F, SchoolID = F, SchoolCode = F, CalendarID = F, CalendarCode = F, PercentEnrolled = F, IsDefaultEntityForEntryWithdrawal = F, IsDefaultEntityForStudentEntityYear = F, StudentTypeID = F, StudentTypeCode = F, EntryComment = F, StaffIDAdvisor = F, AdvisorFullName = F, StaffIDDisciplineOfficer = F, DisciplineOfficerFullName = F, HomeroomID = F, HomeroomCode = F, ExcludeFromHonorRoll = F, ExcludeFromRank = F, FailureReason = F, OutgoingStudent = F, WithdrawalCode = F, WithdrawalCodeID = F, WithdrawalComment = F, EntryWithdrawalID = F, IsTuitionPaidOutOfDistrict = F, TestingSchoolCode = F, TestingSchoolCodeDisplayName = F, GSAADAClaimableOverrideCode = F, GSAADAClaimableOverrideCodeDisplayName = F, ServingRCDTSOverrideID = F, ServingRCDTSOverrideCode = F, ServingRCDTSOverrideCodeDisplayName = F, TestingSchoolRCDTSOverrideID = F, TestingSchoolRCDTSOverrideCode = F, TestingSchoolRCDTSOverrideCodeDisplayName = F, IsPermanentExit = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IncludeAsProspectiveRank = F, StateDistrictMNID = F, CreateFeeManagementCustomer = F, CreateFeeManagementCustomerEntityYear = F, FeeManagementCustomerID = F, StateDistrictMNCodeName = F, StateAidCategoryMNID = F, StateLastAttendanceLocationCodeMNID = F, EdFiDistrictIDResidence = F, EdFiDistrictResidenceCodeDescription = F, ExcludeFromThirdFridaySeptemberCount = F, CompletedSchoolYearOverride = F, SourceEntryWithdrawalID = F, EnrollIntoEntityCode = F, TotalStudentCourseRequestCount = F, StudentCourseRequestNotMoveableCount = F, ScheduledSectionCount = F, EnrollmentMoveable = F, StudentCourseRequestToDeleteCount = F, IsPrivateSchoolChoiceStudent = F, EdFiDistrictIDTransfer = F, EdFiSchoolIDTransfer = F, PromotionStatus = F, Error = F, ErrorCount = F, ProcessEntryWithdrawal = F, HomeRCDTSOverrideID = F, HomeRCDTSOverrideCode = F, HomeRCDTSOverrideCodeDisplayName = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempStudentEnrollmentRecord", objectId = TempStudentEnrollmentRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentEnrollmentRecord <- function(TempStudentEnrollmentRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempStudentEnrollmentRecord", objectId = TempStudentEnrollmentRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempStudentEnrollmentRecord <- function(StudentID = NULL, StudentFullName = NULL, StudentNumber = NULL, GradeReferenceID = NULL, GradYear = NULL, GradeLevelCode = NULL, IsCurrentActive = NULL, EntityID = NULL, EntityCode = NULL, SchoolYearID = NULL, NumericYear = NULL, StartDate = NULL, EndDate = NULL, EntryCodeID = NULL, EntryCode = NULL, SchoolID = NULL, SchoolCode = NULL, CalendarID = NULL, CalendarCode = NULL, PercentEnrolled = NULL, IsDefaultEntityForEntryWithdrawal = NULL, IsDefaultEntityForStudentEntityYear = NULL, StudentTypeID = NULL, StudentTypeCode = NULL, EntryComment = NULL, StaffIDAdvisor = NULL, AdvisorFullName = NULL, StaffIDDisciplineOfficer = NULL, DisciplineOfficerFullName = NULL, HomeroomID = NULL, HomeroomCode = NULL, ExcludeFromHonorRoll = NULL, ExcludeFromRank = NULL, FailureReason = NULL, OutgoingStudent = NULL, WithdrawalCode = NULL, WithdrawalCodeID = NULL, WithdrawalComment = NULL, EntryWithdrawalID = NULL, IsTuitionPaidOutOfDistrict = NULL, TestingSchoolCode = NULL, TestingSchoolCodeDisplayName = NULL, GSAADAClaimableOverrideCode = NULL, GSAADAClaimableOverrideCodeDisplayName = NULL, ServingRCDTSOverrideID = NULL, ServingRCDTSOverrideCode = NULL, ServingRCDTSOverrideCodeDisplayName = NULL, TestingSchoolRCDTSOverrideID = NULL, TestingSchoolRCDTSOverrideCode = NULL, TestingSchoolRCDTSOverrideCodeDisplayName = NULL, IsPermanentExit = NULL, IncludeAsProspectiveRank = NULL, StateDistrictMNID = NULL, CreateFeeManagementCustomer = NULL, CreateFeeManagementCustomerEntityYear = NULL, FeeManagementCustomerID = NULL, StateDistrictMNCodeName = NULL, StateAidCategoryMNID = NULL, StateLastAttendanceLocationCodeMNID = NULL, EdFiDistrictIDResidence = NULL, EdFiDistrictResidenceCodeDescription = NULL, ExcludeFromThirdFridaySeptemberCount = NULL, CompletedSchoolYearOverride = NULL, SourceEntryWithdrawalID = NULL, EnrollIntoEntityCode = NULL, TotalStudentCourseRequestCount = NULL, StudentCourseRequestNotMoveableCount = NULL, ScheduledSectionCount = NULL, EnrollmentMoveable = NULL, StudentCourseRequestToDeleteCount = NULL, IsPrivateSchoolChoiceStudent = NULL, EdFiDistrictIDTransfer = NULL, EdFiSchoolIDTransfer = NULL, PromotionStatus = NULL, Error = NULL, ErrorCount = NULL, ProcessEntryWithdrawal = NULL, HomeRCDTSOverrideID = NULL, HomeRCDTSOverrideCode = NULL, HomeRCDTSOverrideCodeDisplayName = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "TempStudentEnrollmentRecord", body = list(DataObject = body), searchFields = append("TempStudentEnrollmentRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempStudentEnrollmentRecord <- function(TempStudentEnrollmentRecordID, StudentID = NULL, StudentFullName = NULL, StudentNumber = NULL, GradeReferenceID = NULL, GradYear = NULL, GradeLevelCode = NULL, IsCurrentActive = NULL, EntityID = NULL, EntityCode = NULL, SchoolYearID = NULL, NumericYear = NULL, StartDate = NULL, EndDate = NULL, EntryCodeID = NULL, EntryCode = NULL, SchoolID = NULL, SchoolCode = NULL, CalendarID = NULL, CalendarCode = NULL, PercentEnrolled = NULL, IsDefaultEntityForEntryWithdrawal = NULL, IsDefaultEntityForStudentEntityYear = NULL, StudentTypeID = NULL, StudentTypeCode = NULL, EntryComment = NULL, StaffIDAdvisor = NULL, AdvisorFullName = NULL, StaffIDDisciplineOfficer = NULL, DisciplineOfficerFullName = NULL, HomeroomID = NULL, HomeroomCode = NULL, ExcludeFromHonorRoll = NULL, ExcludeFromRank = NULL, FailureReason = NULL, OutgoingStudent = NULL, WithdrawalCode = NULL, WithdrawalCodeID = NULL, WithdrawalComment = NULL, EntryWithdrawalID = NULL, IsTuitionPaidOutOfDistrict = NULL, TestingSchoolCode = NULL, TestingSchoolCodeDisplayName = NULL, GSAADAClaimableOverrideCode = NULL, GSAADAClaimableOverrideCodeDisplayName = NULL, ServingRCDTSOverrideID = NULL, ServingRCDTSOverrideCode = NULL, ServingRCDTSOverrideCodeDisplayName = NULL, TestingSchoolRCDTSOverrideID = NULL, TestingSchoolRCDTSOverrideCode = NULL, TestingSchoolRCDTSOverrideCodeDisplayName = NULL, IsPermanentExit = NULL, IncludeAsProspectiveRank = NULL, StateDistrictMNID = NULL, CreateFeeManagementCustomer = NULL, CreateFeeManagementCustomerEntityYear = NULL, FeeManagementCustomerID = NULL, StateDistrictMNCodeName = NULL, StateAidCategoryMNID = NULL, StateLastAttendanceLocationCodeMNID = NULL, EdFiDistrictIDResidence = NULL, EdFiDistrictResidenceCodeDescription = NULL, ExcludeFromThirdFridaySeptemberCount = NULL, CompletedSchoolYearOverride = NULL, SourceEntryWithdrawalID = NULL, EnrollIntoEntityCode = NULL, TotalStudentCourseRequestCount = NULL, StudentCourseRequestNotMoveableCount = NULL, ScheduledSectionCount = NULL, EnrollmentMoveable = NULL, StudentCourseRequestToDeleteCount = NULL, IsPrivateSchoolChoiceStudent = NULL, EdFiDistrictIDTransfer = NULL, EdFiSchoolIDTransfer = NULL, PromotionStatus = NULL, Error = NULL, ErrorCount = NULL, ProcessEntryWithdrawal = NULL, HomeRCDTSOverrideID = NULL, HomeRCDTSOverrideCode = NULL, HomeRCDTSOverrideCodeDisplayName = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "TempStudentEnrollmentRecord", objectId = TempStudentEnrollmentRecordID, body = list(DataObject = body), searchFields = append("TempStudentEnrollmentRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempAffectedWithdrawalRecord <- function(TempAffectedWithdrawalRecordID, AffectedPrimaryKey = F, StudentID = F, EntityID = F, SchoolYearID = F, NameIDRequestedBy = F, CourseID = F, Description = F, SectionID = F, Section = F, StartDate = F, EndDate = F, NewEndDate = F, HasGrades = F, HasFutureGrades = F, HasAttendance = F, HasFutureAttendance = F, HasPartiallyPaidFees = F, ActionMessage = F, MostFutureGradeStartDate = F, RecordType = F, Action = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsFutureEntryWithdrawal = F, HasTransactionPreventingStudentSectionDelete = F, ParentPrimaryKey = F, IsNoShowDeleteNoOtherEnrollmentInTheDistrict = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempAffectedWithdrawalRecord", objectId = TempAffectedWithdrawalRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempAffectedWithdrawalRecord <- function(TempAffectedWithdrawalRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempAffectedWithdrawalRecord", objectId = TempAffectedWithdrawalRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempAffectedWithdrawalRecord <- function(AffectedPrimaryKey = NULL, StudentID = NULL, EntityID = NULL, SchoolYearID = NULL, NameIDRequestedBy = NULL, CourseID = NULL, Description = NULL, SectionID = NULL, Section = NULL, StartDate = NULL, EndDate = NULL, NewEndDate = NULL, HasGrades = NULL, HasFutureGrades = NULL, HasAttendance = NULL, HasFutureAttendance = NULL, HasPartiallyPaidFees = NULL, ActionMessage = NULL, MostFutureGradeStartDate = NULL, RecordType = NULL, Action = NULL, IsFutureEntryWithdrawal = NULL, HasTransactionPreventingStudentSectionDelete = NULL, ParentPrimaryKey = NULL, IsNoShowDeleteNoOtherEnrollmentInTheDistrict = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "TempAffectedWithdrawalRecord", body = list(DataObject = body), searchFields = append("TempAffectedWithdrawalRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempAffectedWithdrawalRecord <- function(TempAffectedWithdrawalRecordID, AffectedPrimaryKey = NULL, StudentID = NULL, EntityID = NULL, SchoolYearID = NULL, NameIDRequestedBy = NULL, CourseID = NULL, Description = NULL, SectionID = NULL, Section = NULL, StartDate = NULL, EndDate = NULL, NewEndDate = NULL, HasGrades = NULL, HasFutureGrades = NULL, HasAttendance = NULL, HasFutureAttendance = NULL, HasPartiallyPaidFees = NULL, ActionMessage = NULL, MostFutureGradeStartDate = NULL, RecordType = NULL, Action = NULL, IsFutureEntryWithdrawal = NULL, HasTransactionPreventingStudentSectionDelete = NULL, ParentPrimaryKey = NULL, IsNoShowDeleteNoOtherEnrollmentInTheDistrict = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "TempAffectedWithdrawalRecord", objectId = TempAffectedWithdrawalRecordID, body = list(DataObject = body), searchFields = append("TempAffectedWithdrawalRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEnrollmentConfigDistrict <- function(EnrollmentConfigDistrictID, ConfigDistrictID = F, DistrictID = F, EntryDaysBeforeCalendarStart = F, WithdrawalDaysAfterCalendarEnd = F, NumberDaysBackdateEntry = F, NumberDaysBackdateWithdrawal = F, AllowDualEnrollment = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "ConfigDistrict", objectId = EnrollmentConfigDistrictID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEnrollmentConfigDistrict <- function(EnrollmentConfigDistrictID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "ConfigDistrict", objectId = EnrollmentConfigDistrictID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEnrollmentConfigDistrict <- function(DistrictID = NULL, EntryDaysBeforeCalendarStart = NULL, WithdrawalDaysAfterCalendarEnd = NULL, NumberDaysBackdateEntry = NULL, NumberDaysBackdateWithdrawal = NULL, AllowDualEnrollment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "ConfigDistrict", body = list(DataObject = body), searchFields = append("ConfigDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEnrollmentConfigDistrict <- function(ConfigDistrictID, DistrictID = NULL, EntryDaysBeforeCalendarStart = NULL, WithdrawalDaysAfterCalendarEnd = NULL, NumberDaysBackdateEntry = NULL, NumberDaysBackdateWithdrawal = NULL, AllowDualEnrollment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "ConfigDistrict", objectId = ConfigDistrictID, body = list(DataObject = body), searchFields = append("ConfigDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEntitySchool <- function(EntitySchoolID, EntityID = F, SchoolID = F, IsDefaultSchoolForEntity = F, IsDefaultEntityForSchool = F, EntitySchoolIDClonedFrom = F, IsOnlySchoolInEntity = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EntitySchoolIDClonedTo = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "EntitySchool", objectId = EntitySchoolID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEntitySchool <- function(EntitySchoolID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "EntitySchool", objectId = EntitySchoolID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEntitySchool <- function(EntityID = NULL, SchoolID = NULL, IsDefaultSchoolForEntity = NULL, IsDefaultEntityForSchool = NULL, EntitySchoolIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "EntitySchool", body = list(DataObject = body), searchFields = append("EntitySchoolID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEntitySchool <- function(EntitySchoolID, EntityID = NULL, SchoolID = NULL, IsDefaultSchoolForEntity = NULL, IsDefaultEntityForSchool = NULL, EntitySchoolIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "EntitySchool", objectId = EntitySchoolID, body = list(DataObject = body), searchFields = append("EntitySchoolID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEntryCode <- function(EntryCodeID, DistrictID = F, Code = F, Description = F, SchoolYearID = F, Type = F, DistrictGroupKey = F, EntryCodeIDClonedFrom = F, IsCrossEntityCourseEnrollment = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EdFiEntryTypeDescriptorID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "EntryCode", objectId = EntryCodeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEntryCode <- function(EntryCodeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "EntryCode", objectId = EntryCodeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEntryCode <- function(DistrictID = NULL, Code = NULL, Description = NULL, SchoolYearID = NULL, Type = NULL, DistrictGroupKey = NULL, EntryCodeIDClonedFrom = NULL, IsCrossEntityCourseEnrollment = NULL, EdFiEntryTypeDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "EntryCode", body = list(DataObject = body), searchFields = append("EntryCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEntryCode <- function(EntryCodeID, DistrictID = NULL, Code = NULL, Description = NULL, SchoolYearID = NULL, Type = NULL, DistrictGroupKey = NULL, EntryCodeIDClonedFrom = NULL, IsCrossEntityCourseEnrollment = NULL, EdFiEntryTypeDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "EntryCode", objectId = EntryCodeID, body = list(DataObject = body), searchFields = append("EntryCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getGradeLevel <- function(GradeLevelID, DistrictID = F, Code = F, Description = F, NumericValue = F, DistrictGroupKey = F, FederalGradeLevel = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StateGradeLevel = F, CommonEducationDataStandardsGradeLevelID = F, IlluminateOverride = F, EdFiGradeLevelDescriptorID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "GradeLevel", objectId = GradeLevelID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteGradeLevel <- function(GradeLevelID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "GradeLevel", objectId = GradeLevelID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createGradeLevel <- function(DistrictID = NULL, Code = NULL, Description = NULL, NumericValue = NULL, DistrictGroupKey = NULL, FederalGradeLevel = NULL, CommonEducationDataStandardsGradeLevelID = NULL, IlluminateOverride = NULL, EdFiGradeLevelDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "GradeLevel", body = list(DataObject = body), searchFields = append("GradeLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyGradeLevel <- function(GradeLevelID, DistrictID = NULL, Code = NULL, Description = NULL, NumericValue = NULL, DistrictGroupKey = NULL, FederalGradeLevel = NULL, CommonEducationDataStandardsGradeLevelID = NULL, IlluminateOverride = NULL, EdFiGradeLevelDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "GradeLevel", objectId = GradeLevelID, body = list(DataObject = body), searchFields = append("GradeLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getGradeReference <- function(GradeReferenceID, GradeLevelID = F, GradYear = F, SchoolYearID = F, DistrictGroupKey = F, MinutesPresentHalfDay = F, MinutesPresentFullDay = F, GradeReferenceIDClonedFrom = F, GradeReferenceIDClonedTo = F, StateGradeLevel = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, GradeReferenceMNID = F, StateSTARGradeLevelMNID = F, GradeLevelCode = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "GradeReference", objectId = GradeReferenceID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteGradeReference <- function(GradeReferenceID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "GradeReference", objectId = GradeReferenceID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createGradeReference <- function(GradeLevelID = NULL, GradYear = NULL, SchoolYearID = NULL, DistrictGroupKey = NULL, MinutesPresentHalfDay = NULL, MinutesPresentFullDay = NULL, GradeReferenceIDClonedFrom = NULL, StateSTARGradeLevelMNID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "GradeReference", body = list(DataObject = body), searchFields = append("GradeReferenceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyGradeReference <- function(GradeReferenceID, GradeLevelID = NULL, GradYear = NULL, SchoolYearID = NULL, DistrictGroupKey = NULL, MinutesPresentHalfDay = NULL, MinutesPresentFullDay = NULL, GradeReferenceIDClonedFrom = NULL, StateSTARGradeLevelMNID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "GradeReference", objectId = GradeReferenceID, body = list(DataObject = body), searchFields = append("GradeReferenceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getHomeroom <- function(HomeroomID, EntityID = F, Code = F, StaffID = F, RoomID = F, SchoolYearID = F, HomeroomIDClonedFrom = F, HomeroomIDClonedTo = F, HomeroomDetails = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "Homeroom", objectId = HomeroomID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteHomeroom <- function(HomeroomID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "Homeroom", objectId = HomeroomID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createHomeroom <- function(EntityID = NULL, Code = NULL, StaffID = NULL, RoomID = NULL, SchoolYearID = NULL, HomeroomIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "Homeroom", body = list(DataObject = body), searchFields = append("HomeroomID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyHomeroom <- function(HomeroomID, EntityID = NULL, Code = NULL, StaffID = NULL, RoomID = NULL, SchoolYearID = NULL, HomeroomIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "Homeroom", objectId = HomeroomID, body = list(DataObject = body), searchFields = append("HomeroomID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStudentEntityYear <- function(StudentEntityYearID, StudentID = F, EntityID = F, SchoolYearID = F, StaffIDAdvisor = F, HomeroomID = F, IsActive = F, IsDefaultEntity = F, SchedulingTeamID = F, StaffIDDisciplineOfficer = F, ExcludeFromHonorRoll = F, ExcludeFromRank = F, EntryWithdrawalIDLatest = F, SignedAcceptableUsePolicy = F, ChromebookDocumentsReturned = F, HandbookSigned = F, UILFeeReceived = F, OptOutOfMedia = F, IsTransportationRequested = F, IsCrossEntityCourseEnrollment = F, FeeChargeAmount = F, FeePaidAndWaivedAmount = F, FeePaidAmount = F, FeeWaivedAmount = F, FeeUnappliedAmount = F, FeeAmountDue = F, HasNoAttendanceToday = F, DaysAbsentYTD = F, DaysExcusedYTD = F, DaysOtherYTD = F, DaysUnexcusedYTD = F, TardyCountYTD = F, TardyKioskTotals = F, DaysEnrolledYTD = F, HasOpenDisplayPeriodsInRegularSchoolDay = F, HasOverscheduledPeriod = F, WithdrawalDate = F, TotalEarnedCreditsPossibleAnticipatedNonTransferStudentSectionsNonAlternateRequestCredits = F, TotalMissedAssignmentCount = F, HasMissingAssignments = F, HasValidStudentPlan = F, HasFlaggedMissingAssignments = F, FlaggedMissingAssignmentsCount = F, HasConflictedStudentCourseRequest = F, SchedulingCategories = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, HasActiveEndorsementDeclarationTimePeriod = F, IncludeAsProspectiveRank = F, FirstName = F, MiddleName = F, LastName = F, NameID = F, HasActiveCareerPlanDeclarationTimePeriod = F, SectionLengthEnrolled = F, Semester2Enrolled = F, SectionLengthAbsent = F, Semester2Absent = F, Grade = F, StudentNumber = F, HomeroomCodeFollettDestiny = F, HomeroomPeriodFollettDestiny = F, HomeroomStaffNameFollettDestiny = F, NumberOfStudentCourseRequests = F, NumberOfStudentSections = F, ExistsConflictedStudentCourseRequests = F, UnscheduledStudentCourseRequestCount = F, ExistsUnscheduleableStudentSections = F, UnscheduleableStudentSectionCount = F, CurrentPercentEnrolled = F, HasNonCrossEntityCourseSchedulingEntryWithdrawal = F, SchoolIDPathExpectedSchool = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "StudentEntityYear", objectId = StudentEntityYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentEntityYear <- function(StudentEntityYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "StudentEntityYear", objectId = StudentEntityYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createStudentEntityYear <- function(StudentID = NULL, EntityID = NULL, SchoolYearID = NULL, StaffIDAdvisor = NULL, HomeroomID = NULL, IsActive = NULL, IsDefaultEntity = NULL, SchedulingTeamID = NULL, StaffIDDisciplineOfficer = NULL, ExcludeFromHonorRoll = NULL, ExcludeFromRank = NULL, EntryWithdrawalIDLatest = NULL, SignedAcceptableUsePolicy = NULL, ChromebookDocumentsReturned = NULL, HandbookSigned = NULL, UILFeeReceived = NULL, OptOutOfMedia = NULL, IsTransportationRequested = NULL, IsCrossEntityCourseEnrollment = NULL, IncludeAsProspectiveRank = NULL, NameID = NULL, Grade = NULL, StudentNumber = NULL, CurrentPercentEnrolled = NULL, SchoolIDPathExpectedSchool = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "StudentEntityYear", body = list(DataObject = body), searchFields = append("StudentEntityYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyStudentEntityYear <- function(StudentEntityYearID, StudentID = NULL, EntityID = NULL, SchoolYearID = NULL, StaffIDAdvisor = NULL, HomeroomID = NULL, IsActive = NULL, IsDefaultEntity = NULL, SchedulingTeamID = NULL, StaffIDDisciplineOfficer = NULL, ExcludeFromHonorRoll = NULL, ExcludeFromRank = NULL, EntryWithdrawalIDLatest = NULL, SignedAcceptableUsePolicy = NULL, ChromebookDocumentsReturned = NULL, HandbookSigned = NULL, UILFeeReceived = NULL, OptOutOfMedia = NULL, IsTransportationRequested = NULL, IsCrossEntityCourseEnrollment = NULL, IncludeAsProspectiveRank = NULL, NameID = NULL, Grade = NULL, StudentNumber = NULL, CurrentPercentEnrolled = NULL, SchoolIDPathExpectedSchool = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "StudentEntityYear", objectId = StudentEntityYearID, body = list(DataObject = body), searchFields = append("StudentEntityYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentType <- function(StudentTypeID, DistrictID = F, Code = F, Description = F, DistrictGroupKey = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "StudentType", objectId = StudentTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentType <- function(StudentTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "StudentType", objectId = StudentTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentType <- function(DistrictID = NULL, Code = NULL, Description = NULL, DistrictGroupKey = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "StudentType", body = list(DataObject = body), searchFields = append("StudentTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentType <- function(StudentTypeID, DistrictID = NULL, Code = NULL, Description = NULL, DistrictGroupKey = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "StudentType", objectId = StudentTypeID, body = list(DataObject = body), searchFields = append("StudentTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getPermit <- function(PermitID, DistrictID = F, Code = F, Description = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AllowSchoolPathAssignment = F, SchoolYearID = F, PermitIDClonedFrom = F, PermitIDClonedTo = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "Permit", objectId = PermitID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePermit <- function(PermitID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "Permit", objectId = PermitID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPermit <- function(DistrictID = NULL, Code = NULL, Description = NULL, AllowSchoolPathAssignment = NULL, SchoolYearID = NULL, PermitIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "Permit", body = list(DataObject = body), searchFields = append("PermitID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPermit <- function(PermitID, DistrictID = NULL, Code = NULL, Description = NULL, AllowSchoolPathAssignment = NULL, SchoolYearID = NULL, PermitIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "Permit", objectId = PermitID, body = list(DataObject = body), searchFields = append("PermitID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getEntitySchoolBuilding <- function(EntitySchoolBuildingID, BuildingID = F, SchoolYearID = F, EntitySchoolID = F, IsPrimary = F, EntitySchoolBuildingIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "EntitySchoolBuilding", objectId = EntitySchoolBuildingID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEntitySchoolBuilding <- function(EntitySchoolBuildingID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "EntitySchoolBuilding", objectId = EntitySchoolBuildingID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEntitySchoolBuilding <- function(BuildingID = NULL, SchoolYearID = NULL, EntitySchoolID = NULL, IsPrimary = NULL, EntitySchoolBuildingIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "EntitySchoolBuilding", body = list(DataObject = body), searchFields = append("EntitySchoolBuildingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEntitySchoolBuilding <- function(EntitySchoolBuildingID, BuildingID = NULL, SchoolYearID = NULL, EntitySchoolID = NULL, IsPrimary = NULL, EntitySchoolBuildingIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "EntitySchoolBuilding", objectId = EntitySchoolBuildingID, body = list(DataObject = body), searchFields = append("EntitySchoolBuildingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSchoolPathSchoolOverride <- function(SchoolPathSchoolOverrideID, StudentID = F, SchoolID = F, Order = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "SchoolPathSchoolOverride", objectId = SchoolPathSchoolOverrideID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolPathSchoolOverride <- function(SchoolPathSchoolOverrideID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "SchoolPathSchoolOverride", objectId = SchoolPathSchoolOverrideID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolPathSchoolOverride <- function(StudentID = NULL, SchoolID = NULL, Order = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "SchoolPathSchoolOverride", body = list(DataObject = body), searchFields = append("SchoolPathSchoolOverrideID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolPathSchoolOverride <- function(SchoolPathSchoolOverrideID, StudentID = NULL, SchoolID = NULL, Order = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "SchoolPathSchoolOverride", objectId = SchoolPathSchoolOverrideID, body = list(DataObject = body), searchFields = append("SchoolPathSchoolOverrideID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempNoShowEntryWithdrawal <- function(TempNoShowEntryWithdrawalID, EntryWithdrawalID = F, StudentID = F, Student = F, GradeLevel = F, Entity = F, SchoolYear = F, StartDate = F, EndDate = F, EntryCode = F, WithdrawalCode = F, WithdrawalCodeID = F, NoShowTypeOfNoShow = F, NoShowAction = F, NoShowEntryWithdrawalType = F, DisplayAction = F, FailureReason = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StudentNumber = F, SchoolYearID = F, AttemptToUpdateWithdrawalCode = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempNoShowEntryWithdrawal", objectId = TempNoShowEntryWithdrawalID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempNoShowEntryWithdrawal <- function(TempNoShowEntryWithdrawalID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempNoShowEntryWithdrawal", objectId = TempNoShowEntryWithdrawalID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempNoShowEntryWithdrawal <- function(EntryWithdrawalID = NULL, StudentID = NULL, Student = NULL, GradeLevel = NULL, Entity = NULL, SchoolYear = NULL, StartDate = NULL, EndDate = NULL, EntryCode = NULL, WithdrawalCode = NULL, WithdrawalCodeID = NULL, NoShowTypeOfNoShow = NULL, NoShowAction = NULL, NoShowEntryWithdrawalType = NULL, DisplayAction = NULL, FailureReason = NULL, StudentNumber = NULL, SchoolYearID = NULL, AttemptToUpdateWithdrawalCode = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "TempNoShowEntryWithdrawal", body = list(DataObject = body), searchFields = append("TempNoShowEntryWithdrawalID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempNoShowEntryWithdrawal <- function(TempNoShowEntryWithdrawalID, EntryWithdrawalID = NULL, StudentID = NULL, Student = NULL, GradeLevel = NULL, Entity = NULL, SchoolYear = NULL, StartDate = NULL, EndDate = NULL, EntryCode = NULL, WithdrawalCode = NULL, WithdrawalCodeID = NULL, NoShowTypeOfNoShow = NULL, NoShowAction = NULL, NoShowEntryWithdrawalType = NULL, DisplayAction = NULL, FailureReason = NULL, StudentNumber = NULL, SchoolYearID = NULL, AttemptToUpdateWithdrawalCode = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "TempNoShowEntryWithdrawal", objectId = TempNoShowEntryWithdrawalID, body = list(DataObject = body), searchFields = append("TempNoShowEntryWithdrawalID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempNameAddressMoveSchoolPathSchoolOverride <- function(TempNameAddressMoveSchoolPathSchoolOverrideID, StudentFullNameLFM = F, SchoolNameToOverride = F, SchoolNameOverriddingTo = F, StudentID = F, SchoolID = F, SchoolPathSchoolOverrideID = F, Order = F, IsRemoveOverride = F, IsUpdateOverride = F, IsRemovePermit = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsOverrideExists = F, IsCreateOverride = F, SchoolYearDescription = F, PermitID = F, PermitSchoolYearID = F, IsPermitOptional = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempNameAddressMoveSchoolPathSchoolOverride", objectId = TempNameAddressMoveSchoolPathSchoolOverrideID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempNameAddressMoveSchoolPathSchoolOverride <- function(TempNameAddressMoveSchoolPathSchoolOverrideID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempNameAddressMoveSchoolPathSchoolOverride", objectId = TempNameAddressMoveSchoolPathSchoolOverrideID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempNameAddressMoveSchoolPathSchoolOverride <- function(StudentFullNameLFM = NULL, SchoolNameToOverride = NULL, SchoolNameOverriddingTo = NULL, StudentID = NULL, SchoolID = NULL, SchoolPathSchoolOverrideID = NULL, Order = NULL, IsRemoveOverride = NULL, IsUpdateOverride = NULL, IsRemovePermit = NULL, IsOverrideExists = NULL, IsCreateOverride = NULL, SchoolYearDescription = NULL, PermitID = NULL, PermitSchoolYearID = NULL, IsPermitOptional = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "TempNameAddressMoveSchoolPathSchoolOverride", body = list(DataObject = body), searchFields = append("TempNameAddressMoveSchoolPathSchoolOverrideID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempSchoolPathSchoolOverride <- function(TempSchoolPathSchoolOverrideID, StudentID = F, StudentName = F, SchoolID = F, SchoolIDClonedTo = F, SchoolCodeName = F, Order = F, HasExceptions = F, ExceptionNote = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DistrictID = F, PermitID = F, PermitCodeDescription = F, SchoolYearID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempSchoolPathSchoolOverride", objectId = TempSchoolPathSchoolOverrideID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempSchoolPathSchoolOverride <- function(TempSchoolPathSchoolOverrideID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempSchoolPathSchoolOverride", objectId = TempSchoolPathSchoolOverrideID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempSchoolPathSchoolOverride <- function(StudentID = NULL, StudentName = NULL, SchoolID = NULL, SchoolIDClonedTo = NULL, SchoolCodeName = NULL, Order = NULL, HasExceptions = NULL, ExceptionNote = NULL, DistrictID = NULL, PermitID = NULL, PermitCodeDescription = NULL, SchoolYearID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "TempSchoolPathSchoolOverride", body = list(DataObject = body), searchFields = append("TempSchoolPathSchoolOverrideID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempSchoolPathSchoolOverride <- function(TempSchoolPathSchoolOverrideID, StudentID = NULL, StudentName = NULL, SchoolID = NULL, SchoolIDClonedTo = NULL, SchoolCodeName = NULL, Order = NULL, HasExceptions = NULL, ExceptionNote = NULL, DistrictID = NULL, PermitID = NULL, PermitCodeDescription = NULL, SchoolYearID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "TempSchoolPathSchoolOverride", objectId = TempSchoolPathSchoolOverrideID, body = list(DataObject = body), searchFields = append("TempSchoolPathSchoolOverrideID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempHomeroomError <- function(TempHomeroomErrorID, TempHomeroomRecordID = F, Code = F, FailureReason = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempHomeroomError", objectId = TempHomeroomErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempHomeroomError <- function(TempHomeroomErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempHomeroomError", objectId = TempHomeroomErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempHomeroomError <- function(Code = NULL, FailureReason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "TempHomeroomError", body = list(DataObject = body), searchFields = append("TempHomeroomErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempHomeroomError <- function(TempHomeroomErrorID, Code = NULL, FailureReason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "TempHomeroomError", objectId = TempHomeroomErrorID, body = list(DataObject = body), searchFields = append("TempHomeroomErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempHomeroomRecord <- function(TempHomeroomRecordID, HomeroomID = F, Code = F, StaffID = F, Staff = F, RoomID = F, Room = F, BuildingID = F, Building = F, SchoolYearID = F, SchoolYear = F, IsOverwrite = F, HasSaveError = F, ColumnIndex = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempHomeroomRecord", objectId = TempHomeroomRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempHomeroomRecord <- function(TempHomeroomRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempHomeroomRecord", objectId = TempHomeroomRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempHomeroomRecord <- function(HomeroomID = NULL, Code = NULL, StaffID = NULL, Staff = NULL, RoomID = NULL, Room = NULL, BuildingID = NULL, Building = NULL, SchoolYearID = NULL, SchoolYear = NULL, IsOverwrite = NULL, HasSaveError = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "TempHomeroomRecord", body = list(DataObject = body), searchFields = append("TempHomeroomRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempHomeroomRecord <- function(TempHomeroomRecordID, HomeroomID = NULL, Code = NULL, StaffID = NULL, Staff = NULL, RoomID = NULL, Room = NULL, BuildingID = NULL, Building = NULL, SchoolYearID = NULL, SchoolYear = NULL, IsOverwrite = NULL, HasSaveError = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "TempHomeroomRecord", objectId = TempHomeroomRecordID, body = list(DataObject = body), searchFields = append("TempHomeroomRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStudentAccountsMA <- function(StudentAccountsMAID, PaymentPlanMAID = F, FinancialAid = F, iPadLease = F, StudentID = F, ReligionID = F, PlaceofWorship = F, FacultyStaffChild = F, EthnicityMAID = F, NYDepositPaid = F, AMTransportationID = F, PMTransportationID = F, SchoolDistrictID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "StudentAccountsMA", objectId = StudentAccountsMAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentAccountsMA <- function(StudentAccountsMAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "StudentAccountsMA", objectId = StudentAccountsMAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createStudentAccountsMA <- function(PaymentPlanMAID = NULL, FinancialAid = NULL, iPadLease = NULL, StudentID = NULL, ReligionID = NULL, PlaceofWorship = NULL, FacultyStaffChild = NULL, EthnicityMAID = NULL, NYDepositPaid = NULL, AMTransportationID = NULL, PMTransportationID = NULL, SchoolDistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Enrollment", objectName = "StudentAccountsMA", body = list(DataObject = body), searchFields = append("StudentAccountsMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyStudentAccountsMA <- function(StudentAccountsMAID, PaymentPlanMAID = NULL, FinancialAid = NULL, iPadLease = NULL, StudentID = NULL, ReligionID = NULL, PlaceofWorship = NULL, FacultyStaffChild = NULL, EthnicityMAID = NULL, NYDepositPaid = NULL, AMTransportationID = NULL, PMTransportationID = NULL, SchoolDistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Enrollment", objectName = "StudentAccountsMA", objectId = StudentAccountsMAID, body = list(DataObject = body), searchFields = append("StudentAccountsMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listPaymentPlanMAS <- function(searchConditionsList = NULL, PaymentPlanMAID = F, Code = F, Description = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getPaymentPlanMA <- function(PaymentPlanMAID, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "PaymentPlanMA", objectId = PaymentPlanMAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePaymentPlanMA <- function(PaymentPlanMAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "PaymentPlanMA", objectId = PaymentPlanMAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPaymentPlanMA <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "PaymentPlanMA", body = list(DataObject = body), searchFields = append("PaymentPlanMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPaymentPlanMA <- function(PaymentPlanMAID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "PaymentPlanMA", objectId = PaymentPlanMAID, body = list(DataObject = body), searchFields = append("PaymentPlanMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getNumberedStudentEntityYearForDistrictAndSchoolYear <- function(NumberedStudentEntityYearForDistrictAndSchoolYearID, DistrictID = F, EntityID = F, IsDefaultEntity = F, SchoolYearID = F, StudentDistrictRowNumber = F, StudentID = F, StudentEntityYearID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "NumberedStudentEntityYearForDistrictAndSchoolYear", objectId = NumberedStudentEntityYearForDistrictAndSchoolYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteNumberedStudentEntityYearForDistrictAndSchoolYear <- function(NumberedStudentEntityYearForDistrictAndSchoolYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "NumberedStudentEntityYearForDistrictAndSchoolYear", objectId = NumberedStudentEntityYearForDistrictAndSchoolYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCommonEducationDataStandardsGradeLevel <- function(CommonEducationDataStandardsGradeLevelID, Code = F, Description = F, OrderNumber = F, SkywardID = F, SkywardHash = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "CommonEducationDataStandardsGradeLevel", objectId = CommonEducationDataStandardsGradeLevelID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCommonEducationDataStandardsGradeLevel <- function(CommonEducationDataStandardsGradeLevelID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "CommonEducationDataStandardsGradeLevel", objectId = CommonEducationDataStandardsGradeLevelID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCommonEducationDataStandardsGradeLevel <- function(Code = NULL, Description = NULL, OrderNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "CommonEducationDataStandardsGradeLevel", body = list(DataObject = body), searchFields = append("CommonEducationDataStandardsGradeLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCommonEducationDataStandardsGradeLevel <- function(CommonEducationDataStandardsGradeLevelID, Code = NULL, Description = NULL, OrderNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStudentEnrollmentError <- function(TempStudentEnrollmentErrorID, TempStudentEnrollmentRecordID = F, Error = F, ErrorDetail = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ErrorCount = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "TempStudentEnrollmentError", objectId = TempStudentEnrollmentErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentEnrollmentError <- function(TempStudentEnrollmentErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "TempStudentEnrollmentError", objectId = TempStudentEnrollmentErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentEnrollmentError <- function(Error = NULL, ErrorDetail = NULL, ErrorCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "TempStudentEnrollmentError", body = list(DataObject = body), searchFields = append("TempStudentEnrollmentErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentEnrollmentError <- function(TempStudentEnrollmentErrorID, Error = NULL, ErrorDetail = NULL, ErrorCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "TempStudentEnrollmentError", objectId = TempStudentEnrollmentErrorID, body = list(DataObject = body), searchFields = append("TempStudentEnrollmentErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentPermit <- function(StudentPermitID, DistrictID = F, SchoolYearID = F, StudentID = F, PermitID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "StudentPermit", objectId = StudentPermitID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentPermit <- function(StudentPermitID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "StudentPermit", objectId = StudentPermitID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentPermit <- function(DistrictID = NULL, SchoolYearID = NULL, StudentID = NULL, PermitID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "StudentPermit", body = list(DataObject = body), searchFields = append("StudentPermitID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentPermit <- function(StudentPermitID, DistrictID = NULL, SchoolYearID = NULL, StudentID = NULL, PermitID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "StudentPermit", objectId = StudentPermitID, body = list(DataObject = body), searchFields = append("StudentPermitID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listAMTransportations <- function(searchConditionsList = NULL, AMTransportationID = F, Code = F, Description = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAMTransportation <- function(AMTransportationID, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "AMTransportation", objectId = AMTransportationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAMTransportation <- function(AMTransportationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "AMTransportation", objectId = AMTransportationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAMTransportation <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "AMTransportation", body = list(DataObject = body), searchFields = append("AMTransportationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAMTransportation <- function(AMTransportationID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "AMTransportation", objectId = AMTransportationID, body = list(DataObject = body), searchFields = append("AMTransportationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listPMTransportations <- function(searchConditionsList = NULL, PMTransportationID = F, Code = F, Description = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getPMTransportation <- function(PMTransportationID, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "PMTransportation", objectId = PMTransportationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePMTransportation <- function(PMTransportationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "PMTransportation", objectId = PMTransportationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPMTransportation <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "PMTransportation", body = list(DataObject = body), searchFields = append("PMTransportationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPMTransportation <- function(PMTransportationID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "PMTransportation", objectId = PMTransportationID, body = list(DataObject = body), searchFields = append("PMTransportationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listSchoolDistricts <- function(searchConditionsList = NULL, SchoolDistrictID = F, Code = F, Description = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSchoolDistrict <- function(SchoolDistrictID, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "SchoolDistrict", objectId = SchoolDistrictID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolDistrict <- function(SchoolDistrictID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "SchoolDistrict", objectId = SchoolDistrictID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolDistrict <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "SchoolDistrict", body = list(DataObject = body), searchFields = append("SchoolDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolDistrict <- function(SchoolDistrictID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "SchoolDistrict", objectId = SchoolDistrictID, body = list(DataObject = body), searchFields = append("SchoolDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSchoolPathStudent <- function(SchoolPathStudentID, DistrictID = F, SchoolYearID = F, SchoolPathID = F, StudentID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "SchoolPathStudent", objectId = SchoolPathStudentID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolPathStudent <- function(SchoolPathStudentID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "SchoolPathStudent", objectId = SchoolPathStudentID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolPathStudent <- function(DistrictID = NULL, SchoolYearID = NULL, SchoolPathID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "SchoolPathStudent", body = list(DataObject = body), searchFields = append("SchoolPathStudentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolPathStudent <- function(SchoolPathStudentID, DistrictID = NULL, SchoolYearID = NULL, SchoolPathID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "SchoolPathStudent", objectId = SchoolPathStudentID, body = list(DataObject = body), searchFields = append("SchoolPathStudentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSchoolPath <- function(SchoolPathID, Name = F, DistrictID = F, SchoolYearID = F, SchoolPathTypeID = F, SchoolPathIDClonedFrom = F, SchoolPathIDClonedTo = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "SchoolPath", objectId = SchoolPathID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolPath <- function(SchoolPathID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "SchoolPath", objectId = SchoolPathID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolPath <- function(Name = NULL, DistrictID = NULL, SchoolYearID = NULL, SchoolPathTypeID = NULL, SchoolPathIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "SchoolPath", body = list(DataObject = body), searchFields = append("SchoolPathID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolPath <- function(SchoolPathID, Name = NULL, DistrictID = NULL, SchoolYearID = NULL, SchoolPathTypeID = NULL, SchoolPathIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "SchoolPath", objectId = SchoolPathID, body = list(DataObject = body), searchFields = append("SchoolPathID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSchoolPathSchool <- function(SchoolPathSchoolID, DistrictID = F, SchoolYearID = F, SchoolPathID = F, SchoolID = F, Order = F, SchoolPathSchoolIDClonedFrom = F, SchoolPathSchoolIDClonedTo = F, CodeDescription = F, StudentHasPermit = F, IsOverriddenForStudent = F, OverriddenSchoolName = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "SchoolPathSchool", objectId = SchoolPathSchoolID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolPathSchool <- function(SchoolPathSchoolID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "SchoolPathSchool", objectId = SchoolPathSchoolID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolPathSchool <- function(DistrictID = NULL, SchoolYearID = NULL, SchoolPathID = NULL, SchoolID = NULL, Order = NULL, SchoolPathSchoolIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "SchoolPathSchool", body = list(DataObject = body), searchFields = append("SchoolPathSchoolID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolPathSchool <- function(SchoolPathSchoolID, DistrictID = NULL, SchoolYearID = NULL, SchoolPathID = NULL, SchoolID = NULL, Order = NULL, SchoolPathSchoolIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "SchoolPathSchool", objectId = SchoolPathSchoolID, body = list(DataObject = body), searchFields = append("SchoolPathSchoolID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSchoolPathType <- function(SchoolPathTypeID, Code = F, Description = F, SkywardID = F, SkywardHash = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Enrollment", objectName = "SchoolPathType", objectId = SchoolPathTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolPathType <- function(SchoolPathTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Enrollment", objectName = "SchoolPathType", objectId = SchoolPathTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolPathType <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Enrollment", objectName = "SchoolPathType", body = list(DataObject = body), searchFields = append("SchoolPathTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolPathType <- function(SchoolPathTypeID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Enrollment", objectName = "SchoolPathType", objectId = SchoolPathTypeID, body = list(DataObject = body), searchFields = append("SchoolPathTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
