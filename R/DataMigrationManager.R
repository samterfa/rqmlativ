	...
	#' @concept Data Migration Manager
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getDataMigrationManager <- function(DataMigrationManagerID, ProcessedTime = F, MigrationType = F, ProcessType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Label = F, SecondaryType = F, MediaID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "DataMigrationManager", objectName = "DataMigrationManager", objectId = DataMigrationManagerID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMigrationManager <- function(DataMigrationManagerID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "DataMigrationManager", objectName = "DataMigrationManager", objectId = DataMigrationManagerID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMigrationManager <- function(ProcessedTime = NULL, MigrationType = NULL, ProcessType = NULL, Label = NULL, SecondaryType = NULL, MediaID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "DataMigrationManager", objectName = "DataMigrationManager", body = list(DataObject = body), searchFields = append("DataMigrationManagerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMigrationManager <- function(DataMigrationManagerID, ProcessedTime = NULL, MigrationType = NULL, ProcessType = NULL, Label = NULL, SecondaryType = NULL, MediaID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "DataMigrationManager", objectName = "DataMigrationManager", objectId = DataMigrationManagerID, body = list(DataObject = body), searchFields = append("DataMigrationManagerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDataMigrationManagerException <- function(DataMigrationManagerExceptionID, DataMigrationManagerID = F, SourcePrimaryKey = F, Object = F, Identifier = F, Message = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ExceptionType = F, Category = F, Col1 = F, Col2 = F, Col3 = F, Col4 = F, Col5 = F, Col6 = F, Col7 = F, Col8 = F, Col9 = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "DataMigrationManager", objectName = "DataMigrationManagerException", objectId = DataMigrationManagerExceptionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMigrationManagerException <- function(DataMigrationManagerExceptionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "DataMigrationManager", objectName = "DataMigrationManagerException", objectId = DataMigrationManagerExceptionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createDataMigrationManagerException <- function(DataMigrationManagerID = NULL, SourcePrimaryKey = NULL, Object = NULL, Identifier = NULL, Message = NULL, ExceptionType = NULL, Category = NULL, Col1 = NULL, Col2 = NULL, Col3 = NULL, Col4 = NULL, Col5 = NULL, Col6 = NULL, Col7 = NULL, Col8 = NULL, Col9 = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "DataMigrationManager", objectName = "DataMigrationManagerException", body = list(DataObject = body), searchFields = append("DataMigrationManagerExceptionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyDataMigrationManagerException <- function(DataMigrationManagerExceptionID, DataMigrationManagerID = NULL, SourcePrimaryKey = NULL, Object = NULL, Identifier = NULL, Message = NULL, ExceptionType = NULL, Category = NULL, Col1 = NULL, Col2 = NULL, Col3 = NULL, Col4 = NULL, Col5 = NULL, Col6 = NULL, Col7 = NULL, Col8 = NULL, Col9 = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "DataMigrationManager", objectName = "DataMigrationManagerException", objectId = DataMigrationManagerExceptionID, body = list(DataObject = body), searchFields = append("DataMigrationManagerExceptionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
