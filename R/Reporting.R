	...
	getReportingUserSetting <- function(ReportingUserSettingID, UserSettingID = F, ShowSideBar = F, SideBarWidth = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DataMiningShowLeftFieldSelectionPanel = F, DataMiningLeftFieldSelectionPanelWidth = F, DataMiningMiddleFieldSelectionPanelWidth = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "UserSetting", objectId = ReportingUserSettingID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportingUserSetting <- function(ReportingUserSettingID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "UserSetting", objectId = ReportingUserSettingID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportingUserSetting <- function(ShowSideBar = NULL, SideBarWidth = NULL, DataMiningShowLeftFieldSelectionPanel = NULL, DataMiningLeftFieldSelectionPanelWidth = NULL, DataMiningMiddleFieldSelectionPanelWidth = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "UserSetting", body = list(DataObject = body), searchFields = append("UserSettingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportingUserSetting <- function(UserSettingID, ShowSideBar = NULL, SideBarWidth = NULL, DataMiningShowLeftFieldSelectionPanel = NULL, DataMiningLeftFieldSelectionPanelWidth = NULL, DataMiningMiddleFieldSelectionPanelWidth = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "UserSetting", objectId = UserSettingID, body = list(DataObject = body), searchFields = append("UserSettingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getScheduledReport <- function(ScheduledReportID, ReportID = F, ReportName = F, SkywardReportSystemVersion = F, EntityID = F, EntityIDList = F, SchoolYearID = F, FiscalYearID = F, SectionID = F, SchoolYearNumericYearOrCurrent = F, CachedSchoolYear = F, CachedEntity = F, CachedFiscalYear = F, ScheduledTaskID = F, DaysToSaveReport = F, MessageMasterID = F, Name = F, NotifyByEmail = F, NotifyByMessageCenter = F, ExportFileName = F, AutomateFileName = F, OverwriteExistingFile = F, ReportType = F, ReportDefinition = F, PromptValues = F, RunCount = F, DefinitionUpdatedTime = F, ReportIsCurrent = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ReportFileExtensionOverride = F, IsCrystalReport = F, PromptXML = F, MediaIDCrystalRPT = F, AutoUpdate = F, EncodingType = F, UserIDOwner = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ScheduledReport", objectId = ScheduledReportID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteScheduledReport <- function(ScheduledReportID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ScheduledReport", objectId = ScheduledReportID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createScheduledReport <- function(ReportID = NULL, ReportName = NULL, SkywardReportSystemVersion = NULL, EntityID = NULL, SectionID = NULL, ScheduledTaskID = NULL, DaysToSaveReport = NULL, MessageMasterID = NULL, Name = NULL, NotifyByEmail = NULL, NotifyByMessageCenter = NULL, ExportFileName = NULL, AutomateFileName = NULL, OverwriteExistingFile = NULL, ReportType = NULL, DefinitionUpdatedTime = NULL, ReportFileExtensionOverride = NULL, MediaIDCrystalRPT = NULL, AutoUpdate = NULL, EncodingType = NULL, UserIDOwner = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Reporting", objectName = "ScheduledReport", body = list(DataObject = body), searchFields = append("ScheduledReportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyScheduledReport <- function(ScheduledReportID, ReportID = NULL, ReportName = NULL, SkywardReportSystemVersion = NULL, EntityID = NULL, SectionID = NULL, ScheduledTaskID = NULL, DaysToSaveReport = NULL, MessageMasterID = NULL, Name = NULL, NotifyByEmail = NULL, NotifyByMessageCenter = NULL, ExportFileName = NULL, AutomateFileName = NULL, OverwriteExistingFile = NULL, ReportType = NULL, DefinitionUpdatedTime = NULL, ReportFileExtensionOverride = NULL, MediaIDCrystalRPT = NULL, AutoUpdate = NULL, EncodingType = NULL, UserIDOwner = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Reporting", objectName = "ScheduledReport", objectId = ScheduledReportID, body = list(DataObject = body), searchFields = append("ScheduledReportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getReportMenuModule <- function(ReportMenuModuleID, ReportID = F, MenuModuleID = F, IsPrimary = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SkywardID = F, IsSkywardReportMenuModule = F, SkywardHash = F, EffectiveIsPrimary = F, IsPrimaryOverride = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportMenuModule", objectId = ReportMenuModuleID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportMenuModule <- function(ReportMenuModuleID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportMenuModule", objectId = ReportMenuModuleID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportMenuModule <- function(ReportID = NULL, MenuModuleID = NULL, IsPrimary = NULL, IsPrimaryOverride = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ReportMenuModule", body = list(DataObject = body), searchFields = append("ReportMenuModuleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportMenuModule <- function(ReportMenuModuleID, ReportID = NULL, MenuModuleID = NULL, IsPrimary = NULL, IsPrimaryOverride = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ReportMenuModule", objectId = ReportMenuModuleID, body = list(DataObject = body), searchFields = append("ReportMenuModuleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getReportStyle <- function(ReportStyleID, Name = F, SkywardID = F, IsSkywardReportStyle = F, IsNotSkywardReportStyle = F, ReportDefinition = F, IsPublic = F, CurrentUserCanDelete = F, CurrentUserCanMakePublic = F, CurrentUserCanMakeNotPublic = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SkywardHash = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportStyle", objectId = ReportStyleID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportStyle <- function(ReportStyleID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportStyle", objectId = ReportStyleID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportStyle <- function(Name = NULL, IsPublic = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ReportStyle", body = list(DataObject = body), searchFields = append("ReportStyleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportStyle <- function(ReportStyleID, Name = NULL, IsPublic = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ReportStyle", objectId = ReportStyleID, body = list(DataObject = body), searchFields = append("ReportStyleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getReportQueueSQL <- function(ReportQueueSQLID, ReportQueueID = F, ExecutedQuery = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportQueueSQL", objectId = ReportQueueSQLID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportQueueSQL <- function(ReportQueueSQLID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportQueueSQL", objectId = ReportQueueSQLID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportQueueSQL <- function(ReportQueueID = NULL, ExecutedQuery = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ReportQueueSQL", body = list(DataObject = body), searchFields = append("ReportQueueSQLID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportQueueSQL <- function(ReportQueueSQLID, ReportQueueID = NULL, ExecutedQuery = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ReportQueueSQL", objectId = ReportQueueSQLID, body = list(DataObject = body), searchFields = append("ReportQueueSQLID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getUserReportPrompt <- function(UserReportPromptID, ReportID = F, SkywardPromptValues = F, CrystalPromptValues = F, EntityID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, PromptTemplateID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "UserReportPrompt", objectId = UserReportPromptID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteUserReportPrompt <- function(UserReportPromptID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "UserReportPrompt", objectId = UserReportPromptID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createUserReportPrompt <- function(ReportID = NULL, EntityID = NULL, PromptTemplateID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "UserReportPrompt", body = list(DataObject = body), searchFields = append("UserReportPromptID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyUserReportPrompt <- function(UserReportPromptID, ReportID = NULL, EntityID = NULL, PromptTemplateID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "UserReportPrompt", objectId = UserReportPromptID, body = list(DataObject = body), searchFields = append("UserReportPromptID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getPage <- function(PageID, ReportQueueID = F, PageNumber = F, Tables = F, TotalHeightInPoints = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "Page", objectId = PageID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePage <- function(PageID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "Page", objectId = PageID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPage <- function(ReportQueueID = NULL, PageNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "Page", body = list(DataObject = body), searchFields = append("PageID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPage <- function(PageID, ReportQueueID = NULL, PageNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "Page", objectId = PageID, body = list(DataObject = body), searchFields = append("PageID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getReport <- function(ReportID, SkywardID = F, OriginReportSkywardID = F, SkywardReportSystemVersion = F, CrystalParameterData = F, ReportType = F, MediaIDCrystalRPT = F, IsSkywardReport = F, EffectiveDescription = F, Name = F, ModuleIDBase = F, ObjectIDBase = F, UserIDOwner = F, Modules = F, PublishedTime = F, HasUnpublishedChanges = F, Published = F, NotPublished = F, CanBeScheduled = F, CanBeAddedToScreens = F, CurrentUserCanRead = F, CurrentUserCanUpdate = F, CurrentUserCanClone = F, StateID = F, ContainsStateSpecificFields = F, CurrentUserCanSetStateID = F, RunCount = F, LastRunTime = F, AllowOthersToClone = F, SaveUntil = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, CanRevert = F, Portal = F, CurrentUserIsEffectiveOwner = F, ModulePath = F, ObjectName = F, EffectiveDisplayInMainMenuAndListScreens = F, EffectiveFileExtensionOverride = F, StateSpecificFields = F, StateSpecificFieldsDisplay = F, IsCrystalReport = F, SkywardHash = F, UpdatesMadeToMasterReport = F, FileExtensionOverride = F, FileExtensionNewOverride = F, OverrideFileExtensionOverride = F, Description = F, DescriptionOverride = F, OverrideDescription = F, DisplayInMainMenuAndListScreens = F, DisplayInMainMenuAndListScreensOverride = F, OverrideDisplayInMainMenuAndListScreens = F, CurrentUserCanDelete = F, CurrentUserCanUpdateOverrideFields = F, IsSkywardMaintained = F, KeepDataSources = F, EncodingType = F, BurstActionIDPrintAction = F, IsSummaryReport = F, PublishedCalculatedInCSharp = F, DefinitionWasModified = F, HasNoUnpublishedChanges = F, HasErrors = F, PromptForFiscalYear = F, PublishedXML = F, WorkingXML = F, IsLicensed = F, IsWSIPCMaintained = F, IsDeactivatedReport = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "Report", objectId = ReportID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReport <- function(ReportID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "Report", objectId = ReportID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createReport <- function(SkywardReportSystemVersion = NULL, CrystalParameterData = NULL, ReportType = NULL, MediaIDCrystalRPT = NULL, Name = NULL, ModuleIDBase = NULL, ObjectIDBase = NULL, UserIDOwner = NULL, PublishedTime = NULL, StateID = NULL, AllowOthersToClone = NULL, SaveUntil = NULL, Portal = NULL, FileExtensionOverride = NULL, FileExtensionNewOverride = NULL, Description = NULL, DescriptionOverride = NULL, DisplayInMainMenuAndListScreens = NULL, DisplayInMainMenuAndListScreensOverride = NULL, OverrideDisplayInMainMenuAndListScreens = NULL, IsSkywardMaintained = NULL, KeepDataSources = NULL, EncodingType = NULL, BurstActionIDPrintAction = NULL, PublishedXML = NULL, WorkingXML = NULL, IsWSIPCMaintained = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Reporting", objectName = "Report", body = list(DataObject = body), searchFields = append("ReportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyReport <- function(ReportID, SkywardReportSystemVersion = NULL, CrystalParameterData = NULL, ReportType = NULL, MediaIDCrystalRPT = NULL, Name = NULL, ModuleIDBase = NULL, ObjectIDBase = NULL, UserIDOwner = NULL, PublishedTime = NULL, StateID = NULL, AllowOthersToClone = NULL, SaveUntil = NULL, Portal = NULL, FileExtensionOverride = NULL, FileExtensionNewOverride = NULL, Description = NULL, DescriptionOverride = NULL, DisplayInMainMenuAndListScreens = NULL, DisplayInMainMenuAndListScreensOverride = NULL, OverrideDisplayInMainMenuAndListScreens = NULL, IsSkywardMaintained = NULL, KeepDataSources = NULL, EncodingType = NULL, BurstActionIDPrintAction = NULL, PublishedXML = NULL, WorkingXML = NULL, IsWSIPCMaintained = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Reporting", objectName = "Report", objectId = ReportID, body = list(DataObject = body), searchFields = append("ReportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getReportQueue <- function(ReportQueueID, ReportID = F, ReportName = F, ReportType = F, SkywardReportSystemVersion = F, IsFromPublishedVersion = F, PageCountWhenCompleted = F, PageCount = F, LogID = F, SaveUntil = F, HasContent = F, HasContentViewable = F, HasContentDownloadable = F, StatusCode = F, Status = F, QueueCode = F, Queue = F, CanCancel = F, EntityID = F, EntityIDList = F, FiscalYearID = F, SchoolYearID = F, SectionID = F, SchoolYearNumericYearOrCurrent = F, SchoolYearIDSelectedOrCurrent = F, FiscalYearIDSelectedOrCurrent = F, Application = F, Hostname = F, ThreadName = F, ProcessID = F, ReferrerPath = F, MediaID = F, CrystalParameterData = F, ScheduledReportID = F, QueryStartTime = F, RenderingStartTime = F, EndTime = F, QueuedDuration = F, QueryDuration = F, RenderingDuration = F, CachedEntity = F, CachedSchoolYear = F, CachedFiscalYear = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, CurrentUserCanView = F, ReportFileExtensionOverride = F, IsCrystalReport = F, LastActivity = F, StatusAction = F, PromptTemplateID = F, FTPResultID = F, DataSource = F, MediaIDPrint = F, MediaIDDownload = F, MediaIDCsv = F, EncodingType = F, Encoding = F, BurstObjectIDs = F, HasPrintAction = F, HideFiscalYear = F, HideSchoolYear = F, ReportQueueIDSummaryReportSource = F, ReportQueueIDSummaryReport = F, IsViewableReport = F, ResultStatus = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportQueue", objectId = ReportQueueID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportQueue <- function(ReportQueueID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportQueue", objectId = ReportQueueID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createReportQueue <- function(ReportID = NULL, ReportName = NULL, ReportType = NULL, SkywardReportSystemVersion = NULL, IsFromPublishedVersion = NULL, LogID = NULL, SaveUntil = NULL, Status = NULL, Queue = NULL, EntityID = NULL, FiscalYearID = NULL, SchoolYearID = NULL, SectionID = NULL, SchoolYearNumericYearOrCurrent = NULL, SchoolYearIDSelectedOrCurrent = NULL, FiscalYearIDSelectedOrCurrent = NULL, Application = NULL, Hostname = NULL, ThreadName = NULL, ProcessID = NULL, ReferrerPath = NULL, MediaID = NULL, CrystalParameterData = NULL, ScheduledReportID = NULL, QueryStartTime = NULL, RenderingStartTime = NULL, EndTime = NULL, ReportFileExtensionOverride = NULL, LastActivity = NULL, PromptTemplateID = NULL, FTPResultID = NULL, DataSource = NULL, MediaIDPrint = NULL, MediaIDDownload = NULL, MediaIDCsv = NULL, EncodingType = NULL, ReportQueueIDSummaryReportSource = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Reporting", objectName = "ReportQueue", body = list(DataObject = body), searchFields = append("ReportQueueID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyReportQueue <- function(ReportQueueID, ReportID = NULL, ReportName = NULL, ReportType = NULL, SkywardReportSystemVersion = NULL, IsFromPublishedVersion = NULL, LogID = NULL, SaveUntil = NULL, Status = NULL, Queue = NULL, EntityID = NULL, FiscalYearID = NULL, SchoolYearID = NULL, SectionID = NULL, SchoolYearNumericYearOrCurrent = NULL, SchoolYearIDSelectedOrCurrent = NULL, FiscalYearIDSelectedOrCurrent = NULL, Application = NULL, Hostname = NULL, ThreadName = NULL, ProcessID = NULL, ReferrerPath = NULL, MediaID = NULL, CrystalParameterData = NULL, ScheduledReportID = NULL, QueryStartTime = NULL, RenderingStartTime = NULL, EndTime = NULL, ReportFileExtensionOverride = NULL, LastActivity = NULL, PromptTemplateID = NULL, FTPResultID = NULL, DataSource = NULL, MediaIDPrint = NULL, MediaIDDownload = NULL, MediaIDCsv = NULL, EncodingType = NULL, ReportQueueIDSummaryReportSource = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Reporting", objectName = "ReportQueue", objectId = ReportQueueID, body = list(DataObject = body), searchFields = append("ReportQueueID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getReportRole <- function(ReportRoleID, ReportID = F, RoleID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportRole", objectId = ReportRoleID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportRole <- function(ReportRoleID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportRole", objectId = ReportRoleID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportRole <- function(ReportID = NULL, RoleID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ReportRole", body = list(DataObject = body), searchFields = append("ReportRoleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportRole <- function(ReportRoleID, ReportID = NULL, RoleID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ReportRole", objectId = ReportRoleID, body = list(DataObject = body), searchFields = append("ReportRoleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDataMiningReportField <- function(DataMiningReportFieldID, DataMiningReportID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Label = F, Width = F, SubtopicFieldID = F, DisplayOrder = F, CurrentUserCanRead = F, ShowTotal = F, StartPosition = F, EndPosition = F, WidthInPixels = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "DataMiningReportField", objectId = DataMiningReportFieldID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMiningReportField <- function(DataMiningReportFieldID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "DataMiningReportField", objectId = DataMiningReportFieldID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMiningReportField <- function(DataMiningReportID = NULL, Label = NULL, Width = NULL, SubtopicFieldID = NULL, DisplayOrder = NULL, ShowTotal = NULL, StartPosition = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "DataMiningReportField", body = list(DataObject = body), searchFields = append("DataMiningReportFieldID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMiningReportField <- function(DataMiningReportFieldID, DataMiningReportID = NULL, Label = NULL, Width = NULL, SubtopicFieldID = NULL, DisplayOrder = NULL, ShowTotal = NULL, StartPosition = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "DataMiningReportField", objectId = DataMiningReportFieldID, body = list(DataObject = body), searchFields = append("DataMiningReportFieldID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSubtopic <- function(SubtopicID, SkywardID = F, SkywardHash = F, ObjectID = F, RelationshipPath = F, Name = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, CurrentUserHasAccess = F, IsOneToMany = F, OneToManyRelationshipPath = F, FieldAreaPath = F, DisplayOrder = F, DefaultSortDirection = F, CustomizationID = F, UniqueID = F, IsSkywardLoaded = F, SubtopicIDParent = F, SubjectID = F, DefaultSortGuidFieldPath = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "Subtopic", objectId = SubtopicID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSubtopic <- function(SubtopicID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "Subtopic", objectId = SubtopicID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSubtopic <- function(ObjectID = NULL, RelationshipPath = NULL, Name = NULL, IsOneToMany = NULL, DisplayOrder = NULL, SubtopicIDParent = NULL, SubjectID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "Subtopic", body = list(DataObject = body), searchFields = append("SubtopicID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySubtopic <- function(SubtopicID, ObjectID = NULL, RelationshipPath = NULL, Name = NULL, IsOneToMany = NULL, DisplayOrder = NULL, SubtopicIDParent = NULL, SubjectID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "Subtopic", objectId = SubtopicID, body = list(DataObject = body), searchFields = append("SubtopicID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDataMiningReport <- function(DataMiningReportID, Name = F, ReportID = F, CurrentUserCanRun = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ReportSchemaObject = F, HasFieldsThatCanBeTotaled = F, CurrentUserCanRead = F, TextQualifier = F, Delimiter = F, SubjectID = F, IsFixedWidth = F, CurrentUserCanEdit = F, IncludeSectionHeaders = F, DisplayOnSingleLine = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "DataMiningReport", objectId = DataMiningReportID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMiningReport <- function(DataMiningReportID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "DataMiningReport", objectId = DataMiningReportID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMiningReport <- function(ReportID = NULL, TextQualifier = NULL, Delimiter = NULL, SubjectID = NULL, IncludeSectionHeaders = NULL, DisplayOnSingleLine = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "DataMiningReport", body = list(DataObject = body), searchFields = append("DataMiningReportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMiningReport <- function(DataMiningReportID, ReportID = NULL, TextQualifier = NULL, Delimiter = NULL, SubjectID = NULL, IncludeSectionHeaders = NULL, DisplayOnSingleLine = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "DataMiningReport", objectId = DataMiningReportID, body = list(DataObject = body), searchFields = append("DataMiningReportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getReportRunInfo <- function(ReportRunInfoID, ReportID = F, ObjectID = F, PromptDataSources = F, SourceSchemaObject = F, SourceTypeName = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SecurityLocationReportSetSkywardID = F, ObjectSkywardID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportRunInfo", objectId = ReportRunInfoID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportRunInfo <- function(ReportRunInfoID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportRunInfo", objectId = ReportRunInfoID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportRunInfo <- function(ReportID = NULL, ObjectID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ReportRunInfo", body = list(DataObject = body), searchFields = append("ReportRunInfoID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportRunInfo <- function(ReportRunInfoID, ReportID = NULL, ObjectID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ReportRunInfo", objectId = ReportRunInfoID, body = list(DataObject = body), searchFields = append("ReportRunInfoID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSecurityLocationReportSet <- function(SecurityLocationReportSetID, SecurityLocationID = F, DataObjectID = F, IsSkywardLoaded = F, Name = F, PrimaryKeySource = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SkywardID = F, SkywardHash = F, FullLocation = F, Module = F, AcceptsDataObject = F, Object = F, Screen = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SecurityLocationReportSet", objectId = SecurityLocationReportSetID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSecurityLocationReportSet <- function(SecurityLocationReportSetID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SecurityLocationReportSet", objectId = SecurityLocationReportSetID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSecurityLocationReportSet <- function(SecurityLocationID = NULL, DataObjectID = NULL, Name = NULL, PrimaryKeySource = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SecurityLocationReportSet", body = list(DataObject = body), searchFields = append("SecurityLocationReportSetID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySecurityLocationReportSet <- function(SecurityLocationReportSetID, SecurityLocationID = NULL, DataObjectID = NULL, Name = NULL, PrimaryKeySource = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SecurityLocationReportSet", objectId = SecurityLocationReportSetID, body = list(DataObject = body), searchFields = append("SecurityLocationReportSetID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSecurityLocationReportSetReportRunInfo <- function(SecurityLocationReportSetReportRunInfoID, SecurityLocationReportSetID = F, ReportRunInfoID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsSkywardLoaded = F, InUse = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SecurityLocationReportSetReportRunInfo", objectId = SecurityLocationReportSetReportRunInfoID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSecurityLocationReportSetReportRunInfo <- function(SecurityLocationReportSetReportRunInfoID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SecurityLocationReportSetReportRunInfo", objectId = SecurityLocationReportSetReportRunInfoID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSecurityLocationReportSetReportRunInfo <- function(SecurityLocationReportSetID = NULL, ReportRunInfoID = NULL, IsSkywardLoaded = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SecurityLocationReportSetReportRunInfo", body = list(DataObject = body), searchFields = append("SecurityLocationReportSetReportRunInfoID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySecurityLocationReportSetReportRunInfo <- function(SecurityLocationReportSetReportRunInfoID, SecurityLocationReportSetID = NULL, ReportRunInfoID = NULL, IsSkywardLoaded = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	getDataMiningReportFieldFilter <- function(DataMiningReportFieldFilterID, FilterType = F, Low = F, High = F, ListBackingData = F, ListDisplayValue = F, CurrentUserCanRead = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SubtopicFieldID = F, DataMiningReportID = F, DistinctMultiSelectSchemaObject = F, DistinctMultiSelectModule = F, DistinctMultiSelectObject = F, DistinctMultiSelectFieldPath = F, FormatedDisplayValue = F, IsPrompt = F, PromptLabel = F, PromptIsRequired = F, ComparisonType = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "DataMiningReportFieldFilter", objectId = DataMiningReportFieldFilterID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMiningReportFieldFilter <- function(DataMiningReportFieldFilterID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "DataMiningReportFieldFilter", objectId = DataMiningReportFieldFilterID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMiningReportFieldFilter <- function(FilterType = NULL, Low = NULL, High = NULL, SubtopicFieldID = NULL, DataMiningReportID = NULL, IsPrompt = NULL, PromptLabel = NULL, PromptIsRequired = NULL, ComparisonType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "DataMiningReportFieldFilter", body = list(DataObject = body), searchFields = append("DataMiningReportFieldFilterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMiningReportFieldFilter <- function(DataMiningReportFieldFilterID, FilterType = NULL, Low = NULL, High = NULL, SubtopicFieldID = NULL, DataMiningReportID = NULL, IsPrompt = NULL, PromptLabel = NULL, PromptIsRequired = NULL, ComparisonType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "DataMiningReportFieldFilter", objectId = DataMiningReportFieldFilterID, body = list(DataObject = body), searchFields = append("DataMiningReportFieldFilterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDataMiningReportFieldSort <- function(DataMiningReportFieldSortID, SortDirection = F, SortOrder = F, ShowCount = F, CurrentUserCanRead = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SubtopicFieldID = F, DataMiningReportID = F, ShowSubtotals = F, BreakType = F, Length = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "DataMiningReportFieldSort", objectId = DataMiningReportFieldSortID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMiningReportFieldSort <- function(DataMiningReportFieldSortID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "DataMiningReportFieldSort", objectId = DataMiningReportFieldSortID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMiningReportFieldSort <- function(SortDirection = NULL, SortOrder = NULL, ShowCount = NULL, SubtopicFieldID = NULL, DataMiningReportID = NULL, ShowSubtotals = NULL, BreakType = NULL, Length = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "DataMiningReportFieldSort", body = list(DataObject = body), searchFields = append("DataMiningReportFieldSortID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMiningReportFieldSort <- function(DataMiningReportFieldSortID, SortDirection = NULL, SortOrder = NULL, ShowCount = NULL, SubtopicFieldID = NULL, DataMiningReportID = NULL, ShowSubtotals = NULL, BreakType = NULL, Length = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "DataMiningReportFieldSort", objectId = DataMiningReportFieldSortID, body = list(DataObject = body), searchFields = append("DataMiningReportFieldSortID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSubtopicField <- function(SubtopicFieldID, SubtopicID = F, FullFieldPath = F, SystemType = F, IsCalculatedInCSharp = F, IsFilterable = F, IsString = F, IsNumeric = F, IsDateTime = F, IsTimeSpan = F, IsBoolean = F, IsEnum = F, IsNotEnumOrBoolean = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, MaxSortBreakPosition = F, CurrentUserHasAccess = F, SkywardHash = F, SkywardID = F, IsSkywardMaintained = F, FieldIDSkySys = F, SkywardFriendlyName = F, FriendlyName = F, OverrideFriendlyName = F, SkywardDisplayLevelCode = F, DisplayLevelCode = F, OverrideDisplayLevel = F, GuidFieldPath = F, FieldPath = F, Field = F, IsFieldPathValid = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SubtopicField", objectId = SubtopicFieldID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSubtopicField <- function(SubtopicFieldID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SubtopicField", objectId = SubtopicFieldID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSubtopicField <- function(SubtopicID = NULL, SystemType = NULL, IsCalculatedInCSharp = NULL, FieldIDSkySys = NULL, FriendlyName = NULL, OverrideFriendlyName = NULL, DisplayLevelCode = NULL, OverrideDisplayLevel = NULL, FieldPath = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SubtopicField", body = list(DataObject = body), searchFields = append("SubtopicFieldID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySubtopicField <- function(SubtopicFieldID, SubtopicID = NULL, SystemType = NULL, IsCalculatedInCSharp = NULL, FieldIDSkySys = NULL, FriendlyName = NULL, OverrideFriendlyName = NULL, DisplayLevelCode = NULL, OverrideDisplayLevel = NULL, FieldPath = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SubtopicField", objectId = SubtopicFieldID, body = list(DataObject = body), searchFields = append("SubtopicFieldID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getUploadReportLog <- function(UploadReportLogID, FileName = F, Result = F, Message = F, ReportID = F, LogID = F, WorkflowInstanceID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "UploadReportLog", objectId = UploadReportLogID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteUploadReportLog <- function(UploadReportLogID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "UploadReportLog", objectId = UploadReportLogID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createUploadReportLog <- function(FileName = NULL, Result = NULL, Message = NULL, ReportID = NULL, LogID = NULL, WorkflowInstanceID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "UploadReportLog", body = list(DataObject = body), searchFields = append("UploadReportLogID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyUploadReportLog <- function(UploadReportLogID, FileName = NULL, Result = NULL, Message = NULL, ReportID = NULL, LogID = NULL, WorkflowInstanceID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "UploadReportLog", objectId = UploadReportLogID, body = list(DataObject = body), searchFields = append("UploadReportLogID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getReportingSubject <- function(ReportingSubjectID, SubjectID = F, Name = F, ObjectID = F, SkywardID = F, SkywardHash = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, CurrentUserHasAccess = F, AllowAccountBreaks = F, PromptForFiscalYear = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "Subject", objectId = ReportingSubjectID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportingSubject <- function(ReportingSubjectID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "Subject", objectId = ReportingSubjectID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportingSubject <- function(Name = NULL, ObjectID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "Subject", body = list(DataObject = body), searchFields = append("SubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportingSubject <- function(SubjectID, Name = NULL, ObjectID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "Subject", objectId = SubjectID, body = list(DataObject = body), searchFields = append("SubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDataMiningReportSubtopic <- function(DataMiningReportSubtopicID, DataMiningReportID = F, SubtopicID = F, HasRecord = F, HasRecordIsEditable = F, CurrentUserCanRead = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ShowSubtotals = F, OnlyShowTotals = F, ShowCount = F, SingleLineRecordCount = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "DataMiningReportSubtopic", objectId = DataMiningReportSubtopicID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMiningReportSubtopic <- function(DataMiningReportSubtopicID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "DataMiningReportSubtopic", objectId = DataMiningReportSubtopicID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMiningReportSubtopic <- function(DataMiningReportID = NULL, SubtopicID = NULL, HasRecord = NULL, ShowSubtotals = NULL, OnlyShowTotals = NULL, ShowCount = NULL, SingleLineRecordCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "DataMiningReportSubtopic", body = list(DataObject = body), searchFields = append("DataMiningReportSubtopicID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMiningReportSubtopic <- function(DataMiningReportSubtopicID, DataMiningReportID = NULL, SubtopicID = NULL, HasRecord = NULL, ShowSubtotals = NULL, OnlyShowTotals = NULL, ShowCount = NULL, SingleLineRecordCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "DataMiningReportSubtopic", objectId = DataMiningReportSubtopicID, body = list(DataObject = body), searchFields = append("DataMiningReportSubtopicID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getPromptTemplate <- function(PromptTemplateID, EntityID = F, UserIDOwner = F, ReportID = F, Name = F, Description = F, PromptXML = F, PromptValues = F, Published = F, CurrentUserIsOwnerOrCreator = F, CurrentUserIsOwnerOrCreatorNonOperation = F, ModifiedDate = F, CurrentUserHasAccess = F, ReportDefinitionXml = F, ReportDefinition = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "PromptTemplate", objectId = PromptTemplateID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePromptTemplate <- function(PromptTemplateID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "PromptTemplate", objectId = PromptTemplateID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPromptTemplate <- function(EntityID = NULL, UserIDOwner = NULL, ReportID = NULL, Name = NULL, Description = NULL, Published = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "PromptTemplate", body = list(DataObject = body), searchFields = append("PromptTemplateID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPromptTemplate <- function(PromptTemplateID, EntityID = NULL, UserIDOwner = NULL, ReportID = NULL, Name = NULL, Description = NULL, Published = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "PromptTemplate", objectId = PromptTemplateID, body = list(DataObject = body), searchFields = append("PromptTemplateID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSubjectSecurityLocation <- function(SubjectSecurityLocationID, SkywardID = F, SubjectID = F, SecurityLocationID = F, SkywardHash = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SubjectSecurityLocation", objectId = SubjectSecurityLocationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSubjectSecurityLocation <- function(SubjectSecurityLocationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SubjectSecurityLocation", objectId = SubjectSecurityLocationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSubjectSecurityLocation <- function(SubjectID = NULL, SecurityLocationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SubjectSecurityLocation", body = list(DataObject = body), searchFields = append("SubjectSecurityLocationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySubjectSecurityLocation <- function(SubjectSecurityLocationID, SubjectID = NULL, SecurityLocationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SubjectSecurityLocation", objectId = SubjectSecurityLocationID, body = list(DataObject = body), searchFields = append("SubjectSecurityLocationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getDataMiningReportSortBreak <- function(DataMiningReportSortBreakID, DataMiningReportFieldSortID = F, SortBreakID = F, BreakType = F, HasSeparator = F, HasDoubleUnderline = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "DataMiningReportSortBreak", objectId = DataMiningReportSortBreakID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMiningReportSortBreak <- function(DataMiningReportSortBreakID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "DataMiningReportSortBreak", objectId = DataMiningReportSortBreakID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMiningReportSortBreak <- function(DataMiningReportFieldSortID = NULL, SortBreakID = NULL, BreakType = NULL, HasSeparator = NULL, HasDoubleUnderline = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "DataMiningReportSortBreak", body = list(DataObject = body), searchFields = append("DataMiningReportSortBreakID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMiningReportSortBreak <- function(DataMiningReportSortBreakID, DataMiningReportFieldSortID = NULL, SortBreakID = NULL, BreakType = NULL, HasSeparator = NULL, HasDoubleUnderline = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "DataMiningReportSortBreak", objectId = DataMiningReportSortBreakID, body = list(DataObject = body), searchFields = append("DataMiningReportSortBreakID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSortBreak <- function(SortBreakID, SkywardHash = F, SkywardID = F, CharacterPosition = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SubtopicFieldID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SortBreak", objectId = SortBreakID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSortBreak <- function(SortBreakID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SortBreak", objectId = SortBreakID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSortBreak <- function(CharacterPosition = NULL, SubtopicFieldID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SortBreak", body = list(DataObject = body), searchFields = append("SortBreakID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySortBreak <- function(SortBreakID, CharacterPosition = NULL, SubtopicFieldID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SortBreak", objectId = SortBreakID, body = list(DataObject = body), searchFields = append("SortBreakID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSort <- function(SortID, SortGroupID = F, SubtopicFieldID = F, SortOrder = F, SortDirectionCode = F, SkywardHash = F, SkywardID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "Sort", objectId = SortID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSort <- function(SortID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "Sort", objectId = SortID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSort <- function(SortGroupID = NULL, SubtopicFieldID = NULL, SortOrder = NULL, SortDirectionCode = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "Sort", body = list(DataObject = body), searchFields = append("SortID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySort <- function(SortID, SortGroupID = NULL, SubtopicFieldID = NULL, SortOrder = NULL, SortDirectionCode = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "Sort", objectId = SortID, body = list(DataObject = body), searchFields = append("SortID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSortGroup <- function(SortGroupID, ObjectID = F, IsDefault = F, Name = F, SkywardHash = F, SkywardID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SortGroup", objectId = SortGroupID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSortGroup <- function(SortGroupID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SortGroup", objectId = SortGroupID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSortGroup <- function(ObjectID = NULL, IsDefault = NULL, Name = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SortGroup", body = list(DataObject = body), searchFields = append("SortGroupID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySortGroup <- function(SortGroupID, ObjectID = NULL, IsDefault = NULL, Name = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SortGroup", objectId = SortGroupID, body = list(DataObject = body), searchFields = append("SortGroupID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getPageBurst <- function(PageBurstID, ObjectID = F, ObjectPrimaryKey = F, PageID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "PageBurst", objectId = PageBurstID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePageBurst <- function(PageBurstID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "PageBurst", objectId = PageBurstID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPageBurst <- function(ObjectID = NULL, ObjectPrimaryKey = NULL, PageID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "PageBurst", body = list(DataObject = body), searchFields = append("PageBurstID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPageBurst <- function(PageBurstID, ObjectID = NULL, ObjectPrimaryKey = NULL, PageID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "PageBurst", objectId = PageBurstID, body = list(DataObject = body), searchFields = append("PageBurstID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getBurstAction <- function(BurstActionID, SkywardID = F, SkywardHash = F, ActionHandler = F, Name = F, ObjectID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ParameterSxlPath = F, IsPrintAction = F, CanBeReverted = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "BurstAction", objectId = BurstActionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteBurstAction <- function(BurstActionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "BurstAction", objectId = BurstActionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createBurstAction <- function(Name = NULL, ObjectID = NULL, IsPrintAction = NULL, CanBeReverted = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "BurstAction", body = list(DataObject = body), searchFields = append("BurstActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyBurstAction <- function(BurstActionID, Name = NULL, ObjectID = NULL, IsPrintAction = NULL, CanBeReverted = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "BurstAction", objectId = BurstActionID, body = list(DataObject = body), searchFields = append("BurstActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getReportQueueBurstAction <- function(ReportQueueBurstActionID, ReportQueueID = F, BurstActionID = F, StatusCode = F, Status = F, Parameters = F, LogID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ChangesetXML = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportQueueBurstAction", objectId = ReportQueueBurstActionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportQueueBurstAction <- function(ReportQueueBurstActionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportQueueBurstAction", objectId = ReportQueueBurstActionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportQueueBurstAction <- function(ReportQueueID = NULL, BurstActionID = NULL, Status = NULL, LogID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ReportQueueBurstAction", body = list(DataObject = body), searchFields = append("ReportQueueBurstActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportQueueBurstAction <- function(ReportQueueBurstActionID, ReportQueueID = NULL, BurstActionID = NULL, Status = NULL, LogID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ReportQueueBurstAction", objectId = ReportQueueBurstActionID, body = list(DataObject = body), searchFields = append("ReportQueueBurstActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSummaryReportParameter <- function(SummaryReportParameterID, Name = F, Value = F, UsedBy = F, ReportQueueID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SummaryReportParameter", objectId = SummaryReportParameterID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSummaryReportParameter <- function(SummaryReportParameterID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SummaryReportParameter", objectId = SummaryReportParameterID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSummaryReportParameter <- function(Name = NULL, Value = NULL, UsedBy = NULL, ReportQueueID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SummaryReportParameter", body = list(DataObject = body), searchFields = append("SummaryReportParameterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySummaryReportParameter <- function(SummaryReportParameterID, Name = NULL, Value = NULL, UsedBy = NULL, ReportQueueID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SummaryReportParameter", objectId = SummaryReportParameterID, body = list(DataObject = body), searchFields = append("SummaryReportParameterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSummaryReportPrompt <- function(SummaryReportPromptID, ReportQueueID = F, Label = F, Value = F, Order = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SummaryReportPrompt", objectId = SummaryReportPromptID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSummaryReportPrompt <- function(SummaryReportPromptID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SummaryReportPrompt", objectId = SummaryReportPromptID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSummaryReportPrompt <- function(ReportQueueID = NULL, Label = NULL, Value = NULL, Order = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SummaryReportPrompt", body = list(DataObject = body), searchFields = append("SummaryReportPromptID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySummaryReportPrompt <- function(SummaryReportPromptID, ReportQueueID = NULL, Label = NULL, Value = NULL, Order = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SummaryReportPrompt", objectId = SummaryReportPromptID, body = list(DataObject = body), searchFields = append("SummaryReportPromptID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSummaryReportSection <- function(SummaryReportSectionID, ReportQueueID = F, Path = F, DisplayName = F, Order = F, HiddenType = F, HiddenTypeCode = F, SummaryReportSectionIDParent = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SummaryReportSection", objectId = SummaryReportSectionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSummaryReportSection <- function(SummaryReportSectionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SummaryReportSection", objectId = SummaryReportSectionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSummaryReportSection <- function(ReportQueueID = NULL, Path = NULL, DisplayName = NULL, Order = NULL, HiddenType = NULL, SummaryReportSectionIDParent = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SummaryReportSection", body = list(DataObject = body), searchFields = append("SummaryReportSectionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySummaryReportSection <- function(SummaryReportSectionID, ReportQueueID = NULL, Path = NULL, DisplayName = NULL, Order = NULL, HiddenType = NULL, SummaryReportSectionIDParent = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SummaryReportSection", objectId = SummaryReportSectionID, body = list(DataObject = body), searchFields = append("SummaryReportSectionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSummaryReportSectionColumn <- function(SummaryReportSectionColumnID, SummaryReportSectionID = F, DisplayName = F, FieldName = F, DataType = F, HiddenType = F, HiddenTypeCode = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SummaryReportSectionColumn", objectId = SummaryReportSectionColumnID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSummaryReportSectionColumn <- function(SummaryReportSectionColumnID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SummaryReportSectionColumn", objectId = SummaryReportSectionColumnID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSummaryReportSectionColumn <- function(SummaryReportSectionID = NULL, DisplayName = NULL, FieldName = NULL, DataType = NULL, HiddenType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SummaryReportSectionColumn", body = list(DataObject = body), searchFields = append("SummaryReportSectionColumnID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySummaryReportSectionColumn <- function(SummaryReportSectionColumnID, SummaryReportSectionID = NULL, DisplayName = NULL, FieldName = NULL, DataType = NULL, HiddenType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SummaryReportSectionColumn", objectId = SummaryReportSectionColumnID, body = list(DataObject = body), searchFields = append("SummaryReportSectionColumnID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getReportingConfigSystem <- function(ReportingConfigSystemID, ConfigSystemID = F, DaysToSaveReportResults = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ConfigSystem", objectId = ReportingConfigSystemID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportingConfigSystem <- function(ReportingConfigSystemID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ConfigSystem", objectId = ReportingConfigSystemID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportingConfigSystem <- function(DaysToSaveReportResults = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ConfigSystem", body = list(DataObject = body), searchFields = append("ConfigSystemID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportingConfigSystem <- function(ConfigSystemID, DaysToSaveReportResults = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ConfigSystem", objectId = ConfigSystemID, body = list(DataObject = body), searchFields = append("ConfigSystemID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getDataMiningReportSubtopicStandardFilter <- function(DataMiningReportSubtopicStandardFilterID, IsEnabled = F, DataMiningReportID = F, SubtopicStandardFilterID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "DataMiningReportSubtopicStandardFilter", objectId = DataMiningReportSubtopicStandardFilterID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMiningReportSubtopicStandardFilter <- function(DataMiningReportSubtopicStandardFilterID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "DataMiningReportSubtopicStandardFilter", objectId = DataMiningReportSubtopicStandardFilterID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMiningReportSubtopicStandardFilter <- function(IsEnabled = NULL, DataMiningReportID = NULL, SubtopicStandardFilterID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "DataMiningReportSubtopicStandardFilter", body = list(DataObject = body), searchFields = append("DataMiningReportSubtopicStandardFilterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMiningReportSubtopicStandardFilter <- function(DataMiningReportSubtopicStandardFilterID, IsEnabled = NULL, DataMiningReportID = NULL, SubtopicStandardFilterID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSubtopicStandardFilter <- function(SubtopicStandardFilterID, SkywardID = F, SkywardHash = F, Path = F, SubtopicID = F, StandardFilterID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsRequired = F, DisplayOnReport = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "SubtopicStandardFilter", objectId = SubtopicStandardFilterID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSubtopicStandardFilter <- function(SubtopicStandardFilterID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "SubtopicStandardFilter", objectId = SubtopicStandardFilterID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSubtopicStandardFilter <- function(Path = NULL, SubtopicID = NULL, StandardFilterID = NULL, IsRequired = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "SubtopicStandardFilter", body = list(DataObject = body), searchFields = append("SubtopicStandardFilterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySubtopicStandardFilter <- function(SubtopicStandardFilterID, Path = NULL, SubtopicID = NULL, StandardFilterID = NULL, IsRequired = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "SubtopicStandardFilter", objectId = SubtopicStandardFilterID, body = list(DataObject = body), searchFields = append("SubtopicStandardFilterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDataMiningReportFieldParameter <- function(DataMiningReportFieldParameterID, ParameterName = F, DataType = F, Value = F, IsPrompt = F, PromptLabel = F, PromptLabelOrParameterName = F, DataMiningReportID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "DataMiningReportFieldParameter", objectId = DataMiningReportFieldParameterID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDataMiningReportFieldParameter <- function(DataMiningReportFieldParameterID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "DataMiningReportFieldParameter", objectId = DataMiningReportFieldParameterID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDataMiningReportFieldParameter <- function(ParameterName = NULL, IsPrompt = NULL, PromptLabel = NULL, DataMiningReportID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "DataMiningReportFieldParameter", body = list(DataObject = body), searchFields = append("DataMiningReportFieldParameterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDataMiningReportFieldParameter <- function(DataMiningReportFieldParameterID, ParameterName = NULL, IsPrompt = NULL, PromptLabel = NULL, DataMiningReportID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "DataMiningReportFieldParameter", objectId = DataMiningReportFieldParameterID, body = list(DataObject = body), searchFields = append("DataMiningReportFieldParameterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempUploadDataMiningReportLog <- function(TempUploadDataMiningReportLogID, FileName = F, Message = F, ResultCode = F, LogID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "TempUploadDataMiningReportLog", objectId = TempUploadDataMiningReportLogID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempUploadDataMiningReportLog <- function(TempUploadDataMiningReportLogID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "TempUploadDataMiningReportLog", objectId = TempUploadDataMiningReportLogID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempUploadDataMiningReportLog <- function(FileName = NULL, Message = NULL, ResultCode = NULL, LogID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "TempUploadDataMiningReportLog", body = list(DataObject = body), searchFields = append("TempUploadDataMiningReportLogID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempUploadDataMiningReportLog <- function(TempUploadDataMiningReportLogID, FileName = NULL, Message = NULL, ResultCode = NULL, LogID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "TempUploadDataMiningReportLog", objectId = TempUploadDataMiningReportLogID, body = list(DataObject = body), searchFields = append("TempUploadDataMiningReportLogID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getReportError <- function(ReportErrorID, ReportID = F, ErrorMessage = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportError", objectId = ReportErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportError <- function(ReportErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportError", objectId = ReportErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportError <- function(ReportID = NULL, ErrorMessage = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ReportError", body = list(DataObject = body), searchFields = append("ReportErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportError <- function(ReportErrorID, ReportID = NULL, ErrorMessage = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ReportError", objectId = ReportErrorID, body = list(DataObject = body), searchFields = append("ReportErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempReportRole <- function(TempReportRoleID, ReportRoleID = F, ReportID = F, ReportName = F, ReportPortalCode = F, ReportPrimaryMenuModuleDisplayName = F, ReportReportTypeCode = F, ReportIsSkywardMaintained = F, RoleID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ReportIsWSIPCMaintained = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "TempReportRole", objectId = TempReportRoleID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempReportRole <- function(TempReportRoleID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "TempReportRole", objectId = TempReportRoleID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempReportRole <- function(ReportRoleID = NULL, ReportID = NULL, ReportName = NULL, ReportPortalCode = NULL, ReportPrimaryMenuModuleDisplayName = NULL, ReportReportTypeCode = NULL, ReportIsSkywardMaintained = NULL, RoleID = NULL, ReportIsWSIPCMaintained = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "TempReportRole", body = list(DataObject = body), searchFields = append("TempReportRoleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempReportRole <- function(TempReportRoleID, ReportRoleID = NULL, ReportID = NULL, ReportName = NULL, ReportPortalCode = NULL, ReportPrimaryMenuModuleDisplayName = NULL, ReportReportTypeCode = NULL, ReportIsSkywardMaintained = NULL, RoleID = NULL, ReportIsWSIPCMaintained = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Reporting", objectName = "TempReportRole", objectId = TempReportRoleID, body = list(DataObject = body), searchFields = append("TempReportRoleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getReportQueueDestinationResult <- function(ReportQueueDestinationResultID, ReportQueueID = F, FileDestinationResultID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ReportQueueDestinationResult", objectId = ReportQueueDestinationResultID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReportQueueDestinationResult <- function(ReportQueueDestinationResultID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ReportQueueDestinationResult", objectId = ReportQueueDestinationResultID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReportQueueDestinationResult <- function(ReportQueueID = NULL, FileDestinationResultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ReportQueueDestinationResult", body = list(DataObject = body), searchFields = append("ReportQueueDestinationResultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReportQueueDestinationResult <- function(ReportQueueDestinationResultID, ReportQueueID = NULL, FileDestinationResultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ReportQueueDestinationResult", objectId = ReportQueueDestinationResultID, body = list(DataObject = body), searchFields = append("ReportQueueDestinationResultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getScheduledReportDestination <- function(ScheduledReportDestinationID, ScheduledReportID = F, FileDestinationID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Reporting", objectName = "ScheduledReportDestination", objectId = ScheduledReportDestinationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteScheduledReportDestination <- function(ScheduledReportDestinationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Reporting", objectName = "ScheduledReportDestination", objectId = ScheduledReportDestinationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createScheduledReportDestination <- function(ScheduledReportID = NULL, FileDestinationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Reporting", objectName = "ScheduledReportDestination", body = list(DataObject = body), searchFields = append("ScheduledReportDestinationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyScheduledReportDestination <- function(ScheduledReportDestinationID, ScheduledReportID = NULL, FileDestinationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Reporting", objectName = "ScheduledReportDestination", objectId = ScheduledReportDestinationID, body = list(DataObject = body), searchFields = append("ScheduledReportDestinationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
