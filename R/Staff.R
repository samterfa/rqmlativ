	...
	getStaff <- function(StaffID, StaffMNID = F, FileFolderNumber = F, NameID = F, FullNameLFM = F, FullNameFL = F, FullNameFML = F, StaffWebsite = F, DistrictID = F, StaffNumber = F, IsCurrentStaffEntityYear = F, StaffMeetCount = F, AssignmentCount = F, NonGradedAssignmentCountForTerm = F, NonGradedAssignmentCountNoStudentAssignmentsYTD = F, PercentageOfAssignmentsScoredYTD = F, StudentAssignmentDataString = F, AssignmentDataString = F, ActiveStudentCount = F, DueDateOfLastAssignmentScored = F, DateTimeofLastScoredAssignment = F, NonGradedAssignmentCountNoStudentAssignmentsForTerm = F, GradebookLastAccessedTime = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, GradeLevelLowerBound = F, GradeLevelUpperBound = F, IsActiveForDistrict = F, FamilyStudentAccessStaffNameToUse = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "Staff", objectId = StaffID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStaff <- function(StaffID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "Staff", objectId = StaffID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStaff <- function(FileFolderNumber = NULL, NameID = NULL, StaffWebsite = NULL, DistrictID = NULL, StaffNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "Staff", body = list(DataObject = body), searchFields = append("StaffID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStaff <- function(StaffID, FileFolderNumber = NULL, NameID = NULL, StaffWebsite = NULL, DistrictID = NULL, StaffNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "Staff", objectId = StaffID, body = list(DataObject = body), searchFields = append("StaffID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStaffConfigSystem <- function(StaffConfigSystemID, ConfigSystemID = F, StaffNumberMask = F, StaffNumberStartValue = F, AutoGenerateSecurityUser = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, NewTeacherAccessUserMessageSubject = F, NewTeacherAccessUserMessageContent = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "ConfigSystem", objectId = StaffConfigSystemID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStaffConfigSystem <- function(StaffConfigSystemID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "ConfigSystem", objectId = StaffConfigSystemID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStaffConfigSystem <- function(StaffNumberMask = NULL, StaffNumberStartValue = NULL, AutoGenerateSecurityUser = NULL, NewTeacherAccessUserMessageSubject = NULL, NewTeacherAccessUserMessageContent = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "ConfigSystem", body = list(DataObject = body), searchFields = append("ConfigSystemID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStaffConfigSystem <- function(ConfigSystemID, StaffNumberMask = NULL, StaffNumberStartValue = NULL, AutoGenerateSecurityUser = NULL, NewTeacherAccessUserMessageSubject = NULL, NewTeacherAccessUserMessageContent = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "ConfigSystem", objectId = ConfigSystemID, body = list(DataObject = body), searchFields = append("ConfigSystemID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getNextStaffNumber <- function(NextStaffNumberID, MaskPrefix = F, SequenceNumber = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "NextStaffNumber", objectId = NextStaffNumberID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteNextStaffNumber <- function(NextStaffNumberID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "NextStaffNumber", objectId = NextStaffNumberID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createNextStaffNumber <- function(MaskPrefix = NULL, SequenceNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "NextStaffNumber", body = list(DataObject = body), searchFields = append("NextStaffNumberID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyNextStaffNumber <- function(NextStaffNumberID, MaskPrefix = NULL, SequenceNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "NextStaffNumber", objectId = NextStaffNumberID, body = list(DataObject = body), searchFields = append("NextStaffNumberID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStaffType <- function(StaffTypeID, DistrictID = F, Code = F, Description = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, CodeDescription = F, SchoolYearID = F, StaffTypeIDClonedFrom = F, StaffTypeIDClonedTo = F, EdFiStaffClassificationDescriptorID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "StaffType", objectId = StaffTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStaffType <- function(StaffTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "StaffType", objectId = StaffTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStaffType <- function(DistrictID = NULL, Code = NULL, Description = NULL, SchoolYearID = NULL, StaffTypeIDClonedFrom = NULL, EdFiStaffClassificationDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "StaffType", body = list(DataObject = body), searchFields = append("StaffTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStaffType <- function(StaffTypeID, DistrictID = NULL, Code = NULL, Description = NULL, SchoolYearID = NULL, StaffTypeIDClonedFrom = NULL, EdFiStaffClassificationDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "StaffType", objectId = StaffTypeID, body = list(DataObject = body), searchFields = append("StaffTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStaffStaffType <- function(StaffStaffTypeID, StaffTypeID = F, StaffID = F, IsPrimary = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StartDate = F, EndDate = F, StaffStaffTypeIDClonedFrom = F, PositionDescription = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "StaffStaffType", objectId = StaffStaffTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStaffStaffType <- function(StaffStaffTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "StaffStaffType", objectId = StaffStaffTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStaffStaffType <- function(StaffTypeID = NULL, StaffID = NULL, IsPrimary = NULL, StartDate = NULL, EndDate = NULL, StaffStaffTypeIDClonedFrom = NULL, PositionDescription = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "StaffStaffType", body = list(DataObject = body), searchFields = append("StaffStaffTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStaffStaffType <- function(StaffStaffTypeID, StaffTypeID = NULL, StaffID = NULL, IsPrimary = NULL, StartDate = NULL, EndDate = NULL, StaffStaffTypeIDClonedFrom = NULL, PositionDescription = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "StaffStaffType", objectId = StaffStaffTypeID, body = list(DataObject = body), searchFields = append("StaffStaffTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStaffEntityYear <- function(StaffEntityYearID, StaffID = F, EntityID = F, IsActive = F, IsDisciplineOfficer = F, IsTeacher = F, TeacherNumber = F, IsSubstituteTeacher = F, RoomIDDefault = F, SchoolYearID = F, IsCareerCenterCounselor = F, StaffDepartmentSummary = F, StaffEntityYearIDClonedFrom = F, StaffEntityYearClonedTo = F, IsAdditionalStaffOnNotification = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "StaffEntityYear", objectId = StaffEntityYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStaffEntityYear <- function(StaffEntityYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "StaffEntityYear", objectId = StaffEntityYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createStaffEntityYear <- function(StaffID = NULL, EntityID = NULL, IsActive = NULL, IsDisciplineOfficer = NULL, IsTeacher = NULL, TeacherNumber = NULL, IsSubstituteTeacher = NULL, RoomIDDefault = NULL, SchoolYearID = NULL, IsCareerCenterCounselor = NULL, StaffEntityYearIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Staff", objectName = "StaffEntityYear", body = list(DataObject = body), searchFields = append("StaffEntityYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyStaffEntityYear <- function(StaffEntityYearID, StaffID = NULL, EntityID = NULL, IsActive = NULL, IsDisciplineOfficer = NULL, IsTeacher = NULL, TeacherNumber = NULL, IsSubstituteTeacher = NULL, RoomIDDefault = NULL, SchoolYearID = NULL, IsCareerCenterCounselor = NULL, StaffEntityYearIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Staff", objectName = "StaffEntityYear", objectId = StaffEntityYearID, body = list(DataObject = body), searchFields = append("StaffEntityYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}

	#' List StaffStaffDepartments
	#'
	#' This function returns a dataframe or json object of StaffStaffDepartments
	#' @param fieldNames A TRUE or FALSE value determining whether or not to return the field for the given StaffStaffDepartments. Defaults to FALSE for all return fields which, for convenience, returns all fields for the StaffStaffDepartments.
	#' @param fieldPaths Fields from other objects with 'Many to One' or 'One to One' relationships to the given object listed as text. Run \code{\link{getSchemaForObjects}}('StaffStaffDepartment') to get more field paths.
	#' @param searchConditionsList A list of search conditions to filter results which are joined by the searchConditionsGroupType. Of the form {FieldName} {ConditionType} {SearchCondition}. For example, c('StudentID LessEqual 500', 'LastName Like Ander\%'). Run \code{\link{listSearchConditionTypes}} for a list of ConditionTypes. Defaults to NULL (unfiltered).
	#' @param searchConditionsGroupType The conjunction which joins multiple searchConditions in the searchConditionsList. Either 'Or' or 'And'. Defaults to 'And'.
	#' @param searchSortFieldNamesList The list of fields sort results by. Defaults to NULL (unsorted).
	#' @param searchSortFieldNamesDescendingList A list of T/F values corresponding to whether to sort each field in searchSortFieldNamesList in descending order. Defaults to F for each FieldName in searchSortFieldNamesList.
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Staff
	#' @return A list of StaffStaffDepartments
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	...
	#' Get a StaffStaffDepartment
	#'
	#' This function returns a dataframe or json object of a StaffStaffDepartment
	#' @param StaffStaffDepartmentID The ID of the StaffStaffDepartment to return.
	#' @param fieldNames A TRUE or FALSE value determining whether or not to return the field for the given StaffStaffDepartment. Defaults to FALSE for all return fields which, for convenience, returns all fields for the StaffStaffDepartment.
	#' @param fieldPaths Fields from other objects with 'Many to One' or 'One to One' relationships to the given object listed as text. Run \code{\link{getSchemaForObjects}}('StaffStaffDepartment') to get more field paths.
	#' @param entityId The id of the entity (school). Run \code{\link{listEntities}} for a list of entities. Defaults to 1 (district).
	#' @param schoolYearId The id of the schoolYear. Run \code{\link{listSchoolYears}} for a list of school years. Defaults to NULL (all school years).
	#' @param flatten Whether to flatten result into a dataframe or return the json object. Default is TRUE (flatten to dataframe).
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Staff
	#' @return A dataframe or of StaffStaffDepartment
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStaffStaffDepartment <- function(StaffStaffDepartmentID, StaffDepartmentID = F, StaffID = F, DepartmentID = F, IsDefaultDepartment = F, StaffDepartmentIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment()) %>% purrr::keep(names(.) != "StaffStaffDepartmentID")

		searchFields <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper())

		ifelse(!any(searchFields %>% unlist()), searchFields <- searchFields %>% names(), searchFields <- searchFields %>% purrr::keep(~.x) %>% names())

		getSkyObject(module = "Staff", objectName = "StaffDepartment", objectId = StaffStaffDepartmentID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}

	#' Delete a StaffStaffDepartment
	#'
	#' This function deletes a StaffStaffDepartment
	#' @param StaffStaffDepartmentID The ID of the StaffStaffDepartment to delete
	#' @param entityId The id of the entity (school). Run \code{\link{listEntities}} for a list of entities. Defaults to 1 (district).
	#' @param schoolYearId The id of the schoolYear. Run \code{\link{listSchoolYears}} for a list of school years. Defaults to NULL (all school years).
	#' @param flatten Whether to flatten result into a dataframe or return the json object. Default is TRUE (flatten to dataframe).
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Staff
	#' @return The StaffStaffDepartmentID of the deleted StaffStaffDepartment.
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStaffStaffDepartment <- function(StaffStaffDepartmentID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "StaffDepartment", objectId = StaffStaffDepartmentID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}

	#' Create a StaffStaffDepartment
	#'
	#' This function creates a StaffStaffDepartment
	#' @param fieldNames The field values to give the created StaffStaffDepartment. Each defaults to NULL.
	#' @param entityId The id of the entity (school). Run \code{\link{listEntities}} for a list of entities. Defaults to 1 (district).
	#' @param schoolYearId The id of the schoolYear. Run \code{\link{listSchoolYears}} for a list of school years. Defaults to NULL (all school years).
	#' @param flatten Whether to flatten result into a dataframe or return the json object. Default is TRUE (flatten to dataframe).
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Staff
	#' @return A newly created StaffStaffDepartment
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStaffStaffDepartment <- function(StaffID = NULL, DepartmentID = NULL, IsDefaultDepartment = NULL, StaffDepartmentIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "StaffDepartment", body = list(DataObject = body), searchFields = append("StaffDepartmentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}

	#' Modify a StaffStaffDepartment
	#'
	#' This function modifies a StaffStaffDepartment
	#' @param fieldNames The field values to give the modified StaffStaffDepartment. Each defaults to NULL.
	#' @param entityId The id of the entity (school). Run \code{\link{listEntities}} for a list of entities. Defaults to 1 (district).
	#' @param schoolYearId The id of the schoolYear. Run \code{\link{listSchoolYears}} for a list of school years. Defaults to NULL (all school years).
	#' @param flatten Whether to flatten result into a dataframe or return the json object. Default is TRUE (flatten to dataframe).
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Staff
	#' @return The modified StaffStaffDepartment
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStaffStaffDepartment <- function(StaffDepartmentID, StaffID = NULL, DepartmentID = NULL, IsDefaultDepartment = NULL, StaffDepartmentIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "StaffDepartment", objectId = StaffDepartmentID, body = list(DataObject = body), searchFields = append("StaffDepartmentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStaffDepartment <- function(StaffDepartmentID, DepartmentID = F, SchoolYearID = F, EntityID = F, EntityGroupKey = F, Code = F, Description = F, StaffIDDepartmentHead = F, DepartmentIDClonedFrom = F, CodeDescription = F, DepartmentIDClonedTo = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "Department", objectId = StaffDepartmentID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStaffDepartment <- function(StaffDepartmentID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "Department", objectId = StaffDepartmentID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStaffDepartment <- function(SchoolYearID = NULL, EntityID = NULL, EntityGroupKey = NULL, Code = NULL, Description = NULL, StaffIDDepartmentHead = NULL, DepartmentIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "Department", body = list(DataObject = body), searchFields = append("DepartmentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStaffDepartment <- function(DepartmentID, SchoolYearID = NULL, EntityID = NULL, EntityGroupKey = NULL, Code = NULL, Description = NULL, StaffIDDepartmentHead = NULL, DepartmentIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "Department", objectId = DepartmentID, body = list(DataObject = body), searchFields = append("DepartmentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getScheduleBlockerDisplayPeriod <- function(ScheduleBlockerDisplayPeriodID, ScheduleBlockerID = F, DisplayPeriodID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "ScheduleBlockerDisplayPeriod", objectId = ScheduleBlockerDisplayPeriodID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteScheduleBlockerDisplayPeriod <- function(ScheduleBlockerDisplayPeriodID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "ScheduleBlockerDisplayPeriod", objectId = ScheduleBlockerDisplayPeriodID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createScheduleBlockerDisplayPeriod <- function(ScheduleBlockerID = NULL, DisplayPeriodID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "ScheduleBlockerDisplayPeriod", body = list(DataObject = body), searchFields = append("ScheduleBlockerDisplayPeriodID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyScheduleBlockerDisplayPeriod <- function(ScheduleBlockerDisplayPeriodID, ScheduleBlockerID = NULL, DisplayPeriodID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "ScheduleBlockerDisplayPeriod", objectId = ScheduleBlockerDisplayPeriodID, body = list(DataObject = body), searchFields = append("ScheduleBlockerDisplayPeriodID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getScheduleBlocker <- function(ScheduleBlockerID, StaffID = F, EntityID = F, SchoolYearID = F, StartDate = F, EndDate = F, Reason = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "ScheduleBlocker", objectId = ScheduleBlockerID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteScheduleBlocker <- function(ScheduleBlockerID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "ScheduleBlocker", objectId = ScheduleBlockerID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createScheduleBlocker <- function(StaffID = NULL, EntityID = NULL, SchoolYearID = NULL, StartDate = NULL, EndDate = NULL, Reason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "ScheduleBlocker", body = list(DataObject = body), searchFields = append("ScheduleBlockerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyScheduleBlocker <- function(ScheduleBlockerID, StaffID = NULL, EntityID = NULL, SchoolYearID = NULL, StartDate = NULL, EndDate = NULL, Reason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "ScheduleBlocker", objectId = ScheduleBlockerID, body = list(DataObject = body), searchFields = append("ScheduleBlockerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getMassPrintStaffScheduleRunHistory <- function(MassPrintStaffScheduleRunHistoryID, EntityID = F, SchoolYearID = F, RunDescription = F, MediaID = F, WorkflowInstanceID = F, RequestIdentifier = F, SendMessageOnComplete = F, ParameterData = F, ParameterDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "MassPrintStaffScheduleRunHistory", objectId = MassPrintStaffScheduleRunHistoryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteMassPrintStaffScheduleRunHistory <- function(MassPrintStaffScheduleRunHistoryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "MassPrintStaffScheduleRunHistory", objectId = MassPrintStaffScheduleRunHistoryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createMassPrintStaffScheduleRunHistory <- function(EntityID = NULL, SchoolYearID = NULL, RunDescription = NULL, MediaID = NULL, WorkflowInstanceID = NULL, SendMessageOnComplete = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "MassPrintStaffScheduleRunHistory", body = list(DataObject = body), searchFields = append("MassPrintStaffScheduleRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyMassPrintStaffScheduleRunHistory <- function(MassPrintStaffScheduleRunHistoryID, EntityID = NULL, SchoolYearID = NULL, RunDescription = NULL, MediaID = NULL, WorkflowInstanceID = NULL, SendMessageOnComplete = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "MassPrintStaffScheduleRunHistory", objectId = MassPrintStaffScheduleRunHistoryID, body = list(DataObject = body), searchFields = append("MassPrintStaffScheduleRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStaffConfigEntityGroupYear <- function(StaffConfigEntityGroupYearID, ConfigEntityGroupYearID = F, SchoolYearID = F, EntityID = F, EntityGroupKey = F, AllowFoodServiceOnlinePaymentsAccessByDefault = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "ConfigEntityGroupYear", objectId = StaffConfigEntityGroupYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStaffConfigEntityGroupYear <- function(StaffConfigEntityGroupYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "ConfigEntityGroupYear", objectId = StaffConfigEntityGroupYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStaffConfigEntityGroupYear <- function(SchoolYearID = NULL, EntityID = NULL, EntityGroupKey = NULL, AllowFoodServiceOnlinePaymentsAccessByDefault = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "ConfigEntityGroupYear", body = list(DataObject = body), searchFields = append("ConfigEntityGroupYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStaffConfigEntityGroupYear <- function(ConfigEntityGroupYearID, SchoolYearID = NULL, EntityID = NULL, EntityGroupKey = NULL, AllowFoodServiceOnlinePaymentsAccessByDefault = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "ConfigEntityGroupYear", objectId = ConfigEntityGroupYearID, body = list(DataObject = body), searchFields = append("ConfigEntityGroupYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listJobTitleMAS <- function(searchConditionsList = NULL, JobTitleMAID = F, Title = F, StaffID = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getJobTitleMA <- function(JobTitleMAID, Title = F, StaffID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "JobTitleMA", objectId = JobTitleMAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteJobTitleMA <- function(JobTitleMAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "JobTitleMA", objectId = JobTitleMAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createJobTitleMA <- function(Title = NULL, StaffID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Staff", objectName = "JobTitleMA", body = list(DataObject = body), searchFields = append("JobTitleMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyJobTitleMA <- function(JobTitleMAID, Title = NULL, StaffID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Staff", objectName = "JobTitleMA", objectId = JobTitleMAID, body = list(DataObject = body), searchFields = append("JobTitleMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getNumberedStaffEntityYearForDistrictAndSchoolYear <- function(NumberedStaffEntityYearForDistrictAndSchoolYearID, DistrictID = F, EntityID = F, SchoolYearID = F, StaffDistrictRowNumber = F, StaffID = F, StaffEntityYearID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Staff", objectName = "NumberedStaffEntityYearForDistrictAndSchoolYear", objectId = NumberedStaffEntityYearForDistrictAndSchoolYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteNumberedStaffEntityYearForDistrictAndSchoolYear <- function(NumberedStaffEntityYearForDistrictAndSchoolYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Staff", objectName = "NumberedStaffEntityYearForDistrictAndSchoolYear", objectId = NumberedStaffEntityYearForDistrictAndSchoolYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
