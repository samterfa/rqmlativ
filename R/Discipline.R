	...
	getActionAttendanceType <- function(ActionAttendanceTypeID, ActionID = F, AttendanceTypeID = F, EntityGroupKey = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, ActionAttendanceTypeIDClonedFrom = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "ActionAttendanceType", objectId = ActionAttendanceTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActionAttendanceType <- function(ActionAttendanceTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "ActionAttendanceType", objectId = ActionAttendanceTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createActionAttendanceType <- function(ActionID = NULL, AttendanceTypeID = NULL, EntityGroupKey = NULL, ActionAttendanceTypeIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "ActionAttendanceType", body = list(DataObject = body), searchFields = append("ActionAttendanceTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyActionAttendanceType <- function(ActionAttendanceTypeID, ActionID = NULL, AttendanceTypeID = NULL, EntityGroupKey = NULL, ActionAttendanceTypeIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "ActionAttendanceType", objectId = ActionAttendanceTypeID, body = list(DataObject = body), searchFields = append("ActionAttendanceTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncidentOffenseNameActionDetailPeriod <- function(IncidentOffenseNameActionDetailPeriodID, IncidentOffenseNameActionDetailID = F, AttendancePeriodID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "IncidentOffenseNameActionDetailPeriod", objectId = IncidentOffenseNameActionDetailPeriodID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncidentOffenseNameActionDetailPeriod <- function(IncidentOffenseNameActionDetailPeriodID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "IncidentOffenseNameActionDetailPeriod", objectId = IncidentOffenseNameActionDetailPeriodID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIncidentOffenseNameActionDetailPeriod <- function(IncidentOffenseNameActionDetailID = NULL, AttendancePeriodID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "IncidentOffenseNameActionDetailPeriod", body = list(DataObject = body), searchFields = append("IncidentOffenseNameActionDetailPeriodID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIncidentOffenseNameActionDetailPeriod <- function(IncidentOffenseNameActionDetailPeriodID, IncidentOffenseNameActionDetailID = NULL, AttendancePeriodID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	getDisciplineConfigEntityGroupYear <- function(DisciplineConfigEntityGroupYearID, ConfigEntityGroupYearID = F, EntityID = F, EntityGroupKey = F, SchoolYearID = F, UseAlternateActionDetails = F, DetentionsOnMon = F, DetentionsOnTue = F, DetentionsOnWed = F, DetentionsOnThu = F, DetentionsOnFri = F, DetentionsOnSat = F, DetentionsOnSun = F, InSchoolSuspensionsOnMon = F, InSchoolSuspensionsOnTue = F, InSchoolSuspensionsOnWed = F, InSchoolSuspensionsOnThu = F, InSchoolSuspensionsOnFri = F, InSchoolSuspensionsOnSat = F, InSchoolSuspensionsOnSun = F, OutOfSchoolSuspensionsOnMon = F, OutOfSchoolSuspensionsOnTue = F, OutOfSchoolSuspensionsOnWed = F, OutOfSchoolSuspensionsOnThu = F, OutOfSchoolSuspensionsOnFri = F, OutOfSchoolSuspensionsOnSat = F, OutOfSchoolSuspensionsOnSun = F, ExpulsionsOnMon = F, ExpulsionsOnTue = F, ExpulsionsOnWed = F, ExpulsionsOnThu = F, ExpulsionsOnFri = F, ExpulsionsOnSat = F, ExpulsionsOnSun = F, DefaultActionStatusCode = F, TardyKioskDisciplineSlipTitle = F, IncludeStudentNameAndOrNumberOnLetter = F, IncludeGradeLevelOnLetter = F, IncludeSchoolOrCampusOnLetter = F, IncludeParentNameAndOrPhoneNumberOnLetter = F, IncludeDisciplinaryActionAndDetailsOnLetter = F, IncludeSignatureLineForParentOnLetter = F, IncludeSignatureLineForStudentOnLetter = F, IncludeSignatureLineForOfficeOnLetter = F, ActionStatusDefaultValue = F, ConfigEntityGroupYearIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, IncludeOffenseDescriptionOnLetter = F, IncludeIncidentDateAndTimeOnLetter = F, IncludeIncidentDescriptionOnLetter = F, IncludeReferredByOnLetter = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "ConfigEntityGroupYear", objectId = DisciplineConfigEntityGroupYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineConfigEntityGroupYear <- function(DisciplineConfigEntityGroupYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "ConfigEntityGroupYear", objectId = DisciplineConfigEntityGroupYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createDisciplineConfigEntityGroupYear <- function(EntityID = NULL, EntityGroupKey = NULL, SchoolYearID = NULL, UseAlternateActionDetails = NULL, DetentionsOnMon = NULL, DetentionsOnTue = NULL, DetentionsOnWed = NULL, DetentionsOnThu = NULL, DetentionsOnFri = NULL, DetentionsOnSat = NULL, DetentionsOnSun = NULL, InSchoolSuspensionsOnMon = NULL, InSchoolSuspensionsOnTue = NULL, InSchoolSuspensionsOnWed = NULL, InSchoolSuspensionsOnThu = NULL, InSchoolSuspensionsOnFri = NULL, InSchoolSuspensionsOnSat = NULL, InSchoolSuspensionsOnSun = NULL, OutOfSchoolSuspensionsOnMon = NULL, OutOfSchoolSuspensionsOnTue = NULL, OutOfSchoolSuspensionsOnWed = NULL, OutOfSchoolSuspensionsOnThu = NULL, OutOfSchoolSuspensionsOnFri = NULL, OutOfSchoolSuspensionsOnSat = NULL, OutOfSchoolSuspensionsOnSun = NULL, ExpulsionsOnMon = NULL, ExpulsionsOnTue = NULL, ExpulsionsOnWed = NULL, ExpulsionsOnThu = NULL, ExpulsionsOnFri = NULL, ExpulsionsOnSat = NULL, ExpulsionsOnSun = NULL, DefaultActionStatusCode = NULL, TardyKioskDisciplineSlipTitle = NULL, IncludeStudentNameAndOrNumberOnLetter = NULL, IncludeGradeLevelOnLetter = NULL, IncludeSchoolOrCampusOnLetter = NULL, IncludeParentNameAndOrPhoneNumberOnLetter = NULL, IncludeDisciplinaryActionAndDetailsOnLetter = NULL, IncludeSignatureLineForParentOnLetter = NULL, IncludeSignatureLineForStudentOnLetter = NULL, IncludeSignatureLineForOfficeOnLetter = NULL, ActionStatusDefaultValue = NULL, ConfigEntityGroupYearIDClonedFrom = NULL, IncludeOffenseDescriptionOnLetter = NULL, IncludeIncidentDateAndTimeOnLetter = NULL, IncludeIncidentDescriptionOnLetter = NULL, IncludeReferredByOnLetter = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "ConfigEntityGroupYear", body = list(DataObject = body), searchFields = append("ConfigEntityGroupYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyDisciplineConfigEntityGroupYear <- function(ConfigEntityGroupYearID, EntityID = NULL, EntityGroupKey = NULL, SchoolYearID = NULL, UseAlternateActionDetails = NULL, DetentionsOnMon = NULL, DetentionsOnTue = NULL, DetentionsOnWed = NULL, DetentionsOnThu = NULL, DetentionsOnFri = NULL, DetentionsOnSat = NULL, DetentionsOnSun = NULL, InSchoolSuspensionsOnMon = NULL, InSchoolSuspensionsOnTue = NULL, InSchoolSuspensionsOnWed = NULL, InSchoolSuspensionsOnThu = NULL, InSchoolSuspensionsOnFri = NULL, InSchoolSuspensionsOnSat = NULL, InSchoolSuspensionsOnSun = NULL, OutOfSchoolSuspensionsOnMon = NULL, OutOfSchoolSuspensionsOnTue = NULL, OutOfSchoolSuspensionsOnWed = NULL, OutOfSchoolSuspensionsOnThu = NULL, OutOfSchoolSuspensionsOnFri = NULL, OutOfSchoolSuspensionsOnSat = NULL, OutOfSchoolSuspensionsOnSun = NULL, ExpulsionsOnMon = NULL, ExpulsionsOnTue = NULL, ExpulsionsOnWed = NULL, ExpulsionsOnThu = NULL, ExpulsionsOnFri = NULL, ExpulsionsOnSat = NULL, ExpulsionsOnSun = NULL, DefaultActionStatusCode = NULL, TardyKioskDisciplineSlipTitle = NULL, IncludeStudentNameAndOrNumberOnLetter = NULL, IncludeGradeLevelOnLetter = NULL, IncludeSchoolOrCampusOnLetter = NULL, IncludeParentNameAndOrPhoneNumberOnLetter = NULL, IncludeDisciplinaryActionAndDetailsOnLetter = NULL, IncludeSignatureLineForParentOnLetter = NULL, IncludeSignatureLineForStudentOnLetter = NULL, IncludeSignatureLineForOfficeOnLetter = NULL, ActionStatusDefaultValue = NULL, ConfigEntityGroupYearIDClonedFrom = NULL, IncludeOffenseDescriptionOnLetter = NULL, IncludeIncidentDateAndTimeOnLetter = NULL, IncludeIncidentDescriptionOnLetter = NULL, IncludeReferredByOnLetter = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "ConfigEntityGroupYear", objectId = ConfigEntityGroupYearID, body = list(DataObject = body), searchFields = append("ConfigEntityGroupYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameActionDetail <- function(TempIncidentOffenseNameActionDetailID, IncidentOffenseNameActionDetailID = F, FullName = F, InvolvementType = F, OffenseCodeDescription = F, IsPrimaryOffense = F, ActionCodeDescription = F, DurationToServe = F, DurationType = F, CreateAttendance = F, IsAlternate = F, LocationID = F, PartialDayPeriods = F, OldStatus = F, NewStatus = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, TempIncidentOffenseNameActionID = F, ScheduledTime = F, DurationServed = F, StaffIDFollowUpOfficer = F, Status = F, IsGuardianNotified = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionDetail", objectId = TempIncidentOffenseNameActionDetailID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameActionDetail <- function(TempIncidentOffenseNameActionDetailID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionDetail", objectId = TempIncidentOffenseNameActionDetailID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameActionDetail <- function(IncidentOffenseNameActionDetailID = NULL, FullName = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionCodeDescription = NULL, DurationToServe = NULL, DurationType = NULL, CreateAttendance = NULL, IsAlternate = NULL, LocationID = NULL, PartialDayPeriods = NULL, OldStatus = NULL, NewStatus = NULL, TempIncidentOffenseNameActionID = NULL, ScheduledTime = NULL, DurationServed = NULL, StaffIDFollowUpOfficer = NULL, Status = NULL, IsGuardianNotified = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionDetail", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionDetailID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseNameActionDetail <- function(TempIncidentOffenseNameActionDetailID, IncidentOffenseNameActionDetailID = NULL, FullName = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionCodeDescription = NULL, DurationToServe = NULL, DurationType = NULL, CreateAttendance = NULL, IsAlternate = NULL, LocationID = NULL, PartialDayPeriods = NULL, OldStatus = NULL, NewStatus = NULL, TempIncidentOffenseNameActionID = NULL, ScheduledTime = NULL, DurationServed = NULL, StaffIDFollowUpOfficer = NULL, Status = NULL, IsGuardianNotified = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionDetail", objectId = TempIncidentOffenseNameActionDetailID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionDetailID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameAction <- function(TempIncidentOffenseNameActionID, FullName = F, InvolvementType = F, OffenseCodeDescription = F, IsPrimaryOffense = F, ActionCodeDescription = F, DurationToServe = F, StaffIDAuthorizedByName = F, PerceivedMotivationCodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Comment = F, StudentNumber = F, EntityID = F, ActionTypeID = F, ActionTypeCode = F, ActionID = F, Status = F, OrderedDate = F, DurationType = F, StaffIDAuthorizedBy = F, StaffIDFollowUpOfficer = F, LocationID = F, BuildingID = F, RoomID = F, TempIncidentOffenseNameID = F, IsGuardianNotified = F, StartTime = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameAction", objectId = TempIncidentOffenseNameActionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameAction <- function(TempIncidentOffenseNameActionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameAction", objectId = TempIncidentOffenseNameActionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameAction <- function(FullName = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionCodeDescription = NULL, DurationToServe = NULL, StaffIDAuthorizedByName = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, StudentNumber = NULL, EntityID = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, StaffIDAuthorizedBy = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameAction", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseNameAction <- function(TempIncidentOffenseNameActionID, FullName = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionCodeDescription = NULL, DurationToServe = NULL, StaffIDAuthorizedByName = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, StudentNumber = NULL, EntityID = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, StaffIDAuthorizedBy = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameAction", objectId = TempIncidentOffenseNameActionID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncident <- function(IncidentID, DistrictID = F, EntityID = F, SchoolYearID = F, IncidentNumber = F, DateTime = F, Type = F, LocationID = F, BuildingID = F, RoomID = F, Description = F, DamageCost = F, ActionIDRecommended = F, ReferredByType = F, ReferredByNameID = F, ReferredByFreeformName = F, ReferredByName = F, IncidentNumberValue = F, HasActions = F, HasActionsForOffenders = F, HasOpenActions = F, HasOverdueActionDetails = F, IsReferralOrWarning = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IncidentMNID = F, StateDIRSTimeMNID = F, ReportedToLawEnforcement = F, NumberOfNonEnrolledOffenders = F, NumberOfNonEnrolledVictims = F, IsIncidentOrWarning = F, IsSuppressed = F, HasWeapons = F, HasDrugs = F, IsReadOnlyHistoricalRecord = F, DateBeforeLastEffectiveRun = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "Incident", objectId = IncidentID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncident <- function(IncidentID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "Incident", objectId = IncidentID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createIncident <- function(DistrictID = NULL, EntityID = NULL, SchoolYearID = NULL, IncidentNumber = NULL, DateTime = NULL, Type = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, Description = NULL, DamageCost = NULL, ActionIDRecommended = NULL, ReferredByType = NULL, ReferredByNameID = NULL, ReferredByFreeformName = NULL, StateDIRSTimeMNID = NULL, ReportedToLawEnforcement = NULL, NumberOfNonEnrolledOffenders = NULL, NumberOfNonEnrolledVictims = NULL, IsSuppressed = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "Incident", body = list(DataObject = body), searchFields = append("IncidentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyIncident <- function(IncidentID, DistrictID = NULL, EntityID = NULL, SchoolYearID = NULL, IncidentNumber = NULL, DateTime = NULL, Type = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, Description = NULL, DamageCost = NULL, ActionIDRecommended = NULL, ReferredByType = NULL, ReferredByNameID = NULL, ReferredByFreeformName = NULL, StateDIRSTimeMNID = NULL, ReportedToLawEnforcement = NULL, NumberOfNonEnrolledOffenders = NULL, NumberOfNonEnrolledVictims = NULL, IsSuppressed = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "Incident", objectId = IncidentID, body = list(DataObject = body), searchFields = append("IncidentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncidentOffense <- function(IncidentOffenseID, IncidentID = F, OffenseID = F, IsPrimaryOffense = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, HasActions = F, HasWeapons = F, HasDrugs = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "IncidentOffense", objectId = IncidentOffenseID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncidentOffense <- function(IncidentOffenseID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "IncidentOffense", objectId = IncidentOffenseID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIncidentOffense <- function(IncidentID = NULL, OffenseID = NULL, IsPrimaryOffense = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "IncidentOffense", body = list(DataObject = body), searchFields = append("IncidentOffenseID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIncidentOffense <- function(IncidentOffenseID, IncidentID = NULL, OffenseID = NULL, IsPrimaryOffense = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "IncidentOffense", objectId = IncidentOffenseID, body = list(DataObject = body), searchFields = append("IncidentOffenseID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncidentOffenseName <- function(IncidentOffenseNameID, IncidentOffenseID = F, NameID = F, IncidentOffenseNameType = F, FreeformName = F, InvolvementType = F, StaffIDDisciplineOfficer = F, Statement = F, IsGuardianNotified = F, PerceivedMotivationID = F, OffenseLevelID = F, PersonalName = F, HasActions = F, HasOpenActions = F, HasOverdueActionDetails = F, IsStudentOffender = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IncidentOffenseNameMNID = F, StateVictimTypeMNID = F, StateVictimCostMNID = F, InjuryOccured = F, WasSeriousBodilyInjury = F, AttachmentCount = F, HasWeapons = F, HasDrugs = F, ReportedToLawEnforcement = F, StateOffenderActivityMNID = F, HasDangerousWeapons = F, IsPhysicalAssault = F, IsPhysicalAssaultState = F, FirstDrugCodeforNorthEastExport = F, OffenderArrestedByLawEnforcement = F, IsReadOnlyHistoricalRecord = F, DisciplineThresholdID = F, InternalComment = F, MultipleVictimCount = F, EstimatedVictimsEnrolled = F, EstimatedVictimsNotEnrolled = F, CreatedBeforeLastEffectiveRunAndWasWithinDelay = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "IncidentOffenseName", objectId = IncidentOffenseNameID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncidentOffenseName <- function(IncidentOffenseNameID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "IncidentOffenseName", objectId = IncidentOffenseNameID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createIncidentOffenseName <- function(IncidentOffenseID = NULL, NameID = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, InvolvementType = NULL, StaffIDDisciplineOfficer = NULL, Statement = NULL, IsGuardianNotified = NULL, PerceivedMotivationID = NULL, OffenseLevelID = NULL, StateVictimTypeMNID = NULL, StateVictimCostMNID = NULL, InjuryOccured = NULL, WasSeriousBodilyInjury = NULL, ReportedToLawEnforcement = NULL, StateOffenderActivityMNID = NULL, IsPhysicalAssault = NULL, IsPhysicalAssaultState = NULL, OffenderArrestedByLawEnforcement = NULL, DisciplineThresholdID = NULL, MultipleVictimCount = NULL, EstimatedVictimsEnrolled = NULL, EstimatedVictimsNotEnrolled = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "IncidentOffenseName", body = list(DataObject = body), searchFields = append("IncidentOffenseNameID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyIncidentOffenseName <- function(IncidentOffenseNameID, IncidentOffenseID = NULL, NameID = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, InvolvementType = NULL, StaffIDDisciplineOfficer = NULL, Statement = NULL, IsGuardianNotified = NULL, PerceivedMotivationID = NULL, OffenseLevelID = NULL, StateVictimTypeMNID = NULL, StateVictimCostMNID = NULL, InjuryOccured = NULL, WasSeriousBodilyInjury = NULL, ReportedToLawEnforcement = NULL, StateOffenderActivityMNID = NULL, IsPhysicalAssault = NULL, IsPhysicalAssaultState = NULL, OffenderArrestedByLawEnforcement = NULL, DisciplineThresholdID = NULL, MultipleVictimCount = NULL, EstimatedVictimsEnrolled = NULL, EstimatedVictimsNotEnrolled = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "IncidentOffenseName", objectId = IncidentOffenseNameID, body = list(DataObject = body), searchFields = append("IncidentOffenseNameID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncidentOffenseNameAction <- function(IncidentOffenseNameActionID, IncidentOffenseNameID = F, ActionID = F, Status = F, OrderedDate = F, DurationToServe = F, EntityID = F, LocationID = F, BuildingID = F, RoomID = F, StaffIDAuthorizedBy = F, StaffIDFollowUpOfficer = F, IsGuardianNotified = F, Comment = F, DurationServedOverride = F, DurationServed = F, ActualDurationServed = F, TotalDurationServed = F, DurationToServeWithLabel = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IncidentOffenseNameActionMNID = F, StateDIRSAESTypeMNID = F, DateExpulsionExclusionEnds = F, ReturnBeforeYearEnd = F, ExclusionThroughYearEnd = F, ExpulsionModified = F, ExpulsionThroughYearEnd = F, DIRSActionExplanation = F, FirstActionDetailDateNorthEastExport = F, LastActionDetailDateNorthEastExport = F, ActionTypeID = F, DurationType = F, StartTime = F, IsReadOnlyHistoricalRecord = F, InternalComment = F, NoServiceProvidedExplanation = F, MeetsLastRunDates = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "IncidentOffenseNameAction", objectId = IncidentOffenseNameActionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncidentOffenseNameAction <- function(IncidentOffenseNameActionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "IncidentOffenseNameAction", objectId = IncidentOffenseNameActionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createIncidentOffenseNameAction <- function(IncidentOffenseNameID = NULL, ActionID = NULL, Status = NULL, OrderedDate = NULL, DurationToServe = NULL, EntityID = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, StaffIDAuthorizedBy = NULL, StaffIDFollowUpOfficer = NULL, IsGuardianNotified = NULL, Comment = NULL, DurationServedOverride = NULL, StateDIRSAESTypeMNID = NULL, DateExpulsionExclusionEnds = NULL, ReturnBeforeYearEnd = NULL, ExclusionThroughYearEnd = NULL, ExpulsionModified = NULL, ExpulsionThroughYearEnd = NULL, DIRSActionExplanation = NULL, ActionTypeID = NULL, DurationType = NULL, StartTime = NULL, NoServiceProvidedExplanation = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "IncidentOffenseNameAction", body = list(DataObject = body), searchFields = append("IncidentOffenseNameActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyIncidentOffenseNameAction <- function(IncidentOffenseNameActionID, IncidentOffenseNameID = NULL, ActionID = NULL, Status = NULL, OrderedDate = NULL, DurationToServe = NULL, EntityID = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, StaffIDAuthorizedBy = NULL, StaffIDFollowUpOfficer = NULL, IsGuardianNotified = NULL, Comment = NULL, DurationServedOverride = NULL, StateDIRSAESTypeMNID = NULL, DateExpulsionExclusionEnds = NULL, ReturnBeforeYearEnd = NULL, ExclusionThroughYearEnd = NULL, ExpulsionModified = NULL, ExpulsionThroughYearEnd = NULL, DIRSActionExplanation = NULL, ActionTypeID = NULL, DurationType = NULL, StartTime = NULL, NoServiceProvidedExplanation = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "IncidentOffenseNameAction", objectId = IncidentOffenseNameActionID, body = list(DataObject = body), searchFields = append("IncidentOffenseNameActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncidentOffenseNameActionDetail <- function(IncidentOffenseNameActionDetailID, IncidentOffenseNameActionID = F, Status = F, ScheduledTime = F, IsAlternate = F, DurationToServe = F, DurationServed = F, LocationID = F, BuildingID = F, RoomID = F, StaffIDFollowUpOfficer = F, IsGuardianNotified = F, Comment = F, LastAlternate = F, RenderReissueOption = F, DurationToServeWithLabel = F, DurationServedWithLabel = F, Overdue = F, PartialDayPeriods = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "IncidentOffenseNameActionDetail", objectId = IncidentOffenseNameActionDetailID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncidentOffenseNameActionDetail <- function(IncidentOffenseNameActionDetailID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "IncidentOffenseNameActionDetail", objectId = IncidentOffenseNameActionDetailID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createIncidentOffenseNameActionDetail <- function(IncidentOffenseNameActionID = NULL, Status = NULL, ScheduledTime = NULL, IsAlternate = NULL, DurationToServe = NULL, DurationServed = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, StaffIDFollowUpOfficer = NULL, IsGuardianNotified = NULL, Comment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "IncidentOffenseNameActionDetail", body = list(DataObject = body), searchFields = append("IncidentOffenseNameActionDetailID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyIncidentOffenseNameActionDetail <- function(IncidentOffenseNameActionDetailID, IncidentOffenseNameActionID = NULL, Status = NULL, ScheduledTime = NULL, IsAlternate = NULL, DurationToServe = NULL, DurationServed = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, StaffIDFollowUpOfficer = NULL, IsGuardianNotified = NULL, Comment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "IncidentOffenseNameActionDetail", objectId = IncidentOffenseNameActionDetailID, body = list(DataObject = body), searchFields = append("IncidentOffenseNameActionDetailID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getNextIncidentNumber <- function(NextIncidentNumberID, DistrictID = F, SchoolYearID = F, SequenceNumber = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "NextIncidentNumber", objectId = NextIncidentNumberID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteNextIncidentNumber <- function(NextIncidentNumberID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "NextIncidentNumber", objectId = NextIncidentNumberID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createNextIncidentNumber <- function(DistrictID = NULL, SchoolYearID = NULL, SequenceNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "NextIncidentNumber", body = list(DataObject = body), searchFields = append("NextIncidentNumberID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyNextIncidentNumber <- function(NextIncidentNumberID, DistrictID = NULL, SchoolYearID = NULL, SequenceNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "NextIncidentNumber", objectId = NextIncidentNumberID, body = list(DataObject = body), searchFields = append("NextIncidentNumberID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameActionDetailRecord <- function(TempIncidentOffenseNameActionDetailRecordID, IncidentOffenseNameActionID = F, StatusCode = F, Status = F, ScheduledTime = F, IsAlternate = F, DurationToServe = F, DurationServed = F, DurationType = F, LocationID = F, Location = F, BuildingID = F, Building = F, RoomID = F, RoomNumber = F, StaffIDFollowUpOfficer = F, StaffFollowUpOfficerName = F, IsGuardianNotified = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionDetailRecord", objectId = TempIncidentOffenseNameActionDetailRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameActionDetailRecord <- function(TempIncidentOffenseNameActionDetailRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionDetailRecord", objectId = TempIncidentOffenseNameActionDetailRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameActionDetailRecord <- function(IncidentOffenseNameActionID = NULL, StatusCode = NULL, Status = NULL, ScheduledTime = NULL, IsAlternate = NULL, DurationToServe = NULL, DurationServed = NULL, DurationType = NULL, LocationID = NULL, Location = NULL, BuildingID = NULL, Building = NULL, RoomID = NULL, RoomNumber = NULL, StaffIDFollowUpOfficer = NULL, StaffFollowUpOfficerName = NULL, IsGuardianNotified = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionDetailRecord", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionDetailRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineAction <- function(DisciplineActionID, ActionID = F, DistrictID = F, SchoolYearID = F, Code = F, Description = F, DurationType = F, DefaultDuration = F, DefaultLocationID = F, SuppressCreationOfActionDetails = F, CodeDescription = F, CreateAttendanceForActionDetail = F, ActionIDClonedFrom = F, FederalDisciplineCategoryID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ActionMNID = F, StateActionTypeMNID = F, ActionTypeID = F, RestraintSeclusion = F, TransferToAlternativeSchool = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "Action", objectId = DisciplineActionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineAction <- function(DisciplineActionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "Action", objectId = DisciplineActionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createDisciplineAction <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, DurationType = NULL, DefaultDuration = NULL, DefaultLocationID = NULL, SuppressCreationOfActionDetails = NULL, CreateAttendanceForActionDetail = NULL, ActionIDClonedFrom = NULL, FederalDisciplineCategoryID = NULL, StateActionTypeMNID = NULL, ActionTypeID = NULL, RestraintSeclusion = NULL, TransferToAlternativeSchool = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "Action", body = list(DataObject = body), searchFields = append("ActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyDisciplineAction <- function(ActionID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, DurationType = NULL, DefaultDuration = NULL, DefaultLocationID = NULL, SuppressCreationOfActionDetails = NULL, CreateAttendanceForActionDetail = NULL, ActionIDClonedFrom = NULL, FederalDisciplineCategoryID = NULL, StateActionTypeMNID = NULL, ActionTypeID = NULL, RestraintSeclusion = NULL, TransferToAlternativeSchool = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "Action", objectId = ActionID, body = list(DataObject = body), searchFields = append("ActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineConfigDistrictYear <- function(DisciplineConfigDistrictYearID, ConfigDistrictYearID = F, DistrictID = F, SchoolYearID = F, RestartIncidentNumberThisYear = F, AllowOnlyOneOffensePerIncident = F, DefaultDisciplineScreenDateAndTimes = F, DefaultOffenseValueFromPreviousPerson = F, DefaultActionValueFromPreviousPerson = F, UsePerceivedMotivation = F, UseIncidentBuildingAndRoom = F, ConfigDistrictYearIDClonedFrom = F, AllowUseOfWarning = F, AllowActionRecommendationsOnReferrals = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DisplayWarningsInFamilyAndStudentAccess = F, DaysToDelayDisplayOfIncidentsInFamilyAndStudentAccess = F, AllowActionTypeUpdate = F, DisplayStudentOffensesForAllEntities = F, DisplayInvolvedPersonsFromAllEntities = F, AllowDurationTypeUpdate = F, DefaultActionStatus = F, DefaultGuardianNotifiedOnActionDetailFromAction = F, IsReadOnlyHistoricalRecord = F, AllowInternalComments = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "ConfigDistrictYear", objectId = DisciplineConfigDistrictYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineConfigDistrictYear <- function(DisciplineConfigDistrictYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "ConfigDistrictYear", objectId = DisciplineConfigDistrictYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createDisciplineConfigDistrictYear <- function(DistrictID = NULL, SchoolYearID = NULL, RestartIncidentNumberThisYear = NULL, AllowOnlyOneOffensePerIncident = NULL, DefaultDisciplineScreenDateAndTimes = NULL, DefaultOffenseValueFromPreviousPerson = NULL, DefaultActionValueFromPreviousPerson = NULL, UsePerceivedMotivation = NULL, UseIncidentBuildingAndRoom = NULL, ConfigDistrictYearIDClonedFrom = NULL, AllowUseOfWarning = NULL, AllowActionRecommendationsOnReferrals = NULL, DisplayWarningsInFamilyAndStudentAccess = NULL, DaysToDelayDisplayOfIncidentsInFamilyAndStudentAccess = NULL, AllowActionTypeUpdate = NULL, DisplayStudentOffensesForAllEntities = NULL, DisplayInvolvedPersonsFromAllEntities = NULL, AllowDurationTypeUpdate = NULL, DefaultActionStatus = NULL, DefaultGuardianNotifiedOnActionDetailFromAction = NULL, AllowInternalComments = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "ConfigDistrictYear", body = list(DataObject = body), searchFields = append("ConfigDistrictYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyDisciplineConfigDistrictYear <- function(ConfigDistrictYearID, DistrictID = NULL, SchoolYearID = NULL, RestartIncidentNumberThisYear = NULL, AllowOnlyOneOffensePerIncident = NULL, DefaultDisciplineScreenDateAndTimes = NULL, DefaultOffenseValueFromPreviousPerson = NULL, DefaultActionValueFromPreviousPerson = NULL, UsePerceivedMotivation = NULL, UseIncidentBuildingAndRoom = NULL, ConfigDistrictYearIDClonedFrom = NULL, AllowUseOfWarning = NULL, AllowActionRecommendationsOnReferrals = NULL, DisplayWarningsInFamilyAndStudentAccess = NULL, DaysToDelayDisplayOfIncidentsInFamilyAndStudentAccess = NULL, AllowActionTypeUpdate = NULL, DisplayStudentOffensesForAllEntities = NULL, DisplayInvolvedPersonsFromAllEntities = NULL, AllowDurationTypeUpdate = NULL, DefaultActionStatus = NULL, DefaultGuardianNotifiedOnActionDetailFromAction = NULL, AllowInternalComments = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "ConfigDistrictYear", objectId = ConfigDistrictYearID, body = list(DataObject = body), searchFields = append("ConfigDistrictYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getPerceivedMotivation <- function(PerceivedMotivationID, DistrictID = F, SchoolYearID = F, Code = F, Description = F, CodeDescription = F, PerceivedMotivationIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "PerceivedMotivation", objectId = PerceivedMotivationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePerceivedMotivation <- function(PerceivedMotivationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "PerceivedMotivation", objectId = PerceivedMotivationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPerceivedMotivation <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, PerceivedMotivationIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "PerceivedMotivation", body = list(DataObject = body), searchFields = append("PerceivedMotivationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPerceivedMotivation <- function(PerceivedMotivationID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, PerceivedMotivationIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "PerceivedMotivation", objectId = PerceivedMotivationID, body = list(DataObject = body), searchFields = append("PerceivedMotivationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineLocation <- function(DisciplineLocationID, LocationID = F, DistrictID = F, Code = F, Description = F, EdFiIncidentLocationID = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, LocationMNID = F, StateIncidentLocationMNID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "Location", objectId = DisciplineLocationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineLocation <- function(DisciplineLocationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "Location", objectId = DisciplineLocationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisciplineLocation <- function(DistrictID = NULL, Code = NULL, Description = NULL, EdFiIncidentLocationID = NULL, StateIncidentLocationMNID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "Location", body = list(DataObject = body), searchFields = append("LocationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDisciplineLocation <- function(LocationID, DistrictID = NULL, Code = NULL, Description = NULL, EdFiIncidentLocationID = NULL, StateIncidentLocationMNID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "Location", objectId = LocationID, body = list(DataObject = body), searchFields = append("LocationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getOffense <- function(OffenseID, DistrictID = F, SchoolYearID = F, Code = F, Description = F, RestrictActions = F, DefaultActionID = F, UseForReferral = F, AllowActionRecommendations = F, OffenseLevelIDDefault = F, CodeDescription = F, OffenseIDClonedFrom = F, FederalOffenseCategoryID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsDrugRelated = F, IsWeaponRelated = F, IsInjuryThreat = F, HarassmentBullying = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "Offense", objectId = OffenseID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteOffense <- function(OffenseID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "Offense", objectId = OffenseID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createOffense <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, RestrictActions = NULL, DefaultActionID = NULL, UseForReferral = NULL, AllowActionRecommendations = NULL, OffenseLevelIDDefault = NULL, OffenseIDClonedFrom = NULL, FederalOffenseCategoryID = NULL, IsDrugRelated = NULL, IsWeaponRelated = NULL, IsInjuryThreat = NULL, HarassmentBullying = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "Offense", body = list(DataObject = body), searchFields = append("OffenseID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyOffense <- function(OffenseID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, RestrictActions = NULL, DefaultActionID = NULL, UseForReferral = NULL, AllowActionRecommendations = NULL, OffenseLevelIDDefault = NULL, OffenseIDClonedFrom = NULL, FederalOffenseCategoryID = NULL, IsDrugRelated = NULL, IsWeaponRelated = NULL, IsInjuryThreat = NULL, HarassmentBullying = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "Offense", objectId = OffenseID, body = list(DataObject = body), searchFields = append("OffenseID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getOffenseAction <- function(OffenseActionID, OffenseID = F, ActionID = F, OffenseActionIDClonedFrom = F, IsReferralAction = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "OffenseAction", objectId = OffenseActionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteOffenseAction <- function(OffenseActionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "OffenseAction", objectId = OffenseActionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createOffenseAction <- function(OffenseID = NULL, ActionID = NULL, OffenseActionIDClonedFrom = NULL, IsReferralAction = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "OffenseAction", body = list(DataObject = body), searchFields = append("OffenseActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyOffenseAction <- function(OffenseActionID, OffenseID = NULL, ActionID = NULL, OffenseActionIDClonedFrom = NULL, IsReferralAction = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "OffenseAction", objectId = OffenseActionID, body = list(DataObject = body), searchFields = append("OffenseActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getOffenseLevel <- function(OffenseLevelID, DistrictID = F, SchoolYearID = F, Code = F, Description = F, CodeDescription = F, OffenseLevelIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "OffenseLevel", objectId = OffenseLevelID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteOffenseLevel <- function(OffenseLevelID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "OffenseLevel", objectId = OffenseLevelID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createOffenseLevel <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, OffenseLevelIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "OffenseLevel", body = list(DataObject = body), searchFields = append("OffenseLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyOffenseLevel <- function(OffenseLevelID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, OffenseLevelIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "OffenseLevel", objectId = OffenseLevelID, body = list(DataObject = body), searchFields = append("OffenseLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDrug <- function(DrugID, DrugMNID = F, StateDrugTypeMNID = F, DistrictID = F, SchoolYearID = F, Code = F, Description = F, DrugIDClonedFrom = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "Drug", objectId = DrugID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDrug <- function(DrugID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "Drug", objectId = DrugID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDrug <- function(StateDrugTypeMNID = NULL, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, DrugIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "Drug", body = list(DataObject = body), searchFields = append("DrugID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDrug <- function(DrugID, StateDrugTypeMNID = NULL, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, DrugIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "Drug", objectId = DrugID, body = list(DataObject = body), searchFields = append("DrugID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncidentOffenseNameDrug <- function(IncidentOffenseNameDrugID, IncidentOffenseNameID = F, DrugID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "IncidentOffenseNameDrug", objectId = IncidentOffenseNameDrugID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncidentOffenseNameDrug <- function(IncidentOffenseNameDrugID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "IncidentOffenseNameDrug", objectId = IncidentOffenseNameDrugID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIncidentOffenseNameDrug <- function(IncidentOffenseNameID = NULL, DrugID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "IncidentOffenseNameDrug", body = list(DataObject = body), searchFields = append("IncidentOffenseNameDrugID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIncidentOffenseNameDrug <- function(IncidentOffenseNameDrugID, IncidentOffenseNameID = NULL, DrugID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "IncidentOffenseNameDrug", objectId = IncidentOffenseNameDrugID, body = list(DataObject = body), searchFields = append("IncidentOffenseNameDrugID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncidentOffenseNameWeapon <- function(IncidentOffenseNameWeaponID, IncidentOffenseNameID = F, WeaponID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IncidentOffenseNameWeaponMNID = F, MeetsFederalStatuteOfDangerousWeapon = F, MeetsStateStatuteOfDangerousWeapon = F, GunWasLoaded = F, GunWasInCase = F, GunFoundInTrunk = F, WeaponCount = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "IncidentOffenseNameWeapon", objectId = IncidentOffenseNameWeaponID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncidentOffenseNameWeapon <- function(IncidentOffenseNameWeaponID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "IncidentOffenseNameWeapon", objectId = IncidentOffenseNameWeaponID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIncidentOffenseNameWeapon <- function(IncidentOffenseNameID = NULL, WeaponID = NULL, MeetsFederalStatuteOfDangerousWeapon = NULL, MeetsStateStatuteOfDangerousWeapon = NULL, GunWasLoaded = NULL, GunWasInCase = NULL, GunFoundInTrunk = NULL, WeaponCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "IncidentOffenseNameWeapon", body = list(DataObject = body), searchFields = append("IncidentOffenseNameWeaponID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyIncidentOffenseNameWeapon <- function(IncidentOffenseNameWeaponID, IncidentOffenseNameID = NULL, WeaponID = NULL, MeetsFederalStatuteOfDangerousWeapon = NULL, MeetsStateStatuteOfDangerousWeapon = NULL, GunWasLoaded = NULL, GunWasInCase = NULL, GunFoundInTrunk = NULL, WeaponCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "IncidentOffenseNameWeapon", objectId = IncidentOffenseNameWeaponID, body = list(DataObject = body), searchFields = append("IncidentOffenseNameWeaponID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getWeapon <- function(WeaponID, WeaponMNID = F, StateWeaponTypeMNID = F, StatePelletGunTypeMNID = F, DistrictID = F, SchoolYearID = F, Code = F, Description = F, WeaponIDClonedFrom = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "Weapon", objectId = WeaponID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWeapon <- function(WeaponID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "Weapon", objectId = WeaponID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createWeapon <- function(StateWeaponTypeMNID = NULL, StatePelletGunTypeMNID = NULL, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, WeaponIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "Weapon", body = list(DataObject = body), searchFields = append("WeaponID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyWeapon <- function(WeaponID, StateWeaponTypeMNID = NULL, StatePelletGunTypeMNID = NULL, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, Description = NULL, WeaponIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "Weapon", objectId = WeaponID, body = list(DataObject = body), searchFields = append("WeaponID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getActionType <- function(ActionTypeID, Code = F, Description = F, CodeDescription = F, ValidYearLow = F, ValidYearHigh = F, IsInvalid = F, SkywardID = F, SkywardHash = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, EdFiDisciplineDescriptorID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "ActionType", objectId = ActionTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActionType <- function(ActionTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "ActionType", objectId = ActionTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createActionType <- function(Code = NULL, Description = NULL, ValidYearLow = NULL, ValidYearHigh = NULL, IsInvalid = NULL, EdFiDisciplineDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "ActionType", body = list(DataObject = body), searchFields = append("ActionTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyActionType <- function(ActionTypeID, Code = NULL, Description = NULL, ValidYearLow = NULL, ValidYearHigh = NULL, IsInvalid = NULL, EdFiDisciplineDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "ActionType", objectId = ActionTypeID, body = list(DataObject = body), searchFields = append("ActionTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineConfigSystem <- function(DisciplineConfigSystemID, ConfigSystemID = F, AllowIncidentSuppression = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ReportIDDisciplineLetter = F, AllowUpdateHistoricalData = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "ConfigSystem", objectId = DisciplineConfigSystemID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineConfigSystem <- function(DisciplineConfigSystemID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "ConfigSystem", objectId = DisciplineConfigSystemID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisciplineConfigSystem <- function(AllowIncidentSuppression = NULL, ReportIDDisciplineLetter = NULL, AllowUpdateHistoricalData = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "ConfigSystem", body = list(DataObject = body), searchFields = append("ConfigSystemID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDisciplineConfigSystem <- function(ConfigSystemID, AllowIncidentSuppression = NULL, ReportIDDisciplineLetter = NULL, AllowUpdateHistoricalData = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "ConfigSystem", objectId = ConfigSystemID, body = list(DataObject = body), searchFields = append("ConfigSystemID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineLetterTemplate <- function(DisciplineLetterTemplateID, Description = F, Header = F, Body = F, Footer = F, DistrictID = F, SchoolYearID = F, DisciplineLetterTemplateIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, MediaIDLogo = F, GuardianNameFormat = F, StudentNameFormat = F, AdvisorNameFormat = F, SuperintendentNameFormat = F, ColumnHeaderLabel1 = F, ColumnHeaderLabel2 = F, ColumnHeaderLabel3 = F, ColumnHeaderLabel4 = F, ColumnHeaderLabel5 = F, ColumnHeaderLabel6 = F, ColumnHeaderLabel7 = F, ColumnHeaderLabel8 = F, ColumnHeaderLabel9 = F, ColumnHeaderLabel10 = F, IsDefault = F, ForCurrentEntity = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplate", objectId = DisciplineLetterTemplateID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineLetterTemplate <- function(DisciplineLetterTemplateID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplate", objectId = DisciplineLetterTemplateID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createDisciplineLetterTemplate <- function(Description = NULL, Header = NULL, Body = NULL, Footer = NULL, DistrictID = NULL, SchoolYearID = NULL, DisciplineLetterTemplateIDClonedFrom = NULL, MediaIDLogo = NULL, GuardianNameFormat = NULL, StudentNameFormat = NULL, AdvisorNameFormat = NULL, SuperintendentNameFormat = NULL, ColumnHeaderLabel1 = NULL, ColumnHeaderLabel2 = NULL, ColumnHeaderLabel3 = NULL, ColumnHeaderLabel4 = NULL, ColumnHeaderLabel5 = NULL, ColumnHeaderLabel6 = NULL, ColumnHeaderLabel7 = NULL, ColumnHeaderLabel8 = NULL, ColumnHeaderLabel9 = NULL, ColumnHeaderLabel10 = NULL, IsDefault = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplate", body = list(DataObject = body), searchFields = append("DisciplineLetterTemplateID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyDisciplineLetterTemplate <- function(DisciplineLetterTemplateID, Description = NULL, Header = NULL, Body = NULL, Footer = NULL, DistrictID = NULL, SchoolYearID = NULL, DisciplineLetterTemplateIDClonedFrom = NULL, MediaIDLogo = NULL, GuardianNameFormat = NULL, StudentNameFormat = NULL, AdvisorNameFormat = NULL, SuperintendentNameFormat = NULL, ColumnHeaderLabel1 = NULL, ColumnHeaderLabel2 = NULL, ColumnHeaderLabel3 = NULL, ColumnHeaderLabel4 = NULL, ColumnHeaderLabel5 = NULL, ColumnHeaderLabel6 = NULL, ColumnHeaderLabel7 = NULL, ColumnHeaderLabel8 = NULL, ColumnHeaderLabel9 = NULL, ColumnHeaderLabel10 = NULL, IsDefault = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "DisciplineLetterTemplate", objectId = DisciplineLetterTemplateID, body = list(DataObject = body), searchFields = append("DisciplineLetterTemplateID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineLetterRunHistoryAction <- function(DisciplineLetterRunHistoryActionID, ActionID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DisciplineLetterRunHistoryID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistoryAction", objectId = DisciplineLetterRunHistoryActionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineLetterRunHistoryAction <- function(DisciplineLetterRunHistoryActionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistoryAction", objectId = DisciplineLetterRunHistoryActionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisciplineLetterRunHistoryAction <- function(ActionID = NULL, DisciplineLetterRunHistoryID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistoryAction", body = list(DataObject = body), searchFields = append("DisciplineLetterRunHistoryActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDisciplineLetterRunHistoryAction <- function(DisciplineLetterRunHistoryActionID, ActionID = NULL, DisciplineLetterRunHistoryID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistoryAction", objectId = DisciplineLetterRunHistoryActionID, body = list(DataObject = body), searchFields = append("DisciplineLetterRunHistoryActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineLetterTemplateEntity <- function(DisciplineLetterTemplateEntityID, DisciplineLetterTemplateID = F, EntityID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateEntity", objectId = DisciplineLetterTemplateEntityID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineLetterTemplateEntity <- function(DisciplineLetterTemplateEntityID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateEntity", objectId = DisciplineLetterTemplateEntityID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisciplineLetterTemplateEntity <- function(DisciplineLetterTemplateID = NULL, EntityID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateEntity", body = list(DataObject = body), searchFields = append("DisciplineLetterTemplateEntityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDisciplineLetterTemplateEntity <- function(DisciplineLetterTemplateEntityID, DisciplineLetterTemplateID = NULL, EntityID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateEntity", objectId = DisciplineLetterTemplateEntityID, body = list(DataObject = body), searchFields = append("DisciplineLetterTemplateEntityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineLetterRunHistoryOffense <- function(DisciplineLetterRunHistoryOffenseID, DisciplineLetterRunHistoryID = F, OffenseID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistoryOffense", objectId = DisciplineLetterRunHistoryOffenseID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineLetterRunHistoryOffense <- function(DisciplineLetterRunHistoryOffenseID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistoryOffense", objectId = DisciplineLetterRunHistoryOffenseID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisciplineLetterRunHistoryOffense <- function(DisciplineLetterRunHistoryID = NULL, OffenseID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistoryOffense", body = list(DataObject = body), searchFields = append("DisciplineLetterRunHistoryOffenseID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDisciplineLetterRunHistoryOffense <- function(DisciplineLetterRunHistoryOffenseID, DisciplineLetterRunHistoryID = NULL, OffenseID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistoryOffense", objectId = DisciplineLetterRunHistoryOffenseID, body = list(DataObject = body), searchFields = append("DisciplineLetterRunHistoryOffenseID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIncidentOffenseNameReportRunHistory <- function(IncidentOffenseNameReportRunHistoryID, DisciplineLetterRunHistoryID = F, IncidentOffenseNameID = F, StudentID = F, IsActive = F, AttachmentID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ColumnHeaderData1 = F, ColumnHeaderData2 = F, ColumnHeaderData3 = F, ColumnHeaderData4 = F, ColumnHeaderData5 = F, ColumnHeaderData6 = F, ColumnHeaderData7 = F, ColumnHeaderData8 = F, ColumnHeaderData9 = F, ColumnHeaderData10 = F, UnboundHeader = F, UnboundBody = F, UnboundFooter = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "IncidentOffenseNameReportRunHistory", objectId = IncidentOffenseNameReportRunHistoryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIncidentOffenseNameReportRunHistory <- function(IncidentOffenseNameReportRunHistoryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "IncidentOffenseNameReportRunHistory", objectId = IncidentOffenseNameReportRunHistoryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createIncidentOffenseNameReportRunHistory <- function(DisciplineLetterRunHistoryID = NULL, IncidentOffenseNameID = NULL, StudentID = NULL, IsActive = NULL, AttachmentID = NULL, ColumnHeaderData1 = NULL, ColumnHeaderData2 = NULL, ColumnHeaderData3 = NULL, ColumnHeaderData4 = NULL, ColumnHeaderData5 = NULL, ColumnHeaderData6 = NULL, ColumnHeaderData7 = NULL, ColumnHeaderData8 = NULL, ColumnHeaderData9 = NULL, ColumnHeaderData10 = NULL, UnboundHeader = NULL, UnboundBody = NULL, UnboundFooter = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "IncidentOffenseNameReportRunHistory", body = list(DataObject = body), searchFields = append("IncidentOffenseNameReportRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyIncidentOffenseNameReportRunHistory <- function(IncidentOffenseNameReportRunHistoryID, DisciplineLetterRunHistoryID = NULL, IncidentOffenseNameID = NULL, StudentID = NULL, IsActive = NULL, AttachmentID = NULL, ColumnHeaderData1 = NULL, ColumnHeaderData2 = NULL, ColumnHeaderData3 = NULL, ColumnHeaderData4 = NULL, ColumnHeaderData5 = NULL, ColumnHeaderData6 = NULL, ColumnHeaderData7 = NULL, ColumnHeaderData8 = NULL, ColumnHeaderData9 = NULL, ColumnHeaderData10 = NULL, UnboundHeader = NULL, UnboundBody = NULL, UnboundFooter = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "IncidentOffenseNameReportRunHistory", objectId = IncidentOffenseNameReportRunHistoryID, body = list(DataObject = body), searchFields = append("IncidentOffenseNameReportRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineLetterTemplateHeaderColumn <- function(DisciplineLetterTemplateHeaderColumnID, DisciplineLetterTemplateHeaderRowID = F, SortNumber = F, FieldType = F, LabelOverride = F, FreeformText = F, DisciplineLetterTemplateHeaderColumnIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ColumnNumber = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateHeaderColumn", objectId = DisciplineLetterTemplateHeaderColumnID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineLetterTemplateHeaderColumn <- function(DisciplineLetterTemplateHeaderColumnID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateHeaderColumn", objectId = DisciplineLetterTemplateHeaderColumnID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisciplineLetterTemplateHeaderColumn <- function(DisciplineLetterTemplateHeaderRowID = NULL, SortNumber = NULL, FieldType = NULL, LabelOverride = NULL, FreeformText = NULL, DisciplineLetterTemplateHeaderColumnIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateHeaderColumn", body = list(DataObject = body), searchFields = append("DisciplineLetterTemplateHeaderColumnID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineLetterRunHistory <- function(DisciplineLetterRunHistoryID, DisciplineLetterTemplateID = F, EntityID = F, RunDescription = F, ParameterData = F, ParameterDescription = F, Date = F, FilterType = F, IncidentType = F, GracePeriod = F, IsActive = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StartDate = F, EndDate = F, ReportRunInfoID = F, SchoolYearID = F, FiscalYearID = F, CachedFiscalYear = F, SectionID = F, EntityIDList = F, SchoolYearNumericYearOrCurrent = F, CachedSchoolYear = F, CachedEntity = F, IsReadOnlyHistoricalRecord = F, PostToFASA = F, AttachmentDisplayName = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistory", objectId = DisciplineLetterRunHistoryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineLetterRunHistory <- function(DisciplineLetterRunHistoryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistory", objectId = DisciplineLetterRunHistoryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createDisciplineLetterRunHistory <- function(DisciplineLetterTemplateID = NULL, EntityID = NULL, RunDescription = NULL, Date = NULL, FilterType = NULL, IncidentType = NULL, GracePeriod = NULL, IsActive = NULL, StartDate = NULL, EndDate = NULL, ReportRunInfoID = NULL, PostToFASA = NULL, AttachmentDisplayName = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistory", body = list(DataObject = body), searchFields = append("DisciplineLetterRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyDisciplineLetterRunHistory <- function(DisciplineLetterRunHistoryID, DisciplineLetterTemplateID = NULL, EntityID = NULL, RunDescription = NULL, Date = NULL, FilterType = NULL, IncidentType = NULL, GracePeriod = NULL, IsActive = NULL, StartDate = NULL, EndDate = NULL, ReportRunInfoID = NULL, PostToFASA = NULL, AttachmentDisplayName = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "DisciplineLetterRunHistory", objectId = DisciplineLetterRunHistoryID, body = list(DataObject = body), searchFields = append("DisciplineLetterRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineLetterTemplateHeaderRow <- function(DisciplineLetterTemplateHeaderRowID, DisciplineLetterTemplateID = F, SortNumber = F, ColumnCount = F, DisciplineLetterTemplateHeaderRowIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateHeaderRow", objectId = DisciplineLetterTemplateHeaderRowID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineLetterTemplateHeaderRow <- function(DisciplineLetterTemplateHeaderRowID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateHeaderRow", objectId = DisciplineLetterTemplateHeaderRowID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisciplineLetterTemplateHeaderRow <- function(DisciplineLetterTemplateID = NULL, SortNumber = NULL, ColumnCount = NULL, DisciplineLetterTemplateHeaderRowIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateHeaderRow", body = list(DataObject = body), searchFields = append("DisciplineLetterTemplateHeaderRowID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDisciplineLetterTemplateHeaderRow <- function(DisciplineLetterTemplateHeaderRowID, DisciplineLetterTemplateID = NULL, SortNumber = NULL, ColumnCount = NULL, DisciplineLetterTemplateHeaderRowIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "DisciplineLetterTemplateHeaderRow", objectId = DisciplineLetterTemplateHeaderRowID, body = list(DataObject = body), searchFields = append("DisciplineLetterTemplateHeaderRowID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameReportRunHistoryRecord <- function(TempIncidentOffenseNameReportRunHistoryRecordID, StudentID = F, StudentName = F, IncidentOffenseNameID = F, DateTime = F, Offense = F, Incident = F, IncidentNumber = F, ColumnHeader1 = F, ColumnHeader2 = F, ColumnHeader3 = F, ColumnHeader4 = F, ColumnHeader5 = F, ColumnHeader6 = F, ColumnHeader7 = F, ColumnHeader8 = F, ColumnHeader9 = F, ColumnHeader10 = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, UnboundHeader = F, UnboundBody = F, UnboundFooter = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameReportRunHistoryRecord", objectId = TempIncidentOffenseNameReportRunHistoryRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameReportRunHistoryRecord <- function(TempIncidentOffenseNameReportRunHistoryRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameReportRunHistoryRecord", objectId = TempIncidentOffenseNameReportRunHistoryRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameReportRunHistoryRecord <- function(StudentID = NULL, StudentName = NULL, IncidentOffenseNameID = NULL, DateTime = NULL, Offense = NULL, Incident = NULL, IncidentNumber = NULL, ColumnHeader1 = NULL, ColumnHeader2 = NULL, ColumnHeader3 = NULL, ColumnHeader4 = NULL, ColumnHeader5 = NULL, ColumnHeader6 = NULL, ColumnHeader7 = NULL, ColumnHeader8 = NULL, ColumnHeader9 = NULL, ColumnHeader10 = NULL, UnboundHeader = NULL, UnboundBody = NULL, UnboundFooter = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameReportRunHistoryRecord", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameReportRunHistoryRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getWhiteListFieldPath <- function(WhiteListFieldPathID, FriendlyName = F, Description = F, FieldPath = F, SkywardID = F, SkywardHash = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, UsedForType = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "WhiteListFieldPath", objectId = WhiteListFieldPathID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWhiteListFieldPath <- function(WhiteListFieldPathID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "WhiteListFieldPath", objectId = WhiteListFieldPathID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createWhiteListFieldPath <- function(FriendlyName = NULL, Description = NULL, UsedForType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "WhiteListFieldPath", body = list(DataObject = body), searchFields = append("WhiteListFieldPathID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyWhiteListFieldPath <- function(WhiteListFieldPathID, FriendlyName = NULL, Description = NULL, UsedForType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "WhiteListFieldPath", objectId = WhiteListFieldPathID, body = list(DataObject = body), searchFields = append("WhiteListFieldPathID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getDisciplineConfigEntityYear <- function(DisciplineConfigEntityYearID, ConfigEntityYearID = F, EntityID = F, SchoolYearID = F, ConfigEntityYearIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsReadOnlyHistoricalRecord = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "ConfigEntityYear", objectId = DisciplineConfigEntityYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisciplineConfigEntityYear <- function(DisciplineConfigEntityYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "ConfigEntityYear", objectId = DisciplineConfigEntityYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisciplineConfigEntityYear <- function(EntityID = NULL, SchoolYearID = NULL, ConfigEntityYearIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "ConfigEntityYear", body = list(DataObject = body), searchFields = append("ConfigEntityYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDisciplineConfigEntityYear <- function(ConfigEntityYearID, EntityID = NULL, SchoolYearID = NULL, ConfigEntityYearIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "ConfigEntityYear", objectId = ConfigEntityYearID, body = list(DataObject = body), searchFields = append("ConfigEntityYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseName <- function(TempIncidentOffenseNameID, TempIncidentInvolvedPersonID = F, TempIncidentOffenseID = F, OffenseID = F, ExistingIncidentOffenseNameID = F, InvolvementType = F, PerceivedMotivationID = F, OffenseLevelID = F, FullName = F, StudentNumber = F, OffenseCodeDescription = F, IsPrimaryOffense = F, PerceivedMotivationCodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseName", objectId = TempIncidentOffenseNameID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseName <- function(TempIncidentOffenseNameID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseName", objectId = TempIncidentOffenseNameID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseName <- function(TempIncidentInvolvedPersonID = NULL, TempIncidentOffenseID = NULL, OffenseID = NULL, ExistingIncidentOffenseNameID = NULL, InvolvementType = NULL, PerceivedMotivationID = NULL, OffenseLevelID = NULL, FullName = NULL, StudentNumber = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, PerceivedMotivationCodeDescription = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseName", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseName <- function(TempIncidentOffenseNameID, TempIncidentInvolvedPersonID = NULL, TempIncidentOffenseID = NULL, OffenseID = NULL, ExistingIncidentOffenseNameID = NULL, InvolvementType = NULL, PerceivedMotivationID = NULL, OffenseLevelID = NULL, FullName = NULL, StudentNumber = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, PerceivedMotivationCodeDescription = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseName", objectId = TempIncidentOffenseNameID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffense <- function(TempIncidentOffenseID, ExistingIncidentID = F, OffenseID = F, IsPrimaryOffense = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffense", objectId = TempIncidentOffenseID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffense <- function(TempIncidentOffenseID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffense", objectId = TempIncidentOffenseID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempIncidentOffense <- function(ExistingIncidentID = NULL, OffenseID = NULL, IsPrimaryOffense = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "TempIncidentOffense", body = list(DataObject = body), searchFields = append("TempIncidentOffenseID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempIncidentOffense <- function(TempIncidentOffenseID, ExistingIncidentID = NULL, OffenseID = NULL, IsPrimaryOffense = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffense", objectId = TempIncidentOffenseID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameParentalInvolvementPA <- function(TempIncidentOffenseNameParentalInvolvementPAID, IncidentOffenseNameParentalInvolvementPAID = F, TempIncidentOffenseNameID = F, StateParentalInvolvementPAID = F, Comment = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameParentalInvolvementPA", objectId = TempIncidentOffenseNameParentalInvolvementPAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameParentalInvolvementPA <- function(TempIncidentOffenseNameParentalInvolvementPAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameParentalInvolvementPA", objectId = TempIncidentOffenseNameParentalInvolvementPAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempIncidentOffenseNameParentalInvolvementPA <- function(TempIncidentOffenseNameID = NULL, StateParentalInvolvementPAID = NULL, Comment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameParentalInvolvementPA", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameParentalInvolvementPAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempIncidentOffenseNameParentalInvolvementPA <- function(TempIncidentOffenseNameParentalInvolvementPAID, TempIncidentOffenseNameID = NULL, StateParentalInvolvementPAID = NULL, Comment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	getTempIncidentOffenseNameDrug <- function(TempIncidentOffenseNameDrugID, IncidentOffenseNameDrugID = F, TempIncidentOffenseNameID = F, DrugID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameDrug", objectId = TempIncidentOffenseNameDrugID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameDrug <- function(TempIncidentOffenseNameDrugID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameDrug", objectId = TempIncidentOffenseNameDrugID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempIncidentOffenseNameDrug <- function(TempIncidentOffenseNameID = NULL, DrugID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameDrug", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameDrugID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempIncidentOffenseNameDrug <- function(TempIncidentOffenseNameDrugID, TempIncidentOffenseNameID = NULL, DrugID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameDrug", objectId = TempIncidentOffenseNameDrugID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameDrugID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameWeaponMN <- function(TempIncidentOffenseNameWeaponMNID, MeetsFederalStatuteOfDangerousWeapon = F, MeetsStateStatuteOfDangerousWeapon = F, GunWasLoaded = F, GunWasInCase = F, GunFoundInTrunk = F, TempIncidentOffenseNameWeaponID = F, IncidentOffenseNameWeaponID = F, TempIncidentOffenseNameID = F, WeaponID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, WeaponCount = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameWeaponMN", objectId = TempIncidentOffenseNameWeaponMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameWeaponMN <- function(TempIncidentOffenseNameWeaponMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameWeaponMN", objectId = TempIncidentOffenseNameWeaponMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempIncidentOffenseNameWeaponMN <- function(MeetsFederalStatuteOfDangerousWeapon = NULL, MeetsStateStatuteOfDangerousWeapon = NULL, GunWasLoaded = NULL, GunWasInCase = NULL, GunFoundInTrunk = NULL, TempIncidentOffenseNameID = NULL, WeaponID = NULL, WeaponCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameWeaponMN", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameWeaponMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseNameWeaponMN <- function(TempIncidentOffenseNameWeaponMNID, MeetsFederalStatuteOfDangerousWeapon = NULL, MeetsStateStatuteOfDangerousWeapon = NULL, GunWasLoaded = NULL, GunWasInCase = NULL, GunFoundInTrunk = NULL, TempIncidentOffenseNameID = NULL, WeaponID = NULL, WeaponCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameWeaponMN", objectId = TempIncidentOffenseNameWeaponMNID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameWeaponMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameWeapon <- function(TempIncidentOffenseNameWeaponID, IncidentOffenseNameWeaponID = F, TempIncidentOffenseNameID = F, WeaponID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, WeaponCount = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameWeapon", objectId = TempIncidentOffenseNameWeaponID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameWeapon <- function(TempIncidentOffenseNameWeaponID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameWeapon", objectId = TempIncidentOffenseNameWeaponID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempIncidentOffenseNameWeapon <- function(TempIncidentOffenseNameID = NULL, WeaponID = NULL, WeaponCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameWeapon", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameWeaponID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempIncidentOffenseNameWeapon <- function(TempIncidentOffenseNameWeaponID, TempIncidentOffenseNameID = NULL, WeaponID = NULL, WeaponCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameWeapon", objectId = TempIncidentOffenseNameWeaponID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameWeaponID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameActionWI <- function(TempIncidentOffenseNameActionWIID, StateModifiedTermWIID = F, HasEarlyReinstatementCondition = F, BehaviorDetailedDescription = F, IAESRemovalType = F, CausedSeriousBodilyInjury = F, TempIncidentOffenseNameActionID = F, EntityID = F, FullName = F, StudentNumber = F, InvolvementType = F, OffenseCodeDescription = F, IsPrimaryOffense = F, ActionTypeID = F, ActionTypeCode = F, ActionID = F, ActionCodeDescription = F, Status = F, OrderedDate = F, DurationType = F, DurationToServe = F, StaffIDAuthorizedBy = F, StaffIDAuthorizedByName = F, StaffIDFollowUpOfficer = F, LocationID = F, BuildingID = F, RoomID = F, PerceivedMotivationCodeDescription = F, Comment = F, TempIncidentOffenseNameID = F, IsGuardianNotified = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StartTime = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionWI", objectId = TempIncidentOffenseNameActionWIID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameActionWI <- function(TempIncidentOffenseNameActionWIID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionWI", objectId = TempIncidentOffenseNameActionWIID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameActionWI <- function(StateModifiedTermWIID = NULL, HasEarlyReinstatementCondition = NULL, BehaviorDetailedDescription = NULL, IAESRemovalType = NULL, CausedSeriousBodilyInjury = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionWI", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionWIID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseNameActionWI <- function(TempIncidentOffenseNameActionWIID, StateModifiedTermWIID = NULL, HasEarlyReinstatementCondition = NULL, BehaviorDetailedDescription = NULL, IAESRemovalType = NULL, CausedSeriousBodilyInjury = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionWI", objectId = TempIncidentOffenseNameActionWIID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionWIID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameActionWA <- function(TempIncidentOffenseNameActionWAID, PlacedInInterimAlternativeEducationalSetting = F, DateReadmissionPetitionSubmitted = F, DateReadmissionPetitionGranted = F, DateReengagementMeetingHeld = F, StateAcademicServiceWAID = F, StateBehaviorServiceWAID = F, StatePetitionExtensionExpulsionWAID = F, StateReengagementPlanWAID = F, StateAppealCodeWAID = F, TotalAmountOfExclusionaryTime = F, DurationOfExclusionaryActionDays = F, TempIncidentOffenseNameActionID = F, EntityID = F, FullName = F, StudentNumber = F, InvolvementType = F, OffenseCodeDescription = F, IsPrimaryOffense = F, ActionTypeID = F, ActionTypeCode = F, ActionID = F, ActionCodeDescription = F, Status = F, OrderedDate = F, DurationType = F, DurationToServe = F, StaffIDAuthorizedBy = F, StaffIDAuthorizedByName = F, StaffIDFollowUpOfficer = F, LocationID = F, BuildingID = F, RoomID = F, PerceivedMotivationCodeDescription = F, Comment = F, TempIncidentOffenseNameID = F, IsGuardianNotified = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StartTime = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionWA", objectId = TempIncidentOffenseNameActionWAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameActionWA <- function(TempIncidentOffenseNameActionWAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionWA", objectId = TempIncidentOffenseNameActionWAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameActionWA <- function(PlacedInInterimAlternativeEducationalSetting = NULL, DateReadmissionPetitionSubmitted = NULL, DateReadmissionPetitionGranted = NULL, DateReengagementMeetingHeld = NULL, StateAcademicServiceWAID = NULL, StateBehaviorServiceWAID = NULL, StatePetitionExtensionExpulsionWAID = NULL, StateReengagementPlanWAID = NULL, StateAppealCodeWAID = NULL, TotalAmountOfExclusionaryTime = NULL, DurationOfExclusionaryActionDays = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionWA", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionWAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseNameActionWA <- function(TempIncidentOffenseNameActionWAID, PlacedInInterimAlternativeEducationalSetting = NULL, DateReadmissionPetitionSubmitted = NULL, DateReadmissionPetitionGranted = NULL, DateReengagementMeetingHeld = NULL, StateAcademicServiceWAID = NULL, StateBehaviorServiceWAID = NULL, StatePetitionExtensionExpulsionWAID = NULL, StateReengagementPlanWAID = NULL, StateAppealCodeWAID = NULL, TotalAmountOfExclusionaryTime = NULL, DurationOfExclusionaryActionDays = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionWA", objectId = TempIncidentOffenseNameActionWAID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionWAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameActionPA <- function(TempIncidentOffenseNameActionPAID, ReceivedEducationalServices = F, AssignedAlternativeEducation = F, TempIncidentOffenseNameActionID = F, EntityID = F, FullName = F, StudentNumber = F, InvolvementType = F, OffenseCodeDescription = F, IsPrimaryOffense = F, ActionTypeID = F, ActionTypeCode = F, ActionID = F, ActionCodeDescription = F, Status = F, OrderedDate = F, DurationType = F, DurationToServe = F, StaffIDAuthorizedBy = F, StaffIDAuthorizedByName = F, StaffIDFollowUpOfficer = F, LocationID = F, BuildingID = F, RoomID = F, PerceivedMotivationCodeDescription = F, Comment = F, TempIncidentOffenseNameID = F, IsGuardianNotified = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StartTime = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionPA", objectId = TempIncidentOffenseNameActionPAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameActionPA <- function(TempIncidentOffenseNameActionPAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionPA", objectId = TempIncidentOffenseNameActionPAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameActionPA <- function(ReceivedEducationalServices = NULL, AssignedAlternativeEducation = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionPA", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionPAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseNameActionPA <- function(TempIncidentOffenseNameActionPAID, ReceivedEducationalServices = NULL, AssignedAlternativeEducation = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionPA", objectId = TempIncidentOffenseNameActionPAID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionPAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameActionMN <- function(TempIncidentOffenseNameActionMNID, StateDIRSAESTypeMNID = F, DateExpulsionExclusionEnds = F, ReturnBeforeYearEnd = F, ExclusionThroughYearEnd = F, ExpulsionModified = F, ExpulsionThroughYearEnd = F, DIRSActionExplanation = F, TempIncidentOffenseNameActionID = F, EntityID = F, FullName = F, StudentNumber = F, InvolvementType = F, OffenseCodeDescription = F, IsPrimaryOffense = F, ActionTypeID = F, ActionTypeCode = F, ActionID = F, ActionCodeDescription = F, Status = F, OrderedDate = F, DurationType = F, DurationToServe = F, StaffIDAuthorizedBy = F, StaffIDAuthorizedByName = F, StaffIDFollowUpOfficer = F, LocationID = F, BuildingID = F, RoomID = F, PerceivedMotivationCodeDescription = F, Comment = F, TempIncidentOffenseNameID = F, IsGuardianNotified = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StartTime = F, InternalComment = F, NoServiceProvidedExplanation = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionMN", objectId = TempIncidentOffenseNameActionMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameActionMN <- function(TempIncidentOffenseNameActionMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionMN", objectId = TempIncidentOffenseNameActionMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameActionMN <- function(StateDIRSAESTypeMNID = NULL, DateExpulsionExclusionEnds = NULL, ReturnBeforeYearEnd = NULL, ExclusionThroughYearEnd = NULL, ExpulsionModified = NULL, ExpulsionThroughYearEnd = NULL, DIRSActionExplanation = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, NoServiceProvidedExplanation = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionMN", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseNameActionMN <- function(TempIncidentOffenseNameActionMNID, StateDIRSAESTypeMNID = NULL, DateExpulsionExclusionEnds = NULL, ReturnBeforeYearEnd = NULL, ExclusionThroughYearEnd = NULL, ExpulsionModified = NULL, ExpulsionThroughYearEnd = NULL, DIRSActionExplanation = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, InternalComment = NULL, NoServiceProvidedExplanation = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionMN", objectId = TempIncidentOffenseNameActionMNID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentOffenseNameActionIN <- function(TempIncidentOffenseNameActionINID, StateSuspensionReasonINID = F, StateEducationalServiceProvidedINID = F, TempIncidentOffenseNameActionID = F, EntityID = F, FullName = F, StudentNumber = F, InvolvementType = F, OffenseCodeDescription = F, IsPrimaryOffense = F, ActionTypeID = F, ActionTypeCode = F, ActionID = F, ActionCodeDescription = F, Status = F, OrderedDate = F, DurationType = F, DurationToServe = F, StaffIDAuthorizedBy = F, StaffIDAuthorizedByName = F, StaffIDFollowUpOfficer = F, LocationID = F, BuildingID = F, RoomID = F, PerceivedMotivationCodeDescription = F, Comment = F, TempIncidentOffenseNameID = F, IsGuardianNotified = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StartTime = F, IsPrimaryAction = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionIN", objectId = TempIncidentOffenseNameActionINID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentOffenseNameActionIN <- function(TempIncidentOffenseNameActionINID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionIN", objectId = TempIncidentOffenseNameActionINID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentOffenseNameActionIN <- function(StateSuspensionReasonINID = NULL, StateEducationalServiceProvidedINID = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, IsPrimaryAction = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionIN", body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionINID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentOffenseNameActionIN <- function(TempIncidentOffenseNameActionINID, StateSuspensionReasonINID = NULL, StateEducationalServiceProvidedINID = NULL, EntityID = NULL, FullName = NULL, StudentNumber = NULL, InvolvementType = NULL, OffenseCodeDescription = NULL, IsPrimaryOffense = NULL, ActionTypeID = NULL, ActionTypeCode = NULL, ActionID = NULL, ActionCodeDescription = NULL, Status = NULL, OrderedDate = NULL, DurationType = NULL, DurationToServe = NULL, StaffIDAuthorizedBy = NULL, StaffIDAuthorizedByName = NULL, StaffIDFollowUpOfficer = NULL, LocationID = NULL, BuildingID = NULL, RoomID = NULL, PerceivedMotivationCodeDescription = NULL, Comment = NULL, TempIncidentOffenseNameID = NULL, IsGuardianNotified = NULL, StartTime = NULL, IsPrimaryAction = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentOffenseNameActionIN", objectId = TempIncidentOffenseNameActionINID, body = list(DataObject = body), searchFields = append("TempIncidentOffenseNameActionINID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentInvolvedPersonWA <- function(TempIncidentInvolvedPersonWAID, StateReportedOffense = F, TempIncidentInvolvedPersonID = F, IncidentOffenseNameKey = F, PrimaryOffenseID = F, SecondaryOffensesBackingData = F, ExcludePrimaryOffense = F, ExistingIncidentOffenseNamesToDelete = F, InvolvementType = F, IncidentOffenseNameType = F, FreeformName = F, StudentID = F, StaffID = F, NameID = F, StaffIDDisciplineOfficer = F, PerceivedMotivationID = F, FullName = F, StudentNumber = F, PerceivedMotivationCodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, OSSCount = F, OSSPartialCount = F, ISSCount = F, ISSPartialCount = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonWA", objectId = TempIncidentInvolvedPersonWAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentInvolvedPersonWA <- function(TempIncidentInvolvedPersonWAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonWA", objectId = TempIncidentInvolvedPersonWAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentInvolvedPersonWA <- function(StateReportedOffense = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonWA", body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonWAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentInvolvedPersonWA <- function(TempIncidentInvolvedPersonWAID, StateReportedOffense = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonWA", objectId = TempIncidentInvolvedPersonWAID, body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonWAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentInvolvedPersonTX <- function(TempIncidentInvolvedPersonTXID, CampusIDOfDisciplinaryResponsibility = F, TempIncidentInvolvedPersonID = F, IncidentOffenseNameKey = F, PrimaryOffenseID = F, SecondaryOffensesBackingData = F, ExcludePrimaryOffense = F, ExistingIncidentOffenseNamesToDelete = F, InvolvementType = F, IncidentOffenseNameType = F, FreeformName = F, StudentID = F, StaffID = F, NameID = F, StaffIDDisciplineOfficer = F, PerceivedMotivationID = F, FullName = F, StudentNumber = F, PerceivedMotivationCodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, OSSCount = F, OSSPartialCount = F, ISSCount = F, ISSPartialCount = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonTX", objectId = TempIncidentInvolvedPersonTXID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentInvolvedPersonTX <- function(TempIncidentInvolvedPersonTXID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonTX", objectId = TempIncidentInvolvedPersonTXID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentInvolvedPersonTX <- function(CampusIDOfDisciplinaryResponsibility = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonTX", body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonTXID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentInvolvedPersonTX <- function(TempIncidentInvolvedPersonTXID, CampusIDOfDisciplinaryResponsibility = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonTX", objectId = TempIncidentInvolvedPersonTXID, body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonTXID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentInvolvedPersonPA <- function(TempIncidentInvolvedPersonPAID, StateVictimTypePAID = F, StudentAssistanceProgramReferral = F, MedicalTreatmentRequired = F, IncidentVictimComment = F, StateInjurySeverityPAID = F, StateOffenderTypePAID = F, StateArrestedPAID = F, StateAdjudicationPAID = F, StateWeaponDetectedMethodPAID = F, WeaponDetectionComment = F, LocalLawEnforcementNotified = F, NameOfLocalLawEnforcementContacted = F, TempIncidentInvolvedPersonID = F, IncidentOffenseNameKey = F, PrimaryOffenseID = F, SecondaryOffensesBackingData = F, ExcludePrimaryOffense = F, ExistingIncidentOffenseNamesToDelete = F, InvolvementType = F, IncidentOffenseNameType = F, FreeformName = F, StudentID = F, StaffID = F, NameID = F, StaffIDDisciplineOfficer = F, PerceivedMotivationID = F, FullName = F, StudentNumber = F, PerceivedMotivationCodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsResidentialPlacementByNonEdAgency = F, LLEIncidentNumber = F, OSSCount = F, OSSPartialCount = F, ISSCount = F, ISSPartialCount = F, InternalComment = F, StateDistrictPAIDPerson = F, PASecureID = F, FirstName = F, LastName = F, RaceEthnicities = F, Genders = F, SendingOrCharterTypes = F, SendingDistrictOrCharterAUNID = F, AgeAtTimeOfIncident = F, StateGradeLevelPIMSPAID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonPA", objectId = TempIncidentInvolvedPersonPAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentInvolvedPersonPA <- function(TempIncidentInvolvedPersonPAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonPA", objectId = TempIncidentInvolvedPersonPAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentInvolvedPersonPA <- function(StateVictimTypePAID = NULL, StudentAssistanceProgramReferral = NULL, MedicalTreatmentRequired = NULL, IncidentVictimComment = NULL, StateInjurySeverityPAID = NULL, StateOffenderTypePAID = NULL, StateArrestedPAID = NULL, StateAdjudicationPAID = NULL, StateWeaponDetectedMethodPAID = NULL, WeaponDetectionComment = NULL, LocalLawEnforcementNotified = NULL, NameOfLocalLawEnforcementContacted = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, IsResidentialPlacementByNonEdAgency = NULL, LLEIncidentNumber = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, StateDistrictPAIDPerson = NULL, PASecureID = NULL, FirstName = NULL, LastName = NULL, RaceEthnicities = NULL, Genders = NULL, SendingOrCharterTypes = NULL, SendingDistrictOrCharterAUNID = NULL, AgeAtTimeOfIncident = NULL, StateGradeLevelPIMSPAID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonPA", body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonPAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentInvolvedPersonPA <- function(TempIncidentInvolvedPersonPAID, StateVictimTypePAID = NULL, StudentAssistanceProgramReferral = NULL, MedicalTreatmentRequired = NULL, IncidentVictimComment = NULL, StateInjurySeverityPAID = NULL, StateOffenderTypePAID = NULL, StateArrestedPAID = NULL, StateAdjudicationPAID = NULL, StateWeaponDetectedMethodPAID = NULL, WeaponDetectionComment = NULL, LocalLawEnforcementNotified = NULL, NameOfLocalLawEnforcementContacted = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, IsResidentialPlacementByNonEdAgency = NULL, LLEIncidentNumber = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, StateDistrictPAIDPerson = NULL, PASecureID = NULL, FirstName = NULL, LastName = NULL, RaceEthnicities = NULL, Genders = NULL, SendingOrCharterTypes = NULL, SendingDistrictOrCharterAUNID = NULL, AgeAtTimeOfIncident = NULL, StateGradeLevelPIMSPAID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonPA", objectId = TempIncidentInvolvedPersonPAID, body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonPAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentInvolvedPersonMN <- function(TempIncidentInvolvedPersonMNID, StateVictimTypeMNID = F, StateVictimCostMNID = F, InjuryOccured = F, WasSeriousBodilyInjury = F, ReportedToLawEnforcement = F, OffenderArrestedByLawEnforcement = F, StateOffenderActivityMNID = F, IsPhysicalAssault = F, IsPhysicalAssaultState = F, TempIncidentInvolvedPersonID = F, IncidentOffenseNameKey = F, PrimaryOffenseID = F, SecondaryOffensesBackingData = F, ExcludePrimaryOffense = F, ExistingIncidentOffenseNamesToDelete = F, InvolvementType = F, IncidentOffenseNameType = F, FreeformName = F, StudentID = F, StaffID = F, NameID = F, StaffIDDisciplineOfficer = F, PerceivedMotivationID = F, FullName = F, StudentNumber = F, PerceivedMotivationCodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, OSSCount = F, OSSPartialCount = F, ISSCount = F, ISSPartialCount = F, InternalComment = F, MultipleVictimCount = F, EstimatedVictimsEnrolled = F, EstimatedVictimsNotEnrolled = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonMN", objectId = TempIncidentInvolvedPersonMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentInvolvedPersonMN <- function(TempIncidentInvolvedPersonMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonMN", objectId = TempIncidentInvolvedPersonMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentInvolvedPersonMN <- function(StateVictimTypeMNID = NULL, StateVictimCostMNID = NULL, InjuryOccured = NULL, WasSeriousBodilyInjury = NULL, ReportedToLawEnforcement = NULL, OffenderArrestedByLawEnforcement = NULL, StateOffenderActivityMNID = NULL, IsPhysicalAssault = NULL, IsPhysicalAssaultState = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, MultipleVictimCount = NULL, EstimatedVictimsEnrolled = NULL, EstimatedVictimsNotEnrolled = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonMN", body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentInvolvedPersonMN <- function(TempIncidentInvolvedPersonMNID, StateVictimTypeMNID = NULL, StateVictimCostMNID = NULL, InjuryOccured = NULL, WasSeriousBodilyInjury = NULL, ReportedToLawEnforcement = NULL, OffenderArrestedByLawEnforcement = NULL, StateOffenderActivityMNID = NULL, IsPhysicalAssault = NULL, IsPhysicalAssaultState = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, MultipleVictimCount = NULL, EstimatedVictimsEnrolled = NULL, EstimatedVictimsNotEnrolled = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonMN", objectId = TempIncidentInvolvedPersonMNID, body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentInvolvedPersonIN <- function(TempIncidentInvolvedPersonINID, StateCriminalEventINID = F, StateArrestTypeINID = F, StateArrestReasonINID = F, IsChemicalRestraint = F, IsMechanicalRestraint = F, IsPhysicalRestraint = F, IsSeclusion = F, StaffIDResourceOfficer = F, TempIncidentInvolvedPersonID = F, IncidentOffenseNameKey = F, PrimaryOffenseID = F, SecondaryOffensesBackingData = F, ExcludePrimaryOffense = F, ExistingIncidentOffenseNamesToDelete = F, InvolvementType = F, IncidentOffenseNameType = F, FreeformName = F, StudentID = F, StaffID = F, NameID = F, StaffIDDisciplineOfficer = F, PerceivedMotivationID = F, FullName = F, StudentNumber = F, PerceivedMotivationCodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, OSSCount = F, OSSPartialCount = F, ISSCount = F, ISSPartialCount = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonIN", objectId = TempIncidentInvolvedPersonINID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentInvolvedPersonIN <- function(TempIncidentInvolvedPersonINID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonIN", objectId = TempIncidentInvolvedPersonINID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentInvolvedPersonIN <- function(StateCriminalEventINID = NULL, StateArrestTypeINID = NULL, StateArrestReasonINID = NULL, IsChemicalRestraint = NULL, IsMechanicalRestraint = NULL, IsPhysicalRestraint = NULL, IsSeclusion = NULL, StaffIDResourceOfficer = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonIN", body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonINID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentInvolvedPersonIN <- function(TempIncidentInvolvedPersonINID, StateCriminalEventINID = NULL, StateArrestTypeINID = NULL, StateArrestReasonINID = NULL, IsChemicalRestraint = NULL, IsMechanicalRestraint = NULL, IsPhysicalRestraint = NULL, IsSeclusion = NULL, StaffIDResourceOfficer = NULL, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPersonIN", objectId = TempIncidentInvolvedPersonINID, body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonINID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempIncidentInvolvedPerson <- function(TempIncidentInvolvedPersonID, IncidentOffenseNameKey = F, PrimaryOffenseID = F, SecondaryOffensesBackingData = F, ExcludePrimaryOffense = F, ExistingIncidentOffenseNamesToDelete = F, InvolvementType = F, IncidentOffenseNameType = F, FreeformName = F, StudentID = F, StaffID = F, NameID = F, StaffIDDisciplineOfficer = F, PerceivedMotivationID = F, FullName = F, StudentNumber = F, PerceivedMotivationCodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, OSSCount = F, OSSPartialCount = F, ISSCount = F, ISSPartialCount = F, InternalComment = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPerson", objectId = TempIncidentInvolvedPersonID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempIncidentInvolvedPerson <- function(TempIncidentInvolvedPersonID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPerson", objectId = TempIncidentInvolvedPersonID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempIncidentInvolvedPerson <- function(IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPerson", body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempIncidentInvolvedPerson <- function(TempIncidentInvolvedPersonID, IncidentOffenseNameKey = NULL, PrimaryOffenseID = NULL, ExcludePrimaryOffense = NULL, InvolvementType = NULL, IncidentOffenseNameType = NULL, FreeformName = NULL, StudentID = NULL, StaffID = NULL, NameID = NULL, StaffIDDisciplineOfficer = NULL, PerceivedMotivationID = NULL, FullName = NULL, StudentNumber = NULL, PerceivedMotivationCodeDescription = NULL, OSSCount = NULL, OSSPartialCount = NULL, ISSCount = NULL, ISSPartialCount = NULL, InternalComment = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Discipline", objectName = "TempIncidentInvolvedPerson", objectId = TempIncidentInvolvedPersonID, body = list(DataObject = body), searchFields = append("TempIncidentInvolvedPersonID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
