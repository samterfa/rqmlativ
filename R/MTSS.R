	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAreaOfConcern <- function(AreaOfConcernID, Code = F, Description = F, DistrictID = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsActive = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "AreaOfConcern", objectId = AreaOfConcernID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAreaOfConcern <- function(AreaOfConcernID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "AreaOfConcern", objectId = AreaOfConcernID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAreaOfConcern <- function(Code = NULL, Description = NULL, DistrictID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "AreaOfConcern", body = list(DataObject = body), searchFields = append("AreaOfConcernID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAreaOfConcern <- function(AreaOfConcernID, Code = NULL, Description = NULL, DistrictID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "AreaOfConcern", objectId = AreaOfConcernID, body = list(DataObject = body), searchFields = append("AreaOfConcernID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOutcome <- function(OutcomeID, Code = F, Description = F, DistrictID = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, UseForObservation = F, UseForIntervention = F, IsActive = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "Outcome", objectId = OutcomeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteOutcome <- function(OutcomeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "Outcome", objectId = OutcomeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createOutcome <- function(Code = NULL, Description = NULL, DistrictID = NULL, UseForObservation = NULL, UseForIntervention = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "Outcome", body = list(DataObject = body), searchFields = append("OutcomeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyOutcome <- function(OutcomeID, Code = NULL, Description = NULL, DistrictID = NULL, UseForObservation = NULL, UseForIntervention = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "Outcome", objectId = OutcomeID, body = list(DataObject = body), searchFields = append("OutcomeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getObservation <- function(ObservationID, StudentID = F, AreaOfConcernID = F, Note = F, StartDate = F, EndDate = F, AttachmentCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DateMethod = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "Observation", objectId = ObservationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteObservation <- function(ObservationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "Observation", objectId = ObservationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createObservation <- function(StudentID = NULL, AreaOfConcernID = NULL, Note = NULL, StartDate = NULL, EndDate = NULL, DateMethod = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "Observation", body = list(DataObject = body), searchFields = append("ObservationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyObservation <- function(ObservationID, StudentID = NULL, AreaOfConcernID = NULL, Note = NULL, StartDate = NULL, EndDate = NULL, DateMethod = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "Observation", objectId = ObservationID, body = list(DataObject = body), searchFields = append("ObservationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getObservationAction <- function(ObservationActionID, ObservationID = F, OutcomeID = F, OutcomeNote = F, StartDate = F, EndDate = F, Description = F, AttachmentCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DateMethod = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "ObservationAction", objectId = ObservationActionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteObservationAction <- function(ObservationActionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "ObservationAction", objectId = ObservationActionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createObservationAction <- function(ObservationID = NULL, OutcomeID = NULL, OutcomeNote = NULL, StartDate = NULL, EndDate = NULL, Description = NULL, DateMethod = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "ObservationAction", body = list(DataObject = body), searchFields = append("ObservationActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyObservationAction <- function(ObservationActionID, ObservationID = NULL, OutcomeID = NULL, OutcomeNote = NULL, StartDate = NULL, EndDate = NULL, Description = NULL, DateMethod = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "ObservationAction", objectId = ObservationActionID, body = list(DataObject = body), searchFields = append("ObservationActionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTier <- function(TierID, Code = F, Description = F, Level = F, DistrictID = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "Tier", objectId = TierID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTier <- function(TierID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "Tier", objectId = TierID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTier <- function(Code = NULL, Description = NULL, Level = NULL, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "Tier", body = list(DataObject = body), searchFields = append("TierID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTier <- function(TierID, Code = NULL, Description = NULL, Level = NULL, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "Tier", objectId = TierID, body = list(DataObject = body), searchFields = append("TierID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStudentInterventionReferral <- function(StudentInterventionReferralID, StudentID = F, AreaOfConcernID = F, Note = F, ReferralDate = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AttachmentCount = F, WatchlistID = F, NameIDAssignedTo = F, ApprovedBeforeLastEffectiveRun = F, StatusChangedBeforeLastEffectiveRun = F, CreatedBeforeLastEffectiveRun = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "StudentInterventionReferral", objectId = StudentInterventionReferralID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentInterventionReferral <- function(StudentInterventionReferralID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "StudentInterventionReferral", objectId = StudentInterventionReferralID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentInterventionReferral <- function(StudentID = NULL, AreaOfConcernID = NULL, Note = NULL, ReferralDate = NULL, WatchlistID = NULL, NameIDAssignedTo = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "StudentInterventionReferral", body = list(DataObject = body), searchFields = append("StudentInterventionReferralID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentInterventionReferral <- function(StudentInterventionReferralID, StudentID = NULL, AreaOfConcernID = NULL, Note = NULL, ReferralDate = NULL, WatchlistID = NULL, NameIDAssignedTo = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "StudentInterventionReferral", objectId = StudentInterventionReferralID, body = list(DataObject = body), searchFields = append("StudentInterventionReferralID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentInterventionReferralObservation <- function(StudentInterventionReferralObservationID, StudentInterventionReferralID = F, ObservationID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "StudentInterventionReferralObservation", objectId = StudentInterventionReferralObservationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentInterventionReferralObservation <- function(StudentInterventionReferralObservationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "StudentInterventionReferralObservation", objectId = StudentInterventionReferralObservationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentInterventionReferralObservation <- function(StudentInterventionReferralID = NULL, ObservationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "StudentInterventionReferralObservation", body = list(DataObject = body), searchFields = append("StudentInterventionReferralObservationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentInterventionReferralObservation <- function(StudentInterventionReferralObservationID, StudentInterventionReferralID = NULL, ObservationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentInterventionReferralStatus <- function(StudentInterventionReferralStatusID, StudentInterventionReferralID = F, Note = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ReferralStatus = F, ReferralDateTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "StudentInterventionReferralStatus", objectId = StudentInterventionReferralStatusID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentInterventionReferralStatus <- function(StudentInterventionReferralStatusID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "StudentInterventionReferralStatus", objectId = StudentInterventionReferralStatusID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentInterventionReferralStatus <- function(StudentInterventionReferralID = NULL, Note = NULL, ReferralStatus = NULL, ReferralDateTime = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "StudentInterventionReferralStatus", body = list(DataObject = body), searchFields = append("StudentInterventionReferralStatusID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentInterventionReferralStatus <- function(StudentInterventionReferralStatusID, StudentInterventionReferralID = NULL, Note = NULL, ReferralStatus = NULL, ReferralDateTime = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "StudentInterventionReferralStatus", objectId = StudentInterventionReferralStatusID, body = list(DataObject = body), searchFields = append("StudentInterventionReferralStatusID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getInterventionTeam <- function(InterventionTeamID, Name = F, Description = F, IsActive = F, DistrictID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "InterventionTeam", objectId = InterventionTeamID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInterventionTeam <- function(InterventionTeamID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "InterventionTeam", objectId = InterventionTeamID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInterventionTeam <- function(Name = NULL, Description = NULL, IsActive = NULL, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "InterventionTeam", body = list(DataObject = body), searchFields = append("InterventionTeamID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInterventionTeam <- function(InterventionTeamID, Name = NULL, Description = NULL, IsActive = NULL, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "InterventionTeam", objectId = InterventionTeamID, body = list(DataObject = body), searchFields = append("InterventionTeamID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getInterventionTeamStaff <- function(InterventionTeamStaffID, InterventionTeamID = F, StaffID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsActive = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "InterventionTeamStaff", objectId = InterventionTeamStaffID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInterventionTeamStaff <- function(InterventionTeamStaffID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "InterventionTeamStaff", objectId = InterventionTeamStaffID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInterventionTeamStaff <- function(InterventionTeamID = NULL, StaffID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "InterventionTeamStaff", body = list(DataObject = body), searchFields = append("InterventionTeamStaffID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInterventionTeamStaff <- function(InterventionTeamStaffID, InterventionTeamID = NULL, StaffID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "InterventionTeamStaff", objectId = InterventionTeamStaffID, body = list(DataObject = body), searchFields = append("InterventionTeamStaffID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getInterventionPlan <- function(InterventionPlanID, StudentID = F, TierID = F, OutcomeID = F, GoalFreeform = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StartDate = F, EndDate = F, AreaOfConcernID = F, ObjectiveID = F, StartingGoal = F, MeasurementID = F, StartingGoalDisplay = F, TargetGoal = F, TargetGoalDisplay = F, StudentInterventionReferralID = F, CurrentUserHasPermission = F, AttachmentCount = F, ReviewDate = F, QualitativeScaleMappingIDStarting = F, QualitativeScaleMappingIDTarget = F, WatchlistID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "InterventionPlan", objectId = InterventionPlanID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInterventionPlan <- function(InterventionPlanID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "InterventionPlan", objectId = InterventionPlanID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createInterventionPlan <- function(StudentID = NULL, TierID = NULL, OutcomeID = NULL, GoalFreeform = NULL, StartDate = NULL, EndDate = NULL, AreaOfConcernID = NULL, ObjectiveID = NULL, StartingGoal = NULL, MeasurementID = NULL, TargetGoal = NULL, StudentInterventionReferralID = NULL, ReviewDate = NULL, QualitativeScaleMappingIDStarting = NULL, QualitativeScaleMappingIDTarget = NULL, WatchlistID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "MTSS", objectName = "InterventionPlan", body = list(DataObject = body), searchFields = append("InterventionPlanID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyInterventionPlan <- function(InterventionPlanID, StudentID = NULL, TierID = NULL, OutcomeID = NULL, GoalFreeform = NULL, StartDate = NULL, EndDate = NULL, AreaOfConcernID = NULL, ObjectiveID = NULL, StartingGoal = NULL, MeasurementID = NULL, TargetGoal = NULL, StudentInterventionReferralID = NULL, ReviewDate = NULL, QualitativeScaleMappingIDStarting = NULL, QualitativeScaleMappingIDTarget = NULL, WatchlistID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "MTSS", objectName = "InterventionPlan", objectId = InterventionPlanID, body = list(DataObject = body), searchFields = append("InterventionPlanID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getInterventionPlanStaff <- function(InterventionPlanStaffID, InterventionPlanID = F, StaffID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, InterventionTeamStaffID = F, IsActive = F, IsProvidedBy = F, StaffAddedBeforeLastEffectiveRun = F, UserAddedSelf = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "InterventionPlanStaff", objectId = InterventionPlanStaffID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInterventionPlanStaff <- function(InterventionPlanStaffID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "InterventionPlanStaff", objectId = InterventionPlanStaffID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInterventionPlanStaff <- function(InterventionPlanID = NULL, StaffID = NULL, InterventionTeamStaffID = NULL, IsActive = NULL, IsProvidedBy = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "InterventionPlanStaff", body = list(DataObject = body), searchFields = append("InterventionPlanStaffID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInterventionPlanStaff <- function(InterventionPlanStaffID, InterventionPlanID = NULL, StaffID = NULL, InterventionTeamStaffID = NULL, IsActive = NULL, IsProvidedBy = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "InterventionPlanStaff", objectId = InterventionPlanStaffID, body = list(DataObject = body), searchFields = append("InterventionPlanStaffID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getInterventionPlanStrategy <- function(InterventionPlanStrategyID, InterventionPlanID = F, GoalFreeform = F, Duration = F, MeetingTime = F, StartDate = F, EndDate = F, Sunday = F, Monday = F, Tuesday = F, Wednesday = F, Thursday = F, Friday = F, Saturday = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StrategyID = F, OutcomeID = F, StrategyGoal = F, StrategyGoalDisplay = F, Days = F, IsAdministrableAsOfSpecifiedDate = F, InterventionStaffIDByCurrentUser = F, MeetingTimeDisplay = F, Frequency = F, TimesToMeet = F, DayAbbreviations = F, QualitativeScaleMappingIDStrategy = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "InterventionPlanStrategy", objectId = InterventionPlanStrategyID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInterventionPlanStrategy <- function(InterventionPlanStrategyID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "InterventionPlanStrategy", objectId = InterventionPlanStrategyID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createInterventionPlanStrategy <- function(InterventionPlanID = NULL, GoalFreeform = NULL, Duration = NULL, MeetingTime = NULL, StartDate = NULL, EndDate = NULL, Sunday = NULL, Monday = NULL, Tuesday = NULL, Wednesday = NULL, Thursday = NULL, Friday = NULL, Saturday = NULL, StrategyID = NULL, OutcomeID = NULL, StrategyGoal = NULL, Frequency = NULL, TimesToMeet = NULL, QualitativeScaleMappingIDStrategy = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "MTSS", objectName = "InterventionPlanStrategy", body = list(DataObject = body), searchFields = append("InterventionPlanStrategyID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyInterventionPlanStrategy <- function(InterventionPlanStrategyID, InterventionPlanID = NULL, GoalFreeform = NULL, Duration = NULL, MeetingTime = NULL, StartDate = NULL, EndDate = NULL, Sunday = NULL, Monday = NULL, Tuesday = NULL, Wednesday = NULL, Thursday = NULL, Friday = NULL, Saturday = NULL, StrategyID = NULL, OutcomeID = NULL, StrategyGoal = NULL, Frequency = NULL, TimesToMeet = NULL, QualitativeScaleMappingIDStrategy = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "MTSS", objectName = "InterventionPlanStrategy", objectId = InterventionPlanStrategyID, body = list(DataObject = body), searchFields = append("InterventionPlanStrategyID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStrategyTier <- function(StrategyTierID, StrategyID = F, TierID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "StrategyTier", objectId = StrategyTierID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStrategyTier <- function(StrategyTierID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "StrategyTier", objectId = StrategyTierID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStrategyTier <- function(StrategyID = NULL, TierID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "StrategyTier", body = list(DataObject = body), searchFields = append("StrategyTierID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStrategyTier <- function(StrategyTierID, StrategyID = NULL, TierID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "StrategyTier", objectId = StrategyTierID, body = list(DataObject = body), searchFields = append("StrategyTierID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStrategy <- function(StrategyID, Description = F, AreaOfConcernID = F, DistrictID = F, TierLabels = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Note = F, AttachmentCount = F, IsActive = F, EntityLabels = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "Strategy", objectId = StrategyID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStrategy <- function(StrategyID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "Strategy", objectId = StrategyID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStrategy <- function(Description = NULL, AreaOfConcernID = NULL, DistrictID = NULL, Note = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "Strategy", body = list(DataObject = body), searchFields = append("StrategyID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStrategy <- function(StrategyID, Description = NULL, AreaOfConcernID = NULL, DistrictID = NULL, Note = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "Strategy", objectId = StrategyID, body = list(DataObject = body), searchFields = append("StrategyID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getObjectiveMeasurement <- function(ObjectiveMeasurementID, ObjectiveID = F, MeasurementID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "ObjectiveMeasurement", objectId = ObjectiveMeasurementID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteObjectiveMeasurement <- function(ObjectiveMeasurementID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "ObjectiveMeasurement", objectId = ObjectiveMeasurementID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createObjectiveMeasurement <- function(ObjectiveID = NULL, MeasurementID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "ObjectiveMeasurement", body = list(DataObject = body), searchFields = append("ObjectiveMeasurementID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyObjectiveMeasurement <- function(ObjectiveMeasurementID, ObjectiveID = NULL, MeasurementID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "ObjectiveMeasurement", objectId = ObjectiveMeasurementID, body = list(DataObject = body), searchFields = append("ObjectiveMeasurementID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getMeasurement <- function(MeasurementID, Code = F, Description = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, UseQualitativeMeasurement = F, QualitativeScaleID = F, IsActive = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "Measurement", objectId = MeasurementID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteMeasurement <- function(MeasurementID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "Measurement", objectId = MeasurementID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createMeasurement <- function(Code = NULL, Description = NULL, UseQualitativeMeasurement = NULL, QualitativeScaleID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "Measurement", body = list(DataObject = body), searchFields = append("MeasurementID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyMeasurement <- function(MeasurementID, Code = NULL, Description = NULL, UseQualitativeMeasurement = NULL, QualitativeScaleID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "Measurement", objectId = MeasurementID, body = list(DataObject = body), searchFields = append("MeasurementID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getObjective <- function(ObjectiveID, Code = F, Description = F, ObjectiveType = F, AreaOfConcernID = F, DistrictID = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsActive = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "Objective", objectId = ObjectiveID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteObjective <- function(ObjectiveID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "Objective", objectId = ObjectiveID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createObjective <- function(Code = NULL, Description = NULL, ObjectiveType = NULL, AreaOfConcernID = NULL, DistrictID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "Objective", body = list(DataObject = body), searchFields = append("ObjectiveID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyObjective <- function(ObjectiveID, Code = NULL, Description = NULL, ObjectiveType = NULL, AreaOfConcernID = NULL, DistrictID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "Objective", objectId = ObjectiveID, body = list(DataObject = body), searchFields = append("ObjectiveID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getInterventionPlanMeeting <- function(InterventionPlanMeetingID, InterventionPlanStrategyID = F, Date = F, Time = F, Measurement = F, InterventionPlanStaffID = F, Note = F, MeetingType = F, MeasurementDisplay = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DidNotMeet = F, AttachmentCount = F, QualitativeScaleMappingID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "InterventionPlanMeeting", objectId = InterventionPlanMeetingID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInterventionPlanMeeting <- function(InterventionPlanMeetingID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "InterventionPlanMeeting", objectId = InterventionPlanMeetingID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInterventionPlanMeeting <- function(InterventionPlanStrategyID = NULL, Date = NULL, Time = NULL, Measurement = NULL, InterventionPlanStaffID = NULL, Note = NULL, MeetingType = NULL, DidNotMeet = NULL, QualitativeScaleMappingID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "InterventionPlanMeeting", body = list(DataObject = body), searchFields = append("InterventionPlanMeetingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInterventionPlanMeeting <- function(InterventionPlanMeetingID, InterventionPlanStrategyID = NULL, Date = NULL, Time = NULL, Measurement = NULL, InterventionPlanStaffID = NULL, Note = NULL, MeetingType = NULL, DidNotMeet = NULL, QualitativeScaleMappingID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "InterventionPlanMeeting", objectId = InterventionPlanMeetingID, body = list(DataObject = body), searchFields = append("InterventionPlanMeetingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getInterventionPlanNote <- function(InterventionPlanNoteID, InterventionPlanID = F, Note = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "InterventionPlanNote", objectId = InterventionPlanNoteID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInterventionPlanNote <- function(InterventionPlanNoteID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "InterventionPlanNote", objectId = InterventionPlanNoteID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInterventionPlanNote <- function(InterventionPlanID = NULL, Note = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "InterventionPlanNote", body = list(DataObject = body), searchFields = append("InterventionPlanNoteID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInterventionPlanNote <- function(InterventionPlanNoteID, InterventionPlanID = NULL, Note = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "InterventionPlanNote", objectId = InterventionPlanNoteID, body = list(DataObject = body), searchFields = append("InterventionPlanNoteID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getQualitativeScale <- function(QualitativeScaleID, Code = F, Description = F, DistrictID = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsActive = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "QualitativeScale", objectId = QualitativeScaleID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteQualitativeScale <- function(QualitativeScaleID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "QualitativeScale", objectId = QualitativeScaleID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createQualitativeScale <- function(Code = NULL, Description = NULL, DistrictID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "QualitativeScale", body = list(DataObject = body), searchFields = append("QualitativeScaleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyQualitativeScale <- function(QualitativeScaleID, Code = NULL, Description = NULL, DistrictID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "QualitativeScale", objectId = QualitativeScaleID, body = list(DataObject = body), searchFields = append("QualitativeScaleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getQualitativeScaleMapping <- function(QualitativeScaleMappingID, QualitativeScaleID = F, Value = F, NumericValue = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "QualitativeScaleMapping", objectId = QualitativeScaleMappingID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteQualitativeScaleMapping <- function(QualitativeScaleMappingID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "QualitativeScaleMapping", objectId = QualitativeScaleMappingID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createQualitativeScaleMapping <- function(QualitativeScaleID = NULL, Value = NULL, NumericValue = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "QualitativeScaleMapping", body = list(DataObject = body), searchFields = append("QualitativeScaleMappingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyQualitativeScaleMapping <- function(QualitativeScaleMappingID, QualitativeScaleID = NULL, Value = NULL, NumericValue = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "QualitativeScaleMapping", objectId = QualitativeScaleMappingID, body = list(DataObject = body), searchFields = append("QualitativeScaleMappingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getWatchlistCondition <- function(WatchlistConditionID, SkywardID = F, SkywardHash = F, FieldPath = F, DisplayName = F, MultiSelectBrowseSkywardID = F, Order = F, DependentSkywardID = F, DependentFriendlyNames = F, RuleType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "WatchlistCondition", objectId = WatchlistConditionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWatchlistCondition <- function(WatchlistConditionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "WatchlistCondition", objectId = WatchlistConditionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createWatchlistCondition <- function(RuleType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "WatchlistCondition", body = list(DataObject = body), searchFields = append("WatchlistConditionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyWatchlistCondition <- function(WatchlistConditionID, RuleType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "WatchlistCondition", objectId = WatchlistConditionID, body = list(DataObject = body), searchFields = append("WatchlistConditionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getWatchlistThreshold <- function(WatchlistThresholdID, EntityID = F, SchoolYearID = F, AreaOfConcernID = F, Name = F, Description = F, RunStartDate = F, RunEndDate = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsActive = F, WatchlistThresholdIDClonedFrom = F, WatchlistThresholdIDClonedTo = F, GradeLevelLabels = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "WatchlistThreshold", objectId = WatchlistThresholdID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWatchlistThreshold <- function(WatchlistThresholdID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "WatchlistThreshold", objectId = WatchlistThresholdID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createWatchlistThreshold <- function(EntityID = NULL, SchoolYearID = NULL, AreaOfConcernID = NULL, Name = NULL, Description = NULL, RunStartDate = NULL, RunEndDate = NULL, IsActive = NULL, WatchlistThresholdIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "WatchlistThreshold", body = list(DataObject = body), searchFields = append("WatchlistThresholdID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyWatchlistThreshold <- function(WatchlistThresholdID, EntityID = NULL, SchoolYearID = NULL, AreaOfConcernID = NULL, Name = NULL, Description = NULL, RunStartDate = NULL, RunEndDate = NULL, IsActive = NULL, WatchlistThresholdIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "WatchlistThreshold", objectId = WatchlistThresholdID, body = list(DataObject = body), searchFields = append("WatchlistThresholdID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getThresholdRule <- function(ThresholdRuleID, ThresholdID = F, ThresholdRuleGroupID = F, NumberOfOccurrences = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ThresholdRuleIDClonedFrom = F, ThresholdRuleIDClonedTo = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "ThresholdRule", objectId = ThresholdRuleID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteThresholdRule <- function(ThresholdRuleID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "ThresholdRule", objectId = ThresholdRuleID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createThresholdRule <- function(ThresholdID = NULL, ThresholdRuleGroupID = NULL, NumberOfOccurrences = NULL, ThresholdRuleIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "ThresholdRule", body = list(DataObject = body), searchFields = append("ThresholdRuleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyThresholdRule <- function(ThresholdRuleID, ThresholdID = NULL, ThresholdRuleGroupID = NULL, NumberOfOccurrences = NULL, ThresholdRuleIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "ThresholdRule", objectId = ThresholdRuleID, body = list(DataObject = body), searchFields = append("ThresholdRuleID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getRuleCondition <- function(RuleConditionID, ThresholdRuleGroupID = F, WatchlistConditionID = F, Value = F, OperationType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, RuleConditionIDClonedFrom = F, RuleConditionIDClonedTo = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "RuleCondition", objectId = RuleConditionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteRuleCondition <- function(RuleConditionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "RuleCondition", objectId = RuleConditionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createRuleCondition <- function(ThresholdRuleGroupID = NULL, WatchlistConditionID = NULL, Value = NULL, OperationType = NULL, RuleConditionIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "RuleCondition", body = list(DataObject = body), searchFields = append("RuleConditionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyRuleCondition <- function(RuleConditionID, ThresholdRuleGroupID = NULL, WatchlistConditionID = NULL, Value = NULL, OperationType = NULL, RuleConditionIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "RuleCondition", objectId = RuleConditionID, body = list(DataObject = body), searchFields = append("RuleConditionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getThresholdRuleGroup <- function(ThresholdRuleGroupID, Name = F, EntityID = F, SchoolYearID = F, RuleType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ThresholdRuleGroupIDClonedFrom = F, ThresholdRuleGroupIDClonedTo = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "ThresholdRuleGroup", objectId = ThresholdRuleGroupID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteThresholdRuleGroup <- function(ThresholdRuleGroupID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "ThresholdRuleGroup", objectId = ThresholdRuleGroupID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createThresholdRuleGroup <- function(Name = NULL, EntityID = NULL, SchoolYearID = NULL, RuleType = NULL, ThresholdRuleGroupIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "ThresholdRuleGroup", body = list(DataObject = body), searchFields = append("ThresholdRuleGroupID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyThresholdRuleGroup <- function(ThresholdRuleGroupID, Name = NULL, EntityID = NULL, SchoolYearID = NULL, RuleType = NULL, ThresholdRuleGroupIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "ThresholdRuleGroup", objectId = ThresholdRuleGroupID, body = list(DataObject = body), searchFields = append("ThresholdRuleGroupID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getThreshold <- function(ThresholdID, WatchlistThresholdID = F, TierID = F, Name = F, Description = F, NumberOfRulesToMeet = F, Rank = F, RulesToMeet = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ThresholdIDClonedFrom = F, ThresholdIDClonedTo = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "Threshold", objectId = ThresholdID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteThreshold <- function(ThresholdID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "Threshold", objectId = ThresholdID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createThreshold <- function(WatchlistThresholdID = NULL, TierID = NULL, Name = NULL, Description = NULL, NumberOfRulesToMeet = NULL, Rank = NULL, RulesToMeet = NULL, ThresholdIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "Threshold", body = list(DataObject = body), searchFields = append("ThresholdID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyThreshold <- function(ThresholdID, WatchlistThresholdID = NULL, TierID = NULL, Name = NULL, Description = NULL, NumberOfRulesToMeet = NULL, Rank = NULL, RulesToMeet = NULL, ThresholdIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "Threshold", objectId = ThresholdID, body = list(DataObject = body), searchFields = append("ThresholdID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getWatchlist <- function(WatchlistID, StudentID = F, ThresholdID = F, LastActiveDate = F, IsActive = F, PlanCreated = F, ReferralCreated = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "Watchlist", objectId = WatchlistID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWatchlist <- function(WatchlistID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "Watchlist", objectId = WatchlistID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createWatchlist <- function(StudentID = NULL, ThresholdID = NULL, LastActiveDate = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "Watchlist", body = list(DataObject = body), searchFields = append("WatchlistID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyWatchlist <- function(WatchlistID, StudentID = NULL, ThresholdID = NULL, LastActiveDate = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "Watchlist", objectId = WatchlistID, body = list(DataObject = body), searchFields = append("WatchlistID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempInterventionPlan <- function(TempInterventionPlanID, InterventionPlanID = F, StudentNameLFM = F, StudentNumber = F, AreaOfConcernDescription = F, InterventionPlanStartDate = F, TierDescription = F, ObjectiveDescription = F, OutcomeDescription = F, HasExceptions = F, Exceptions = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StudentID = F, Threshold = F, Duration = F, MeetingTime = F, StartingGoal = F, QualitativeScaleMappingIDStarting = F, TargetGoal = F, QualitativeScaleMappingIDTarget = F, WatchlistID = F, IsSelected = F, ErrorCount = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "TempInterventionPlan", objectId = TempInterventionPlanID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempInterventionPlan <- function(TempInterventionPlanID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "TempInterventionPlan", objectId = TempInterventionPlanID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempInterventionPlan <- function(StudentNameLFM = NULL, StudentNumber = NULL, AreaOfConcernDescription = NULL, InterventionPlanStartDate = NULL, TierDescription = NULL, ObjectiveDescription = NULL, OutcomeDescription = NULL, Exceptions = NULL, Threshold = NULL, Duration = NULL, MeetingTime = NULL, StartingGoal = NULL, QualitativeScaleMappingIDStarting = NULL, TargetGoal = NULL, QualitativeScaleMappingIDTarget = NULL, IsSelected = NULL, ErrorCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "MTSS", objectName = "TempInterventionPlan", body = list(DataObject = body), searchFields = append("TempInterventionPlanID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempInterventionPlan <- function(TempInterventionPlanID, StudentNameLFM = NULL, StudentNumber = NULL, AreaOfConcernDescription = NULL, InterventionPlanStartDate = NULL, TierDescription = NULL, ObjectiveDescription = NULL, OutcomeDescription = NULL, Exceptions = NULL, Threshold = NULL, Duration = NULL, MeetingTime = NULL, StartingGoal = NULL, QualitativeScaleMappingIDStarting = NULL, TargetGoal = NULL, QualitativeScaleMappingIDTarget = NULL, IsSelected = NULL, ErrorCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "MTSS", objectName = "TempInterventionPlan", objectId = TempInterventionPlanID, body = list(DataObject = body), searchFields = append("TempInterventionPlanID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempInterventionTeamStaffError <- function(TempInterventionTeamStaffErrorID, StaffNameLFM = F, ErrorMessage = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "TempInterventionTeamStaffError", objectId = TempInterventionTeamStaffErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempInterventionTeamStaffError <- function(TempInterventionTeamStaffErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "TempInterventionTeamStaffError", objectId = TempInterventionTeamStaffErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempInterventionTeamStaffError <- function(StaffNameLFM = NULL, ErrorMessage = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "TempInterventionTeamStaffError", body = list(DataObject = body), searchFields = append("TempInterventionTeamStaffErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempInterventionTeamStaffError <- function(TempInterventionTeamStaffErrorID, StaffNameLFM = NULL, ErrorMessage = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "TempInterventionTeamStaffError", objectId = TempInterventionTeamStaffErrorID, body = list(DataObject = body), searchFields = append("TempInterventionTeamStaffErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempInterventionPlanStaff <- function(TempInterventionPlanStaffID, InterventionPlanStaffID = F, InterventionTeamStaffID = F, InterventionPlanID = F, StaffID = F, StaffNameLFM = F, NewIsProvidedBy = F, NewIsActive = F, OldIsProvidedBy = F, OldIsActive = F, StudentNameLFM = F, StudentNumber = F, AreaOfConcern = F, ErrorMessage = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "TempInterventionPlanStaff", objectId = TempInterventionPlanStaffID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempInterventionPlanStaff <- function(TempInterventionPlanStaffID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "TempInterventionPlanStaff", objectId = TempInterventionPlanStaffID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempInterventionPlanStaff <- function(StaffNameLFM = NULL, NewIsProvidedBy = NULL, NewIsActive = NULL, OldIsProvidedBy = NULL, OldIsActive = NULL, StudentNameLFM = NULL, StudentNumber = NULL, AreaOfConcern = NULL, ErrorMessage = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "TempInterventionPlanStaff", body = list(DataObject = body), searchFields = append("TempInterventionPlanStaffID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempInterventionPlanStaff <- function(TempInterventionPlanStaffID, StaffNameLFM = NULL, NewIsProvidedBy = NULL, NewIsActive = NULL, OldIsProvidedBy = NULL, OldIsActive = NULL, StudentNameLFM = NULL, StudentNumber = NULL, AreaOfConcern = NULL, ErrorMessage = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "TempInterventionPlanStaff", objectId = TempInterventionPlanStaffID, body = list(DataObject = body), searchFields = append("TempInterventionPlanStaffID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStrategyEntity <- function(StrategyEntityID, StrategyID = F, EntityID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "StrategyEntity", objectId = StrategyEntityID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStrategyEntity <- function(StrategyEntityID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "StrategyEntity", objectId = StrategyEntityID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStrategyEntity <- function(StrategyID = NULL, EntityID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "StrategyEntity", body = list(DataObject = body), searchFields = append("StrategyEntityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStrategyEntity <- function(StrategyEntityID, StrategyID = NULL, EntityID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "StrategyEntity", objectId = StrategyEntityID, body = list(DataObject = body), searchFields = append("StrategyEntityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getMTSSConfigEntity <- function(MTSSConfigEntityID, ConfigEntityID = F, EntityID = F, DisplayReferrals = F, DisplayInterventionPlans = F, DisplayWatchlist = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "ConfigEntity", objectId = MTSSConfigEntityID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteMTSSConfigEntity <- function(MTSSConfigEntityID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "ConfigEntity", objectId = MTSSConfigEntityID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createMTSSConfigEntity <- function(EntityID = NULL, DisplayReferrals = NULL, DisplayInterventionPlans = NULL, DisplayWatchlist = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "ConfigEntity", body = list(DataObject = body), searchFields = append("ConfigEntityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyMTSSConfigEntity <- function(ConfigEntityID, EntityID = NULL, DisplayReferrals = NULL, DisplayInterventionPlans = NULL, DisplayWatchlist = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "ConfigEntity", objectId = ConfigEntityID, body = list(DataObject = body), searchFields = append("ConfigEntityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStudentInterventionReferralError <- function(TempStudentInterventionReferralErrorID, TempStudentInterventionReferralID = F, Error = F, ErrorDetail = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "TempStudentInterventionReferralError", objectId = TempStudentInterventionReferralErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentInterventionReferralError <- function(TempStudentInterventionReferralErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "TempStudentInterventionReferralError", objectId = TempStudentInterventionReferralErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentInterventionReferralError <- function(TempStudentInterventionReferralID = NULL, Error = NULL, ErrorDetail = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "TempStudentInterventionReferralError", body = list(DataObject = body), searchFields = append("TempStudentInterventionReferralErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentInterventionReferralError <- function(TempStudentInterventionReferralErrorID, TempStudentInterventionReferralID = NULL, Error = NULL, ErrorDetail = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "TempStudentInterventionReferralError", objectId = TempStudentInterventionReferralErrorID, body = list(DataObject = body), searchFields = append("TempStudentInterventionReferralErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentInterventionReferral <- function(TempStudentInterventionReferralID, WatchlistID = F, StudentID = F, StudentNameLFM = F, StudentNumber = F, NameIDAssignedTo = F, NameAssignedToLFM = F, AreaOfConcernID = F, AreaOfConcernDescription = F, ReferralDate = F, Note = F, ErrorCount = F, Exceptions = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StudentInterventionReferralID = F, Threshold = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "TempStudentInterventionReferral", objectId = TempStudentInterventionReferralID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentInterventionReferral <- function(TempStudentInterventionReferralID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "TempStudentInterventionReferral", objectId = TempStudentInterventionReferralID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentInterventionReferral <- function(StudentNameLFM = NULL, StudentNumber = NULL, NameAssignedToLFM = NULL, AreaOfConcernDescription = NULL, ReferralDate = NULL, Note = NULL, ErrorCount = NULL, Exceptions = NULL, Threshold = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "TempStudentInterventionReferral", body = list(DataObject = body), searchFields = append("TempStudentInterventionReferralID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentInterventionReferral <- function(TempStudentInterventionReferralID, StudentNameLFM = NULL, StudentNumber = NULL, NameAssignedToLFM = NULL, AreaOfConcernDescription = NULL, ReferralDate = NULL, Note = NULL, ErrorCount = NULL, Exceptions = NULL, Threshold = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "TempStudentInterventionReferral", objectId = TempStudentInterventionReferralID, body = list(DataObject = body), searchFields = append("TempStudentInterventionReferralID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getWatchlistThresholdGradeLevel <- function(WatchlistThresholdGradeLevelID, WatchlistThresholdID = F, GradeLevelID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "WatchlistThresholdGradeLevel", objectId = WatchlistThresholdGradeLevelID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWatchlistThresholdGradeLevel <- function(WatchlistThresholdGradeLevelID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "WatchlistThresholdGradeLevel", objectId = WatchlistThresholdGradeLevelID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createWatchlistThresholdGradeLevel <- function(WatchlistThresholdID = NULL, GradeLevelID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "WatchlistThresholdGradeLevel", body = list(DataObject = body), searchFields = append("WatchlistThresholdGradeLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyWatchlistThresholdGradeLevel <- function(WatchlistThresholdGradeLevelID, WatchlistThresholdID = NULL, GradeLevelID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "WatchlistThresholdGradeLevel", objectId = WatchlistThresholdGradeLevelID, body = list(DataObject = body), searchFields = append("WatchlistThresholdGradeLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempMTSSYearEndTypeSummary <- function(TempMTSSYearEndTypeSummaryID, CloneWarning = F, DisplayName = F, SkywardIDObject = F, SourceRecordsFound = F, TargetRecordsFound = F, EstimatedRecordsToProcess = F, RecordsProcessedCount = F, SuccessCount = F, FailureCount = F, CloneUnsuccessful = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "TempMTSSYearEndTypeSummary", objectId = TempMTSSYearEndTypeSummaryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempMTSSYearEndTypeSummary <- function(TempMTSSYearEndTypeSummaryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "TempMTSSYearEndTypeSummary", objectId = TempMTSSYearEndTypeSummaryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempMTSSYearEndTypeSummary <- function(DisplayName = NULL, SkywardIDObject = NULL, SourceRecordsFound = NULL, TargetRecordsFound = NULL, EstimatedRecordsToProcess = NULL, RecordsProcessedCount = NULL, SuccessCount = NULL, FailureCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "TempMTSSYearEndTypeSummary", body = list(DataObject = body), searchFields = append("TempMTSSYearEndTypeSummaryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempMTSSYearEndTypeSummary <- function(TempMTSSYearEndTypeSummaryID, DisplayName = NULL, SkywardIDObject = NULL, SourceRecordsFound = NULL, TargetRecordsFound = NULL, EstimatedRecordsToProcess = NULL, RecordsProcessedCount = NULL, SuccessCount = NULL, FailureCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "TempMTSSYearEndTypeSummary", objectId = TempMTSSYearEndTypeSummaryID, body = list(DataObject = body), searchFields = append("TempMTSSYearEndTypeSummaryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getInterventionPlanMeetingAttendee <- function(InterventionPlanMeetingAttendeeID, NameID = F, InterventionPlanMeetingID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "InterventionPlanMeetingAttendee", objectId = InterventionPlanMeetingAttendeeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInterventionPlanMeetingAttendee <- function(InterventionPlanMeetingAttendeeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "InterventionPlanMeetingAttendee", objectId = InterventionPlanMeetingAttendeeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInterventionPlanMeetingAttendee <- function(NameID = NULL, InterventionPlanMeetingID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "InterventionPlanMeetingAttendee", body = list(DataObject = body), searchFields = append("InterventionPlanMeetingAttendeeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInterventionPlanMeetingAttendee <- function(InterventionPlanMeetingAttendeeID, NameID = NULL, InterventionPlanMeetingID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "InterventionPlanMeetingAttendee", objectId = InterventionPlanMeetingAttendeeID, body = list(DataObject = body), searchFields = append("InterventionPlanMeetingAttendeeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempInterventionPlanError <- function(TempInterventionPlanErrorID, TempInterventionPlanID = F, Error = F, ErrorDetail = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "MTSS", objectName = "TempInterventionPlanError", objectId = TempInterventionPlanErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempInterventionPlanError <- function(TempInterventionPlanErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "MTSS", objectName = "TempInterventionPlanError", objectId = TempInterventionPlanErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempInterventionPlanError <- function(TempInterventionPlanID = NULL, Error = NULL, ErrorDetail = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "MTSS", objectName = "TempInterventionPlanError", body = list(DataObject = body), searchFields = append("TempInterventionPlanErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempInterventionPlanError <- function(TempInterventionPlanErrorID, TempInterventionPlanID = NULL, Error = NULL, ErrorDetail = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "MTSS", objectName = "TempInterventionPlanError", objectId = TempInterventionPlanErrorID, body = list(DataObject = body), searchFields = append("TempInterventionPlanErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
