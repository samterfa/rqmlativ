	...
	getRestAPIRequest <- function(RestAPIRequestID, Nonce = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "RestAPIRequest", objectId = RestAPIRequestID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteRestAPIRequest <- function(RestAPIRequestID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "RestAPIRequest", objectId = RestAPIRequestID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createRestAPIRequest <- function(Nonce = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "RestAPIRequest", body = list(DataObject = body), searchFields = append("RestAPIRequestID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyRestAPIRequest <- function(RestAPIRequestID, Nonce = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "RestAPIRequest", objectId = RestAPIRequestID, body = list(DataObject = body), searchFields = append("RestAPIRequestID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getUserAccess <- function(UserAccessID, Description = F, IsActive = F, EffectiveDate = F, ExpirationDate = F, APIType = F, AuthenticationTypeOverride = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, UserID = F, DisplayText = F, EffectiveAuthenticationTypeCode = F, TimeTrackingConfigID = F, IdentificationConfigID = F, OneRosterConfigID = F, AttendanceConfigID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "UserAccess", objectId = UserAccessID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteUserAccess <- function(UserAccessID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "UserAccess", objectId = UserAccessID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createUserAccess <- function(Description = NULL, IsActive = NULL, EffectiveDate = NULL, ExpirationDate = NULL, APIType = NULL, AuthenticationTypeOverride = NULL, UserID = NULL, TimeTrackingConfigID = NULL, IdentificationConfigID = NULL, OneRosterConfigID = NULL, AttendanceConfigID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "API", objectName = "UserAccess", body = list(DataObject = body), searchFields = append("UserAccessID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyUserAccess <- function(UserAccessID, Description = NULL, IsActive = NULL, EffectiveDate = NULL, ExpirationDate = NULL, APIType = NULL, AuthenticationTypeOverride = NULL, UserID = NULL, TimeTrackingConfigID = NULL, IdentificationConfigID = NULL, OneRosterConfigID = NULL, AttendanceConfigID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "API", objectName = "UserAccess", objectId = UserAccessID, body = list(DataObject = body), searchFields = append("UserAccessID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getUserAuthorization <- function(UserAuthorizationID, AccessCode = F, AccessCodeExpirationTime = F, State = F, Scope = F, RedirectURI = F, Revoke = F, AccessToken = F, AccessTokenExpirationTime = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, UserID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "UserAuthorization", objectId = UserAuthorizationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteUserAuthorization <- function(UserAuthorizationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "UserAuthorization", objectId = UserAuthorizationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createUserAuthorization <- function(AccessCode = NULL, AccessCodeExpirationTime = NULL, State = NULL, Scope = NULL, RedirectURI = NULL, Revoke = NULL, AccessToken = NULL, AccessTokenExpirationTime = NULL, UserID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "UserAuthorization", body = list(DataObject = body), searchFields = append("UserAuthorizationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyUserAuthorization <- function(UserAuthorizationID, AccessCode = NULL, AccessCodeExpirationTime = NULL, State = NULL, Scope = NULL, RedirectURI = NULL, Revoke = NULL, AccessToken = NULL, AccessTokenExpirationTime = NULL, UserID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "UserAuthorization", objectId = UserAuthorizationID, body = list(DataObject = body), searchFields = append("UserAuthorizationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAPIUsageHistory <- function(APIUsageHistoryID, UsageHistoryID = F, UserAccessID = F, APIType = F, Url = F, HttpMethod = F, EntityID = F, SchoolYearID = F, FiscalYearID = F, HostAddress = F, ServerResponseTimeInMilliseconds = F, ResponseSize = F, HttpStatusCode = F, LogID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "UsageHistory", objectId = APIUsageHistoryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAPIUsageHistory <- function(APIUsageHistoryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "UsageHistory", objectId = APIUsageHistoryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAPIUsageHistory <- function(UserAccessID = NULL, APIType = NULL, Url = NULL, HttpMethod = NULL, EntityID = NULL, SchoolYearID = NULL, FiscalYearID = NULL, HostAddress = NULL, ServerResponseTimeInMilliseconds = NULL, ResponseSize = NULL, HttpStatusCode = NULL, LogID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "UsageHistory", body = list(DataObject = body), searchFields = append("UsageHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyAPIUsageHistory <- function(UsageHistoryID, UserAccessID = NULL, APIType = NULL, Url = NULL, HttpMethod = NULL, EntityID = NULL, SchoolYearID = NULL, FiscalYearID = NULL, HostAddress = NULL, ServerResponseTimeInMilliseconds = NULL, ResponseSize = NULL, HttpStatusCode = NULL, LogID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "API", objectName = "UsageHistory", objectId = UsageHistoryID, body = list(DataObject = body), searchFields = append("UsageHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAPIUser <- function(APIUserID, UserID = F, Name = F, ConsumerKey = F, UserIDSecurity = F, ConsumerSecret = F, IsActive = F, AuthenticationType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "User", objectId = APIUserID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAPIUser <- function(APIUserID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "User", objectId = APIUserID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAPIUser <- function(Name = NULL, ConsumerKey = NULL, UserIDSecurity = NULL, IsActive = NULL, AuthenticationType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "User", body = list(DataObject = body), searchFields = append("UserID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAPIUser <- function(UserID, Name = NULL, ConsumerKey = NULL, UserIDSecurity = NULL, IsActive = NULL, AuthenticationType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "User", objectId = UserID, body = list(DataObject = body), searchFields = append("UserID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIdentificationEnrollment <- function(IdentificationEnrollmentID, UserID = F, IdentificationApplicationID = F, Type = F, Group = F, DataType = F, AuthenticationData = F, BiometricData = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "IdentificationEnrollment", objectId = IdentificationEnrollmentID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIdentificationEnrollment <- function(IdentificationEnrollmentID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "IdentificationEnrollment", objectId = IdentificationEnrollmentID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIdentificationEnrollment <- function(UserID = NULL, IdentificationApplicationID = NULL, Type = NULL, Group = NULL, DataType = NULL, AuthenticationData = NULL, BiometricData = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "IdentificationEnrollment", body = list(DataObject = body), searchFields = append("IdentificationEnrollmentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIdentificationEnrollment <- function(IdentificationEnrollmentID, UserID = NULL, IdentificationApplicationID = NULL, Type = NULL, Group = NULL, DataType = NULL, AuthenticationData = NULL, BiometricData = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "IdentificationEnrollment", objectId = IdentificationEnrollmentID, body = list(DataObject = body), searchFields = append("IdentificationEnrollmentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIdentificationApplication <- function(IdentificationApplicationID, Name = F, Description = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "IdentificationApplication", objectId = IdentificationApplicationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIdentificationApplication <- function(IdentificationApplicationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "IdentificationApplication", objectId = IdentificationApplicationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIdentificationApplication <- function(Name = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "IdentificationApplication", body = list(DataObject = body), searchFields = append("IdentificationApplicationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIdentificationApplication <- function(IdentificationApplicationID, Name = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "IdentificationApplication", objectId = IdentificationApplicationID, body = list(DataObject = body), searchFields = append("IdentificationApplicationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIdentificationConfig <- function(IdentificationConfigID, IdentificationApplicationID = F, BiometricDataMaxBytes = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "IdentificationConfig", objectId = IdentificationConfigID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIdentificationConfig <- function(IdentificationConfigID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "IdentificationConfig", objectId = IdentificationConfigID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIdentificationConfig <- function(IdentificationApplicationID = NULL, BiometricDataMaxBytes = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "IdentificationConfig", body = list(DataObject = body), searchFields = append("IdentificationConfigID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIdentificationConfig <- function(IdentificationConfigID, IdentificationApplicationID = NULL, BiometricDataMaxBytes = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "IdentificationConfig", objectId = IdentificationConfigID, body = list(DataObject = body), searchFields = append("IdentificationConfigID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIdentificationUserParameter <- function(IdentificationUserParameterID, UserID = F, IdentificationApplicationID = F, Name = F, Value = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "IdentificationUserParameter", objectId = IdentificationUserParameterID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIdentificationUserParameter <- function(IdentificationUserParameterID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "IdentificationUserParameter", objectId = IdentificationUserParameterID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIdentificationUserParameter <- function(UserID = NULL, IdentificationApplicationID = NULL, Name = NULL, Value = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "IdentificationUserParameter", body = list(DataObject = body), searchFields = append("IdentificationUserParameterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIdentificationUserParameter <- function(IdentificationUserParameterID, UserID = NULL, IdentificationApplicationID = NULL, Name = NULL, Value = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "IdentificationUserParameter", objectId = IdentificationUserParameterID, body = list(DataObject = body), searchFields = append("IdentificationUserParameterID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTimeTrackingConfig <- function(TimeTrackingConfigID, DistrictID = F, BuildingID = F, IPAddress = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Code = F, Description = F, CodeDescription = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "TimeTrackingConfig", objectId = TimeTrackingConfigID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTimeTrackingConfig <- function(TimeTrackingConfigID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "TimeTrackingConfig", objectId = TimeTrackingConfigID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTimeTrackingConfig <- function(DistrictID = NULL, BuildingID = NULL, IPAddress = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "TimeTrackingConfig", body = list(DataObject = body), searchFields = append("TimeTrackingConfigID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTimeTrackingConfig <- function(TimeTrackingConfigID, DistrictID = NULL, BuildingID = NULL, IPAddress = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "TimeTrackingConfig", objectId = TimeTrackingConfigID, body = list(DataObject = body), searchFields = append("TimeTrackingConfigID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getOneRosterConfig <- function(OneRosterConfigID, OneRosterVendorID = F, AllowGradePassBack = F, UserAccessCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Code = F, Description = F, CodeDescription = F, DistrictID = F, DefaultCategoryCode = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "OneRosterConfig", objectId = OneRosterConfigID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteOneRosterConfig <- function(OneRosterConfigID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "OneRosterConfig", objectId = OneRosterConfigID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createOneRosterConfig <- function(OneRosterVendorID = NULL, AllowGradePassBack = NULL, Code = NULL, Description = NULL, DistrictID = NULL, DefaultCategoryCode = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "OneRosterConfig", body = list(DataObject = body), searchFields = append("OneRosterConfigID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyOneRosterConfig <- function(OneRosterConfigID, OneRosterVendorID = NULL, AllowGradePassBack = NULL, Code = NULL, Description = NULL, DistrictID = NULL, DefaultCategoryCode = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "OneRosterConfig", objectId = OneRosterConfigID, body = list(DataObject = body), searchFields = append("OneRosterConfigID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getOneRosterVendor <- function(OneRosterVendorID, Name = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "OneRosterVendor", objectId = OneRosterVendorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteOneRosterVendor <- function(OneRosterVendorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "OneRosterVendor", objectId = OneRosterVendorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createOneRosterVendor <- function(Name = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "OneRosterVendor", body = list(DataObject = body), searchFields = append("OneRosterVendorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyOneRosterVendor <- function(OneRosterVendorID, Name = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "OneRosterVendor", objectId = OneRosterVendorID, body = list(DataObject = body), searchFields = append("OneRosterVendorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getIdentificationApplicationAdmin <- function(IdentificationApplicationAdminID, UserID = F, IdentificationApplicationID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "IdentificationApplicationAdmin", objectId = IdentificationApplicationAdminID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIdentificationApplicationAdmin <- function(IdentificationApplicationAdminID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "IdentificationApplicationAdmin", objectId = IdentificationApplicationAdminID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIdentificationApplicationAdmin <- function(UserID = NULL, IdentificationApplicationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "IdentificationApplicationAdmin", body = list(DataObject = body), searchFields = append("IdentificationApplicationAdminID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIdentificationApplicationAdmin <- function(IdentificationApplicationAdminID, UserID = NULL, IdentificationApplicationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "IdentificationApplicationAdmin", objectId = IdentificationApplicationAdminID, body = list(DataObject = body), searchFields = append("IdentificationApplicationAdminID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEdFiApplication <- function(EdFiApplicationID, DistrictID = F, Name = F, NumericYear = F, Key = F, Secret = F, IsEnabled = F, ProcessEvents = F, ReportingType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, HasRunningMassSend = F, RetainMessageQueueRecordsFor = F, LiveURI = F, SandboxURI = F, GPAMethodID = F, GPABucketID = F, EarnedCreditsMethodIDOverride = F, GradeSendOption = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "EdFiApplication", objectId = EdFiApplicationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEdFiApplication <- function(EdFiApplicationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "EdFiApplication", objectId = EdFiApplicationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createEdFiApplication <- function(DistrictID = NULL, Name = NULL, NumericYear = NULL, IsEnabled = NULL, ProcessEvents = NULL, ReportingType = NULL, RetainMessageQueueRecordsFor = NULL, LiveURI = NULL, SandboxURI = NULL, GPAMethodID = NULL, GPABucketID = NULL, EarnedCreditsMethodIDOverride = NULL, GradeSendOption = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "API", objectName = "EdFiApplication", body = list(DataObject = body), searchFields = append("EdFiApplicationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyEdFiApplication <- function(EdFiApplicationID, DistrictID = NULL, Name = NULL, NumericYear = NULL, IsEnabled = NULL, ProcessEvents = NULL, ReportingType = NULL, RetainMessageQueueRecordsFor = NULL, LiveURI = NULL, SandboxURI = NULL, GPAMethodID = NULL, GPABucketID = NULL, EarnedCreditsMethodIDOverride = NULL, GradeSendOption = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "API", objectName = "EdFiApplication", objectId = EdFiApplicationID, body = list(DataObject = body), searchFields = append("EdFiApplicationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEdFiMessageQueue <- function(EdFiMessageQueueID, EdFiApplicationID = F, EdFiLogID = F, IsFromSyncProcess = F, EdFiRecordTypeName = F, Status = F, RequestHTTPMethodType = F, Payload = F, RequestSentTime = F, ResponseHTTPStatus = F, ResponseReceivedTime = F, ResponsePayload = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SkipEdFiLogUpdateOnResponse = F, EdFiRecordID = F, SentToSandbox = F, SortOrder = F, DisablePooling = F, PayloadDisplay = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "EdFiMessageQueue", objectId = EdFiMessageQueueID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEdFiMessageQueue <- function(EdFiMessageQueueID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "EdFiMessageQueue", objectId = EdFiMessageQueueID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createEdFiMessageQueue <- function(EdFiApplicationID = NULL, EdFiLogID = NULL, IsFromSyncProcess = NULL, EdFiRecordTypeName = NULL, Status = NULL, RequestHTTPMethodType = NULL, RequestSentTime = NULL, ResponseHTTPStatus = NULL, ResponseReceivedTime = NULL, ResponsePayload = NULL, SkipEdFiLogUpdateOnResponse = NULL, EdFiRecordID = NULL, SentToSandbox = NULL, DisablePooling = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "API", objectName = "EdFiMessageQueue", body = list(DataObject = body), searchFields = append("EdFiMessageQueueID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyEdFiMessageQueue <- function(EdFiMessageQueueID, EdFiApplicationID = NULL, EdFiLogID = NULL, IsFromSyncProcess = NULL, EdFiRecordTypeName = NULL, Status = NULL, RequestHTTPMethodType = NULL, RequestSentTime = NULL, ResponseHTTPStatus = NULL, ResponseReceivedTime = NULL, ResponsePayload = NULL, SkipEdFiLogUpdateOnResponse = NULL, EdFiRecordID = NULL, SentToSandbox = NULL, DisablePooling = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "API", objectName = "EdFiMessageQueue", objectId = EdFiMessageQueueID, body = list(DataObject = body), searchFields = append("EdFiMessageQueueID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEdFiLog <- function(EdFiLogID, EdFiApplicationID = F, ModuleID = F, ObjectID = F, EdFiRecordID = F, EdFiRecordTypeName = F, IsDeleted = F, Payload = F, Status = F, StatusDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SourceKey = F, StudentID = F, NameIDStaff = F, EntityID = F, CourseID = F, SectionID = F, IncidentID = F, ErroredPayload = F, ErrorMessage = F, DBSStatusCode = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "EdFiLog", objectId = EdFiLogID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEdFiLog <- function(EdFiLogID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "EdFiLog", objectId = EdFiLogID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createEdFiLog <- function(EdFiApplicationID = NULL, ModuleID = NULL, ObjectID = NULL, EdFiRecordID = NULL, EdFiRecordTypeName = NULL, IsDeleted = NULL, Payload = NULL, Status = NULL, StatusDescription = NULL, SourceKey = NULL, StudentID = NULL, NameIDStaff = NULL, EntityID = NULL, CourseID = NULL, SectionID = NULL, IncidentID = NULL, ErrorMessage = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "API", objectName = "EdFiLog", body = list(DataObject = body), searchFields = append("EdFiLogID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyEdFiLog <- function(EdFiLogID, EdFiApplicationID = NULL, ModuleID = NULL, ObjectID = NULL, EdFiRecordID = NULL, EdFiRecordTypeName = NULL, IsDeleted = NULL, Payload = NULL, Status = NULL, StatusDescription = NULL, SourceKey = NULL, StudentID = NULL, NameIDStaff = NULL, EntityID = NULL, CourseID = NULL, SectionID = NULL, IncidentID = NULL, ErrorMessage = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "API", objectName = "EdFiLog", objectId = EdFiLogID, body = list(DataObject = body), searchFields = append("EdFiLogID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTableWatchApplication <- function(TableWatchApplicationID, AllowsMultipleInstances = F, IsEnabled = F, ProcessEvents = F, Schema = F, Table = F, Type = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "TableWatchApplication", objectId = TableWatchApplicationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTableWatchApplication <- function(TableWatchApplicationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "TableWatchApplication", objectId = TableWatchApplicationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTableWatchApplication <- function(IsEnabled = NULL, ProcessEvents = NULL, Schema = NULL, Table = NULL, Type = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "TableWatchApplication", body = list(DataObject = body), searchFields = append("TableWatchApplicationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTableWatchApplication <- function(TableWatchApplicationID, IsEnabled = NULL, ProcessEvents = NULL, Schema = NULL, Table = NULL, Type = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "TableWatchApplication", objectId = TableWatchApplicationID, body = list(DataObject = body), searchFields = append("TableWatchApplicationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAttendanceConfig <- function(AttendanceConfigID, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Description = F, Entities = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "AttendanceConfig", objectId = AttendanceConfigID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAttendanceConfig <- function(AttendanceConfigID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "AttendanceConfig", objectId = AttendanceConfigID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAttendanceConfig <- function(Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "AttendanceConfig", body = list(DataObject = body), searchFields = append("AttendanceConfigID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAttendanceConfig <- function(AttendanceConfigID, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "AttendanceConfig", objectId = AttendanceConfigID, body = list(DataObject = body), searchFields = append("AttendanceConfigID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAttendanceConfigEntity <- function(AttendanceConfigEntityID, AttendanceConfigID = F, EntityID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "AttendanceConfigEntity", objectId = AttendanceConfigEntityID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAttendanceConfigEntity <- function(AttendanceConfigEntityID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "AttendanceConfigEntity", objectId = AttendanceConfigEntityID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAttendanceConfigEntity <- function(AttendanceConfigID = NULL, EntityID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "AttendanceConfigEntity", body = list(DataObject = body), searchFields = append("AttendanceConfigEntityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAttendanceConfigEntity <- function(AttendanceConfigEntityID, AttendanceConfigID = NULL, EntityID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "AttendanceConfigEntity", objectId = AttendanceConfigEntityID, body = list(DataObject = body), searchFields = append("AttendanceConfigEntityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEdFiMassSendRunHistory <- function(EdFiMassSendRunHistoryID, EdFiApplicationID = F, StartDateTime = F, EndDateTime = F, Type = F, MediaID = F, ScopeAccessAllowed = F, HasValidMedia = F, CanAccessMedia = F, IsExport = F, IsLocked = F, Status = F, RunData = F, UserIDCanceledBy = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, RunParameters = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "EdFiMassSendRunHistory", objectId = EdFiMassSendRunHistoryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEdFiMassSendRunHistory <- function(EdFiMassSendRunHistoryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "EdFiMassSendRunHistory", objectId = EdFiMassSendRunHistoryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEdFiMassSendRunHistory <- function(EdFiApplicationID = NULL, StartDateTime = NULL, EndDateTime = NULL, Type = NULL, MediaID = NULL, Status = NULL, UserIDCanceledBy = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "EdFiMassSendRunHistory", body = list(DataObject = body), searchFields = append("EdFiMassSendRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEdFiMassSendRunHistory <- function(EdFiMassSendRunHistoryID, EdFiApplicationID = NULL, StartDateTime = NULL, EndDateTime = NULL, Type = NULL, MediaID = NULL, Status = NULL, UserIDCanceledBy = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "EdFiMassSendRunHistory", objectId = EdFiMassSendRunHistoryID, body = list(DataObject = body), searchFields = append("EdFiMassSendRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempEdFiAPISpecialEducationEnrollment <- function(TempEdFiAPISpecialEducationEnrollmentID, StudentID = F, DistrictID = F, SchoolYearID = F, LastName = F, FirstName = F, MiddleName = F, DisabilityCodes = F, UpdateType = F, StartDate = F, EndDate = F, LastEvaluationDate = F, LatestServiceStartDate = F, WISEIDNumber = F, EnrollmentWIID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "TempEdFiAPISpecialEducationEnrollment", objectId = TempEdFiAPISpecialEducationEnrollmentID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempEdFiAPISpecialEducationEnrollment <- function(TempEdFiAPISpecialEducationEnrollmentID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "TempEdFiAPISpecialEducationEnrollment", objectId = TempEdFiAPISpecialEducationEnrollmentID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempEdFiAPISpecialEducationEnrollment <- function(LastName = NULL, FirstName = NULL, MiddleName = NULL, DisabilityCodes = NULL, UpdateType = NULL, StartDate = NULL, EndDate = NULL, LastEvaluationDate = NULL, LatestServiceStartDate = NULL, WISEIDNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "TempEdFiAPISpecialEducationEnrollment", body = list(DataObject = body), searchFields = append("TempEdFiAPISpecialEducationEnrollmentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempEdFiAPISpecialEducationEnrollment <- function(TempEdFiAPISpecialEducationEnrollmentID, LastName = NULL, FirstName = NULL, MiddleName = NULL, DisabilityCodes = NULL, UpdateType = NULL, StartDate = NULL, EndDate = NULL, LastEvaluationDate = NULL, LatestServiceStartDate = NULL, WISEIDNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "API", objectName = "TempEdFiAPISpecialEducationEnrollment", objectId = TempEdFiAPISpecialEducationEnrollmentID, body = list(DataObject = body), searchFields = append("TempEdFiAPISpecialEducationEnrollmentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempEdFiAPISpecialEducationIEPService <- function(TempEdFiAPISpecialEducationIEPServiceID, TempEdFiAPISpecialEducationEnrollmentID = F, UpdateType = F, StartDate = F, EndDate = F, SpecialEducationSettingDescriptor = F, ReasonExitedDescriptor = F, FapeResponsibleSchool = F, IEPServiceWIID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "TempEdFiAPISpecialEducationIEPService", objectId = TempEdFiAPISpecialEducationIEPServiceID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempEdFiAPISpecialEducationIEPService <- function(TempEdFiAPISpecialEducationIEPServiceID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "TempEdFiAPISpecialEducationIEPService", objectId = TempEdFiAPISpecialEducationIEPServiceID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempEdFiAPISpecialEducationIEPService <- function(UpdateType = NULL, StartDate = NULL, EndDate = NULL, SpecialEducationSettingDescriptor = NULL, ReasonExitedDescriptor = NULL, FapeResponsibleSchool = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "TempEdFiAPISpecialEducationIEPService", body = list(DataObject = body), searchFields = append("TempEdFiAPISpecialEducationIEPServiceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempEdFiAPISpecialEducationIEPService <- function(TempEdFiAPISpecialEducationIEPServiceID, UpdateType = NULL, StartDate = NULL, EndDate = NULL, SpecialEducationSettingDescriptor = NULL, ReasonExitedDescriptor = NULL, FapeResponsibleSchool = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "TempEdFiAPISpecialEducationIEPService", objectId = TempEdFiAPISpecialEducationIEPServiceID, body = list(DataObject = body), searchFields = append("TempEdFiAPISpecialEducationIEPServiceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempEdFiLoadSpecialEducationFromAPIError <- function(TempEdFiLoadSpecialEducationFromAPIErrorID, StudentID = F, LastName = F, FirstName = F, MiddleName = F, FailureReason = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "TempEdFiLoadSpecialEducationFromAPIError", objectId = TempEdFiLoadSpecialEducationFromAPIErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempEdFiLoadSpecialEducationFromAPIError <- function(TempEdFiLoadSpecialEducationFromAPIErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "TempEdFiLoadSpecialEducationFromAPIError", objectId = TempEdFiLoadSpecialEducationFromAPIErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempEdFiLoadSpecialEducationFromAPIError <- function(StudentID = NULL, LastName = NULL, FirstName = NULL, MiddleName = NULL, FailureReason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "TempEdFiLoadSpecialEducationFromAPIError", body = list(DataObject = body), searchFields = append("TempEdFiLoadSpecialEducationFromAPIErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempEdFiLoadSpecialEducationFromAPIError <- function(TempEdFiLoadSpecialEducationFromAPIErrorID, StudentID = NULL, LastName = NULL, FirstName = NULL, MiddleName = NULL, FailureReason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	getETranscriptApplication <- function(ETranscriptApplicationID, DistrictID = F, Key = F, Secret = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "ETranscriptApplication", objectId = ETranscriptApplicationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteETranscriptApplication <- function(ETranscriptApplicationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "ETranscriptApplication", objectId = ETranscriptApplicationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createETranscriptApplication <- function(DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "ETranscriptApplication", body = list(DataObject = body), searchFields = append("ETranscriptApplicationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyETranscriptApplication <- function(ETranscriptApplicationID, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "ETranscriptApplication", objectId = ETranscriptApplicationID, body = list(DataObject = body), searchFields = append("ETranscriptApplicationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEdFiLocalEducationAgencySchoolProcess <- function(EdFiLocalEducationAgencySchoolProcessID, EdFiApplicationID = F, Process = F, SendOption = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "API", objectName = "EdFiLocalEducationAgencySchoolProcess", objectId = EdFiLocalEducationAgencySchoolProcessID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEdFiLocalEducationAgencySchoolProcess <- function(EdFiLocalEducationAgencySchoolProcessID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "API", objectName = "EdFiLocalEducationAgencySchoolProcess", objectId = EdFiLocalEducationAgencySchoolProcessID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEdFiLocalEducationAgencySchoolProcess <- function(EdFiApplicationID = NULL, Process = NULL, SendOption = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "API", objectName = "EdFiLocalEducationAgencySchoolProcess", body = list(DataObject = body), searchFields = append("EdFiLocalEducationAgencySchoolProcessID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEdFiLocalEducationAgencySchoolProcess <- function(EdFiLocalEducationAgencySchoolProcessID, EdFiApplicationID = NULL, Process = NULL, SendOption = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "API", objectName = "EdFiLocalEducationAgencySchoolProcess", objectId = EdFiLocalEducationAgencySchoolProcessID, body = list(DataObject = body), searchFields = append("EdFiLocalEducationAgencySchoolProcessID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
