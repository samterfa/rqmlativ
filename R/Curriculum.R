	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempGradeRangeCopyResult <- function(TempGradeRangeCopyResultID, AcademicStandardSubjectCode = F, GradeRangeCode = F, IsError = F, ErrorText = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "TempGradeRangeCopyResult", objectId = TempGradeRangeCopyResultID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempGradeRangeCopyResult <- function(TempGradeRangeCopyResultID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "TempGradeRangeCopyResult", objectId = TempGradeRangeCopyResultID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempGradeRangeCopyResult <- function(AcademicStandardSubjectCode = NULL, GradeRangeCode = NULL, IsError = NULL, ErrorText = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "TempGradeRangeCopyResult", body = list(DataObject = body), searchFields = append("TempGradeRangeCopyResultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempGradeRangeCopyResult <- function(TempGradeRangeCopyResultID, AcademicStandardSubjectCode = NULL, GradeRangeCode = NULL, IsError = NULL, ErrorText = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "TempGradeRangeCopyResult", objectId = TempGradeRangeCopyResultID, body = list(DataObject = body), searchFields = append("TempGradeRangeCopyResultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStandardPlacementMN <- function(StandardPlacementMNID, StateStandardCodeMNID = F, CurriculumYearID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "StandardPlacementMN", objectId = StandardPlacementMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStandardPlacementMN <- function(StandardPlacementMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "StandardPlacementMN", objectId = StandardPlacementMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStandardPlacementMN <- function(StateStandardCodeMNID = NULL, CurriculumYearID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "StandardPlacementMN", body = list(DataObject = body), searchFields = append("StandardPlacementMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStandardPlacementMN <- function(StandardPlacementMNID, StateStandardCodeMNID = NULL, CurriculumYearID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "StandardPlacementMN", objectId = StandardPlacementMNID, body = list(DataObject = body), searchFields = append("StandardPlacementMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getCurriculumYear <- function(CurriculumYearID, CurriculumYearMNID = F, StateCourseCodeMNID = F, Description = F, StateStandardAddressedCodeMNID = F, StateSubjectAreaCodeMNID = F, IsGraduationRequirement = F, IsEndOfCourse = F, HasCourseLevels = F, CurriculumID = F, SchoolYearID = F, DistrictGroupKey = F, ReportToFitnessGram = F, IsFederalDistanceEducation = F, IsFederalDualEnrollment = F, FederalSubjectTypeID = F, FederalAdvancedPlacementCourseTypeID = F, CurriculumYearIDClonedFrom = F, CurriculumYearIDClonedTo = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StateSTARAssignmentCodeMNID = F, StateEarlyEducationLocationMNID = F, IsStateProgram = F, IsFederalProgram = F, IsAdultBasicEducation = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "CurriculumYear", objectId = CurriculumYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumYear <- function(CurriculumYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "CurriculumYear", objectId = CurriculumYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createCurriculumYear <- function(StateCourseCodeMNID = NULL, Description = NULL, StateStandardAddressedCodeMNID = NULL, StateSubjectAreaCodeMNID = NULL, IsGraduationRequirement = NULL, IsEndOfCourse = NULL, CurriculumID = NULL, SchoolYearID = NULL, DistrictGroupKey = NULL, ReportToFitnessGram = NULL, IsFederalDistanceEducation = NULL, IsFederalDualEnrollment = NULL, FederalSubjectTypeID = NULL, FederalAdvancedPlacementCourseTypeID = NULL, CurriculumYearIDClonedFrom = NULL, StateSTARAssignmentCodeMNID = NULL, StateEarlyEducationLocationMNID = NULL, IsStateProgram = NULL, IsFederalProgram = NULL, IsAdultBasicEducation = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Curriculum", objectName = "CurriculumYear", body = list(DataObject = body), searchFields = append("CurriculumYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyCurriculumYear <- function(CurriculumYearID, StateCourseCodeMNID = NULL, Description = NULL, StateStandardAddressedCodeMNID = NULL, StateSubjectAreaCodeMNID = NULL, IsGraduationRequirement = NULL, IsEndOfCourse = NULL, CurriculumID = NULL, SchoolYearID = NULL, DistrictGroupKey = NULL, ReportToFitnessGram = NULL, IsFederalDistanceEducation = NULL, IsFederalDualEnrollment = NULL, FederalSubjectTypeID = NULL, FederalAdvancedPlacementCourseTypeID = NULL, CurriculumYearIDClonedFrom = NULL, StateSTARAssignmentCodeMNID = NULL, StateEarlyEducationLocationMNID = NULL, IsStateProgram = NULL, IsFederalProgram = NULL, IsAdultBasicEducation = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Curriculum", objectName = "CurriculumYear", objectId = CurriculumYearID, body = list(DataObject = body), searchFields = append("CurriculumYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAcademicStandardHierarchyDepth <- function(AcademicStandardHierarchyDepthID, DistrictGroupKey = F, AcademicStandardID = F, HierarchyDepthID = F, AcademicStandardIDAtLevel = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandardHierarchyDepth", objectId = AcademicStandardHierarchyDepthID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandardHierarchyDepth <- function(AcademicStandardHierarchyDepthID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandardHierarchyDepth", objectId = AcademicStandardHierarchyDepthID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAcademicStandardHierarchyDepth <- function(DistrictGroupKey = NULL, AcademicStandardID = NULL, HierarchyDepthID = NULL, AcademicStandardIDAtLevel = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "AcademicStandardHierarchyDepth", body = list(DataObject = body), searchFields = append("AcademicStandardHierarchyDepthID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAcademicStandardHierarchyDepth <- function(AcademicStandardHierarchyDepthID, DistrictGroupKey = NULL, AcademicStandardID = NULL, HierarchyDepthID = NULL, AcademicStandardIDAtLevel = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "AcademicStandardHierarchyDepth", objectId = AcademicStandardHierarchyDepthID, body = list(DataObject = body), searchFields = append("AcademicStandardHierarchyDepthID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getCurriculumCurriculumSubject <- function(CurriculumCurriculumSubjectID, CurriculumSubjectID = F, DistrictGroupKey = F, CurriculumID = F, SubjectID = F, NumberOfAttachedCurriculumAcademicStandards = F, IsDefault = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, CurriculumSubjectIDClonedFrom = F, CurriculumSubjectIDClonedTo = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "CurriculumSubject", objectId = CurriculumCurriculumSubjectID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumCurriculumSubject <- function(CurriculumCurriculumSubjectID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "CurriculumSubject", objectId = CurriculumCurriculumSubjectID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurriculumCurriculumSubject <- function(DistrictGroupKey = NULL, CurriculumID = NULL, SubjectID = NULL, IsDefault = NULL, CurriculumSubjectIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "CurriculumSubject", body = list(DataObject = body), searchFields = append("CurriculumSubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurriculumCurriculumSubject <- function(CurriculumSubjectID, DistrictGroupKey = NULL, CurriculumID = NULL, SubjectID = NULL, IsDefault = NULL, CurriculumSubjectIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "CurriculumSubject", objectId = CurriculumSubjectID, body = list(DataObject = body), searchFields = append("CurriculumSubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCurriculumSubjectAcademicStandard <- function(CurriculumSubjectAcademicStandardID, CurriculumAcademicStandardID = F, CurriculumSubjectID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "CurriculumSubjectAcademicStandard", objectId = CurriculumSubjectAcademicStandardID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumSubjectAcademicStandard <- function(CurriculumSubjectAcademicStandardID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "CurriculumSubjectAcademicStandard", objectId = CurriculumSubjectAcademicStandardID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurriculumSubjectAcademicStandard <- function(CurriculumAcademicStandardID = NULL, CurriculumSubjectID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "CurriculumSubjectAcademicStandard", body = list(DataObject = body), searchFields = append("CurriculumSubjectAcademicStandardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurriculumSubjectAcademicStandard <- function(CurriculumSubjectAcademicStandardID, CurriculumAcademicStandardID = NULL, CurriculumSubjectID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "CurriculumSubjectAcademicStandard", objectId = CurriculumSubjectAcademicStandardID, body = list(DataObject = body), searchFields = append("CurriculumSubjectAcademicStandardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getHierarchyDepth <- function(HierarchyDepthID, DistrictGroupKey = F, AcademicStandardSetID = F, Code = F, Description = F, DepthLevel = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DynamicRelationshipID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "HierarchyDepth", objectId = HierarchyDepthID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteHierarchyDepth <- function(HierarchyDepthID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "HierarchyDepth", objectId = HierarchyDepthID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createHierarchyDepth <- function(DistrictGroupKey = NULL, AcademicStandardSetID = NULL, Code = NULL, Description = NULL, DepthLevel = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "HierarchyDepth", body = list(DataObject = body), searchFields = append("HierarchyDepthID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyHierarchyDepth <- function(HierarchyDepthID, DistrictGroupKey = NULL, AcademicStandardSetID = NULL, Code = NULL, Description = NULL, DepthLevel = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "HierarchyDepth", objectId = HierarchyDepthID, body = list(DataObject = body), searchFields = append("HierarchyDepthID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempHierarchyDepth <- function(TempHierarchyDepthID, Code = F, Description = F, DepthLevel = F, AcademicStandardSetCode = F, AcademicStandardSetDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "TempHierarchyDepth", objectId = TempHierarchyDepthID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempHierarchyDepth <- function(TempHierarchyDepthID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "TempHierarchyDepth", objectId = TempHierarchyDepthID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempHierarchyDepth <- function(Code = NULL, Description = NULL, DepthLevel = NULL, AcademicStandardSetCode = NULL, AcademicStandardSetDescription = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "TempHierarchyDepth", body = list(DataObject = body), searchFields = append("TempHierarchyDepthID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempHierarchyDepth <- function(TempHierarchyDepthID, Code = NULL, Description = NULL, DepthLevel = NULL, AcademicStandardSetCode = NULL, AcademicStandardSetDescription = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "TempHierarchyDepth", objectId = TempHierarchyDepthID, body = list(DataObject = body), searchFields = append("TempHierarchyDepthID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getPrerequisiteCurriculum <- function(PrerequisiteCurriculumID, CurriculumIDRequired = F, PrerequisiteID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "PrerequisiteCurriculum", objectId = PrerequisiteCurriculumID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePrerequisiteCurriculum <- function(PrerequisiteCurriculumID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "PrerequisiteCurriculum", objectId = PrerequisiteCurriculumID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPrerequisiteCurriculum <- function(CurriculumIDRequired = NULL, PrerequisiteID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "PrerequisiteCurriculum", body = list(DataObject = body), searchFields = append("PrerequisiteCurriculumID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPrerequisiteCurriculum <- function(PrerequisiteCurriculumID, CurriculumIDRequired = NULL, PrerequisiteID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "PrerequisiteCurriculum", objectId = PrerequisiteCurriculumID, body = list(DataObject = body), searchFields = append("PrerequisiteCurriculumID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempAcademicStandard <- function(TempAcademicStandardID, Label = F, StateNumber = F, Level = F, IsPlaceHolder = F, Description = F, ExtendedDescription = F, Sequence = F, Guid = F, ParentGuid = F, TempAcademicStandardGradeRangeID = F, TempAcademicStandardIDParent = F, TempAcademicStandardSetID = F, ImportedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Key = F, EnteredByDistrict = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "TempAcademicStandard", objectId = TempAcademicStandardID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempAcademicStandard <- function(TempAcademicStandardID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "TempAcademicStandard", objectId = TempAcademicStandardID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempAcademicStandard <- function(Label = NULL, StateNumber = NULL, Level = NULL, IsPlaceHolder = NULL, Description = NULL, ExtendedDescription = NULL, Sequence = NULL, Guid = NULL, ParentGuid = NULL, TempAcademicStandardGradeRangeID = NULL, TempAcademicStandardIDParent = NULL, TempAcademicStandardSetID = NULL, ImportedFrom = NULL, Key = NULL, EnteredByDistrict = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Curriculum", objectName = "TempAcademicStandard", body = list(DataObject = body), searchFields = append("TempAcademicStandardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempAcademicStandard <- function(TempAcademicStandardID, Label = NULL, StateNumber = NULL, Level = NULL, IsPlaceHolder = NULL, Description = NULL, ExtendedDescription = NULL, Sequence = NULL, Guid = NULL, ParentGuid = NULL, TempAcademicStandardGradeRangeID = NULL, TempAcademicStandardIDParent = NULL, TempAcademicStandardSetID = NULL, ImportedFrom = NULL, Key = NULL, EnteredByDistrict = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Curriculum", objectName = "TempAcademicStandard", objectId = TempAcademicStandardID, body = list(DataObject = body), searchFields = append("TempAcademicStandardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempAcademicStandardGradeRange <- function(TempAcademicStandardGradeRangeID, Code = F, Description = F, GradeRangeLow = F, GradeRangeHigh = F, Sequence = F, Guid = F, TempAcademicStandardSubjectID = F, ImportedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EnteredByDistrict = F, Key = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "TempAcademicStandardGradeRange", objectId = TempAcademicStandardGradeRangeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempAcademicStandardGradeRange <- function(TempAcademicStandardGradeRangeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "TempAcademicStandardGradeRange", objectId = TempAcademicStandardGradeRangeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempAcademicStandardGradeRange <- function(Code = NULL, Description = NULL, GradeRangeLow = NULL, GradeRangeHigh = NULL, Sequence = NULL, Guid = NULL, TempAcademicStandardSubjectID = NULL, ImportedFrom = NULL, EnteredByDistrict = NULL, Key = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "TempAcademicStandardGradeRange", body = list(DataObject = body), searchFields = append("TempAcademicStandardGradeRangeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempAcademicStandardGradeRange <- function(TempAcademicStandardGradeRangeID, Code = NULL, Description = NULL, GradeRangeLow = NULL, GradeRangeHigh = NULL, Sequence = NULL, Guid = NULL, TempAcademicStandardSubjectID = NULL, ImportedFrom = NULL, EnteredByDistrict = NULL, Key = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Curriculum", objectName = "TempAcademicStandardGradeRange", objectId = TempAcademicStandardGradeRangeID, body = list(DataObject = body), searchFields = append("TempAcademicStandardGradeRangeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempAcademicStandardSet <- function(TempAcademicStandardSetID, Code = F, Description = F, IsActive = F, StateCode = F, ImportedFrom = F, DistrictID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EnteredByDistrict = F, Key = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "TempAcademicStandardSet", objectId = TempAcademicStandardSetID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempAcademicStandardSet <- function(TempAcademicStandardSetID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "TempAcademicStandardSet", objectId = TempAcademicStandardSetID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempAcademicStandardSet <- function(Code = NULL, Description = NULL, IsActive = NULL, StateCode = NULL, ImportedFrom = NULL, DistrictID = NULL, EnteredByDistrict = NULL, Key = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "TempAcademicStandardSet", body = list(DataObject = body), searchFields = append("TempAcademicStandardSetID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempAcademicStandardSet <- function(TempAcademicStandardSetID, Code = NULL, Description = NULL, IsActive = NULL, StateCode = NULL, ImportedFrom = NULL, DistrictID = NULL, EnteredByDistrict = NULL, Key = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "TempAcademicStandardSet", objectId = TempAcademicStandardSetID, body = list(DataObject = body), searchFields = append("TempAcademicStandardSetID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempAcademicStandardSubject <- function(TempAcademicStandardSubjectID, Code = F, Description = F, Year = F, Sequence = F, TempAcademicStandardSetID = F, ImportedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EnteredByDistrict = F, Key = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "TempAcademicStandardSubject", objectId = TempAcademicStandardSubjectID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempAcademicStandardSubject <- function(TempAcademicStandardSubjectID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "TempAcademicStandardSubject", objectId = TempAcademicStandardSubjectID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempAcademicStandardSubject <- function(Code = NULL, Description = NULL, Year = NULL, Sequence = NULL, TempAcademicStandardSetID = NULL, ImportedFrom = NULL, EnteredByDistrict = NULL, Key = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "TempAcademicStandardSubject", body = list(DataObject = body), searchFields = append("TempAcademicStandardSubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempAcademicStandardSubject <- function(TempAcademicStandardSubjectID, Code = NULL, Description = NULL, Year = NULL, Sequence = NULL, TempAcademicStandardSetID = NULL, ImportedFrom = NULL, EnteredByDistrict = NULL, Key = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "TempAcademicStandardSubject", objectId = TempAcademicStandardSubjectID, body = list(DataObject = body), searchFields = append("TempAcademicStandardSubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCurriculumGradeLevel <- function(CurriculumGradeLevelID, CurriculumID = F, GradeLevelID = F, DistrictGroupKey = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "CurriculumGradeLevel", objectId = CurriculumGradeLevelID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumGradeLevel <- function(CurriculumGradeLevelID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "CurriculumGradeLevel", objectId = CurriculumGradeLevelID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurriculumGradeLevel <- function(CurriculumID = NULL, GradeLevelID = NULL, DistrictGroupKey = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "CurriculumGradeLevel", body = list(DataObject = body), searchFields = append("CurriculumGradeLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurriculumGradeLevel <- function(CurriculumGradeLevelID, CurriculumID = NULL, GradeLevelID = NULL, DistrictGroupKey = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "CurriculumGradeLevel", objectId = CurriculumGradeLevelID, body = list(DataObject = body), searchFields = append("CurriculumGradeLevelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAcademicStandardSet <- function(AcademicStandardSetID, DistrictID = F, DistrictGroupKey = F, Code = F, Description = F, IsActive = F, StateCode = F, EnteredByDistrict = F, Key = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AcademicStandardSetDefaultID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandardSet", objectId = AcademicStandardSetID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandardSet <- function(AcademicStandardSetID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandardSet", objectId = AcademicStandardSetID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAcademicStandardSet <- function(DistrictID = NULL, DistrictGroupKey = NULL, Code = NULL, Description = NULL, IsActive = NULL, StateCode = NULL, EnteredByDistrict = NULL, Key = NULL, AcademicStandardSetDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "AcademicStandardSet", body = list(DataObject = body), searchFields = append("AcademicStandardSetID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAcademicStandardSet <- function(AcademicStandardSetID, DistrictID = NULL, DistrictGroupKey = NULL, Code = NULL, Description = NULL, IsActive = NULL, StateCode = NULL, EnteredByDistrict = NULL, Key = NULL, AcademicStandardSetDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "AcademicStandardSet", objectId = AcademicStandardSetID, body = list(DataObject = body), searchFields = append("AcademicStandardSetID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAcademicStandardSubject <- function(AcademicStandardSubjectID, DistrictGroupKey = F, AcademicStandardSetID = F, Code = F, Description = F, Year = F, Sequence = F, EnteredByDistrict = F, Key = F, FullKeyPrefix = F, FullKey = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AcademicStandardSubjectDefaultID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandardSubject", objectId = AcademicStandardSubjectID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandardSubject <- function(AcademicStandardSubjectID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandardSubject", objectId = AcademicStandardSubjectID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAcademicStandardSubject <- function(DistrictGroupKey = NULL, AcademicStandardSetID = NULL, Code = NULL, Description = NULL, Year = NULL, Sequence = NULL, EnteredByDistrict = NULL, Key = NULL, AcademicStandardSubjectDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "AcademicStandardSubject", body = list(DataObject = body), searchFields = append("AcademicStandardSubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAcademicStandardSubject <- function(AcademicStandardSubjectID, DistrictGroupKey = NULL, AcademicStandardSetID = NULL, Code = NULL, Description = NULL, Year = NULL, Sequence = NULL, EnteredByDistrict = NULL, Key = NULL, AcademicStandardSubjectDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "AcademicStandardSubject", objectId = AcademicStandardSubjectID, body = list(DataObject = body), searchFields = append("AcademicStandardSubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAcademicStandardGradeRange <- function(AcademicStandardGradeRangeID, DistrictGroupKey = F, AcademicStandardSubjectID = F, Code = F, Description = F, GradeRangeLow = F, GradeRangeHigh = F, Sequence = F, Guid = F, EnteredByDistrict = F, Key = F, FullKey = F, FullKeyPrefix = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AcademicStandardGradeRangeDefaultID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandardGradeRange", objectId = AcademicStandardGradeRangeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandardGradeRange <- function(AcademicStandardGradeRangeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandardGradeRange", objectId = AcademicStandardGradeRangeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createAcademicStandardGradeRange <- function(DistrictGroupKey = NULL, AcademicStandardSubjectID = NULL, Code = NULL, Description = NULL, GradeRangeLow = NULL, GradeRangeHigh = NULL, Sequence = NULL, Guid = NULL, EnteredByDistrict = NULL, Key = NULL, AcademicStandardGradeRangeDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Curriculum", objectName = "AcademicStandardGradeRange", body = list(DataObject = body), searchFields = append("AcademicStandardGradeRangeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyAcademicStandardGradeRange <- function(AcademicStandardGradeRangeID, DistrictGroupKey = NULL, AcademicStandardSubjectID = NULL, Code = NULL, Description = NULL, GradeRangeLow = NULL, GradeRangeHigh = NULL, Sequence = NULL, Guid = NULL, EnteredByDistrict = NULL, Key = NULL, AcademicStandardGradeRangeDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Curriculum", objectName = "AcademicStandardGradeRange", objectId = AcademicStandardGradeRangeID, body = list(DataObject = body), searchFields = append("AcademicStandardGradeRangeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAcademicStandard <- function(AcademicStandardID, DistrictGroupKey = F, AcademicStandardGradeRangeID = F, Label = F, StateNumber = F, Level = F, IsPlaceHolder = F, Description = F, ExtendedDescription = F, Sequence = F, Guid = F, ParentGuid = F, AcademicStandardIDParent = F, EnteredByDistrict = F, Key = F, DisplayAs = F, DescriptionToUse = F, IsAttachedToASubject = F, FullKeyPrefix = F, FullKey = F, HierarchyDepthDescription = F, NextLevelHierarchyDepthDescription = F, GrandChildLevelHierarchyDepthDescription = F, ChildAcademicStandardCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsHighFrequencyWord = F, LetterAndSoundType = F, LetterType = F, AcademicStandardDefaultID = F, IsLettersAndSounds = F, BackgroundColor = F, TextColor = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandard", objectId = AcademicStandardID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandard <- function(AcademicStandardID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandard", objectId = AcademicStandardID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createAcademicStandard <- function(DistrictGroupKey = NULL, AcademicStandardGradeRangeID = NULL, Label = NULL, StateNumber = NULL, Level = NULL, IsPlaceHolder = NULL, Description = NULL, ExtendedDescription = NULL, Sequence = NULL, Guid = NULL, ParentGuid = NULL, AcademicStandardIDParent = NULL, EnteredByDistrict = NULL, Key = NULL, DisplayAs = NULL, IsHighFrequencyWord = NULL, LetterAndSoundType = NULL, LetterType = NULL, AcademicStandardDefaultID = NULL, BackgroundColor = NULL, TextColor = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Curriculum", objectName = "AcademicStandard", body = list(DataObject = body), searchFields = append("AcademicStandardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyAcademicStandard <- function(AcademicStandardID, DistrictGroupKey = NULL, AcademicStandardGradeRangeID = NULL, Label = NULL, StateNumber = NULL, Level = NULL, IsPlaceHolder = NULL, Description = NULL, ExtendedDescription = NULL, Sequence = NULL, Guid = NULL, ParentGuid = NULL, AcademicStandardIDParent = NULL, EnteredByDistrict = NULL, Key = NULL, DisplayAs = NULL, IsHighFrequencyWord = NULL, LetterAndSoundType = NULL, LetterType = NULL, AcademicStandardDefaultID = NULL, BackgroundColor = NULL, TextColor = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Curriculum", objectName = "AcademicStandard", objectId = AcademicStandardID, body = list(DataObject = body), searchFields = append("AcademicStandardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCurriculumAcademicStandard <- function(CurriculumAcademicStandardID, DistrictGroupKey = F, AcademicStandardID = F, CurriculumID = F, IsGraded = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "CurriculumAcademicStandard", objectId = CurriculumAcademicStandardID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumAcademicStandard <- function(CurriculumAcademicStandardID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "CurriculumAcademicStandard", objectId = CurriculumAcademicStandardID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurriculumAcademicStandard <- function(DistrictGroupKey = NULL, AcademicStandardID = NULL, CurriculumID = NULL, IsGraded = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "CurriculumAcademicStandard", body = list(DataObject = body), searchFields = append("CurriculumAcademicStandardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurriculumAcademicStandard <- function(CurriculumAcademicStandardID, DistrictGroupKey = NULL, AcademicStandardID = NULL, CurriculumID = NULL, IsGraded = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "CurriculumAcademicStandard", objectId = CurriculumAcademicStandardID, body = list(DataObject = body), searchFields = append("CurriculumAcademicStandardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCurriculumCustomRequirement <- function(CurriculumCustomRequirementID, CustomRequirementID = F, CurriculumID = F, SchoolYearLow = F, SchoolYearHigh = F, DistrictGroupKey = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "CurriculumCustomRequirement", objectId = CurriculumCustomRequirementID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumCustomRequirement <- function(CurriculumCustomRequirementID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "CurriculumCustomRequirement", objectId = CurriculumCustomRequirementID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurriculumCustomRequirement <- function(CustomRequirementID = NULL, CurriculumID = NULL, SchoolYearLow = NULL, SchoolYearHigh = NULL, DistrictGroupKey = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "CurriculumCustomRequirement", body = list(DataObject = body), searchFields = append("CurriculumCustomRequirementID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurriculumCustomRequirement <- function(CurriculumCustomRequirementID, CustomRequirementID = NULL, CurriculumID = NULL, SchoolYearLow = NULL, SchoolYearHigh = NULL, DistrictGroupKey = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "CurriculumCustomRequirement", objectId = CurriculumCustomRequirementID, body = list(DataObject = body), searchFields = append("CurriculumCustomRequirementID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getPrerequisite <- function(PrerequisiteID, CurriculumID = F, Code = F, Description = F, SchoolYearLow = F, SchoolYearHigh = F, DistrictGroupKey = F, CodeDescription = F, EarnedCredits = F, HasPrerequisiteCurriculums = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "Prerequisite", objectId = PrerequisiteID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deletePrerequisite <- function(PrerequisiteID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "Prerequisite", objectId = PrerequisiteID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createPrerequisite <- function(CurriculumID = NULL, Code = NULL, Description = NULL, SchoolYearLow = NULL, SchoolYearHigh = NULL, DistrictGroupKey = NULL, EarnedCredits = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "Prerequisite", body = list(DataObject = body), searchFields = append("PrerequisiteID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyPrerequisite <- function(PrerequisiteID, CurriculumID = NULL, Code = NULL, Description = NULL, SchoolYearLow = NULL, SchoolYearHigh = NULL, DistrictGroupKey = NULL, EarnedCredits = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "Prerequisite", objectId = PrerequisiteID, body = list(DataObject = body), searchFields = append("PrerequisiteID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getCurriculum <- function(CurriculumID, Code = F, Description = F, IsActive = F, DistrictID = F, DistrictGroupKey = F, CodeDescription = F, NumberOfActiveCurrentOrFutureCourses = F, CurriculumSubAreaExistsForSubAreaWithoutStudent = F, CurriculumSubAreaExistsForStudentAndSubArea = F, PrerequisiteCurriculumExistsForPrerequisite = F, HasPrerequisites = F, HasPrerequisiteCurriculums = F, NumberOfAttachedSubjects = F, CurriculumSubjectSummary = F, IsFederalDistanceEducation = F, IsFederalDualEnrollment = F, GradeLevelSummary = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EarnedCredits = F, IsAllowedToBeSelectedInCareerPlan = F, GradReqSubjectTypeID = F, GradReqRankGPAIgnoreDuplicateCheck = F, MaximumCompletionsForCredit = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "Curriculum", objectId = CurriculumID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculum <- function(CurriculumID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "Curriculum", objectId = CurriculumID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createCurriculum <- function(Code = NULL, Description = NULL, IsActive = NULL, DistrictID = NULL, DistrictGroupKey = NULL, EarnedCredits = NULL, IsAllowedToBeSelectedInCareerPlan = NULL, GradReqSubjectTypeID = NULL, GradReqRankGPAIgnoreDuplicateCheck = NULL, MaximumCompletionsForCredit = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Curriculum", objectName = "Curriculum", body = list(DataObject = body), searchFields = append("CurriculumID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyCurriculum <- function(CurriculumID, Code = NULL, Description = NULL, IsActive = NULL, DistrictID = NULL, DistrictGroupKey = NULL, EarnedCredits = NULL, IsAllowedToBeSelectedInCareerPlan = NULL, GradReqSubjectTypeID = NULL, GradReqRankGPAIgnoreDuplicateCheck = NULL, MaximumCompletionsForCredit = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Curriculum", objectName = "Curriculum", objectId = CurriculumID, body = list(DataObject = body), searchFields = append("CurriculumID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getCurriculumSubject <- function(CurriculumSubjectID, SubjectID = F, Code = F, Description = F, DistrictID = F, SchoolYearID = F, DistrictGroupKey = F, BackgroundColor = F, TextColor = F, CodeDescription = F, NumberOfAttachedCurriculums = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SubjectIDClonedFrom = F, IsPrimaryForSelectedCurriculum = F, SubjectIDClonedTo = F, EdFiAcademicSubjectDescriptorID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "Subject", objectId = CurriculumSubjectID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumSubject <- function(CurriculumSubjectID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "Subject", objectId = CurriculumSubjectID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurriculumSubject <- function(Code = NULL, Description = NULL, DistrictID = NULL, SchoolYearID = NULL, DistrictGroupKey = NULL, BackgroundColor = NULL, TextColor = NULL, SubjectIDClonedFrom = NULL, EdFiAcademicSubjectDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "Subject", body = list(DataObject = body), searchFields = append("SubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurriculumSubject <- function(SubjectID, Code = NULL, Description = NULL, DistrictID = NULL, SchoolYearID = NULL, DistrictGroupKey = NULL, BackgroundColor = NULL, TextColor = NULL, SubjectIDClonedFrom = NULL, EdFiAcademicSubjectDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "Subject", objectId = SubjectID, body = list(DataObject = body), searchFields = append("SubjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAssessmentToolMN <- function(AssessmentToolMNID, StateAssessmentToolMNID = F, StateImplementationStatusMNID = F, CurriculumYearID = F, AssessmentToolMNIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AssessmentToolMN", objectId = AssessmentToolMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAssessmentToolMN <- function(AssessmentToolMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AssessmentToolMN", objectId = AssessmentToolMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAssessmentToolMN <- function(StateAssessmentToolMNID = NULL, StateImplementationStatusMNID = NULL, CurriculumYearID = NULL, AssessmentToolMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "AssessmentToolMN", body = list(DataObject = body), searchFields = append("AssessmentToolMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAssessmentToolMN <- function(AssessmentToolMNID, StateAssessmentToolMNID = NULL, StateImplementationStatusMNID = NULL, CurriculumYearID = NULL, AssessmentToolMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "AssessmentToolMN", objectId = AssessmentToolMNID, body = list(DataObject = body), searchFields = append("AssessmentToolMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEarlyEducationInstructionalApproachMN <- function(EarlyEducationInstructionalApproachMNID, StateEarlyEducationInstructionalApproachMNID = F, StateImplementationStatusMNID = F, CurriculumYearID = F, EarlyEducationInstructionalApproachMNIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "EarlyEducationInstructionalApproachMN", objectId = EarlyEducationInstructionalApproachMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEarlyEducationInstructionalApproachMN <- function(EarlyEducationInstructionalApproachMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "EarlyEducationInstructionalApproachMN", objectId = EarlyEducationInstructionalApproachMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEarlyEducationInstructionalApproachMN <- function(StateEarlyEducationInstructionalApproachMNID = NULL, StateImplementationStatusMNID = NULL, CurriculumYearID = NULL, EarlyEducationInstructionalApproachMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "EarlyEducationInstructionalApproachMN", body = list(DataObject = body), searchFields = append("EarlyEducationInstructionalApproachMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSiteBasedInitiativeMN <- function(SiteBasedInitiativeMNID, StateSiteBasedInitiativeMNID = F, StateImplementationStatusMNID = F, CurriculumYearID = F, SiteBasedInitiativeMNIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "SiteBasedInitiativeMN", objectId = SiteBasedInitiativeMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSiteBasedInitiativeMN <- function(SiteBasedInitiativeMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "SiteBasedInitiativeMN", objectId = SiteBasedInitiativeMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSiteBasedInitiativeMN <- function(StateSiteBasedInitiativeMNID = NULL, StateImplementationStatusMNID = NULL, CurriculumYearID = NULL, SiteBasedInitiativeMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "SiteBasedInitiativeMN", body = list(DataObject = body), searchFields = append("SiteBasedInitiativeMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySiteBasedInitiativeMN <- function(SiteBasedInitiativeMNID, StateSiteBasedInitiativeMNID = NULL, StateImplementationStatusMNID = NULL, CurriculumYearID = NULL, SiteBasedInitiativeMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "SiteBasedInitiativeMN", objectId = SiteBasedInitiativeMNID, body = list(DataObject = body), searchFields = append("SiteBasedInitiativeMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCurriculumProgramMN <- function(CurriculumProgramMNID, StateCurriculumProgramMNID = F, StateImplementationStatusMNID = F, CurriculumYearID = F, CurriculumProgramMNIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "CurriculumProgramMN", objectId = CurriculumProgramMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumProgramMN <- function(CurriculumProgramMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "CurriculumProgramMN", objectId = CurriculumProgramMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurriculumProgramMN <- function(StateCurriculumProgramMNID = NULL, StateImplementationStatusMNID = NULL, CurriculumYearID = NULL, CurriculumProgramMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "CurriculumProgramMN", body = list(DataObject = body), searchFields = append("CurriculumProgramMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurriculumProgramMN <- function(CurriculumProgramMNID, StateCurriculumProgramMNID = NULL, StateImplementationStatusMNID = NULL, CurriculumYearID = NULL, CurriculumProgramMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "CurriculumProgramMN", objectId = CurriculumProgramMNID, body = list(DataObject = body), searchFields = append("CurriculumProgramMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getEarlyEducationProgramMN <- function(EarlyEducationProgramMNID, StateEarlyEducationProgramMNID = F, CurriculumYearID = F, EarlyEducationProgramMNIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "EarlyEducationProgramMN", objectId = EarlyEducationProgramMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEarlyEducationProgramMN <- function(EarlyEducationProgramMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "EarlyEducationProgramMN", objectId = EarlyEducationProgramMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEarlyEducationProgramMN <- function(StateEarlyEducationProgramMNID = NULL, CurriculumYearID = NULL, EarlyEducationProgramMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "EarlyEducationProgramMN", body = list(DataObject = body), searchFields = append("EarlyEducationProgramMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEarlyEducationProgramMN <- function(EarlyEducationProgramMNID, StateEarlyEducationProgramMNID = NULL, CurriculumYearID = NULL, EarlyEducationProgramMNIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "EarlyEducationProgramMN", objectId = EarlyEducationProgramMNID, body = list(DataObject = body), searchFields = append("EarlyEducationProgramMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getAcademicStandardDefault <- function(AcademicStandardDefaultID, Level = F, Description = F, Key = F, ParentGuid = F, IsHighFrequencyWord = F, LetterAndSoundType = F, LetterType = F, AcademicStandardDefaultIDParent = F, SkywardID = F, SkywardHash = F, AcademicStandardGradeRangeDefaultID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Language = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandardDefault", objectId = AcademicStandardDefaultID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandardDefault <- function(AcademicStandardDefaultID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandardDefault", objectId = AcademicStandardDefaultID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAcademicStandardDefault <- function(Level = NULL, Description = NULL, Key = NULL, ParentGuid = NULL, IsHighFrequencyWord = NULL, LetterAndSoundType = NULL, LetterType = NULL, AcademicStandardDefaultIDParent = NULL, AcademicStandardGradeRangeDefaultID = NULL, Language = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "AcademicStandardDefault", body = list(DataObject = body), searchFields = append("AcademicStandardDefaultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyAcademicStandardDefault <- function(AcademicStandardDefaultID, Level = NULL, Description = NULL, Key = NULL, ParentGuid = NULL, IsHighFrequencyWord = NULL, LetterAndSoundType = NULL, LetterType = NULL, AcademicStandardDefaultIDParent = NULL, AcademicStandardGradeRangeDefaultID = NULL, Language = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Curriculum", objectName = "AcademicStandardDefault", objectId = AcademicStandardDefaultID, body = list(DataObject = body), searchFields = append("AcademicStandardDefaultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAcademicStandardGradeRangeDefault <- function(AcademicStandardGradeRangeDefaultID, Code = F, Description = F, Key = F, SkywardID = F, SkywardHash = F, AcademicStandardSubjectDefaultID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandardGradeRangeDefault", objectId = AcademicStandardGradeRangeDefaultID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandardGradeRangeDefault <- function(AcademicStandardGradeRangeDefaultID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandardGradeRangeDefault", objectId = AcademicStandardGradeRangeDefaultID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAcademicStandardGradeRangeDefault <- function(Code = NULL, Description = NULL, Key = NULL, AcademicStandardSubjectDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "AcademicStandardGradeRangeDefault", body = list(DataObject = body), searchFields = append("AcademicStandardGradeRangeDefaultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAcademicStandardGradeRangeDefault <- function(AcademicStandardGradeRangeDefaultID, Code = NULL, Description = NULL, Key = NULL, AcademicStandardSubjectDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "AcademicStandardGradeRangeDefault", objectId = AcademicStandardGradeRangeDefaultID, body = list(DataObject = body), searchFields = append("AcademicStandardGradeRangeDefaultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAcademicStandardSetDefault <- function(AcademicStandardSetDefaultID, Code = F, Description = F, Key = F, SkywardID = F, SkywardHash = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandardSetDefault", objectId = AcademicStandardSetDefaultID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandardSetDefault <- function(AcademicStandardSetDefaultID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandardSetDefault", objectId = AcademicStandardSetDefaultID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAcademicStandardSetDefault <- function(Code = NULL, Description = NULL, Key = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "AcademicStandardSetDefault", body = list(DataObject = body), searchFields = append("AcademicStandardSetDefaultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAcademicStandardSetDefault <- function(AcademicStandardSetDefaultID, Code = NULL, Description = NULL, Key = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "AcademicStandardSetDefault", objectId = AcademicStandardSetDefaultID, body = list(DataObject = body), searchFields = append("AcademicStandardSetDefaultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAcademicStandardSubjectDefault <- function(AcademicStandardSubjectDefaultID, Code = F, Description = F, Key = F, SkywardID = F, SkywardHash = F, AcademicStandardSetDefaultID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "AcademicStandardSubjectDefault", objectId = AcademicStandardSubjectDefaultID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAcademicStandardSubjectDefault <- function(AcademicStandardSubjectDefaultID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "AcademicStandardSubjectDefault", objectId = AcademicStandardSubjectDefaultID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAcademicStandardSubjectDefault <- function(Code = NULL, Description = NULL, Key = NULL, AcademicStandardSetDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "AcademicStandardSubjectDefault", body = list(DataObject = body), searchFields = append("AcademicStandardSubjectDefaultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAcademicStandardSubjectDefault <- function(AcademicStandardSubjectDefaultID, Code = NULL, Description = NULL, Key = NULL, AcademicStandardSetDefaultID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Curriculum", objectName = "AcademicStandardSubjectDefault", objectId = AcademicStandardSubjectDefaultID, body = list(DataObject = body), searchFields = append("AcademicStandardSubjectDefaultID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getCurriculumYearEdFiCourseLevelCharacteristic <- function(CurriculumYearEdFiCourseLevelCharacteristicID, CurriculumYearID = F, EdFiCourseLevelCharacteristicID = F, CurriculumYearEdFiCourseLevelCharacteristicIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Curriculum", objectName = "CurriculumYearEdFiCourseLevelCharacteristic", objectId = CurriculumYearEdFiCourseLevelCharacteristicID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurriculumYearEdFiCourseLevelCharacteristic <- function(CurriculumYearEdFiCourseLevelCharacteristicID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Curriculum", objectName = "CurriculumYearEdFiCourseLevelCharacteristic", objectId = CurriculumYearEdFiCourseLevelCharacteristicID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurriculumYearEdFiCourseLevelCharacteristic <- function(CurriculumYearID = NULL, EdFiCourseLevelCharacteristicID = NULL, CurriculumYearEdFiCourseLevelCharacteristicIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Curriculum", objectName = "CurriculumYearEdFiCourseLevelCharacteristic", body = list(DataObject = body), searchFields = append("CurriculumYearEdFiCourseLevelCharacteristicID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurriculumYearEdFiCourseLevelCharacteristic <- function(CurriculumYearEdFiCourseLevelCharacteristicID, CurriculumYearID = NULL, EdFiCourseLevelCharacteristicID = NULL, CurriculumYearEdFiCourseLevelCharacteristicIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
