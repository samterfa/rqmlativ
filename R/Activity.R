	...
	getTempStudentActivity <- function(TempStudentActivityID, ActivityID = F, Code = F, Description = F, StudentID = F, StudentName = F, StartDate = F, EndDate = F, Age = F, GradeLevel = F, ParticipationStartDate = F, ParticipationEndDate = F, FullNameLFM = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StudentNumber = F, GradYear = F, GenderCodeAndGender = F, EntityCode = F, IsActive = F, ErrorNumber = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempStudentActivity", objectId = TempStudentActivityID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentActivity <- function(TempStudentActivityID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempStudentActivity", objectId = TempStudentActivityID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempStudentActivity <- function(ActivityID = NULL, Code = NULL, Description = NULL, StudentID = NULL, StudentName = NULL, StartDate = NULL, EndDate = NULL, Age = NULL, GradeLevel = NULL, ParticipationStartDate = NULL, ParticipationEndDate = NULL, FullNameLFM = NULL, StudentNumber = NULL, GradYear = NULL, GenderCodeAndGender = NULL, EntityCode = NULL, IsActive = NULL, ErrorNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Activity", objectName = "TempStudentActivity", body = list(DataObject = body), searchFields = append("TempStudentActivityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempStudentActivity <- function(TempStudentActivityID, ActivityID = NULL, Code = NULL, Description = NULL, StudentID = NULL, StudentName = NULL, StartDate = NULL, EndDate = NULL, Age = NULL, GradeLevel = NULL, ParticipationStartDate = NULL, ParticipationEndDate = NULL, FullNameLFM = NULL, StudentNumber = NULL, GradYear = NULL, GenderCodeAndGender = NULL, EntityCode = NULL, IsActive = NULL, ErrorNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Activity", objectName = "TempStudentActivity", objectId = TempStudentActivityID, body = list(DataObject = body), searchFields = append("TempStudentActivityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempActivityRecord <- function(TempActivityRecordID, ActivityID = F, Code = F, Description = F, NewStartDate = F, NewEndDate = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempActivityRecord", objectId = TempActivityRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempActivityRecord <- function(TempActivityRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempActivityRecord", objectId = TempActivityRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempActivityRecord <- function(ActivityID = NULL, Code = NULL, Description = NULL, NewStartDate = NULL, NewEndDate = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "TempActivityRecord", body = list(DataObject = body), searchFields = append("TempActivityRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempActivityRecord <- function(TempActivityRecordID, ActivityID = NULL, Code = NULL, Description = NULL, NewStartDate = NULL, NewEndDate = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "TempActivityRecord", objectId = TempActivityRecordID, body = list(DataObject = body), searchFields = append("TempActivityRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentActivityTransactionRecord <- function(TempStudentActivityTransactionRecordID, ActivityID = F, StudentActivityTransactionID = F, StudentFullNameLFM = F, NewStartDate = F, NewEndDate = F, IsValidTransaction = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempStudentActivityTransactionRecord", objectId = TempStudentActivityTransactionRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentActivityTransactionRecord <- function(TempStudentActivityTransactionRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempStudentActivityTransactionRecord", objectId = TempStudentActivityTransactionRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentActivityTransactionRecord <- function(ActivityID = NULL, StudentActivityTransactionID = NULL, StudentFullNameLFM = NULL, NewStartDate = NULL, NewEndDate = NULL, IsValidTransaction = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "TempStudentActivityTransactionRecord", body = list(DataObject = body), searchFields = append("TempStudentActivityTransactionRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentActivityTransactionRecord <- function(TempStudentActivityTransactionRecordID, ActivityID = NULL, StudentActivityTransactionID = NULL, StudentFullNameLFM = NULL, NewStartDate = NULL, NewEndDate = NULL, IsValidTransaction = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "TempStudentActivityTransactionRecord", objectId = TempStudentActivityTransactionRecordID, body = list(DataObject = body), searchFields = append("TempStudentActivityTransactionRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getActivityEvent <- function(ActivityEventID, ActivityID = F, EventTypeID = F, Summary = F, Description = F, CodeSummary = F, Cost = F, Status = F, NameIDContact = F, StartTime = F, EndTime = F, LocationID = F, VisibleTo = F, ContactType = F, DisplayOnDistrictCalendar = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Date = F, DescriptionSummary = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "ActivityEvent", objectId = ActivityEventID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActivityEvent <- function(ActivityEventID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "ActivityEvent", objectId = ActivityEventID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createActivityEvent <- function(ActivityID = NULL, EventTypeID = NULL, Summary = NULL, Description = NULL, Cost = NULL, Status = NULL, NameIDContact = NULL, StartTime = NULL, EndTime = NULL, LocationID = NULL, VisibleTo = NULL, ContactType = NULL, DisplayOnDistrictCalendar = NULL, Date = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "ActivityEvent", body = list(DataObject = body), searchFields = append("ActivityEventID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyActivityEvent <- function(ActivityEventID, ActivityID = NULL, EventTypeID = NULL, Summary = NULL, Description = NULL, Cost = NULL, Status = NULL, NameIDContact = NULL, StartTime = NULL, EndTime = NULL, LocationID = NULL, VisibleTo = NULL, ContactType = NULL, DisplayOnDistrictCalendar = NULL, Date = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Activity", objectName = "ActivityEvent", objectId = ActivityEventID, body = list(DataObject = body), searchFields = append("ActivityEventID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getEventType <- function(EventTypeID, Code = F, Description = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "EventType", objectId = EventTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEventType <- function(EventTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "EventType", objectId = EventTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEventType <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "EventType", body = list(DataObject = body), searchFields = append("EventTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEventType <- function(EventTypeID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "EventType", objectId = EventTypeID, body = list(DataObject = body), searchFields = append("EventTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentActivityTransaction <- function(StudentActivityTransactionID, StudentActivityID = F, ParticipationStartDate = F, ParticipationEndDate = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "StudentActivityTransaction", objectId = StudentActivityTransactionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentActivityTransaction <- function(StudentActivityTransactionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "StudentActivityTransaction", objectId = StudentActivityTransactionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentActivityTransaction <- function(StudentActivityID = NULL, ParticipationStartDate = NULL, ParticipationEndDate = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "StudentActivityTransaction", body = list(DataObject = body), searchFields = append("StudentActivityTransactionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentActivityTransaction <- function(StudentActivityTransactionID, StudentActivityID = NULL, ParticipationStartDate = NULL, ParticipationEndDate = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "StudentActivityTransaction", objectId = StudentActivityTransactionID, body = list(DataObject = body), searchFields = append("StudentActivityTransactionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getActivity <- function(ActivityID, Code = F, Description = F, EntityID = F, SchoolYearID = F, ActivityTypeID = F, StartDate = F, EndDate = F, CodeDescription = F, ActivityIDClonedFrom = F, UseForAthleticEligibilityReporting = F, ActivityLeaderNames = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, HideInFamilyAccess = F, SingleSex = F, ActivityIDClonedTo = F, StudentAwardID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "Activity", objectId = ActivityID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActivity <- function(ActivityID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "Activity", objectId = ActivityID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createActivity <- function(Code = NULL, Description = NULL, EntityID = NULL, SchoolYearID = NULL, ActivityTypeID = NULL, StartDate = NULL, EndDate = NULL, ActivityIDClonedFrom = NULL, UseForAthleticEligibilityReporting = NULL, HideInFamilyAccess = NULL, SingleSex = NULL, StudentAwardID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Activity", objectName = "Activity", body = list(DataObject = body), searchFields = append("ActivityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyActivity <- function(ActivityID, Code = NULL, Description = NULL, EntityID = NULL, SchoolYearID = NULL, ActivityTypeID = NULL, StartDate = NULL, EndDate = NULL, ActivityIDClonedFrom = NULL, UseForAthleticEligibilityReporting = NULL, HideInFamilyAccess = NULL, SingleSex = NULL, StudentAwardID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Activity", objectName = "Activity", objectId = ActivityID, body = list(DataObject = body), searchFields = append("ActivityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getActivityType <- function(ActivityTypeID, Code = F, Description = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EdFiCohortTypeDescriptorID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "ActivityType", objectId = ActivityTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActivityType <- function(ActivityTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "ActivityType", objectId = ActivityTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createActivityType <- function(Code = NULL, Description = NULL, EdFiCohortTypeDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "ActivityType", body = list(DataObject = body), searchFields = append("ActivityTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyActivityType <- function(ActivityTypeID, Code = NULL, Description = NULL, EdFiCohortTypeDescriptorID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "ActivityType", objectId = ActivityTypeID, body = list(DataObject = body), searchFields = append("ActivityTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getActivityPersonnel <- function(ActivityPersonnelID, ActivityID = F, NameID = F, IsLeader = F, ActivityPersonnelIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "ActivityPersonnel", objectId = ActivityPersonnelID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActivityPersonnel <- function(ActivityPersonnelID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "ActivityPersonnel", objectId = ActivityPersonnelID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createActivityPersonnel <- function(ActivityID = NULL, NameID = NULL, IsLeader = NULL, ActivityPersonnelIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "ActivityPersonnel", body = list(DataObject = body), searchFields = append("ActivityPersonnelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyActivityPersonnel <- function(ActivityPersonnelID, ActivityID = NULL, NameID = NULL, IsLeader = NULL, ActivityPersonnelIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "ActivityPersonnel", objectId = ActivityPersonnelID, body = list(DataObject = body), searchFields = append("ActivityPersonnelID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentActivity <- function(StudentActivityID, StudentID = F, ActivityID = F, CourseID = F, IsActive = F, StudentActivityIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, HasParticipation = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "StudentActivity", objectId = StudentActivityID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentActivity <- function(StudentActivityID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "StudentActivity", objectId = StudentActivityID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentActivity <- function(StudentID = NULL, ActivityID = NULL, CourseID = NULL, IsActive = NULL, StudentActivityIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "StudentActivity", body = list(DataObject = body), searchFields = append("StudentActivityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentActivity <- function(StudentActivityID, StudentID = NULL, ActivityID = NULL, CourseID = NULL, IsActive = NULL, StudentActivityIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "StudentActivity", objectId = StudentActivityID, body = list(DataObject = body), searchFields = append("StudentActivityID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStudentActivityError <- function(TempStudentActivityErrorID, TempStudentActivityID = F, ErrorNumber = F, ErrorText = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempStudentActivityError", objectId = TempStudentActivityErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentActivityError <- function(TempStudentActivityErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempStudentActivityError", objectId = TempStudentActivityErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentActivityError <- function(TempStudentActivityID = NULL, ErrorNumber = NULL, ErrorText = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "TempStudentActivityError", body = list(DataObject = body), searchFields = append("TempStudentActivityErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentActivityError <- function(TempStudentActivityErrorID, TempStudentActivityID = NULL, ErrorNumber = NULL, ErrorText = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "TempStudentActivityError", objectId = TempStudentActivityErrorID, body = list(DataObject = body), searchFields = append("TempStudentActivityErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getActivityConfigDistrict <- function(ActivityConfigDistrictID, ConfigDistrictID = F, DistrictID = F, StructureDimensionID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "ConfigDistrict", objectId = ActivityConfigDistrictID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActivityConfigDistrict <- function(ActivityConfigDistrictID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "ConfigDistrict", objectId = ActivityConfigDistrictID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createActivityConfigDistrict <- function(DistrictID = NULL, StructureDimensionID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "ConfigDistrict", body = list(DataObject = body), searchFields = append("ConfigDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyActivityConfigDistrict <- function(ConfigDistrictID, DistrictID = NULL, StructureDimensionID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "ConfigDistrict", objectId = ConfigDistrictID, body = list(DataObject = body), searchFields = append("ConfigDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getConfigDistrictStructureDimensionPosition <- function(ConfigDistrictStructureDimensionPositionID, ConfigDistrictID = F, Position = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "ConfigDistrictStructureDimensionPosition", objectId = ConfigDistrictStructureDimensionPositionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteConfigDistrictStructureDimensionPosition <- function(ConfigDistrictStructureDimensionPositionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "ConfigDistrictStructureDimensionPosition", objectId = ConfigDistrictStructureDimensionPositionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createConfigDistrictStructureDimensionPosition <- function(ConfigDistrictID = NULL, Position = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "ConfigDistrictStructureDimensionPosition", body = list(DataObject = body), searchFields = append("ConfigDistrictStructureDimensionPositionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyConfigDistrictStructureDimensionPosition <- function(ConfigDistrictStructureDimensionPositionID, ConfigDistrictID = NULL, Position = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getActivityAccountingGroup <- function(ActivityAccountingGroupID, EntityID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AccountEntityOverlay = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "ActivityAccountingGroup", objectId = ActivityAccountingGroupID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActivityAccountingGroup <- function(ActivityAccountingGroupID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "ActivityAccountingGroup", objectId = ActivityAccountingGroupID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createActivityAccountingGroup <- function(EntityID = NULL, AccountEntityOverlay = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "ActivityAccountingGroup", body = list(DataObject = body), searchFields = append("ActivityAccountingGroupID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyActivityAccountingGroup <- function(ActivityAccountingGroupID, EntityID = NULL, AccountEntityOverlay = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "ActivityAccountingGroup", objectId = ActivityAccountingGroupID, body = list(DataObject = body), searchFields = append("ActivityAccountingGroupID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getActivityAccountingGroupClearance <- function(ActivityAccountingGroupClearanceID, ActivityAccountingGroupID = F, GroupIDSecurity = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "ActivityAccountingGroupClearance", objectId = ActivityAccountingGroupClearanceID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteActivityAccountingGroupClearance <- function(ActivityAccountingGroupClearanceID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "ActivityAccountingGroupClearance", objectId = ActivityAccountingGroupClearanceID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createActivityAccountingGroupClearance <- function(ActivityAccountingGroupID = NULL, GroupIDSecurity = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "ActivityAccountingGroupClearance", body = list(DataObject = body), searchFields = append("ActivityAccountingGroupClearanceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyActivityAccountingGroupClearance <- function(ActivityAccountingGroupClearanceID, ActivityAccountingGroupID = NULL, GroupIDSecurity = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "ActivityAccountingGroupClearance", objectId = ActivityAccountingGroupClearanceID, body = list(DataObject = body), searchFields = append("ActivityAccountingGroupClearanceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempActivityAccountingGroupMassUpdate <- function(TempActivityAccountingGroupMassUpdateID, UpdateType = F, ActivityAccountingGroupIDOld = F, ActivityAccountingGroupOld = F, ActivityAccountingGroupIDNew = F, ActivityAccountingGroupNew = F, UpdateObjectID = F, UpdateObjectDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempActivityAccountingGroupMassUpdate", objectId = TempActivityAccountingGroupMassUpdateID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempActivityAccountingGroupMassUpdate <- function(TempActivityAccountingGroupMassUpdateID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempActivityAccountingGroupMassUpdate", objectId = TempActivityAccountingGroupMassUpdateID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempActivityAccountingGroupMassUpdate <- function(UpdateType = NULL, ActivityAccountingGroupIDOld = NULL, ActivityAccountingGroupOld = NULL, ActivityAccountingGroupIDNew = NULL, ActivityAccountingGroupNew = NULL, UpdateObjectID = NULL, UpdateObjectDescription = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "TempActivityAccountingGroupMassUpdate", body = list(DataObject = body), searchFields = append("TempActivityAccountingGroupMassUpdateID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempClearance <- function(TempClearanceID, GroupIDSecurity = F, GroupID = F, GroupDescription = F, EntityName = F, ClearanceType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempClearance", objectId = TempClearanceID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempClearance <- function(TempClearanceID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempClearance", objectId = TempClearanceID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempClearance <- function(GroupIDSecurity = NULL, GroupID = NULL, GroupDescription = NULL, EntityName = NULL, ClearanceType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "TempClearance", body = list(DataObject = body), searchFields = append("TempClearanceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempClearance <- function(TempClearanceID, GroupIDSecurity = NULL, GroupID = NULL, GroupDescription = NULL, EntityName = NULL, ClearanceType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "TempClearance", objectId = TempClearanceID, body = list(DataObject = body), searchFields = append("TempClearanceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempEntityBalanceError <- function(TempEntityBalanceErrorID, FundDimensionID = F, FundDimensionCodeDescription = F, ActivityAccountingGroupID = F, EntityCodeName = F, Error = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempEntityBalanceError", objectId = TempEntityBalanceErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempEntityBalanceError <- function(TempEntityBalanceErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempEntityBalanceError", objectId = TempEntityBalanceErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempEntityBalanceError <- function(FundDimensionID = NULL, FundDimensionCodeDescription = NULL, ActivityAccountingGroupID = NULL, EntityCodeName = NULL, Error = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "TempEntityBalanceError", body = list(DataObject = body), searchFields = append("TempEntityBalanceErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempEntityBalanceError <- function(TempEntityBalanceErrorID, FundDimensionID = NULL, FundDimensionCodeDescription = NULL, ActivityAccountingGroupID = NULL, EntityCodeName = NULL, Error = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "TempEntityBalanceError", objectId = TempEntityBalanceErrorID, body = list(DataObject = body), searchFields = append("TempEntityBalanceErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempActivityAccountError <- function(TempActivityAccountErrorID, AccountID = F, DisplayAccount = F, FundDimensionID = F, FundDimensionCodeDescription = F, Error = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempActivityAccountError", objectId = TempActivityAccountErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempActivityAccountError <- function(TempActivityAccountErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempActivityAccountError", objectId = TempActivityAccountErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempActivityAccountError <- function(AccountID = NULL, DisplayAccount = NULL, FundDimensionID = NULL, FundDimensionCodeDescription = NULL, Error = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "Activity", objectName = "TempActivityAccountError", body = list(DataObject = body), searchFields = append("TempActivityAccountErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempActivityAccountError <- function(TempActivityAccountErrorID, AccountID = NULL, DisplayAccount = NULL, FundDimensionID = NULL, FundDimensionCodeDescription = NULL, Error = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "Activity", objectName = "TempActivityAccountError", objectId = TempActivityAccountErrorID, body = list(DataObject = body), searchFields = append("TempActivityAccountErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempActivityAccount <- function(TempActivityAccountID, AccountID = F, DisplayAccount = F, FundDimensionID = F, FundDimensionCodeDescription = F, ActivityAccountingGroupIDOld = F, ActivityAccountingGroupIDNew = F, EntityCodeNameOld = F, EntityCodeNameNew = F, ExpenseSummaryIDOld = F, ExpenseSummaryOld = F, ExpenseSummaryIDNew = F, ExpenseSummaryNew = F, RevenueSummaryIDOld = F, RevenueSummaryOld = F, RevenueSummaryIDNew = F, RevenueSummaryNew = F, EncumbranceOffsetIDOld = F, EncumbranceOffsetOld = F, EncumbranceOffsetIDNew = F, EncumbranceOffsetNew = F, ReservedForEncumbranceIDOld = F, ReservedForEncumbranceOld = F, ReservedForEncumbranceIDNew = F, ReservedForEncumbranceNew = F, HasError = F, ErrorCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Activity", objectName = "TempActivityAccount", objectId = TempActivityAccountID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempActivityAccount <- function(TempActivityAccountID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Activity", objectName = "TempActivityAccount", objectId = TempActivityAccountID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempActivityAccount <- function(AccountID = NULL, DisplayAccount = NULL, FundDimensionID = NULL, FundDimensionCodeDescription = NULL, ActivityAccountingGroupIDOld = NULL, ActivityAccountingGroupIDNew = NULL, EntityCodeNameOld = NULL, EntityCodeNameNew = NULL, ExpenseSummaryIDOld = NULL, ExpenseSummaryOld = NULL, ExpenseSummaryIDNew = NULL, ExpenseSummaryNew = NULL, RevenueSummaryIDOld = NULL, RevenueSummaryOld = NULL, RevenueSummaryIDNew = NULL, RevenueSummaryNew = NULL, EncumbranceOffsetIDOld = NULL, EncumbranceOffsetOld = NULL, EncumbranceOffsetIDNew = NULL, EncumbranceOffsetNew = NULL, ReservedForEncumbranceIDOld = NULL, ReservedForEncumbranceOld = NULL, ReservedForEncumbranceIDNew = NULL, ReservedForEncumbranceNew = NULL, HasError = NULL, ErrorCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Activity", objectName = "TempActivityAccount", body = list(DataObject = body), searchFields = append("TempActivityAccountID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempActivityAccount <- function(TempActivityAccountID, AccountID = NULL, DisplayAccount = NULL, FundDimensionID = NULL, FundDimensionCodeDescription = NULL, ActivityAccountingGroupIDOld = NULL, ActivityAccountingGroupIDNew = NULL, EntityCodeNameOld = NULL, EntityCodeNameNew = NULL, ExpenseSummaryIDOld = NULL, ExpenseSummaryOld = NULL, ExpenseSummaryIDNew = NULL, ExpenseSummaryNew = NULL, RevenueSummaryIDOld = NULL, RevenueSummaryOld = NULL, RevenueSummaryIDNew = NULL, RevenueSummaryNew = NULL, EncumbranceOffsetIDOld = NULL, EncumbranceOffsetOld = NULL, EncumbranceOffsetIDNew = NULL, EncumbranceOffsetNew = NULL, ReservedForEncumbranceIDOld = NULL, ReservedForEncumbranceOld = NULL, ReservedForEncumbranceIDNew = NULL, ReservedForEncumbranceNew = NULL, HasError = NULL, ErrorCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Activity", objectName = "TempActivityAccount", objectId = TempActivityAccountID, body = list(DataObject = body), searchFields = append("TempActivityAccountID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
