	...
	getStudent <- function(StudentID, StudentMNID = F, StudentStateID = F, StateEthnicityRaceCodeMNID = F, HasSection504Indicator = F, HasActiveSection504 = F, NameID = F, FullNameLFM = F, FullNameFL = F, FullNameFML = F, AllowMediaDistribution = F, AllowTripsDistribution = F, AllowDistrictDistribution = F, AllowHigherEdDistribution = F, AllowLocalDistribution = F, AllowMilitaryDistribution = F, AllowPublicDistribution = F, AllowVendorsDistribution = F, ConversionKey = F, IsGraduated = F, StudentNumber = F, GraduationDate = F, GradYear = F, GraduationRequirementYear = F, IsCurrentActive = F, IsActiveAsOfDate = F, SpecifiedEntityYearNoShow = F, LanguageIDNative = F, EdFiCountryIDBirth = F, EarnedCredits = F, EarnedCreditsPossible = F, FailedCredits = F, EntityConfigFailedCredits = F, EntityConfigEarnedCredits = F, HasActiveAlert = F, HasActiveCriticalAlert = F, HasActiveHealthCondition = F, MMRStatus = F, HasActiveIHP = F, HasActiveGeneralNote = F, HasActiveParentalConsentNote = F, HealthProfessionalIDPrimaryPhysician = F, IsHealthProfessionalPrimaryPhysician = F, NameIDHospital = F, HealthProfessionalIDDentist = F, IsHealthProfessionalDentist = F, NameIDDentalPractice = F, NameIDHealthInsuranceCompany = F, HealthPolicyNumber = F, NameIDDentalInsuranceCompany = F, DentalPolicyNumber = F, HasAlertIndicator = F, HasCriticalAlertIndicator = F, HasHealthIndicator = F, HasIHPIndicator = F, HasGeneralNoteIndicator = F, HasParentalConsentNoteIndicator = F, CalculatedGradYear = F, CurrentDefaultEntityIsActive = F, CalculatedEntityYearIsActive = F, CalculatedGrade = F, GradeNumeric = F, Grade = F, Location = F, IsIDEASnapshot = F, IsIDEA = F, IsLEPSnapshot = F, IsLEP = F, IsGiftedTalentedSnapshot = F, IsSection504 = F, IsSection504Snapshot = F, IsChronicallyAbsent = F, HasTakenACT0912 = F, HasTakenSAT0912 = F, CorporalPunishmentIncidents = F, InSchoolSuspensionCount = F, OutOfSchoolSuspensionCount = F, ExpulsionWithServicesCount = F, ExpulsionWithoutServicesCount = F, ZeroToleranceWithServicesCount = F, ZeroToleranceWithoutServicesCount = F, LawEnforcementReferralCount = F, ArrestCount = F, OutOfSchoolSuspensionMissedDays = F, IsFederalDualEnrollment = F, IsFederalDistanceEducation = F, HasAlgebraIGrade07 = F, HasAlgebraIGrade08 = F, HasAlgebraIGrade0910 = F, HasAlgebraIGrade1112 = F, HasAlgebraIIGrade0912 = F, HasAdvancedMathGrade0912 = F, HasCalculusGrade0912 = F, HasGeometryGrade08 = F, HasGeometryGrade0912 = F, HasBiologyGrade0912 = F, HasChemistryGrade0912 = F, HasPhysicsGrade0912 = F, HasAPCourseGrade0912 = F, HasAPMathGrade0912 = F, HasAPScienceGrade0912 = F, HasAPOtherGrade0912 = F, HasPassedAlgebraIGrade07 = F, HasPassedAlgebraIGrade08 = F, HasPassedAlgebraIGrade0910 = F, HasPassedAlgebraIGrade1112 = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IndicatorsXML = F, HasActiveStudentGuardianRestrictedAccess = F, FirstName = F, MiddleName = F, LastName = F, LanguageIDPrimary = F, HasStudentGuardianWithAllowFamilyAccessButNoSecurity = F, HasStudentEntityYearForCurrentSchoolYear = F, HasAllowStudentAccessButNoSecurity = F, EarliestDistrictEnrollmentDate = F, AllowStudentAccess = F, OverrideFeeOnlinePaymentAccess = F, FeeOnlinePaymentOverrideType = F, OverrideFoodServiceOnlinePaymentAccess = F, FoodServiceOnlinePaymentOverrideType = F, DateOfFirstEntryWithdrawalInEntity = F, MedicaidNumber = F, SchoolPathExpectedSchoolName = F, IsIBDiplomaProgramme = F, FormattedVaccinationDates = F, SchoolPathExpectedSchoolCode = F, CalculatedStudentStateID = F, HasDuplicateStudentNumber = F, IsCurrentlyTransported = F, SpecifiedCohortNumericSchoolYear = F, SchoolYearIDSpecifiedCohort = F, StudentRankSort = F, HasComputerScienceGrade0912 = F, HasAPComputerScienceGrade0912 = F, CalculatedPrimaryFormattedPhoneNumber = F, HasCreditRecovery = F, SingleSexAthleticCount = F, ReportedBulliedSex = F, ReportedBulliedRace = F, ReportedBulliedDisability = F, DisciplinedBullyingSex = F, DisciplinedBullyingRace = F, DisciplinedBullyingDisability = F, MechanicalRestraintCount = F, PhysicalRestraintCount = F, SeclusionCount = F, TransferToAlternativeSchool = F, EntryWithdrawalIDDefaultEntityToday = F, AttachmentCount = F, LocationDateToUse = F, LocationEntityID = F, LocationSchoolYearID = F, HasTakenAPExam0912 = F, CurrentEconomicIndicator = F, IsStateReportingUnknownGender = F, HasOneNormalEnrollmentInEntityDuringSchoolYear = F, TotalCommunityServiceHours = F, HasActiveInterventionPlan = F, HasInterventionPlanIndicator = F, InSpecifiedDirectCertificationImport = F, EligibilityCategoryForDirectCertificationImport = F, EffectiveDateForDirectCertificationImport = F, HasActiveMethodOfInstruction = F, HasMethodOfInstructionIndicator = F, HasSpecialEducationIndicator = F, HasActiveSpecialEducation = F, CountryIDBirth = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "Student", objectId = StudentID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudent <- function(StudentID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "Student", objectId = StudentID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createStudent <- function(StudentStateID = NULL, StateEthnicityRaceCodeMNID = NULL, HasSection504Indicator = NULL, NameID = NULL, AllowMediaDistribution = NULL, AllowTripsDistribution = NULL, AllowDistrictDistribution = NULL, AllowHigherEdDistribution = NULL, AllowLocalDistribution = NULL, AllowMilitaryDistribution = NULL, AllowPublicDistribution = NULL, AllowVendorsDistribution = NULL, ConversionKey = NULL, IsGraduated = NULL, StudentNumber = NULL, GraduationDate = NULL, GradYear = NULL, GraduationRequirementYear = NULL, LanguageIDNative = NULL, EdFiCountryIDBirth = NULL, HealthProfessionalIDPrimaryPhysician = NULL, NameIDHospital = NULL, HealthProfessionalIDDentist = NULL, NameIDDentalPractice = NULL, NameIDHealthInsuranceCompany = NULL, HealthPolicyNumber = NULL, NameIDDentalInsuranceCompany = NULL, DentalPolicyNumber = NULL, HasAlertIndicator = NULL, HasCriticalAlertIndicator = NULL, HasHealthIndicator = NULL, HasIHPIndicator = NULL, HasGeneralNoteIndicator = NULL, HasParentalConsentNoteIndicator = NULL, GradeNumeric = NULL, Grade = NULL, IndicatorsXML = NULL, LanguageIDPrimary = NULL, AllowStudentAccess = NULL, OverrideFeeOnlinePaymentAccess = NULL, FeeOnlinePaymentOverrideType = NULL, OverrideFoodServiceOnlinePaymentAccess = NULL, FoodServiceOnlinePaymentOverrideType = NULL, MedicaidNumber = NULL, IsIBDiplomaProgramme = NULL, IsStateReportingUnknownGender = NULL, HasInterventionPlanIndicator = NULL, HasMethodOfInstructionIndicator = NULL, HasSpecialEducationIndicator = NULL, CountryIDBirth = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "Student", body = list(DataObject = body), searchFields = append("StudentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyStudent <- function(StudentID, StudentStateID = NULL, StateEthnicityRaceCodeMNID = NULL, HasSection504Indicator = NULL, NameID = NULL, AllowMediaDistribution = NULL, AllowTripsDistribution = NULL, AllowDistrictDistribution = NULL, AllowHigherEdDistribution = NULL, AllowLocalDistribution = NULL, AllowMilitaryDistribution = NULL, AllowPublicDistribution = NULL, AllowVendorsDistribution = NULL, ConversionKey = NULL, IsGraduated = NULL, StudentNumber = NULL, GraduationDate = NULL, GradYear = NULL, GraduationRequirementYear = NULL, LanguageIDNative = NULL, EdFiCountryIDBirth = NULL, HealthProfessionalIDPrimaryPhysician = NULL, NameIDHospital = NULL, HealthProfessionalIDDentist = NULL, NameIDDentalPractice = NULL, NameIDHealthInsuranceCompany = NULL, HealthPolicyNumber = NULL, NameIDDentalInsuranceCompany = NULL, DentalPolicyNumber = NULL, HasAlertIndicator = NULL, HasCriticalAlertIndicator = NULL, HasHealthIndicator = NULL, HasIHPIndicator = NULL, HasGeneralNoteIndicator = NULL, HasParentalConsentNoteIndicator = NULL, GradeNumeric = NULL, Grade = NULL, IndicatorsXML = NULL, LanguageIDPrimary = NULL, AllowStudentAccess = NULL, OverrideFeeOnlinePaymentAccess = NULL, FeeOnlinePaymentOverrideType = NULL, OverrideFoodServiceOnlinePaymentAccess = NULL, FoodServiceOnlinePaymentOverrideType = NULL, MedicaidNumber = NULL, IsIBDiplomaProgramme = NULL, IsStateReportingUnknownGender = NULL, HasInterventionPlanIndicator = NULL, HasMethodOfInstructionIndicator = NULL, HasSpecialEducationIndicator = NULL, CountryIDBirth = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "Student", objectId = StudentID, body = list(DataObject = body), searchFields = append("StudentID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getNoteType <- function(NoteTypeID, Code = F, Description = F, IsParentalConsent = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IndicatorID = F, IsActive = F, SkywardID = F, SkywardHash = F, CodeDescription = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "NoteType", objectId = NoteTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteNoteType <- function(NoteTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "NoteType", objectId = NoteTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createNoteType <- function(Code = NULL, Description = NULL, IsParentalConsent = NULL, IndicatorID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "NoteType", body = list(DataObject = body), searchFields = append("NoteTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyNoteType <- function(NoteTypeID, Code = NULL, Description = NULL, IsParentalConsent = NULL, IndicatorID = NULL, IsActive = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "NoteType", objectId = NoteTypeID, body = list(DataObject = body), searchFields = append("NoteTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentNote <- function(StudentNoteID, StudentID = F, NoteTypeID = F, StartDate = F, EndDate = F, Description = F, IsActive = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AttachmentCount = F, StudentTransportationID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "StudentNote", objectId = StudentNoteID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentNote <- function(StudentNoteID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "StudentNote", objectId = StudentNoteID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentNote <- function(StudentID = NULL, NoteTypeID = NULL, StartDate = NULL, EndDate = NULL, Description = NULL, StudentTransportationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "StudentNote", body = list(DataObject = body), searchFields = append("StudentNoteID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentNote <- function(StudentNoteID, StudentID = NULL, NoteTypeID = NULL, StartDate = NULL, EndDate = NULL, Description = NULL, StudentTransportationID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "StudentNote", objectId = StudentNoteID, body = list(DataObject = body), searchFields = append("StudentNoteID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempFitnessGram <- function(TempFitnessGramID, HasMissingData = F, Message = F, SchoolID = F, StudentID = F, StudentFirstName = F, StudentLastName = F, StudentBirthdate = F, StudentGrade = F, StudentGender = F, StudentPassword = F, ClassName = F, ClassID = F, ClassStartDate = F, ClassEndDate = F, TeacherID = F, TeacherFirstName = F, TeacherLastName = F, TeacherBirthDate = F, TeacherPassword = F, TeacherEmail = F, StudentMiddleInitial = F, StudentReportEmail = F, ParentReportEmail1 = F, ParentReportEmail2 = F, ClassDescription = F, TeacherMiddleInitial = F, CourseCodeDescription = F, SectionCode = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StudentSSOID = F, TeacherSSOID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempFitnessGram", objectId = TempFitnessGramID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempFitnessGram <- function(TempFitnessGramID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempFitnessGram", objectId = TempFitnessGramID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempFitnessGram <- function(HasMissingData = NULL, Message = NULL, SchoolID = NULL, StudentID = NULL, StudentFirstName = NULL, StudentLastName = NULL, StudentBirthdate = NULL, StudentGrade = NULL, StudentGender = NULL, StudentPassword = NULL, ClassName = NULL, ClassID = NULL, ClassStartDate = NULL, ClassEndDate = NULL, TeacherID = NULL, TeacherFirstName = NULL, TeacherLastName = NULL, TeacherBirthDate = NULL, TeacherPassword = NULL, TeacherEmail = NULL, StudentMiddleInitial = NULL, StudentReportEmail = NULL, ParentReportEmail1 = NULL, ParentReportEmail2 = NULL, ClassDescription = NULL, TeacherMiddleInitial = NULL, CourseCodeDescription = NULL, SectionCode = NULL, StudentSSOID = NULL, TeacherSSOID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "TempFitnessGram", body = list(DataObject = body), searchFields = append("TempFitnessGramID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempFitnessGram <- function(TempFitnessGramID, HasMissingData = NULL, Message = NULL, SchoolID = NULL, StudentID = NULL, StudentFirstName = NULL, StudentLastName = NULL, StudentBirthdate = NULL, StudentGrade = NULL, StudentGender = NULL, StudentPassword = NULL, ClassName = NULL, ClassID = NULL, ClassStartDate = NULL, ClassEndDate = NULL, TeacherID = NULL, TeacherFirstName = NULL, TeacherLastName = NULL, TeacherBirthDate = NULL, TeacherPassword = NULL, TeacherEmail = NULL, StudentMiddleInitial = NULL, StudentReportEmail = NULL, ParentReportEmail1 = NULL, ParentReportEmail2 = NULL, ClassDescription = NULL, TeacherMiddleInitial = NULL, CourseCodeDescription = NULL, SectionCode = NULL, StudentSSOID = NULL, TeacherSSOID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "TempFitnessGram", objectId = TempFitnessGramID, body = list(DataObject = body), searchFields = append("TempFitnessGramID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getIndicator <- function(IndicatorID, Name = F, Rank = F, IsActive = F, SkywardID = F, Image = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SkywardHash = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "Indicator", objectId = IndicatorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteIndicator <- function(IndicatorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "Indicator", objectId = IndicatorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createIndicator <- function(Name = NULL, Rank = NULL, IsActive = NULL, Image = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "Indicator", body = list(DataObject = body), searchFields = append("IndicatorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyIndicator <- function(IndicatorID, Name = NULL, Rank = NULL, IsActive = NULL, Image = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "Indicator", objectId = IndicatorID, body = list(DataObject = body), searchFields = append("IndicatorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSkylertAttendanceExportAttendanceType <- function(SkylertAttendanceExportAttendanceTypeID, SkylertAttendanceExportSettingID = F, AttendanceTypeID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AttendanceTypeCodeOverride = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "SkylertAttendanceExportAttendanceType", objectId = SkylertAttendanceExportAttendanceTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSkylertAttendanceExportAttendanceType <- function(SkylertAttendanceExportAttendanceTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "SkylertAttendanceExportAttendanceType", objectId = SkylertAttendanceExportAttendanceTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSkylertAttendanceExportAttendanceType <- function(SkylertAttendanceExportSettingID = NULL, AttendanceTypeID = NULL, AttendanceTypeCodeOverride = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "SkylertAttendanceExportAttendanceType", body = list(DataObject = body), searchFields = append("SkylertAttendanceExportAttendanceTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySkylertAttendanceExportAttendanceType <- function(SkylertAttendanceExportAttendanceTypeID, SkylertAttendanceExportSettingID = NULL, AttendanceTypeID = NULL, AttendanceTypeCodeOverride = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	getSkylertAttendanceExportSetting <- function(SkylertAttendanceExportSettingID, EntityID = F, SchoolYearID = F, ParentNotifiedOption = F, MinimumPeriodsAbsent = F, AttendancePeriodIDLow = F, AttendancePeriodIDHigh = F, FileSequence = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "SkylertAttendanceExportSetting", objectId = SkylertAttendanceExportSettingID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSkylertAttendanceExportSetting <- function(SkylertAttendanceExportSettingID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "SkylertAttendanceExportSetting", objectId = SkylertAttendanceExportSettingID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSkylertAttendanceExportSetting <- function(EntityID = NULL, SchoolYearID = NULL, ParentNotifiedOption = NULL, MinimumPeriodsAbsent = NULL, AttendancePeriodIDLow = NULL, AttendancePeriodIDHigh = NULL, FileSequence = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "SkylertAttendanceExportSetting", body = list(DataObject = body), searchFields = append("SkylertAttendanceExportSettingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySkylertAttendanceExportSetting <- function(SkylertAttendanceExportSettingID, EntityID = NULL, SchoolYearID = NULL, ParentNotifiedOption = NULL, MinimumPeriodsAbsent = NULL, AttendancePeriodIDLow = NULL, AttendancePeriodIDHigh = NULL, FileSequence = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "SkylertAttendanceExportSetting", objectId = SkylertAttendanceExportSettingID, body = list(DataObject = body), searchFields = append("SkylertAttendanceExportSettingID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStudentMedia <- function(StudentMediaID, StudentID = F, MediaID = F, DisplayName = F, DisplayInTeacherAccess = F, DisplayNameOrMediaName = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AttachmentTypeID = F, DisplayOnFamilyAccessPortfolio = F, DisplayOnStudentAccessPortfolio = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "StudentMedia", objectId = StudentMediaID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentMedia <- function(StudentMediaID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "StudentMedia", objectId = StudentMediaID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentMedia <- function(StudentID = NULL, MediaID = NULL, DisplayName = NULL, DisplayInTeacherAccess = NULL, AttachmentTypeID = NULL, DisplayOnFamilyAccessPortfolio = NULL, DisplayOnStudentAccessPortfolio = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "StudentMedia", body = list(DataObject = body), searchFields = append("StudentMediaID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentMedia <- function(StudentMediaID, StudentID = NULL, MediaID = NULL, DisplayName = NULL, DisplayInTeacherAccess = NULL, AttachmentTypeID = NULL, DisplayOnFamilyAccessPortfolio = NULL, DisplayOnStudentAccessPortfolio = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "StudentMedia", objectId = StudentMediaID, body = list(DataObject = body), searchFields = append("StudentMediaID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStudentWithoutLockerRecord <- function(TempStudentWithoutLockerRecordID, StudentID = F, FullName = F, StudentNumber = F, Gender = F, Age = F, GradYear = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentWithoutLockerRecord", objectId = TempStudentWithoutLockerRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentWithoutLockerRecord <- function(TempStudentWithoutLockerRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentWithoutLockerRecord", objectId = TempStudentWithoutLockerRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentWithoutLockerRecord <- function(StudentID = NULL, FullName = NULL, StudentNumber = NULL, Gender = NULL, Age = NULL, GradYear = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempStudentWithoutLockerRecord", body = list(DataObject = body), searchFields = append("TempStudentWithoutLockerRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentWithoutLockerRecord <- function(TempStudentWithoutLockerRecordID, StudentID = NULL, FullName = NULL, StudentNumber = NULL, Gender = NULL, Age = NULL, GradYear = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "TempStudentWithoutLockerRecord", objectId = TempStudentWithoutLockerRecordID, body = list(DataObject = body), searchFields = append("TempStudentWithoutLockerRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAlert <- function(AlertID, Information = F, StudentID = F, StartDate = F, EndDate = F, IsActive = F, IsCritical = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "Alert", objectId = AlertID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAlert <- function(AlertID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "Alert", objectId = AlertID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAlert <- function(Information = NULL, StudentID = NULL, StartDate = NULL, EndDate = NULL, IsCritical = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "Alert", body = list(DataObject = body), searchFields = append("AlertID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAlert <- function(AlertID, Information = NULL, StudentID = NULL, StartDate = NULL, EndDate = NULL, IsCritical = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "Alert", objectId = AlertID, body = list(DataObject = body), searchFields = append("AlertID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentError <- function(TempStudentErrorID, StudentID = F, FullStudentNameLFM = F, StudentNumber = F, GradYear = F, GradeLevelCode = F, StudentTypeCode = F, Note = F, LockerNumber = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, GraduationRequirementYear = F, ErrorCount = F, StudentTypeDescription = F, IsCurrentActive = F, GenderCode = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentError", objectId = TempStudentErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentError <- function(TempStudentErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentError", objectId = TempStudentErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempStudentError <- function(StudentID = NULL, FullStudentNameLFM = NULL, StudentNumber = NULL, GradYear = NULL, GradeLevelCode = NULL, StudentTypeCode = NULL, Note = NULL, LockerNumber = NULL, GraduationRequirementYear = NULL, ErrorCount = NULL, StudentTypeDescription = NULL, IsCurrentActive = NULL, GenderCode = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "TempStudentError", body = list(DataObject = body), searchFields = append("TempStudentErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempStudentError <- function(TempStudentErrorID, StudentID = NULL, FullStudentNameLFM = NULL, StudentNumber = NULL, GradYear = NULL, GradeLevelCode = NULL, StudentTypeCode = NULL, Note = NULL, LockerNumber = NULL, GraduationRequirementYear = NULL, ErrorCount = NULL, StudentTypeDescription = NULL, IsCurrentActive = NULL, GenderCode = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "TempStudentError", objectId = TempStudentErrorID, body = list(DataObject = body), searchFields = append("TempStudentErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentCustomCode <- function(StudentCustomCodeID, CustomCodeID = F, StudentID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "StudentCustomCode", objectId = StudentCustomCodeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentCustomCode <- function(StudentCustomCodeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "StudentCustomCode", objectId = StudentCustomCodeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentCustomCode <- function(CustomCodeID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "StudentCustomCode", body = list(DataObject = body), searchFields = append("StudentCustomCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentCustomCode <- function(StudentCustomCodeID, CustomCodeID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "StudentCustomCode", objectId = StudentCustomCodeID, body = list(DataObject = body), searchFields = append("StudentCustomCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCustomCode <- function(CustomCodeID, DistrictGroupKey = F, CustomCodeTypeID = F, Code = F, Description = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "CustomCode", objectId = CustomCodeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCustomCode <- function(CustomCodeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "CustomCode", objectId = CustomCodeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCustomCode <- function(DistrictGroupKey = NULL, CustomCodeTypeID = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "CustomCode", body = list(DataObject = body), searchFields = append("CustomCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCustomCode <- function(CustomCodeID, DistrictGroupKey = NULL, CustomCodeTypeID = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "CustomCode", objectId = CustomCodeID, body = list(DataObject = body), searchFields = append("CustomCodeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCustomCodeType <- function(CustomCodeTypeID, DistrictID = F, DistrictGroupKey = F, Code = F, Description = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "CustomCodeType", objectId = CustomCodeTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCustomCodeType <- function(CustomCodeTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "CustomCodeType", objectId = CustomCodeTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCustomCodeType <- function(DistrictID = NULL, DistrictGroupKey = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "CustomCodeType", body = list(DataObject = body), searchFields = append("CustomCodeTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCustomCodeType <- function(CustomCodeTypeID, DistrictID = NULL, DistrictGroupKey = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "CustomCodeType", objectId = CustomCodeTypeID, body = list(DataObject = body), searchFields = append("CustomCodeTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getFeederSchool <- function(FeederSchoolID, DistrictID = F, Code = F, Description = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "FeederSchool", objectId = FeederSchoolID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteFeederSchool <- function(FeederSchoolID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "FeederSchool", objectId = FeederSchoolID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createFeederSchool <- function(DistrictID = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "FeederSchool", body = list(DataObject = body), searchFields = append("FeederSchoolID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyFeederSchool <- function(FeederSchoolID, DistrictID = NULL, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "FeederSchool", objectId = FeederSchoolID, body = list(DataObject = body), searchFields = append("FeederSchoolID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentAssignedLockCombinationRecord <- function(TempStudentAssignedLockCombinationRecordID, StudentID = F, LockID = F, LockerID = F, FullName = F, StudentNumber = F, Gender = F, BirthDate = F, Age = F, GradYear = F, Grade = F, Building = F, LockerArea = F, LockerNumber = F, OldLockCombinationID = F, OldCombination = F, OldCombinationNumber = F, NewLockCombinationID = F, NewCombination = F, NewCombinationNumber = F, UnoccupiedLockersOnly = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentAssignedLockCombinationRecord", objectId = TempStudentAssignedLockCombinationRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentAssignedLockCombinationRecord <- function(TempStudentAssignedLockCombinationRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentAssignedLockCombinationRecord", objectId = TempStudentAssignedLockCombinationRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempStudentAssignedLockCombinationRecord <- function(StudentID = NULL, LockID = NULL, LockerID = NULL, FullName = NULL, StudentNumber = NULL, Gender = NULL, BirthDate = NULL, Age = NULL, GradYear = NULL, Grade = NULL, Building = NULL, LockerArea = NULL, LockerNumber = NULL, OldLockCombinationID = NULL, OldCombination = NULL, OldCombinationNumber = NULL, NewLockCombinationID = NULL, NewCombination = NULL, NewCombinationNumber = NULL, UnoccupiedLockersOnly = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "TempStudentAssignedLockCombinationRecord", body = list(DataObject = body), searchFields = append("TempStudentAssignedLockCombinationRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getLock <- function(LockID, SerialNumber = F, OwnedBySchool = F, IsBuiltInLock = F, LockerID = F, StudentID = F, LockMakeID = F, BuildingID = F, RenderRemoveLock = F, IsAvailable = F, IsAttached = F, IsAssigned = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "Lock", objectId = LockID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteLock <- function(LockID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "Lock", objectId = LockID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createLock <- function(SerialNumber = NULL, OwnedBySchool = NULL, IsBuiltInLock = NULL, LockerID = NULL, StudentID = NULL, LockMakeID = NULL, BuildingID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "Lock", body = list(DataObject = body), searchFields = append("LockID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyLock <- function(LockID, SerialNumber = NULL, OwnedBySchool = NULL, IsBuiltInLock = NULL, LockerID = NULL, StudentID = NULL, LockMakeID = NULL, BuildingID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "Lock", objectId = LockID, body = list(DataObject = body), searchFields = append("LockID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getLockCombination <- function(LockCombinationID, Combination = F, IsCurrentCombination = F, CombinationNumber = F, LockID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "LockCombination", objectId = LockCombinationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteLockCombination <- function(LockCombinationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "LockCombination", objectId = LockCombinationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createLockCombination <- function(Combination = NULL, IsCurrentCombination = NULL, CombinationNumber = NULL, LockID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "LockCombination", body = list(DataObject = body), searchFields = append("LockCombinationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyLockCombination <- function(LockCombinationID, Combination = NULL, IsCurrentCombination = NULL, CombinationNumber = NULL, LockID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "LockCombination", objectId = LockCombinationID, body = list(DataObject = body), searchFields = append("LockCombinationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getLocker <- function(LockerID, LockerNumber = F, IsActive = F, IsDamaged = F, HasBuiltInLock = F, Comment = F, LockerAreaID = F, StudentsPerLocker = F, IsAvailable = F, CurrentCombination = F, GenderCode = F, GenderCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, NeedsLock = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "Locker", objectId = LockerID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteLocker <- function(LockerID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "Locker", objectId = LockerID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createLocker <- function(LockerNumber = NULL, IsActive = NULL, IsDamaged = NULL, HasBuiltInLock = NULL, Comment = NULL, LockerAreaID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "Locker", body = list(DataObject = body), searchFields = append("LockerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyLocker <- function(LockerID, LockerNumber = NULL, IsActive = NULL, IsDamaged = NULL, HasBuiltInLock = NULL, Comment = NULL, LockerAreaID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "Locker", objectId = LockerID, body = list(DataObject = body), searchFields = append("LockerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getLockerArea <- function(LockerAreaID, Code = F, Description = F, HasBuiltInLockDefault = F, MaximumStudentsPerLocker = F, AllowCoedLocker = F, BuildingID = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "LockerArea", objectId = LockerAreaID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteLockerArea <- function(LockerAreaID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "LockerArea", objectId = LockerAreaID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createLockerArea <- function(Code = NULL, Description = NULL, HasBuiltInLockDefault = NULL, MaximumStudentsPerLocker = NULL, AllowCoedLocker = NULL, BuildingID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "LockerArea", body = list(DataObject = body), searchFields = append("LockerAreaID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyLockerArea <- function(LockerAreaID, Code = NULL, Description = NULL, HasBuiltInLockDefault = NULL, MaximumStudentsPerLocker = NULL, AllowCoedLocker = NULL, BuildingID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "LockerArea", objectId = LockerAreaID, body = list(DataObject = body), searchFields = append("LockerAreaID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getLockMake <- function(LockMakeID, Code = F, Description = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "LockMake", objectId = LockMakeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteLockMake <- function(LockMakeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "LockMake", objectId = LockMakeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createLockMake <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "LockMake", body = list(DataObject = body), searchFields = append("LockMakeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyLockMake <- function(LockMakeID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "LockMake", objectId = LockMakeID, body = list(DataObject = body), searchFields = append("LockMakeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentDistrict <- function(StudentDistrictID, StudentID = F, DistrictID = F, FeederSchoolID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, FirstName = F, MiddleName = F, LastName = F, NameID = F, Grade = F, StudentNumber = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "StudentDistrict", objectId = StudentDistrictID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentDistrict <- function(StudentDistrictID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "StudentDistrict", objectId = StudentDistrictID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentDistrict <- function(StudentID = NULL, DistrictID = NULL, FeederSchoolID = NULL, NameID = NULL, Grade = NULL, StudentNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "StudentDistrict", body = list(DataObject = body), searchFields = append("StudentDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentDistrict <- function(StudentDistrictID, StudentID = NULL, DistrictID = NULL, FeederSchoolID = NULL, NameID = NULL, Grade = NULL, StudentNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "StudentDistrict", objectId = StudentDistrictID, body = list(DataObject = body), searchFields = append("StudentDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentLocker <- function(StudentLockerID, IsPrimaryLocker = F, LockerID = F, StudentID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "StudentLocker", objectId = StudentLockerID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentLocker <- function(StudentLockerID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "StudentLocker", objectId = StudentLockerID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentLocker <- function(IsPrimaryLocker = NULL, LockerID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "StudentLocker", body = list(DataObject = body), searchFields = append("StudentLockerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentLocker <- function(StudentLockerID, IsPrimaryLocker = NULL, LockerID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "StudentLocker", objectId = StudentLockerID, body = list(DataObject = body), searchFields = append("StudentLockerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentAssignedLockerRecord <- function(TempStudentAssignedLockerRecordID, StudentID = F, LockerID = F, FullName = F, StudentNumber = F, Gender = F, BirthDate = F, Age = F, GradYear = F, Grade = F, Building = F, LockerArea = F, LockerNumber = F, Combination = F, IsStudentAccessUser = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentAssignedLockerRecord", objectId = TempStudentAssignedLockerRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentAssignedLockerRecord <- function(TempStudentAssignedLockerRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentAssignedLockerRecord", objectId = TempStudentAssignedLockerRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempStudentAssignedLockerRecord <- function(StudentID = NULL, LockerID = NULL, FullName = NULL, StudentNumber = NULL, Gender = NULL, BirthDate = NULL, Age = NULL, GradYear = NULL, Grade = NULL, Building = NULL, LockerArea = NULL, LockerNumber = NULL, Combination = NULL, IsStudentAccessUser = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "TempStudentAssignedLockerRecord", body = list(DataObject = body), searchFields = append("TempStudentAssignedLockerRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempStudentAssignedLockerRecord <- function(TempStudentAssignedLockerRecordID, StudentID = NULL, LockerID = NULL, FullName = NULL, StudentNumber = NULL, Gender = NULL, BirthDate = NULL, Age = NULL, GradYear = NULL, Grade = NULL, Building = NULL, LockerArea = NULL, LockerNumber = NULL, Combination = NULL, IsStudentAccessUser = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "TempStudentAssignedLockerRecord", objectId = TempStudentAssignedLockerRecordID, body = list(DataObject = body), searchFields = append("TempStudentAssignedLockerRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStudentConfigSystem <- function(StudentConfigSystemID, ConfigSystemID = F, StudentNumberMask = F, StudentNumberStartValue = F, AllowStudentAccessDefault = F, EmailTypeIDDefault = F, EmailDomain = F, AutoGenerateEmail = F, AutoGenerateSecurityUser = F, StudentAttachmentVisibility = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EasyIEPSpecEdImportFileName = F, EasyIEPSection504ImportFileName = F, FileDestinationIDEasyIEPSpecEdImport = F, FileDestinationIDEasyIEPSection504Import = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "ConfigSystem", objectId = StudentConfigSystemID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentConfigSystem <- function(StudentConfigSystemID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "ConfigSystem", objectId = StudentConfigSystemID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createStudentConfigSystem <- function(StudentNumberMask = NULL, StudentNumberStartValue = NULL, AllowStudentAccessDefault = NULL, EmailTypeIDDefault = NULL, EmailDomain = NULL, AutoGenerateEmail = NULL, AutoGenerateSecurityUser = NULL, StudentAttachmentVisibility = NULL, EasyIEPSpecEdImportFileName = NULL, EasyIEPSection504ImportFileName = NULL, FileDestinationIDEasyIEPSpecEdImport = NULL, FileDestinationIDEasyIEPSection504Import = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "ConfigSystem", body = list(DataObject = body), searchFields = append("ConfigSystemID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyStudentConfigSystem <- function(ConfigSystemID, StudentNumberMask = NULL, StudentNumberStartValue = NULL, AllowStudentAccessDefault = NULL, EmailTypeIDDefault = NULL, EmailDomain = NULL, AutoGenerateEmail = NULL, AutoGenerateSecurityUser = NULL, StudentAttachmentVisibility = NULL, EasyIEPSpecEdImportFileName = NULL, EasyIEPSection504ImportFileName = NULL, FileDestinationIDEasyIEPSpecEdImport = NULL, FileDestinationIDEasyIEPSection504Import = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "ConfigSystem", objectId = ConfigSystemID, body = list(DataObject = body), searchFields = append("ConfigSystemID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getNextStudentNumber <- function(NextStudentNumberID, MaskPrefix = F, SequenceNumber = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsForStateID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "NextStudentNumber", objectId = NextStudentNumberID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteNextStudentNumber <- function(NextStudentNumberID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "NextStudentNumber", objectId = NextStudentNumberID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createNextStudentNumber <- function(MaskPrefix = NULL, SequenceNumber = NULL, IsForStateID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "NextStudentNumber", body = list(DataObject = body), searchFields = append("NextStudentNumberID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyNextStudentNumber <- function(NextStudentNumberID, MaskPrefix = NULL, SequenceNumber = NULL, IsForStateID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "NextStudentNumber", objectId = NextStudentNumberID, body = list(DataObject = body), searchFields = append("NextStudentNumberID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentPermit <- function(TempStudentPermitID, StudentID = F, PermitID = F, FullNameLFM = F, StudentNumber = F, GenderCode = F, Age = F, GradYear = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AddressID = F, EntityName = F, HasExceptions = F, ExceptionNote = F, SchoolYearID = F, DistrictID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentPermit", objectId = TempStudentPermitID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentPermit <- function(TempStudentPermitID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentPermit", objectId = TempStudentPermitID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentPermit <- function(StudentID = NULL, PermitID = NULL, FullNameLFM = NULL, StudentNumber = NULL, GenderCode = NULL, Age = NULL, GradYear = NULL, AddressID = NULL, EntityName = NULL, HasExceptions = NULL, ExceptionNote = NULL, SchoolYearID = NULL, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempStudentPermit", body = list(DataObject = body), searchFields = append("TempStudentPermitID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempStudentPermit <- function(TempStudentPermitID, StudentID = NULL, PermitID = NULL, FullNameLFM = NULL, StudentNumber = NULL, GenderCode = NULL, Age = NULL, GradYear = NULL, AddressID = NULL, EntityName = NULL, HasExceptions = NULL, ExceptionNote = NULL, SchoolYearID = NULL, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "TempStudentPermit", objectId = TempStudentPermitID, body = list(DataObject = body), searchFields = append("TempStudentPermitID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStudentConfigEntityGroupYear <- function(StudentConfigEntityGroupYearID, ConfigEntityGroupYearID = F, EntityID = F, SchoolYearID = F, EntityGroupKey = F, DefaultAllowFeeManagementOnlinePaymentAccess = F, DefaultAllowFoodServiceOnlinePaymentAccess = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, FollettDestinyCustomEntityCode = F, StudentAccessAccountInfoEmailSubject = F, StudentAccessAccountInfoEmailBody = F, StudentAccessAccountInfoEmailIncludeResetPasswordText = F, FollettDestinyRoomTeacherType = F, FollettDestinyRoomTeacherPeriod = F, CourseSubjectIDFollettDestinyRoomTeacher = F, ConfigEntityGroupYearIDClonedFrom = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "ConfigEntityGroupYear", objectId = StudentConfigEntityGroupYearID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentConfigEntityGroupYear <- function(StudentConfigEntityGroupYearID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "ConfigEntityGroupYear", objectId = StudentConfigEntityGroupYearID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createStudentConfigEntityGroupYear <- function(EntityID = NULL, SchoolYearID = NULL, EntityGroupKey = NULL, DefaultAllowFeeManagementOnlinePaymentAccess = NULL, DefaultAllowFoodServiceOnlinePaymentAccess = NULL, FollettDestinyCustomEntityCode = NULL, StudentAccessAccountInfoEmailSubject = NULL, StudentAccessAccountInfoEmailBody = NULL, StudentAccessAccountInfoEmailIncludeResetPasswordText = NULL, FollettDestinyRoomTeacherType = NULL, FollettDestinyRoomTeacherPeriod = NULL, CourseSubjectIDFollettDestinyRoomTeacher = NULL, ConfigEntityGroupYearIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "ConfigEntityGroupYear", body = list(DataObject = body), searchFields = append("ConfigEntityGroupYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyStudentConfigEntityGroupYear <- function(ConfigEntityGroupYearID, EntityID = NULL, SchoolYearID = NULL, EntityGroupKey = NULL, DefaultAllowFeeManagementOnlinePaymentAccess = NULL, DefaultAllowFoodServiceOnlinePaymentAccess = NULL, FollettDestinyCustomEntityCode = NULL, StudentAccessAccountInfoEmailSubject = NULL, StudentAccessAccountInfoEmailBody = NULL, StudentAccessAccountInfoEmailIncludeResetPasswordText = NULL, FollettDestinyRoomTeacherType = NULL, FollettDestinyRoomTeacherPeriod = NULL, CourseSubjectIDFollettDestinyRoomTeacher = NULL, ConfigEntityGroupYearIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "ConfigEntityGroupYear", objectId = ConfigEntityGroupYearID, body = list(DataObject = body), searchFields = append("ConfigEntityGroupYearID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempLockCombination <- function(TempLockCombinationID, TempLockerID = F, Combination = F, CombinationNumber = F, FailureReason = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempLockCombination", objectId = TempLockCombinationID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempLockCombination <- function(TempLockCombinationID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempLockCombination", objectId = TempLockCombinationID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempLockCombination <- function(TempLockerID = NULL, Combination = NULL, CombinationNumber = NULL, FailureReason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempLockCombination", body = list(DataObject = body), searchFields = append("TempLockCombinationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempLockCombination <- function(TempLockCombinationID, TempLockerID = NULL, Combination = NULL, CombinationNumber = NULL, FailureReason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "TempLockCombination", objectId = TempLockCombinationID, body = list(DataObject = body), searchFields = append("TempLockCombinationID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempLocker <- function(TempLockerID, LockerNumber = F, BuildingID = F, Building = F, LockerAreaID = F, LockerArea = F, FailureReason = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Comment = F, LockerNumberDigitLength = F, NewLockerNumber = F, LockerID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempLocker", objectId = TempLockerID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempLocker <- function(TempLockerID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempLocker", objectId = TempLockerID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempLocker <- function(LockerNumber = NULL, BuildingID = NULL, Building = NULL, LockerAreaID = NULL, LockerArea = NULL, FailureReason = NULL, Comment = NULL, LockerNumberDigitLength = NULL, NewLockerNumber = NULL, LockerID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempLocker", body = list(DataObject = body), searchFields = append("TempLockerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempLocker <- function(TempLockerID, LockerNumber = NULL, BuildingID = NULL, Building = NULL, LockerAreaID = NULL, LockerArea = NULL, FailureReason = NULL, Comment = NULL, LockerNumberDigitLength = NULL, NewLockerNumber = NULL, LockerID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "TempLocker", objectId = TempLockerID, body = list(DataObject = body), searchFields = append("TempLockerID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentMassUpdate <- function(StudentMassUpdateID, UserIDRanBy = F, SchoolYearID = F, AsOfDate = F, RunReason = F, FilterParameters = F, ValueParameters = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DistrictID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "StudentMassUpdate", objectId = StudentMassUpdateID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentMassUpdate <- function(StudentMassUpdateID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "StudentMassUpdate", objectId = StudentMassUpdateID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentMassUpdate <- function(UserIDRanBy = NULL, SchoolYearID = NULL, AsOfDate = NULL, RunReason = NULL, FilterParameters = NULL, ValueParameters = NULL, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "StudentMassUpdate", body = list(DataObject = body), searchFields = append("StudentMassUpdateID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentMassUpdate <- function(StudentMassUpdateID, UserIDRanBy = NULL, SchoolYearID = NULL, AsOfDate = NULL, RunReason = NULL, FilterParameters = NULL, ValueParameters = NULL, DistrictID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "StudentMassUpdate", objectId = StudentMassUpdateID, body = list(DataObject = body), searchFields = append("StudentMassUpdateID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStudentMassUpdateError <- function(TempStudentMassUpdateErrorID, FullNameLFM = F, Type = F, FailureReason = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentMassUpdateError", objectId = TempStudentMassUpdateErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentMassUpdateError <- function(TempStudentMassUpdateErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentMassUpdateError", objectId = TempStudentMassUpdateErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentMassUpdateError <- function(FullNameLFM = NULL, Type = NULL, FailureReason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempStudentMassUpdateError", body = list(DataObject = body), searchFields = append("TempStudentMassUpdateErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentMassUpdateError <- function(TempStudentMassUpdateErrorID, FullNameLFM = NULL, Type = NULL, FailureReason = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "TempStudentMassUpdateError", objectId = TempStudentMassUpdateErrorID, body = list(DataObject = body), searchFields = append("TempStudentMassUpdateErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempStudentMassUpdateField <- function(TempStudentMassUpdateFieldID, StudentID = F, AffectedPrimaryKey = F, FullNameLFM = F, FieldName = F, OriginalValue = F, FriendlyOriginalValue = F, UpdatedValue = F, FriendlyUpdatedValue = F, RelatedType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentMassUpdateField", objectId = TempStudentMassUpdateFieldID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentMassUpdateField <- function(TempStudentMassUpdateFieldID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentMassUpdateField", objectId = TempStudentMassUpdateFieldID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentMassUpdateField <- function(StudentID = NULL, AffectedPrimaryKey = NULL, FullNameLFM = NULL, FieldName = NULL, OriginalValue = NULL, FriendlyOriginalValue = NULL, UpdatedValue = NULL, FriendlyUpdatedValue = NULL, RelatedType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempStudentMassUpdateField", body = list(DataObject = body), searchFields = append("TempStudentMassUpdateFieldID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentMassUpdateField <- function(TempStudentMassUpdateFieldID, StudentID = NULL, AffectedPrimaryKey = NULL, FullNameLFM = NULL, FieldName = NULL, OriginalValue = NULL, FriendlyOriginalValue = NULL, UpdatedValue = NULL, FriendlyUpdatedValue = NULL, RelatedType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "TempStudentMassUpdateField", objectId = TempStudentMassUpdateFieldID, body = list(DataObject = body), searchFields = append("TempStudentMassUpdateFieldID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStudentMergeObject <- function(TempStudentMergeObjectID, FieldToShow = F, RecordType = F, HandlingType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentMergeObject", objectId = TempStudentMergeObjectID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentMergeObject <- function(TempStudentMergeObjectID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentMergeObject", objectId = TempStudentMergeObjectID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentMergeObject <- function(FieldToShow = NULL, RecordType = NULL, HandlingType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempStudentMergeObject", body = list(DataObject = body), searchFields = append("TempStudentMergeObjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentMergeObject <- function(TempStudentMergeObjectID, FieldToShow = NULL, RecordType = NULL, HandlingType = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "TempStudentMergeObject", objectId = TempStudentMergeObjectID, body = list(DataObject = body), searchFields = append("TempStudentMergeObjectID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getStudentConfigDistrict <- function(StudentConfigDistrictID, ConfigDistrictID = F, DistrictID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, EnableIEPWriterDocumentFunctions = F, IEPWriterDocumentSecurityToken = F, ShowIEPWriterIEPLinkOnIndicatorPopup = F, ShowIEPWriterIEP504LinkOnIndicatorPopup = F, FileDestinationIDSchoolMint = F, EmbraceImportFileName = F, FileDestinationIDEmbraceImport = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "ConfigDistrict", objectId = StudentConfigDistrictID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentConfigDistrict <- function(StudentConfigDistrictID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "ConfigDistrict", objectId = StudentConfigDistrictID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createStudentConfigDistrict <- function(DistrictID = NULL, EnableIEPWriterDocumentFunctions = NULL, ShowIEPWriterIEPLinkOnIndicatorPopup = NULL, ShowIEPWriterIEP504LinkOnIndicatorPopup = NULL, FileDestinationIDSchoolMint = NULL, EmbraceImportFileName = NULL, FileDestinationIDEmbraceImport = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "ConfigDistrict", body = list(DataObject = body), searchFields = append("ConfigDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyStudentConfigDistrict <- function(ConfigDistrictID, DistrictID = NULL, EnableIEPWriterDocumentFunctions = NULL, ShowIEPWriterIEPLinkOnIndicatorPopup = NULL, ShowIEPWriterIEP504LinkOnIndicatorPopup = NULL, FileDestinationIDSchoolMint = NULL, EmbraceImportFileName = NULL, FileDestinationIDEmbraceImport = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "ConfigDistrict", objectId = ConfigDistrictID, body = list(DataObject = body), searchFields = append("ConfigDistrictID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSkylertAttendanceExportSettingScheduledTask <- function(SkylertAttendanceExportSettingScheduledTaskID, SkylertAttendanceExportSettingID = F, ScheduledTaskID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "SkylertAttendanceExportSettingScheduledTask", objectId = SkylertAttendanceExportSettingScheduledTaskID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSkylertAttendanceExportSettingScheduledTask <- function(SkylertAttendanceExportSettingScheduledTaskID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "SkylertAttendanceExportSettingScheduledTask", objectId = SkylertAttendanceExportSettingScheduledTaskID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSkylertAttendanceExportSettingScheduledTask <- function(SkylertAttendanceExportSettingID = NULL, ScheduledTaskID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "SkylertAttendanceExportSettingScheduledTask", body = list(DataObject = body), searchFields = append("SkylertAttendanceExportSettingScheduledTaskID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySkylertAttendanceExportSettingScheduledTask <- function(SkylertAttendanceExportSettingScheduledTaskID, SkylertAttendanceExportSettingID = NULL, ScheduledTaskID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStudentErrorMessage <- function(TempStudentErrorMessageID, TempStudentErrorID = F, Error = F, ErrorDetail = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempStudentErrorMessage", objectId = TempStudentErrorMessageID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempStudentErrorMessage <- function(TempStudentErrorMessageID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempStudentErrorMessage", objectId = TempStudentErrorMessageID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempStudentErrorMessage <- function(TempStudentErrorID = NULL, Error = NULL, ErrorDetail = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempStudentErrorMessage", body = list(DataObject = body), searchFields = append("TempStudentErrorMessageID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempStudentErrorMessage <- function(TempStudentErrorMessageID, TempStudentErrorID = NULL, Error = NULL, ErrorDetail = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "TempStudentErrorMessage", objectId = TempStudentErrorMessageID, body = list(DataObject = body), searchFields = append("TempStudentErrorMessageID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listFallSports <- function(searchConditionsList = NULL, FallSportID = F, Code = F, FallSport = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getFallSport <- function(FallSportID, Code = F, FallSport = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "FallSport", objectId = FallSportID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteFallSport <- function(FallSportID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "FallSport", objectId = FallSportID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createFallSport <- function(Code = NULL, FallSport = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "FallSport", body = list(DataObject = body), searchFields = append("FallSportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyFallSport <- function(FallSportID, Code = NULL, FallSport = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "FallSport", objectId = FallSportID, body = list(DataObject = body), searchFields = append("FallSportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listWinterSports <- function(searchConditionsList = NULL, WinterSportID = F, Code = F, WinterSport = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getWinterSport <- function(WinterSportID, Code = F, WinterSport = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "WinterSport", objectId = WinterSportID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWinterSport <- function(WinterSportID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "WinterSport", objectId = WinterSportID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createWinterSport <- function(Code = NULL, WinterSport = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "WinterSport", body = list(DataObject = body), searchFields = append("WinterSportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyWinterSport <- function(WinterSportID, Code = NULL, WinterSport = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "WinterSport", objectId = WinterSportID, body = list(DataObject = body), searchFields = append("WinterSportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listSpringSports <- function(searchConditionsList = NULL, SpringSportID = F, Code = F, SpringSport = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSpringSport <- function(SpringSportID, Code = F, SpringSport = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "SpringSport", objectId = SpringSportID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSpringSport <- function(SpringSportID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "SpringSport", objectId = SpringSportID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSpringSport <- function(Code = NULL, SpringSport = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "SpringSport", body = list(DataObject = body), searchFields = append("SpringSportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySpringSport <- function(SpringSportID, Code = NULL, SpringSport = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "SpringSport", objectId = SpringSportID, body = list(DataObject = body), searchFields = append("SpringSportID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getFallSportsTeam <- function(FallSportsTeamID, SchoolYearID = F, FallSportID = F, Lettered = F, Captain = F, StudentID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "FallSportsTeam", objectId = FallSportsTeamID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteFallSportsTeam <- function(FallSportsTeamID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "FallSportsTeam", objectId = FallSportsTeamID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createFallSportsTeam <- function(SchoolYearID = NULL, FallSportID = NULL, Lettered = NULL, Captain = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "FallSportsTeam", body = list(DataObject = body), searchFields = append("FallSportsTeamID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyFallSportsTeam <- function(FallSportsTeamID, SchoolYearID = NULL, FallSportID = NULL, Lettered = NULL, Captain = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "FallSportsTeam", objectId = FallSportsTeamID, body = list(DataObject = body), searchFields = append("FallSportsTeamID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getWinterSportsTeam <- function(WinterSportsTeamID, SchoolYearID = F, WinterSportID = F, Lettered = F, Captain = F, StudentID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "WinterSportsTeam", objectId = WinterSportsTeamID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteWinterSportsTeam <- function(WinterSportsTeamID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "WinterSportsTeam", objectId = WinterSportsTeamID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createWinterSportsTeam <- function(SchoolYearID = NULL, WinterSportID = NULL, Lettered = NULL, Captain = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "WinterSportsTeam", body = list(DataObject = body), searchFields = append("WinterSportsTeamID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyWinterSportsTeam <- function(WinterSportsTeamID, SchoolYearID = NULL, WinterSportID = NULL, Lettered = NULL, Captain = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "WinterSportsTeam", objectId = WinterSportsTeamID, body = list(DataObject = body), searchFields = append("WinterSportsTeamID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSpringSportsTeam <- function(SpringSportsTeamID, SpringSportID = F, SchoolYearID = F, Lettered = F, Captain = F, StudentID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "SpringSportsTeam", objectId = SpringSportsTeamID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSpringSportsTeam <- function(SpringSportsTeamID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "SpringSportsTeam", objectId = SpringSportsTeamID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSpringSportsTeam <- function(SpringSportID = NULL, SchoolYearID = NULL, Lettered = NULL, Captain = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "SpringSportsTeam", body = list(DataObject = body), searchFields = append("SpringSportsTeamID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySpringSportsTeam <- function(SpringSportsTeamID, SpringSportID = NULL, SchoolYearID = NULL, Lettered = NULL, Captain = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "SpringSportsTeam", objectId = SpringSportsTeamID, body = list(DataObject = body), searchFields = append("SpringSportsTeamID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listReligions <- function(searchConditionsList = NULL, ReligionID = F, Code = F, Description = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getReligion <- function(ReligionID, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "Religion", objectId = ReligionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteReligion <- function(ReligionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "Religion", objectId = ReligionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createReligion <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "Religion", body = list(DataObject = body), searchFields = append("ReligionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyReligion <- function(ReligionID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "Religion", objectId = ReligionID, body = list(DataObject = body), searchFields = append("ReligionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getCurrentSportsSelections <- function(CurrentSportsSelectionsID, FallSportID = F, WinterSportID = F, SpringSportID = F, StudentID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "CurrentSportsSelections", objectId = CurrentSportsSelectionsID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteCurrentSportsSelections <- function(CurrentSportsSelectionsID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "CurrentSportsSelections", objectId = CurrentSportsSelectionsID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createCurrentSportsSelections <- function(FallSportID = NULL, WinterSportID = NULL, SpringSportID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "CurrentSportsSelections", body = list(DataObject = body), searchFields = append("CurrentSportsSelectionsID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyCurrentSportsSelections <- function(CurrentSportsSelectionsID, FallSportID = NULL, WinterSportID = NULL, SpringSportID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "CurrentSportsSelections", objectId = CurrentSportsSelectionsID, body = list(DataObject = body), searchFields = append("CurrentSportsSelectionsID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listEthnicityMAS <- function(searchConditionsList = NULL, EthnicityMAID = F, Code = F, Ethnicity = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getEthnicityMA <- function(EthnicityMAID, Code = F, Ethnicity = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "EthnicityMA", objectId = EthnicityMAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEthnicityMA <- function(EthnicityMAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "EthnicityMA", objectId = EthnicityMAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEthnicityMA <- function(Code = NULL, Ethnicity = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "EthnicityMA", body = list(DataObject = body), searchFields = append("EthnicityMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEthnicityMA <- function(EthnicityMAID, Code = NULL, Ethnicity = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "EthnicityMA", objectId = EthnicityMAID, body = list(DataObject = body), searchFields = append("EthnicityMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listStudentEthnicityMAS <- function(searchConditionsList = NULL, StudentEthnicityMAID = F, StudentID = F, EthnicityMAID = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentEthnicityMA <- function(StudentEthnicityMAID, StudentID = F, EthnicityMAID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "StudentEthnicityMA", objectId = StudentEthnicityMAID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentEthnicityMA <- function(StudentEthnicityMAID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "StudentEthnicityMA", objectId = StudentEthnicityMAID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentEthnicityMA <- function(StudentID = NULL, EthnicityMAID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "StudentEthnicityMA", body = list(DataObject = body), searchFields = append("StudentEthnicityMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentEthnicityMA <- function(StudentEthnicityMAID, StudentID = NULL, EthnicityMAID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "StudentEthnicityMA", objectId = StudentEthnicityMAID, body = list(DataObject = body), searchFields = append("StudentEthnicityMAID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listAwardCategories <- function(searchConditionsList = NULL, AwardCategoryID = F, Code = F, Description = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAwardCategory <- function(AwardCategoryID, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "AwardCategory", objectId = AwardCategoryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAwardCategory <- function(AwardCategoryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "AwardCategory", objectId = AwardCategoryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAwardCategory <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "AwardCategory", body = list(DataObject = body), searchFields = append("AwardCategoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAwardCategory <- function(AwardCategoryID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "AwardCategory", objectId = AwardCategoryID, body = list(DataObject = body), searchFields = append("AwardCategoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listAwardTypes <- function(searchConditionsList = NULL, AwardTypeID = F, Code = F, Description = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAwardType <- function(AwardTypeID, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "AwardType", objectId = AwardTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAwardType <- function(AwardTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "AwardType", objectId = AwardTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAwardType <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "AwardType", body = list(DataObject = body), searchFields = append("AwardTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAwardType <- function(AwardTypeID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "AwardType", objectId = AwardTypeID, body = list(DataObject = body), searchFields = append("AwardTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	listAwardHardwares <- function(searchConditionsList = NULL, AwardHardwareID = F, Code = F, Description = F, fieldPaths = NULL, searchConditionsGroupType = "And", searchSortFieldNamesList = NULL, searchSortFieldNamesDescendingList = NULL, entityId = 1, schoolYearId = NULL, page = 1, pageSize = 100000, flatten = T, returnResponse = F){
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getAwardHardware <- function(AwardHardwareID, Code = F, Description = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "AwardHardware", objectId = AwardHardwareID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteAwardHardware <- function(AwardHardwareID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "AwardHardware", objectId = AwardHardwareID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createAwardHardware <- function(Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "AwardHardware", body = list(DataObject = body), searchFields = append("AwardHardwareID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyAwardHardware <- function(AwardHardwareID, Code = NULL, Description = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "AwardHardware", objectId = AwardHardwareID, body = list(DataObject = body), searchFields = append("AwardHardwareID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStudentAward <- function(StudentAwardID, AwardCategoryID = F, AwardTypeID = F, AwardHardwareID = F, ActivityID = F, SchoolYearID = F, StudentID = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "StudentAward", objectId = StudentAwardID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteStudentAward <- function(StudentAwardID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "StudentAward", objectId = StudentAwardID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createStudentAward <- function(AwardCategoryID = NULL, AwardTypeID = NULL, AwardHardwareID = NULL, ActivityID = NULL, SchoolYearID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "StudentAward", body = list(DataObject = body), searchFields = append("StudentAwardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyStudentAward <- function(StudentAwardID, AwardCategoryID = NULL, AwardTypeID = NULL, AwardHardwareID = NULL, ActivityID = NULL, SchoolYearID = NULL, StudentID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "StudentAward", objectId = StudentAwardID, body = list(DataObject = body), searchFields = append("StudentAwardID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempMassAssignCTEIndicatorTXException <- function(TempMassAssignCTEIndicatorTXExceptionID, TempMassAssignCTEIndicatorTXID = F, StudentID = F, Note = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempMassAssignCTEIndicatorTXException", objectId = TempMassAssignCTEIndicatorTXExceptionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempMassAssignCTEIndicatorTXException <- function(TempMassAssignCTEIndicatorTXExceptionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempMassAssignCTEIndicatorTXException", objectId = TempMassAssignCTEIndicatorTXExceptionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTempMassAssignCTEIndicatorTXException <- function(TempMassAssignCTEIndicatorTXID = NULL, StudentID = NULL, Note = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TempMassAssignCTEIndicatorTXException", body = list(DataObject = body), searchFields = append("TempMassAssignCTEIndicatorTXExceptionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTempMassAssignCTEIndicatorTXException <- function(TempMassAssignCTEIndicatorTXExceptionID, TempMassAssignCTEIndicatorTXID = NULL, StudentID = NULL, Note = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	getSchoolMintRunHistoryStudentError <- function(SchoolMintRunHistoryStudentErrorID, SchoolMintRunHistoryID = F, StudentIdentifier = F, StudentNameLFM = F, SchoolName = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ContainsNonStudentInfoDetails = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "SchoolMintRunHistoryStudentError", objectId = SchoolMintRunHistoryStudentErrorID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolMintRunHistoryStudentError <- function(SchoolMintRunHistoryStudentErrorID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "SchoolMintRunHistoryStudentError", objectId = SchoolMintRunHistoryStudentErrorID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolMintRunHistoryStudentError <- function(SchoolMintRunHistoryID = NULL, StudentIdentifier = NULL, StudentNameLFM = NULL, SchoolName = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "SchoolMintRunHistoryStudentError", body = list(DataObject = body), searchFields = append("SchoolMintRunHistoryStudentErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolMintRunHistoryStudentError <- function(SchoolMintRunHistoryStudentErrorID, SchoolMintRunHistoryID = NULL, StudentIdentifier = NULL, StudentNameLFM = NULL, SchoolName = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "SchoolMintRunHistoryStudentError", objectId = SchoolMintRunHistoryStudentErrorID, body = list(DataObject = body), searchFields = append("SchoolMintRunHistoryStudentErrorID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSchoolMintRunHistory <- function(SchoolMintRunHistoryID, SchoolYearID = F, RunTime = F, SuccessCount = F, StudentSuccessCount = F, AddressSuccessCount = F, GuardianSuccessCount = F, FoodServiceSuccessCount = F, FailCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "SchoolMintRunHistory", objectId = SchoolMintRunHistoryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolMintRunHistory <- function(SchoolMintRunHistoryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "SchoolMintRunHistory", objectId = SchoolMintRunHistoryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolMintRunHistory <- function(SchoolYearID = NULL, RunTime = NULL, SuccessCount = NULL, StudentSuccessCount = NULL, AddressSuccessCount = NULL, GuardianSuccessCount = NULL, FoodServiceSuccessCount = NULL, FailCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "SchoolMintRunHistory", body = list(DataObject = body), searchFields = append("SchoolMintRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolMintRunHistory <- function(SchoolMintRunHistoryID, SchoolYearID = NULL, RunTime = NULL, SuccessCount = NULL, StudentSuccessCount = NULL, AddressSuccessCount = NULL, GuardianSuccessCount = NULL, FoodServiceSuccessCount = NULL, FailCount = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "SchoolMintRunHistory", objectId = SchoolMintRunHistoryID, body = list(DataObject = body), searchFields = append("SchoolMintRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getTempEmbrace <- function(TempEmbraceID, HasExceptions = F, Exceptions = F, StudentNumber = F, StudentStateNumber = F, FirstName = F, MiddleName = F, LastName = F, HasIEP = F, IEPStartDate = F, PrimaryEligibility = F, SecondaryEligibility = F, HasSection504 = F, Section504StartDate = F, Section504EndDate = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TempEmbrace", objectId = TempEmbraceID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTempEmbrace <- function(TempEmbraceID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TempEmbrace", objectId = TempEmbraceID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createTempEmbrace <- function(HasExceptions = NULL, Exceptions = NULL, StudentNumber = NULL, StudentStateNumber = NULL, FirstName = NULL, MiddleName = NULL, LastName = NULL, HasIEP = NULL, IEPStartDate = NULL, PrimaryEligibility = NULL, SecondaryEligibility = NULL, HasSection504 = NULL, Section504StartDate = NULL, Section504EndDate = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "Student", objectName = "TempEmbrace", body = list(DataObject = body), searchFields = append("TempEmbraceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyTempEmbrace <- function(TempEmbraceID, HasExceptions = NULL, Exceptions = NULL, StudentNumber = NULL, StudentStateNumber = NULL, FirstName = NULL, MiddleName = NULL, LastName = NULL, HasIEP = NULL, IEPStartDate = NULL, PrimaryEligibility = NULL, SecondaryEligibility = NULL, HasSection504 = NULL, Section504StartDate = NULL, Section504EndDate = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "Student", objectName = "TempEmbrace", objectId = TempEmbraceID, body = list(DataObject = body), searchFields = append("TempEmbraceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getSchoolMintRunHistoryStudentErrorDetail <- function(SchoolMintRunHistoryStudentErrorDetailID, SchoolMintRunHistoryStudentErrorID = F, ObjectName = F, FieldValue = F, FieldName = F, Message = F, Rank = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "SchoolMintRunHistoryStudentErrorDetail", objectId = SchoolMintRunHistoryStudentErrorDetailID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteSchoolMintRunHistoryStudentErrorDetail <- function(SchoolMintRunHistoryStudentErrorDetailID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "SchoolMintRunHistoryStudentErrorDetail", objectId = SchoolMintRunHistoryStudentErrorDetailID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createSchoolMintRunHistoryStudentErrorDetail <- function(SchoolMintRunHistoryStudentErrorID = NULL, ObjectName = NULL, FieldValue = NULL, FieldName = NULL, Message = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "SchoolMintRunHistoryStudentErrorDetail", body = list(DataObject = body), searchFields = append("SchoolMintRunHistoryStudentErrorDetailID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifySchoolMintRunHistoryStudentErrorDetail <- function(SchoolMintRunHistoryStudentErrorDetailID, SchoolMintRunHistoryStudentErrorID = NULL, ObjectName = NULL, FieldValue = NULL, FieldName = NULL, Message = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
	...
	getTechnologyAtHome <- function(TechnologyAtHomeID, StudentFamilyID = F, SurveyedDate = F, InternetAccessID = F, InternetAccessTypeID = F, InternetPerformanceID = F, DeviceID = F, DeviceAccessID = F, DeviceAccessSourceID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "TechnologyAtHome", objectId = TechnologyAtHomeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteTechnologyAtHome <- function(TechnologyAtHomeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "TechnologyAtHome", objectId = TechnologyAtHomeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createTechnologyAtHome <- function(StudentFamilyID = NULL, SurveyedDate = NULL, InternetAccessID = NULL, InternetAccessTypeID = NULL, InternetPerformanceID = NULL, DeviceID = NULL, DeviceAccessID = NULL, DeviceAccessSourceID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "TechnologyAtHome", body = list(DataObject = body), searchFields = append("TechnologyAtHomeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyTechnologyAtHome <- function(TechnologyAtHomeID, StudentFamilyID = NULL, SurveyedDate = NULL, InternetAccessID = NULL, InternetAccessTypeID = NULL, InternetPerformanceID = NULL, DeviceID = NULL, DeviceAccessID = NULL, DeviceAccessSourceID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "TechnologyAtHome", objectId = TechnologyAtHomeID, body = list(DataObject = body), searchFields = append("TechnologyAtHomeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getDeviceAccess <- function(DeviceAccessID, DistrictID = F, SchoolYearID = F, Code = F, StateDeviceAccessID = F, DeviceAccessIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "DeviceAccess", objectId = DeviceAccessID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDeviceAccess <- function(DeviceAccessID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "DeviceAccess", objectId = DeviceAccessID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDeviceAccess <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateDeviceAccessID = NULL, DeviceAccessIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "DeviceAccess", body = list(DataObject = body), searchFields = append("DeviceAccessID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDeviceAccess <- function(DeviceAccessID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateDeviceAccessID = NULL, DeviceAccessIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "DeviceAccess", objectId = DeviceAccessID, body = list(DataObject = body), searchFields = append("DeviceAccessID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getDeviceAccessSource <- function(DeviceAccessSourceID, DistrictID = F, SchoolYearID = F, Code = F, StateDeviceAccessSourceID = F, DeviceAccessSourceIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "DeviceAccessSource", objectId = DeviceAccessSourceID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDeviceAccessSource <- function(DeviceAccessSourceID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "DeviceAccessSource", objectId = DeviceAccessSourceID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDeviceAccessSource <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateDeviceAccessSourceID = NULL, DeviceAccessSourceIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "DeviceAccessSource", body = list(DataObject = body), searchFields = append("DeviceAccessSourceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDeviceAccessSource <- function(DeviceAccessSourceID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateDeviceAccessSourceID = NULL, DeviceAccessSourceIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "DeviceAccessSource", objectId = DeviceAccessSourceID, body = list(DataObject = body), searchFields = append("DeviceAccessSourceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getDevice <- function(DeviceID, DistrictID = F, SchoolYearID = F, Code = F, StateDeviceID = F, DeviceIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "Device", objectId = DeviceID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDevice <- function(DeviceID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "Device", objectId = DeviceID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDevice <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateDeviceID = NULL, DeviceIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "Device", body = list(DataObject = body), searchFields = append("DeviceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDevice <- function(DeviceID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateDeviceID = NULL, DeviceIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "Device", objectId = DeviceID, body = list(DataObject = body), searchFields = append("DeviceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getInternetAccess <- function(InternetAccessID, DistrictID = F, SchoolYearID = F, Code = F, StateInternetAccessID = F, InternetAccessIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "InternetAccess", objectId = InternetAccessID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInternetAccess <- function(InternetAccessID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "InternetAccess", objectId = InternetAccessID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInternetAccess <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateInternetAccessID = NULL, InternetAccessIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "InternetAccess", body = list(DataObject = body), searchFields = append("InternetAccessID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInternetAccess <- function(InternetAccessID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateInternetAccessID = NULL, InternetAccessIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "InternetAccess", objectId = InternetAccessID, body = list(DataObject = body), searchFields = append("InternetAccessID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getInternetAccessType <- function(InternetAccessTypeID, DistrictID = F, SchoolYearID = F, Code = F, StateInternetAccessTypeID = F, InternetAccessTypeIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "InternetAccessType", objectId = InternetAccessTypeID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInternetAccessType <- function(InternetAccessTypeID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "InternetAccessType", objectId = InternetAccessTypeID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInternetAccessType <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateInternetAccessTypeID = NULL, InternetAccessTypeIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "InternetAccessType", body = list(DataObject = body), searchFields = append("InternetAccessTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInternetAccessType <- function(InternetAccessTypeID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateInternetAccessTypeID = NULL, InternetAccessTypeIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "InternetAccessType", objectId = InternetAccessTypeID, body = list(DataObject = body), searchFields = append("InternetAccessTypeID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getInternetPerformance <- function(InternetPerformanceID, DistrictID = F, SchoolYearID = F, Code = F, StateInternetPerformanceID = F, InternetPerformanceIDClonedFrom = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "Student", objectName = "InternetPerformance", objectId = InternetPerformanceID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteInternetPerformance <- function(InternetPerformanceID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "Student", objectName = "InternetPerformance", objectId = InternetPerformanceID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createInternetPerformance <- function(DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateInternetPerformanceID = NULL, InternetPerformanceIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		createSkyObject(module = "Student", objectName = "InternetPerformance", body = list(DataObject = body), searchFields = append("InternetPerformanceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyInternetPerformance <- function(InternetPerformanceID, DistrictID = NULL, SchoolYearID = NULL, Code = NULL, StateInternetPerformanceID = NULL, InternetPerformanceIDClonedFrom = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% compact()

		modifySkyObject(module = "Student", objectName = "InternetPerformance", objectId = InternetPerformanceID, body = list(DataObject = body), searchFields = append("InternetPerformanceID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
