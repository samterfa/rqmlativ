	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getStaffContact
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStaffContact <- function(StaffContactID, OnlineFormID = F, StaffID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "StaffContact", objectId = StaffContactID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormType
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormType <- function(OnlineFormTypeID, Code = F, Description = F, LimitUsersToOneFormOfThisTypePerYear = F, DistrictID = F, CodeDescription = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineFormType", objectId = OnlineFormTypeID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get OnlineFormTempCertification
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormTempCertification
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormTempCertification <- function(OnlineFormTempCertificationID, TempCertificationID = F, CertificationID = F, EmployeeID = F, CertificationTypeID = F, InstitutionID = F, StateID = F, CertificationNumber = F, IssueDate = F, ExpirationDate = F, IsDelete = F, OnScreenCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempCertification", objectId = OnlineFormTempCertificationID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormTempDegree
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormTempDegree <- function(OnlineFormTempDegreeID, TempDegreeID = F, DegreeID = F, EmployeeID = F, DegreeTypeID = F, InstitutionID = F, ReceivedDate = F, ApprovedDate = F, Credits = F, GPA = F, AdditionalCredits = F, IsDelete = F, OnScreenCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempDegree", objectId = OnlineFormTempDegreeID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getElementStatus
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getElementStatus <- function(ElementStatusID, StepStatusID = F, ElementID = F, UserSubmitted = F, IsReadOnly = F, StatusType = F, DenialMessage = F, ValidationMessage = F, OriginalValue = F, RequestedValue = F, UserIDApprover = F, MediaIDAttachment = F, SharedElementStatusID = F, NeedsAdminReviewSave = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "ElementStatus", objectId = ElementStatusID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get NewStudentEnrollmentGuardianData
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getNewStudentEnrollmentGuardianData
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getNewStudentEnrollmentGuardianData <- function(NewStudentEnrollmentGuardianDataID, FamilyGuardianID = F, NameID = F, LastName = F, FirstName = F, MiddleName = F, NameSuffixID = F, GenderCode = F, RelationshipID = F, AllowStudentPickup = F, DriversLicenseNumber = F, DeleteGuardian = F, OnScreenID = F, Rank = F, CreateNewGuardian = F, AddGuardian = F, NameVehicleID = F, VehicleID = F, Year = F, MakeModel = F, Color = F, LicensePlateNumber = F, VIN = F, IsCustodialGuardian = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "NewStudentEnrollmentGuardianData", objectId = NewStudentEnrollmentGuardianDataID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get NewStudentEnrollmentUserData
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getNewStudentEnrollmentUserData
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getNewStudentEnrollmentUserData <- function(NewStudentEnrollmentUserDataID, UserIDSubmittedBy = F, PhysicalStreetNumber = F, PhysicalStreetName = F, UnitNumber = F, Unit = F, ZipCode = F, City = F, State = F, EmailAddress = F, PhoneNumber = F, PreviouslyInDistrict = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "NewStudentEnrollmentUserData", objectId = NewStudentEnrollmentUserDataID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormStatus
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormStatus <- function(OnlineFormStatusID, NameID = F, SecondaryID = F, StatusType = F, SubmittedDateTime = F, DenialMessage = F, DenialDateTime = F, CompletedByAdmin = F, UserIDApprover = F, UserIDSubmittedBy = F, ApprovalRevoked = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, OnlineFormEntityID = F, IsOutsideAddressRanges = F, WithinCutoffTime = F, FullNameLFMSubmittedForOverride = F, FullNameLFMSubmittedFor = F, IsOutsideAddressRangeSchoolPaths = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineFormStatus", objectId = OnlineFormStatusID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getSharedElementStatus
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getSharedElementStatus <- function(SharedElementStatusID, SchoolYearID = F, SecondaryID = F, NameID = F, MediaIDAttachment = F, ElementType = F, FieldGroupType = F, Value = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "SharedElementStatus", objectId = SharedElementStatusID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getStepStatus
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getStepStatus <- function(StepStatusID, OnlineFormStatusID = F, StepID = F, StatusType = F, DenialMessage = F, ValidationMessage = F, PreviousStepStatusID = F, NextStepStatusID = F, HasPreviousStepStatus = F, HasNextStepStatus = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "StepStatus", objectId = StepStatusID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get OnlineFormTempEmergencyContact
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormTempEmergencyContact
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormTempEmergencyContact <- function(OnlineFormTempEmergencyContactID, TempEmergencyContactID = F, EmergencyContactID = F, Rank = F, NameID = F, FirstName = F, MiddleName = F, LastName = F, RelationshipID = F, AllowStudentPickup = F, DriversLicenseNumber = F, Comment = F, PrimaryPhoneNamePhoneID = F, PrimaryPhonePhoneTypeID = F, PrimaryPhonePhoneNumber = F, PrimaryPhoneExtension = F, PrimaryPhonePreventFamilyStudentAccessUpdates = F, SecondPhoneNamePhoneID = F, SecondPhonePhoneTypeID = F, SecondPhonePhoneNumber = F, SecondPhoneExtension = F, SecondPhonePreventFamilyStudentAccessUpdates = F, ThirdPhoneNamePhoneID = F, ThirdPhonePhoneTypeID = F, ThirdPhonePhoneNumber = F, ThirdPhoneExtension = F, ThirdPhonePreventFamilyStudentAccessUpdates = F, PrimaryEmailNameEmailID = F, PrimaryEmailEmailTypeID = F, PrimaryEmailEmailAddress = F, PrimaryEmailPreventFamilyStudentAccessUpdates = F, SecondEmailNameEmailID = F, SecondEmailEmailTypeID = F, SecondEmailEmailAddress = F, SecondEmailPreventFamilyStudentAccessUpdates = F, ThirdEmailNameEmailID = F, ThirdEmailEmailTypeID = F, ThirdEmailEmailAddress = F, ThirdEmailPreventFamilyStudentAccessUpdates = F, OnScreenID = F, CreateNewEmergencyContactName = F, DeleteEmergencyContact = F, AddEmergencyContact = F, IsAlsoGuardian = F, ForSecondFamily = F, IsBusiness = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, IsHealthProfessionalName = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempEmergencyContact", objectId = OnlineFormTempEmergencyContactID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get TempNewStudentEnrollmentGuardianPhone
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getTempNewStudentEnrollmentGuardianPhone
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempNewStudentEnrollmentGuardianPhone <- function(TempNewStudentEnrollmentGuardianPhoneID, NamePhoneID = F, PhoneTypeID = F, PhoneNumber = F, Extension = F, PhonePreventFamilyStudentAccessUpdates = F, Rank = F, OnScreenID = F, ParentOnScreenID = F, CreateNewPhone = F, DeletePhone = F, AddPhone = F, IsConfidential = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempNewStudentEnrollmentGuardianPhone", objectId = TempNewStudentEnrollmentGuardianPhoneID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get TempNewStudentEnrollmentGuardianEmail
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getTempNewStudentEnrollmentGuardianEmail
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempNewStudentEnrollmentGuardianEmail <- function(TempNewStudentEnrollmentGuardianEmailID, NameEmailID = F, EmailTypeID = F, EmailAddress = F, EmailPreventFamilyStudentAccessUpdates = F, OnScreenID = F, ParentOnScreenID = F, CreateNewEmail = F, DeleteEmail = F, AddEmail = F, Rank = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempNewStudentEnrollmentGuardianEmail", objectId = TempNewStudentEnrollmentGuardianEmailID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getTempStep
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStep <- function(TempStepID, EntityGroupKey = F, StepID = F, OnlineFormID = F, Name = F, Message = F, IsRequired = F, IsActive = F, Order = F, IsReadOnlyForNonPrimaryFamily = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ErrorCount = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempStep", objectId = TempStepID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getElement
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getElement <- function(ElementID, StepID = F, MediaID = F, FieldID = F, Type = F, ParameterData = F, Description = F, Order = F, AllowsUserInteraction = F, HasBackingObject = F, AdminCanEdit = F, HasSharedValue = F, SharedValueUsesNotShared = F, IsNewStudentEnrollmentElement = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, RenderWeight = F, FieldRelationship = F, SupportsLabelOverrides = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "Element", objectId = ElementID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormStep
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormStep <- function(OnlineFormStepID, StepID = F, OnlineFormID = F, Name = F, Message = F, IsRequired = F, IsActive = F, Order = F, IsReadOnlyForNonPrimaryFamily = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "Step", objectId = OnlineFormStepID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormDateException
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormDateException <- function(OnlineFormDateExceptionID, OnlineFormID = F, ObjectID = F, ObjectPrimaryKey = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineFormDateException", objectId = OnlineFormDateExceptionID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineForm
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineForm <- function(OnlineFormID, Name = F, SchoolYearID = F, OnlineFormTypeID = F, Description = F, ShowDescriptionOnTile = F, Filter = F, Module = F, Object = F, IncludeInStudentPortal = F, IncludeInFamilyPortal = F, IncludeInAdministrativePortal = F, IncludeInEmployeePortal = F, IncludeInTeacherPortal = F, IncludeInActivitiesPortal = F, IncludeInNewStudentEnrollmentPortal = F, IsPublished = F, StartDate = F, EndDate = F, Message = F, ReviewStepMessage = F, MessageAfterSubmission = F, DisplayForNonPrimaryFamily = F, IncludeAdobeAcrobatLink = F, IconCode = F, OnlineFormIDClonedFrom = F, MessageForNonPrimaryFamily = F, PortalsIncludedIn = F, MainPageEmbeddedLinkProtocol = F, MainPageEmbeddedLinkUrl = F, InUseByUsers = F, ContactHash = F, AllowContact = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, AllowMultipleFormsPerUser = F, Portals = F, NoApprovalNeeded = F, SendFamilyAccessEmail = F, HideCurrentValueOnApproval = F, SkipInstructionsPage = F, SkipThankYouPage = F, YearType = F, FilterSubType = F, PortalType = F, IsUserInitiated = F, CutoffTime = F, WithinCutoffTime = F, LimitToOnePerDay = F, OnlineFormStatusExistsToday = F, SkipReviewPage = F, ThankYouPageLinkProtocol = F, ThankYouPageLinkUrl = F, ThankYouPageLinkUrlDisplayName = F, IncludeInReporting = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineForm", objectId = OnlineFormID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getElementGroup
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getElementGroup <- function(ElementGroupID, SkywardID = F, Name = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SkywardHash = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "ElementGroup", objectId = ElementGroupID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getElementGroupTemplate
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getElementGroupTemplate <- function(ElementGroupTemplateID, SkywardID = F, ElementGroupID = F, Type = F, ParameterData = F, Order = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, SkywardHash = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "ElementGroupTemplate", objectId = ElementGroupTemplateID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormEntity
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormEntity <- function(OnlineFormEntityID, OnlineFormID = F, EntityID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineFormEntity", objectId = OnlineFormEntityID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormStatusName
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormStatusName <- function(OnlineFormStatusNameID, OnlineFormStatusID = F, NameID = F, ElementID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineFormStatusName", objectId = OnlineFormStatusNameID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getMassPrintHistory
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getMassPrintHistory <- function(MassPrintHistoryID, OnlineFormID = F, MediaID = F, WorkflowInstanceID = F, RequestIdentifier = F, SendMessageOnComplete = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "MassPrintHistory", objectId = MassPrintHistoryID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getElementStatusSurveyAnswer
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getElementStatusSurveyAnswer <- function(ElementStatusSurveyAnswerID, ElementStatusID = F, OnlineFormID = F, NameID = F, ColumnName = F, Value = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "ElementStatusSurveyAnswer", objectId = ElementStatusSurveyAnswerID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getTempDependent
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempDependent <- function(TempDependentID, LastName = F, FirstName = F, MiddleName = F, BirthDate = F, IsExistingRecord = F, IsDelete = F, OnScreenCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, DependentID = F, RelationshipID = F, SocialSecurityNumber = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempDependent", objectId = TempDependentID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormClearance
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormClearance <- function(OnlineFormClearanceID, OnlineFormID = F, GroupIDSecurity = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineFormClearance", objectId = OnlineFormClearanceID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getTempDataGridRow
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempDataGridRow <- function(TempDataGridRowID, ColumnHeader = F, ControlType = F, DefaultValue = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, Options = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempDataGridRow", objectId = TempDataGridRowID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getTeacherOnlineForm
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTeacherOnlineForm <- function(TeacherOnlineFormID, OnlineFormEntityID = F, OnlineFormID = F, OnlineFormStatusID = F, OnlineFormTypeID = F, EntityID = F, SchoolYearID = F, NameID = F, SectionID = F, DisplayPeriodID = F, StatusType = F, SecondaryID = F, FilterInformation = F, NoStartedFormsExist = F, NoFormsExistOfSameType = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StatusTypeSortable = F, OnlineFormStatusExistsToday = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TeacherOnlineForm", objectId = TeacherOnlineFormID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get TempStudentHealthCondition
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getTempStudentHealthCondition
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStudentHealthCondition <- function(TempStudentHealthConditionID, HealthConditionID = F, StudentHealthConditionID = F, StartDate = F, IsExistingStudentHealthCondition = F, IsDelete = F, OnScreenCount = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, StudentHealthConditionNoteID = F, Note = F, IsExistingStudentHealthConditionNote = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempStudentHealthCondition", objectId = TempStudentHealthConditionID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormTempError
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormTempError <- function(OnlineFormTempErrorID, TempErrorID = F, Description = F, Message = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempError", objectId = OnlineFormTempErrorID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getTempStepError
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getTempStepError <- function(TempStepErrorID, TempStepID = F, ErrorMessage = F, Error = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "TempStepError", objectId = TempStepErrorID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get OnlineFormReportableReport
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormReportableReport
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormReportableReport <- function(OnlineFormReportableReportID, ReportID = F, OnlineFormID = F, ElementID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineFormReportableReport", objectId = OnlineFormReportableReportID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' Get OnlineFormReportableObject
	#'
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getOnlineFormReportableObject
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getOnlineFormReportableObject <- function(OnlineFormReportableObjectID, ObjectID = F, OnlineFormID = F, DeleteOrder = F, ElementID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "OnlineFormReportableObject", objectId = OnlineFormReportableObjectID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' @param returnResponse Whether to return the server response instead of the results. Useful for debugging. Default is FALSE.
	#' @concept Online Form
	#' @return A dataframe or of getPreschool1perStudent
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getPreschool1perStudent <- function(Preschool1perStudentID, OnlineFormStatusID = F, OnlineFormID = F, Step1Element1 = F, Step1Element2 = F, Step2Element3 = F, Step2Element4 = F, Step2Element5 = F, Step2Element7 = F, Step2Element8 = F, Step2Element9 = F, Step3Element4 = F, Step3Element8 = F, Step3Element12 = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "OnlineForm", objectName = "Preschool1perStudent", objectId = Preschool1perStudentID, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
