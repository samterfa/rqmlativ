	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getDisabilityMN <- function(DisabilityMNID, EnrollmentMNID = F, Rank = F, StateDisabilityCodeMNID = F, DisabilityRank = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "SpecialEducation", objectName = "DisabilityMN", objectId = DisabilityMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteDisabilityMN <- function(DisabilityMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "SpecialEducation", objectName = "DisabilityMN", objectId = DisabilityMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createDisabilityMN <- function(EnrollmentMNID = NULL, Rank = NULL, StateDisabilityCodeMNID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "SpecialEducation", objectName = "DisabilityMN", body = list(DataObject = body), searchFields = append("DisabilityMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyDisabilityMN <- function(DisabilityMNID, EnrollmentMNID = NULL, Rank = NULL, StateDisabilityCodeMNID = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "SpecialEducation", objectName = "DisabilityMN", objectId = DisabilityMNID, body = list(DataObject = body), searchFields = append("DisabilityMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEnrollmentMN <- function(EnrollmentMNID, DistrictID = F, StateEvaluationStatusCodeMNIDEvaluation = F, StateSpecEdInstructionalSettingCodeMNID = F, IsConsideredSpecialEd = F, IsExitingSpecialEd = F, StateEvaluationStatusCodeMNIDMARSSExit = F, EntryComment = F, ExitComment = F, StartDate = F, EndDate = F, IsActive = F, StudentID = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, ReceivesServicesInDistrict = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "SpecialEducation", objectName = "EnrollmentMN", objectId = EnrollmentMNID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEnrollmentMN <- function(EnrollmentMNID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "SpecialEducation", objectName = "EnrollmentMN", objectId = EnrollmentMNID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	createEnrollmentMN <- function(DistrictID = NULL, StateEvaluationStatusCodeMNIDEvaluation = NULL, StateSpecEdInstructionalSettingCodeMNID = NULL, IsConsideredSpecialEd = NULL, IsExitingSpecialEd = NULL, StateEvaluationStatusCodeMNIDMARSSExit = NULL, EntryComment = NULL, ExitComment = NULL, StartDate = NULL, EndDate = NULL, StudentID = NULL, ReceivesServicesInDistrict = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		createSkyObject(module = "SpecialEducation", objectName = "EnrollmentMN", body = list(DataObject = body), searchFields = append("EnrollmentMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	modifyEnrollmentMN <- function(EnrollmentMNID, DistrictID = NULL, StateEvaluationStatusCodeMNIDEvaluation = NULL, StateSpecEdInstructionalSettingCodeMNID = NULL, IsConsideredSpecialEd = NULL, IsExitingSpecialEd = NULL, StateEvaluationStatusCodeMNIDMARSSExit = NULL, EntryComment = NULL, ExitComment = NULL, StartDate = NULL, EndDate = NULL, StudentID = NULL, ReceivesServicesInDistrict = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		modifySkyObject(module = "SpecialEducation", objectName = "EnrollmentMN", objectId = EnrollmentMNID, body = list(DataObject = body), searchFields = append("EnrollmentMNID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getNextRestraintInstanceNumberTX <- function(NextRestraintInstanceNumberTXID, DistrictID = F, SchoolYearID = F, SequenceNumber = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "SpecialEducation", objectName = "NextRestraintInstanceNumberTX", objectId = NextRestraintInstanceNumberTXID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteNextRestraintInstanceNumberTX <- function(NextRestraintInstanceNumberTXID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "SpecialEducation", objectName = "NextRestraintInstanceNumberTX", objectId = NextRestraintInstanceNumberTXID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createNextRestraintInstanceNumberTX <- function(DistrictID = NULL, SchoolYearID = NULL, SequenceNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "SpecialEducation", objectName = "NextRestraintInstanceNumberTX", body = list(DataObject = body), searchFields = append("NextRestraintInstanceNumberTXID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyNextRestraintInstanceNumberTX <- function(NextRestraintInstanceNumberTXID, DistrictID = NULL, SchoolYearID = NULL, SequenceNumber = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "SpecialEducation", objectName = "NextRestraintInstanceNumberTX", objectId = NextRestraintInstanceNumberTXID, body = list(DataObject = body), searchFields = append("NextRestraintInstanceNumberTXID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getEasyIEPException <- function(EasyIEPExceptionID, EasyIEPRunHistoryID = F, StudentID = F, RecordType = F, StartDate = F, EndDate = F, Message = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "SpecialEducation", objectName = "EasyIEPException", objectId = EasyIEPExceptionID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEasyIEPException <- function(EasyIEPExceptionID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "SpecialEducation", objectName = "EasyIEPException", objectId = EasyIEPExceptionID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEasyIEPException <- function(EasyIEPRunHistoryID = NULL, StudentID = NULL, RecordType = NULL, StartDate = NULL, EndDate = NULL, Message = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "SpecialEducation", objectName = "EasyIEPException", body = list(DataObject = body), searchFields = append("EasyIEPExceptionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEasyIEPException <- function(EasyIEPExceptionID, EasyIEPRunHistoryID = NULL, StudentID = NULL, RecordType = NULL, StartDate = NULL, EndDate = NULL, Message = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "SpecialEducation", objectName = "EasyIEPException", objectId = EasyIEPExceptionID, body = list(DataObject = body), searchFields = append("EasyIEPExceptionID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	getEasyIEPImportedRecord <- function(EasyIEPImportedRecordID, EasyIEPRunHistoryID = F, StudentID = F, StartDate = F, EndDate = F, RecordType = F, UpdateType = F, Message = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "SpecialEducation", objectName = "EasyIEPImportedRecord", objectId = EasyIEPImportedRecordID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEasyIEPImportedRecord <- function(EasyIEPImportedRecordID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "SpecialEducation", objectName = "EasyIEPImportedRecord", objectId = EasyIEPImportedRecordID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEasyIEPImportedRecord <- function(EasyIEPRunHistoryID = NULL, StudentID = NULL, StartDate = NULL, EndDate = NULL, RecordType = NULL, UpdateType = NULL, Message = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "SpecialEducation", objectName = "EasyIEPImportedRecord", body = list(DataObject = body), searchFields = append("EasyIEPImportedRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEasyIEPImportedRecord <- function(EasyIEPImportedRecordID, EasyIEPRunHistoryID = NULL, StudentID = NULL, StartDate = NULL, EndDate = NULL, RecordType = NULL, UpdateType = NULL, Message = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "SpecialEducation", objectName = "EasyIEPImportedRecord", objectId = EasyIEPImportedRecordID, body = list(DataObject = body), searchFields = append("EasyIEPImportedRecordID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	getEasyIEPRunHistory <- function(EasyIEPRunHistoryID, SchoolYearID = F, DistrictID = F, StartTime = F, EndTime = F, ProcessType = F, ImportType = F, IsLocked = F, ExceptionCount = F, AddCount = F, UpdateCount = F, DeleteCount = F, Status = F, RunData = F, UserIDCanceledBy = F, UserIDCreatedBy = F, CreatedTime = F, UserIDModifiedBy = F, ModifiedTime = F, RunParameters = F, fieldPaths = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){
		...
		getSkyObject(module = "SpecialEducation", objectName = "EasyIEPRunHistory", objectId = EasyIEPRunHistoryID, searchFields = searchFields, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	deleteEasyIEPRunHistory <- function(EasyIEPRunHistoryID, ignoreWarnings = F, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		deleteSkyObject(module = "SpecialEducation", objectName = "EasyIEPRunHistory", objectId = EasyIEPRunHistoryID, ignoreWarnings = ignoreWarnings, entityId = entityId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	createEasyIEPRunHistory <- function(SchoolYearID = NULL, DistrictID = NULL, StartTime = NULL, EndTime = NULL, ProcessType = NULL, ImportType = NULL, Status = NULL, UserIDCanceledBy = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		createSkyObject(module = "SpecialEducation", objectName = "EasyIEPRunHistory", body = list(DataObject = body), searchFields = append("EasyIEPRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
	...
	#' \href{https://help.skyward.com/}{Skyward's Knowledge Hub}
	#' @export
	modifyEasyIEPRunHistory <- function(EasyIEPRunHistoryID, SchoolYearID = NULL, DistrictID = NULL, StartTime = NULL, EndTime = NULL, ProcessType = NULL, ImportType = NULL, Status = NULL, UserIDCanceledBy = NULL, entityId = 1, schoolYearId = NULL, flatten = T, returnResponse = F){

		params <- as.list(environment())

		body <- params %>% purrr::keep(names(params) %>% stringr::str_sub(1,1) == names(params) %>% stringr::str_sub(1,1) %>% stringr::str_to_upper()) %>% purrr::compact()

		modifySkyObject(module = "SpecialEducation", objectName = "EasyIEPRunHistory", objectId = EasyIEPRunHistoryID, body = list(DataObject = body), searchFields = append("EasyIEPRunHistoryID", body %>% names()), entityId = entityId, schoolYearId = schoolYearId, flatten = flatten, returnResponse = returnResponse)
	}
